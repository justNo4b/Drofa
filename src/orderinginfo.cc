...
void OrderingInfo::decrementFollowHistory(Color color, int ppMoveIndx, PieceType pType, int to, int depth){
  int16_t current = _followMoveHistory[color][ppMoveIndx][pType][to];
  int16_t bonus   = -1 * depth * depth;
