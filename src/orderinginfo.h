...
class OrderingInfo {
 public:
   ...
   * @param PieceType Piece type of the moving Piece
   ...
   * @param prevMove previous move in the search
   */
   ...
   * @param type PieceType of the moving piece
   ...
   */
  int getHistory(Color, PieceType, int, int, int) const;
 ...
 private:
  ...
  /**
   * @brief Table of history values that dependant on previous move
   * Indexed by [prevType][prevTo][moveType][moveTo]
   */
  int16_t _counterMoveHistory[6][64][6][16];
