...
class OrderingInfo {
 public:
  ...
  void incrementCounterHistory(int, int, PieceType, int, int);

  void decrementCounterHistory(int, int, PieceType, int, int);
   ...
   * @param to        move to
   */
  int getCountermoveHistory(int, int, PieceType, int) const;
