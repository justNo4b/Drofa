...
const U64 TRAP_ROOK_WHITE_00  = (ONE << h1) | (ONE << h2) | (ONE << g1);
const U64 TRAP_ROOK_KINGW_00  = (ONE << f1) | (ONE << g1);
const U64 TRAP_ROOK_BLACK_00  = (ONE << h8) | (ONE << h7) | (ONE << g8);
const U64 TRAP_ROOK_KINGB_00  = (ONE << f8) | (ONE << g8);
const U64 TRAP_ROOK_WHITE_000 = (ONE << a1) | (ONE << a2) | (ONE << b1);
const U64 TRAP_ROOK_KINGW_000 = (ONE << c1) | (ONE << b1);
const U64 TRAP_ROOK_BLACK_000 = (ONE << a8) | (ONE << a7) | (ONE << b8);
const U64 TRAP_ROOK_KINGB_000 = (ONE << c8) | (ONE << b8);
/**@}*/
