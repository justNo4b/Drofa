...
tFeature myFeatures [BIG_FEATURE_NUMBER] = {
    ...
    tFeature("KNIGHT_KING_DISTANCE_ENEMY", true, Eval::KNIGHT_KING_DISTANCE_ENEMY, 4, 10, ALL),
    tFeature("KNIGHT_KING_DISTANCE_FRIENDLY", true, Eval::KNIGHT_KING_DISTANCE_FRIENDLY, 4, 10, ALL),
