...
tFeature myFeatures [BIG_FEATURE_NUMBER] = {
    ...
    tFeature("ROOK_PSQT_BLACK", true, Eval::ROOK_PSQT_BLACK, 32, 4, ALL),
    tFeature("BISHOP_PSQT_BLACK", true, Eval::BISHOP_PSQT_BLACK, 32, 4, ALL),
    tFeature("KNIGHT_PSQT_BLACK", true, Eval::KNIGHT_PSQT_BLACK, 32, 4, ALL),
    tFeature("QUEEN_PSQT_BLACK", true, Eval::QUEEN_PSQT_BLACK, 32, 4, ALL),
