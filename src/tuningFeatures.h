...
tFeature myFeatures [BIG_FEATURE_NUMBER] = {
    ...
    tFeature("KING_OPEN_FILE", true, Eval::KING_OPEN_FILE, 2, 10, ALL),
    tFeature("KING_OWN_SEMI_FILE", true, Eval::KING_OWN_SEMI_FILE, 2, 10, ALL),
    tFeature("KING_ENEMY_SEMI_LINE", true, Eval::KING_ENEMY_SEMI_LINE, 2, 10, ALL),
