...
tFeature myFeatures [BIG_FEATURE_NUMBER] = {
    ...
    tFeature("PAWN_CONNECTED", true, Eval::PAWN_CONNECTED, 2, 10, ALL),
    tFeature("DOUBLED_PAWN_PENALTY", true, Eval::DOUBLED_PAWN_PENALTY, 2, 10, ALL),
    tFeature("ISOLATED_PAWN_PENALTY", true, Eval::ISOLATED_PAWN_PENALTY, 2, 10, ALL),
