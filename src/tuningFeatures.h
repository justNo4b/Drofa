...
tFeature myFeatures [BIG_FEATURE_NUMBER] = {
    ...
    tFeature("KING_PASSER_DISTANCE_FRIENDLY_NOTEMPO", true, Eval::KING_PASSER_DISTANCE_FRIENDLY_NOTEMPO, 8, 4, ALL),
    tFeature("KING_PASSER_DISTANCE_ENEMY", true, Eval::KING_PASSER_DISTANCE_ENEMY, 8, 4, ALL),
    tFeature("KING_PASSER_DISTANCE_ENEMY_NOTEMPO", true, Eval::KING_PASSER_DISTANCE_ENEMY_NOTEMPO, 8, 4, ALL),
    tFeature("KNIGHT_PASSER_DISTANCE_ENEMY", true, Eval::KNIGHT_PASSER_DISTANCE_ENEMY, 4, 10, ALL),
    tFeature("KNIGHT_PASSER_DISTANCE_ENEMY_NOTEMPO", true, Eval::KNIGHT_PASSER_DISTANCE_ENEMY_NOTEMPO, 4, 10, ALL),
