...
tFeature myFeatures [BIG_FEATURE_NUMBER] = {
    ...
    tFeature("KING_ATTACK_RAMMED_PAWN", false, &Eval::KING_ATTACK_RAMMED_PAWN, 1, 1, ALL),
    tFeature("KING_ATTACK_PROTECTED_PAWN", false, &Eval::KING_ATTACK_PROTECTED_PAWN, 1, 1, ALL),
