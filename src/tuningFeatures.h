...
tFeature myFeatures [BIG_FEATURE_NUMBER] = {
    ...
    tFeature("CANDIDATE_PASSED_PAWN", true, Eval::CANDIDATE_PASSED_PAWN, 6, 4, ALL),
    tFeature("CANDIDATE_ENEMY_KING_DISTANCE", true, Eval::CANDIDATE_ENEMY_KING_DISTANCE, 8, 4, ALL),
