...
Eval::SetupTuning( KNIGHT, atoi(optionsMap["vKnight"].getValue().c_str()));  

Eval::SetupTuning( BISHOP, atoi(optionsMap["vBishop"].getValue().c_str())); 

Eval::SetupTuning( ROOK, atoi(optionsMap["vRook"].getValue().c_str())); 

Eval::SetupTuning( QUEEN, atoi(optionsMap["vQueen"].getValue().c_str())); 
}
...
void initOptions() {
  ...
  optionsMap["vKnight"] = Option(35, 0, 200, &loadCosts);
  optionsMap["vBishop"] = Option(20, 0, 200, &loadCosts);
  optionsMap["vRook"] =   Option(40, 0, 200, &loadCosts);
  optionsMap["vQueen"] =  Option(80, 0, 200, &loadCosts);
