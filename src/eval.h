...
const int ISOLATED_PAWN_PENALTY = gS(-3,-3);

const int DOUBLE_AND_ISOLATED = gS(-8,-8);
...
const int KING_PASSER_DISTANCE_FRIENDLY[8] = {
           ...
           gS(-3,0), gS(0,0), gS(13,0), gS(12,-1),
};

const int KING_PASSER_DISTANCE_ENEMY[8] = {
           gS(0,0), gS(-49,-2), gS(8,-15), gS(0,1),
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,21), gS(13,0), gS(22,3),
...
const int KNIGHT_MOBILITY[9] = {
           ...
           gS(28,13), gS(32,10), gS(36,4), gS(39,-4),
};

const int KING_MOBILITY[9] = {
           gS(14,-30), gS(5,-4), gS(0,5), gS(-2,10), gS(-5,7),
           gS(-8,6), gS(0,4), gS(0,0), gS(15,-15),
};

const int ROOK_MOBILITY[15] = {
           gS(-27,-88), gS(-14,-51), gS(-7,-32), gS(0,-19), gS(2,-7), gS(0,5), gS(5,7),
           gS(7,7), gS(10,12), gS(13,16), gS(14,21), gS(16,23), gS(21,21), gS(27,21),
           gS(49,10),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-91), gS(0,-28), gS(0,-11), gS(0,-6), gS(0,-18), gS(0,-22), gS(0,-12), gS(0,-94),
           ...
           gS(4,-29), gS(-1,-8), gS(-2,0), gS(-22,8), gS(-23,9), gS(-2,0), gS(-3,-7), gS(4,-32),
           gS(-14,-56), gS(6,-38), gS(-12,-18), gS(-34,-15), gS(10,-45), gS(-13,-26), gS(6,-36), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(51,69), gS(40,76), gS(36,65), gS(65,50), gS(60,57), gS(45,60), gS(0,82), gS(0,69),
           gS(0,32), gS(8,28), gS(25,10), gS(40,-1), gS(41,0), gS(69,2), gS(25,21), gS(26,13),
           gS(-13,16), gS(2,10), gS(4,0), gS(12,-1), gS(18,-2), gS(17,-1), gS(23,0), gS(-5,5),
           gS(-25,5), gS(-20,11), gS(-9,0), gS(9,-3), gS(8,-4), gS(7,-4), gS(-4,1), gS(-19,-4),
           gS(-26,-1), gS(-19,0), gS(-7,-4), gS(-5,-1), gS(0,-1), gS(0,-3), gS(-3,-6), gS(-21,-10),
           gS(-36,6), gS(-16,6), gS(-14,6), gS(0,6), gS(0,9), gS(0,4), gS(-4,1), gS(-26,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-5,12), gS(-6,18), gS(-9,8), gS(-1,0), gS(-1,2), gS(-7,5), gS(-4,21), gS(-4,14),
           gS(-3,-4), gS(-3,-3), gS(-10,-8), gS(0,-19), gS(0,-14), gS(-6,-4), gS(-6,0), gS(-4,0),
           gS(0,-18), gS(-3,-11), gS(2,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-5,-2), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-7,-7), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-4), gS(0,-27),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,11), gS(-7,12), gS(-9,12), gS(-2,0), gS(-1,1), gS(-7,2), gS(-1,21), gS(-4,8),
           gS(0,-1), gS(0,0), gS(-1,0), gS(1,-16), gS(0,-14), gS(-1,-8), gS(-9,-3), gS(0,1),
           gS(0,13), gS(0,0), gS(1,-5), gS(0,-8), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(3,2), gS(-1,6), gS(-1,4), gS(-5,4), gS(-2,6), gS(-2,10), gS(4,-3), gS(7,2),
           gS(5,29), gS(0,15), gS(-2,24), gS(-1,19), gS(-4,16), gS(2,20), gS(6,14), gS(9,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,21), gS(0,27), gS(0,21), gS(5,20), gS(12,20), gS(25,17), gS(37,14),
           ...
           gS(-13,8), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-2,1), gS(-5,5), gS(-18,4),
           ...
           gS(-4,-12), gS(1,-14), gS(2,-9), gS(11,-20), gS(13,-23), gS(13,-21), gS(-8,-11), gS(-3,-25),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-8,-1), gS(9,5), gS(3,2), gS(20,10), gS(15,10), gS(11,4), gS(7,2), gS(-3,-7),
           ...
           gS(16,-19), gS(13,-25), gS(17,-10), gS(5,0), gS(15,0), gS(16,-6), gS(22,-21), gS(8,-29),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(1,0), gS(13,5), gS(18,20), gS(22,17), gS(24,21), gS(29,13), gS(24,1), gS(11,0),
           gS(-6,-21), gS(10,-7), gS(10,4), gS(20,16), gS(24,13), gS(22,1), gS(26,-9), gS(4,-11),
           gS(-5,-27), gS(-10,2), gS(5,-5), gS(7,7), gS(13,5), gS(13,-3), gS(1,0), gS(4,-15),
           gS(-40,-29), gS(-12,-16), gS(0,-5), gS(2,2), gS(9,4), gS(-1,-3), gS(-7,-6), gS(-18,-29),
};
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-4,-16), gS(-7,9), gS(-5,19), gS(-4,40), gS(-8,53), gS(-4,36), gS(-3,26), gS(3,-4),
           gS(0,-26), gS(-6,0), gS(-1,11), gS(-3,38), gS(3,34), gS(-4,10), gS(8,4), gS(-5,-3),
           gS(-3,-32), gS(10,-24), gS(6,-5), gS(3,0), gS(3,0), gS(7,-5), gS(14,-11), gS(4,-27),
           gS(4,-52), gS(11,-57), gS(19,-57), gS(12,-33), gS(14,-29), gS(21,-64), gS(25,-79), gS(0,-44),
...
const int MATERIAL_VALUES[5] = {
           gS(89,112), gS(513,682), gS(355,376), gS(379,396), gS(1001,1259),
};
