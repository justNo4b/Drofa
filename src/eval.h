...
const int KING_PAWNLESS_FLANG = gS(-10,-38);
...
const int PASSED_PAWN_RANKS[7] = {
           ...
           gS(15,52), gS(26,78), gS(52,86),
};

const int PASSED_PAWN_FILES[4] = {
           gS(1,18), gS(-3,13), gS(0,5), gS(-1,-4),
};
...
const int PASSED_PAWN_POS_ADVANCE[7] = {
           ...
           gS(13,28), gS(35,59), gS(62,107),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-4,-22), gS(18,4), gS(0,-19), gS(-7,-7),
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,21), gS(13,0), gS(23,4),
...
const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-34), gS(17,-7), gS(21,2), gS(25,9),
           gS(29,13), gS(32,11), gS(36,4), gS(39,-4),
};

const int KING_MOBILITY[9] = {
           gS(14,-30), gS(5,-3), gS(0,5), gS(-2,10), gS(-5,7),
           gS(-8,5), gS(0,4), gS(0,0), gS(15,-16),
};

const int ROOK_MOBILITY[15] = {
           gS(-27,-88), gS(-13,-51), gS(-6,-32), gS(0,-19), gS(3,-7), gS(0,5), gS(6,7),
           gS(8,7), gS(11,12), gS(13,16), gS(15,21), gS(17,23), gS(21,21), gS(27,20),
           gS(50,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-156), gS(-5,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-17),
           gS(-1,-5), gS(0,7), gS(0,18), gS(0,25), gS(1,30), gS(2,35), gS(2,38),
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-92), gS(0,-29), gS(0,-12), gS(0,-6), gS(0,-18), gS(0,-22), gS(0,-13), gS(0,-94),
           gS(0,-15), gS(0,34), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-22),
           gS(0,-1), gS(27,24), gS(15,36), gS(0,39), gS(0,40), gS(20,36), gS(11,28), gS(0,-3),
           gS(0,-14), gS(11,13), gS(-1,26), gS(-7,35), gS(-8,32), gS(3,24), gS(8,14), gS(-34,-16),
           gS(-12,-25), gS(0,1), gS(-4,15), gS(-15,24), gS(-14,22), gS(-21,17), gS(-1,1), gS(-42,-20),
           gS(-13,-29), gS(12,-6), gS(-12,7), gS(-30,17), gS(-25,16), gS(-22,8), gS(0,-6), gS(-6,-27),
           gS(4,-29), gS(-1,-7), gS(-3,0), gS(-22,9), gS(-24,9), gS(-2,0), gS(-3,-6), gS(4,-32),
           gS(-14,-56), gS(6,-38), gS(-13,-17), gS(-35,-15), gS(10,-44), gS(-13,-25), gS(5,-36), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(52,69), gS(40,76), gS(36,65), gS(65,51), gS(61,57), gS(46,61), gS(0,82), gS(0,69),
           gS(0,32), gS(8,28), gS(25,11), gS(41,-1), gS(42,0), gS(69,3), gS(25,22), gS(26,13),
           gS(-13,16), gS(2,10), gS(5,0), gS(13,-1), gS(19,-1), gS(18,-1), gS(23,0), gS(-5,5),
           gS(-25,5), gS(-20,12), gS(-9,0), gS(9,-3), gS(9,-4), gS(8,-3), gS(-4,1), gS(-18,-5),
           gS(-26,-1), gS(-18,0), gS(-7,-4), gS(-4,0), gS(0,-1), gS(0,-2), gS(-3,-7), gS(-21,-10),
           gS(-35,6), gS(-17,6), gS(-14,7), gS(0,6), gS(0,9), gS(1,5), gS(-4,1), gS(-26,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(0,-44), gS(-1,-21), gS(-5,-7), gS(-12,0), gS(-8,0), gS(1,-2), gS(1,-9), gS(0,-49),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(3,2), gS(-1,6), gS(-1,4), gS(-4,4), gS(-2,6), gS(-2,10), gS(4,-4), gS(7,2),
           gS(5,28), gS(0,16), gS(-2,24), gS(-1,19), gS(-4,16), gS(3,20), gS(6,14), gS(9,17),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,21), gS(0,27), gS(0,21), gS(5,21), gS(12,20), gS(25,17), gS(37,14),
           gS(6,16), gS(0,16), gS(17,12), gS(35,4), gS(27,6), gS(28,4), gS(-6,16), gS(8,11),
           gS(3,17), gS(19,8), gS(19,10), gS(27,2), gS(42,-3), gS(36,-1), gS(27,1), gS(-4,13),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(16,-20), gS(12,-25), gS(17,-10), gS(5,0), gS(15,0), gS(16,-6), gS(22,-21), gS(8,-29),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-6,-21), gS(10,-7), gS(10,5), gS(20,16), gS(23,13), gS(22,1), gS(26,-9), gS(4,-11),
           gS(-5,-27), gS(-10,3), gS(4,-5), gS(7,7), gS(13,5), gS(14,-3), gS(1,1), gS(4,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,35), gS(-2,44), gS(2,36), gS(7,13), gS(-8,14),
           ...
           gS(-3,-32), gS(10,-24), gS(6,-5), gS(4,0), gS(3,0), gS(8,-5), gS(14,-11), gS(4,-27),
           gS(4,-52), gS(12,-57), gS(20,-57), gS(12,-33), gS(14,-29), gS(21,-64), gS(26,-79), gS(0,-44),
...
const int MATERIAL_VALUES[5] = {
           gS(88,112), gS(512,682), gS(355,375), gS(378,396), gS(1001,1260),
};
