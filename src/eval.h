...
const int KNIGHT_POS_KQ_FORK = gS(3,1);

const int KNIGHT_POS_KR_FORK = gS(3,17);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           ...
           gS(5,31), gS(15,44), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(15,12), gS(-4,8), gS(0,0), gS(-7,-3),
};
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-67,-41), gS(-51,-46), gS(-54,-66), gS(-49,-31),
};
...
const int ROOK_ATTACKED_BY[4] = {
           gS(0,0), gS(-2,19), gS(65,21), gS(43,41),
};

const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(62,35), gS(40,20), gS(42,40),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(7,0), gS(14,22), gS(14,1), gS(24,5),
           gS(10,0), gS(-18,-1), gS(-4,15), gS(10,0),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-27,-86), gS(-13,-50), gS(-6,-31), gS(1,-19), gS(4,-7), gS(1,5), gS(6,7),
           gS(8,7), gS(11,12), gS(13,15), gS(15,20), gS(17,23), gS(22,21), gS(28,20),
           gS(50,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-9,-114), gS(-5,-157), gS(-5,-111), gS(-4,-73), gS(-4,-52), gS(-3,-34), gS(-2,-16),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,-16), gS(0,34), gS(5,33), gS(0,33), gS(1,16), gS(0,34), gS(0,31), gS(-4,-22),
           gS(0,-2), gS(27,24), gS(16,36), gS(0,39), gS(0,40), gS(21,35), gS(11,28), gS(0,-3),
           gS(-1,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-8,33), gS(4,24), gS(9,14), gS(-35,-16),
           gS(-13,-25), gS(1,1), gS(-3,15), gS(-15,24), gS(-14,23), gS(-21,17), gS(-1,1), gS(-44,-19),
           gS(-15,-28), gS(12,-6), gS(-12,7), gS(-30,18), gS(-25,17), gS(-22,8), gS(0,-6), gS(-7,-27),
           gS(3,-29), gS(-2,-7), gS(-3,1), gS(-21,9), gS(-23,10), gS(-2,1), gS(-4,-6), gS(4,-32),
           gS(-15,-56), gS(5,-38), gS(-14,-17), gS(-35,-15), gS(9,-44), gS(-13,-25), gS(4,-35), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,77), gS(37,66), gS(65,53), gS(62,58), gS(47,62), gS(0,84), gS(0,71),
           gS(0,31), gS(8,29), gS(25,11), gS(42,0), gS(42,0), gS(70,4), gS(26,23), gS(26,13),
           gS(-12,16), gS(2,11), gS(6,1), gS(14,0), gS(20,-1), gS(19,-1), gS(23,1), gS(-3,5),
           gS(-23,5), gS(-20,12), gS(-8,0), gS(10,-2), gS(9,-4), gS(9,-3), gS(-4,2), gS(-17,-5),
           gS(-24,-1), gS(-18,0), gS(-6,-3), gS(-4,0), gS(1,0), gS(0,-2), gS(-2,-7), gS(-19,-10),
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-3,15), gS(-2,10), gS(0,7), gS(0,2), gS(0,1), gS(-1,1), gS(0,1), gS(0,6),
           gS(-4,11), gS(-7,18), gS(-8,8), gS(-1,0), gS(-1,2), gS(-6,5), gS(-4,21), gS(-4,14),
           gS(-2,-4), gS(-3,-1), gS(-10,-8), gS(0,-19), gS(0,-13), gS(-5,-4), gS(-7,0), gS(-3,0),
           gS(0,-17), gS(-3,-9), gS(1,-13), gS(0,-25), gS(0,-22), gS(0,-6), gS(-6,-1), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-7,-8), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-27),
           gS(0,-42), gS(-1,-21), gS(-5,-7), gS(-12,0), gS(-7,-1), gS(1,-2), gS(1,-10), gS(0,-48),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-6,7), gS(-4,7), gS(-1,1), gS(0,0), gS(0,0), gS(-2,0), gS(0,0), gS(-2,0),
           gS(-3,10), gS(-8,12), gS(-8,12), gS(-2,0), gS(-1,1), gS(-6,1), gS(-2,20), gS(-4,8),
           gS(0,-2), gS(0,0), gS(-1,0), gS(1,-16), gS(0,-14), gS(-1,-8), gS(-9,-2), gS(0,0),
           gS(0,12), gS(0,1), gS(2,-5), gS(0,-8), gS(0,-6), gS(0,-8), gS(0,0), gS(0,0),
           gS(3,1), gS(0,5), gS(-1,4), gS(-4,4), gS(-2,6), gS(-2,9), gS(4,-4), gS(8,1),
           gS(5,27), gS(0,15), gS(-1,23), gS(-2,19), gS(-4,15), gS(3,19), gS(6,13), gS(9,16),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,12), gS(15,21), gS(0,27), gS(0,21), gS(5,20), gS(12,20), gS(26,16), gS(37,14),
           gS(7,16), gS(0,17), gS(17,12), gS(35,4), gS(27,6), gS(28,4), gS(-6,15), gS(9,11),
           gS(3,17), gS(20,9), gS(19,10), gS(27,1), gS(43,-3), gS(37,-1), gS(29,1), gS(-4,13),
           gS(0,13), gS(0,13), gS(18,8), gS(21,1), gS(20,0), gS(20,-1), gS(6,2), gS(0,3),
           gS(-13,8), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-2,2), gS(-5,5), gS(-19,4),
           gS(-16,-1), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(1,-9), gS(-13,-11),
           gS(-21,-10), gS(-4,-11), gS(0,-8), gS(0,-10), gS(12,-16), gS(8,-22), gS(5,-24), gS(-39,-12),
           gS(-5,-12), gS(1,-14), gS(2,-9), gS(11,-20), gS(13,-23), gS(13,-21), gS(-8,-11), gS(-3,-25),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-34,-1), gS(-43,-2), gS(-74,16), gS(-81,16), gS(-55,16), gS(-91,13), gS(-26,-7), gS(-28,-16),
           gS(-37,-1), gS(-18,0), gS(-11,0), gS(-12,9), gS(-12,6), gS(-14,3), gS(-25,-5), gS(-24,-7),
           gS(-3,0), gS(0,1), gS(0,3), gS(24,-3), gS(15,0), gS(20,0), gS(6,0), gS(7,-4),
           gS(-7,-1), gS(9,5), gS(3,2), gS(21,10), gS(16,10), gS(11,4), gS(6,1), gS(-2,-9),
           gS(6,-6), gS(-3,4), gS(7,6), gS(19,7), gS(23,5), gS(6,4), gS(8,0), gS(5,-16),
           gS(4,-15), gS(20,-4), gS(11,-3), gS(11,6), gS(7,10), gS(22,-7), gS(18,-10), gS(9,-12),
           gS(16,-20), gS(12,-24), gS(17,-10), gS(5,0), gS(15,0), gS(16,-5), gS(22,-21), gS(8,-29),
           gS(-2,-32), gS(8,-6), gS(0,-4), gS(2,0), gS(8,-4), gS(-10,3), gS(0,-8), gS(0,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-160,-57), gS(-31,-3), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-80,2), gS(-29,-4), gS(-89,-64),
           gS(-33,-9), gS(-18,0), gS(-2,0), gS(21,5), gS(9,3), gS(28,-12), gS(-12,-1), gS(-18,-16),
           gS(-10,-1), gS(8,2), gS(12,19), gS(30,6), gS(43,0), gS(47,5), gS(14,-1), gS(13,-13),
           gS(5,-1), gS(6,0), gS(15,14), gS(30,17), gS(19,19), gS(34,12), gS(9,0), gS(21,-10),
           gS(1,0), gS(13,5), gS(18,20), gS(23,16), gS(23,21), gS(29,13), gS(24,1), gS(11,0),
           gS(-6,-20), gS(11,-7), gS(10,5), gS(21,16), gS(24,13), gS(22,1), gS(26,-9), gS(4,-10),
           gS(-5,-26), gS(-10,3), gS(5,-4), gS(7,8), gS(13,5), gS(14,-3), gS(1,1), gS(4,-15),
           gS(-40,-30), gS(-12,-16), gS(0,-5), gS(2,2), gS(9,4), gS(-1,-3), gS(-6,-6), gS(-19,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,11), gS(-4,20), gS(-9,25), gS(0,10), gS(-9,17), gS(-12,15),
           gS(-13,1), gS(-27,25), gS(-13,25), gS(-30,47), gS(-47,66), gS(-24,33), gS(-16,37), gS(1,11),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,44), gS(0,36), gS(6,13), gS(-10,14),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-9,53), gS(-6,36), gS(-5,26), gS(2,-4),
           gS(2,-26), gS(-6,0), gS(-1,11), gS(-2,38), gS(3,34), gS(-5,10), gS(8,4), gS(-5,-3),
           gS(-3,-32), gS(11,-24), gS(7,-5), gS(5,0), gS(4,0), gS(8,-5), gS(15,-11), gS(4,-27),
           gS(5,-52), gS(13,-57), gS(21,-57), gS(13,-33), gS(16,-29), gS(22,-64), gS(27,-79), gS(1,-44),
           gS(6,-62), gS(9,-69), gS(7,-76), gS(6,-56), gS(9,-63), gS(-3,-75), gS(0,-65), gS(12,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(87,112), gS(513,681), gS(355,376), gS(378,397), gS(1002,1262),
};
