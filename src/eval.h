...
const int ROOK_RAMMED_FILE = gS(-7,-8);
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(62,35), gS(39,20), gS(42,38),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(15,23), gS(15,3), gS(25,8),
...
const int BISHOP_MOBILITY[14] = {
           gS(-6,-62), gS(2,-24), gS(9,-11), gS(14,-1), gS(17,6), gS(18,9), gS(17,11),
           gS(16,11), gS(15,11), gS(15,10), gS(16,8), gS(28,-1), gS(30,9), gS(55,-11),
};
...
const int KING_MOBILITY[9] = {
           ...
           gS(-8,6), gS(0,5), gS(0,0), gS(16,-18),
};

const int ROOK_MOBILITY[15] = {
           gS(-27,-85), gS(-13,-49), gS(-6,-30), gS(1,-17), gS(4,-6), gS(1,6), gS(7,7),
           gS(9,7), gS(12,12), gS(15,15), gS(16,20), gS(18,22), gS(23,20), gS(28,20),
           gS(51,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-159), gS(-6,-111), gS(-5,-73), gS(-4,-52), gS(-3,-34), gS(-2,-17),
           gS(-1,-4), gS(0,8), gS(0,19), gS(1,26), gS(2,31), gS(2,36), gS(3,38),
           gS(2,41), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(10,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,17), gS(0,13), gS(6,9), gS(11,14), gS(9,11),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,-2), gS(27,24), gS(18,35), gS(0,38), gS(2,39), gS(23,35), gS(12,28), gS(0,-3),
           gS(-2,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(6,24), gS(10,14), gS(-35,-15),
           gS(-14,-25), gS(1,0), gS(-3,16), gS(-16,25), gS(-14,24), gS(-21,18), gS(-1,1), gS(-45,-19),
           gS(-16,-28), gS(12,-6), gS(-12,8), gS(-31,19), gS(-25,18), gS(-23,9), gS(-1,-5), gS(-9,-26),
           gS(2,-29), gS(-3,-7), gS(-3,1), gS(-22,10), gS(-24,11), gS(-3,2), gS(-6,-6), gS(2,-31),
           gS(-15,-55), gS(4,-39), gS(-15,-18), gS(-34,-15), gS(11,-46), gS(-13,-26), gS(3,-36), gS(-1,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(52,68), gS(40,78), gS(37,66), gS(64,53), gS(63,58), gS(49,64), gS(0,85), gS(1,74),
           gS(2,31), gS(9,30), gS(25,12), gS(42,0), gS(44,0), gS(72,6), gS(28,24), gS(28,17),
           gS(-10,15), gS(3,11), gS(8,0), gS(15,-1), gS(22,-2), gS(22,-1), gS(25,1), gS(-1,7),
           gS(-22,3), gS(-20,12), gS(-7,0), gS(11,-3), gS(10,-4), gS(11,-3), gS(-3,2), gS(-15,-3),
           gS(-24,-2), gS(-18,0), gS(-6,-4), gS(-4,-1), gS(1,-1), gS(2,-2), gS(-1,-6), gS(-18,-8),
           gS(-34,5), gS(-15,6), gS(-14,7), gS(0,6), gS(0,9), gS(2,5), gS(-2,1), gS(-25,-3),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-3,14), gS(-3,10), gS(0,7), gS(0,2), gS(0,1), gS(-1,1), gS(0,1), gS(0,6),
           gS(-3,10), gS(-6,16), gS(-9,8), gS(-2,0), gS(-2,2), gS(-6,5), gS(-4,20), gS(-3,13),
           gS(-2,-4), gS(-4,-1), gS(-10,-8), gS(0,-19), gS(-2,-13), gS(-6,-4), gS(-7,0), gS(-3,0),
           gS(0,-16), gS(-3,-9), gS(1,-13), gS(0,-25), gS(0,-22), gS(0,-6), gS(-5,-1), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-6,-9), gS(-5,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-26),
           gS(0,-41), gS(-1,-20), gS(-5,-7), gS(-11,-1), gS(-7,0), gS(1,-2), gS(1,-10), gS(0,-47),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-2,9), gS(-7,12), gS(-8,11), gS(-3,0), gS(-2,1), gS(-6,1), gS(-2,19), gS(-3,7),
           gS(0,-2), gS(0,0), gS(-2,-1), gS(1,-17), gS(-1,-14), gS(-2,-8), gS(-10,-3), gS(0,0),
           gS(0,11), gS(0,0), gS(2,-6), gS(0,-10), gS(0,-8), gS(0,-8), gS(0,0), gS(0,-1),
           gS(4,1), gS(0,5), gS(0,3), gS(-4,3), gS(-2,6), gS(-2,9), gS(4,-4), gS(8,1),
           gS(6,26), gS(0,14), gS(-1,22), gS(-1,18), gS(-4,15), gS(4,19), gS(6,14), gS(10,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,12), gS(15,21), gS(0,27), gS(0,21), gS(6,20), gS(11,20), gS(27,16), gS(38,14),
           gS(7,15), gS(0,16), gS(17,12), gS(35,4), gS(26,6), gS(28,3), gS(-6,15), gS(10,10),
           gS(3,17), gS(20,9), gS(19,10), gS(27,1), gS(43,-4), gS(37,-2), gS(29,0), gS(-3,12),
           gS(0,13), gS(0,13), gS(18,7), gS(21,1), gS(20,0), gS(20,-1), gS(6,2), gS(0,3),
           gS(-13,9), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-2,0), gS(-5,5), gS(-19,4),
           gS(-15,0), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-10), gS(1,-9), gS(-12,-10),
           gS(-20,-8), gS(-4,-10), gS(1,-7), gS(1,-10), gS(12,-16), gS(9,-23), gS(5,-23), gS(-39,-10),
           gS(-5,-9), gS(1,-12), gS(2,-8), gS(12,-19), gS(14,-22), gS(13,-20), gS(-8,-10), gS(-3,-23),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-34,-1), gS(-43,-2), gS(-74,16), gS(-81,16), gS(-56,16), gS(-91,13), gS(-26,-7), gS(-28,-16),
           gS(-37,-1), gS(-17,0), gS(-11,0), gS(-12,9), gS(-12,6), gS(-14,3), gS(-25,-4), gS(-23,-7),
           gS(-4,0), gS(0,1), gS(0,4), gS(24,-3), gS(16,0), gS(22,-1), gS(7,0), gS(8,-5),
           gS(-7,-2), gS(9,5), gS(4,2), gS(22,9), gS(16,10), gS(12,4), gS(8,0), gS(-1,-10),
           gS(6,-7), gS(-2,3), gS(8,5), gS(19,7), gS(23,5), gS(6,3), gS(8,0), gS(6,-17),
           ...
           gS(-2,-32), gS(8,-7), gS(0,-3), gS(2,0), gS(7,-4), gS(-11,4), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-159,-58), gS(-31,-4), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-78,2), gS(-29,-5), gS(-89,-64),
           gS(-31,-10), gS(-17,0), gS(-2,0), gS(22,5), gS(9,3), gS(30,-12), gS(-12,-2), gS(-17,-16),
           gS(-10,-1), gS(10,2), gS(13,19), gS(31,5), gS(45,0), gS(48,5), gS(15,-2), gS(13,-13),
           gS(6,-1), gS(7,0), gS(15,14), gS(32,16), gS(20,17), gS(35,11), gS(12,-2), gS(23,-11),
           ...
           gS(-40,-30), gS(-12,-15), gS(0,-4), gS(1,3), gS(9,4), gS(-1,-3), gS(-7,-5), gS(-19,-30),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,13), gS(-4,22), gS(-9,27), gS(0,12), gS(-9,19), gS(-11,16),
           gS(-13,1), gS(-27,25), gS(-13,25), gS(-30,49), gS(-47,68), gS(-24,35), gS(-17,39), gS(1,13),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,46), gS(0,38), gS(6,15), gS(-9,16),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,54), gS(-6,38), gS(-5,28), gS(4,-4),
           gS(1,-26), gS(-5,0), gS(0,11), gS(-2,38), gS(3,34), gS(-4,11), gS(8,4), gS(-4,-2),
           gS(-2,-33), gS(11,-24), gS(7,-6), gS(4,0), gS(4,0), gS(9,-6), gS(15,-11), gS(5,-27),
           gS(5,-52), gS(12,-57), gS(20,-58), gS(13,-33), gS(15,-30), gS(22,-64), gS(26,-80), gS(1,-44),
           gS(6,-62), gS(9,-70), gS(7,-76), gS(5,-57), gS(8,-64), gS(-3,-75), gS(0,-67), gS(12,-69),
};
/**
 * @brief Array indexed by [PieceType] of material values (in centipawns)
 */
const int MATERIAL_VALUES[5] = {
           gS(85,113), gS(508,684), gS(353,375), gS(377,397), gS(1001,1265),
};
