...
const int PAWN_BLOCKED = gS(3,12);

const int PASSER_BLOCKED = gS(2,-1);
...
const int MINOR_BLOCK_OWN_PASSER = gS(2,-5);

const int KING_AHEAD_PASSER = gS(-13,13);

const int KING_EQUAL_PASSER = gS(11,6);
...
const int KING_ATTACK_PAWN = gS(22,50);
/**
 * @brief Various array terms, related to the evaluation of the pawns
 */
const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-8,-7), gS(-5,7), gS(0,43),
           gS(17,58), gS(29,84), gS(54,90),
};

const int PASSED_PAWN_FILES[8] = {
           gS(1,23), gS(0,15), gS(1,7), gS(1,-4),
           gS(-4,-2), gS(-4,6), gS(-3,15), gS(2,17),
};

const int PASSED_PAWN_FREE[7] = {
           gS(0,0), gS(-7,8), gS(-11,2), gS(-8,5),
           gS(0,7), gS(4,20), gS(53,22),
};

const int PASSED_PAWN_POS_ADVANCE[7] = {
           gS(0,0), gS(4,5), gS(5,1), gS(6,13),
           gS(8,26), gS(26,55), gS(49,109),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-3,-20), gS(16,4), gS(2,-18), gS(-6,-7),
           gS(-9,-9), gS(-18,-9), gS(-16,-13), gS(-14,-11),
};

const int KING_PASSER_DISTANCE_FRIENDLY[8] = {
           gS(0,0), gS(3,33), gS(-11,23), gS(-7,7),
           gS(-3,-2), gS(0,-2), gS(11,-2), gS(12,-3),
};

const int KING_PASSER_DISTANCE_ENEMY[8] = {
           gS(0,0), gS(-32,-5), gS(5,-19), gS(-3,-1),
           gS(-1,9), gS(-5,19), gS(-1,20), gS(-9,19),
};

const int KNIGHT_PASSER_DISTANCE_ENEMY[4] = {
           gS(-5,-7), gS(0,3), gS(7,7), gS(14,11),
};

const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-15,-8), gS(-8,0), gS(0,-2),
           gS(0,6), gS(2,12), gS(0,0),
};
...
const int ROOK_ATTACKED_BY[4] = {
           gS(0,0), gS(-3,19), gS(65,22), gS(43,42),
};

const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(62,35), gS(39,20), gS(42,35),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-6,2), gS(6,10), gS(0,12), gS(0,9),
...
const int BISHOP_MOBILITY[14] = {
           gS(-8,-65), gS(1,-25), gS(9,-13), gS(14,-2), gS(16,6), gS(18,9), gS(17,12),
           gS(17,11), gS(17,12), gS(17,11), gS(18,9), gS(31,0), gS(32,11), gS(57,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-93), gS(9,-35), gS(16,-8), gS(21,2), gS(26,10),
           gS(30,16), gS(34,13), gS(38,7), gS(42,-1),
};

const int KING_MOBILITY[9] = {
           gS(14,-26), gS(5,-5), gS(0,4), gS(-2,9), gS(-5,8),
           gS(-9,6), gS(0,5), gS(0,0), gS(15,-18),
};

const int ROOK_MOBILITY[15] = {
           gS(-26,-86), gS(-13,-48), gS(-6,-29), gS(1,-17), gS(4,-5), gS(1,6), gS(7,8),
           gS(9,8), gS(12,12), gS(15,15), gS(16,20), gS(19,22), gS(23,20), gS(28,19),
           gS(51,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-161), gS(-6,-111), gS(-5,-72), gS(-4,-51), gS(-3,-33), gS(-2,-16),
           gS(-1,-3), gS(0,9), gS(0,20), gS(1,26), gS(2,32), gS(3,36), gS(3,38),
           gS(2,41), gS(3,43), gS(2,46), gS(5,41), gS(7,39), gS(10,37), gS(13,30),
           gS(16,24), gS(9,27), gS(19,17), gS(0,15), gS(8,11), gS(13,16), gS(11,13),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-92), gS(0,-34), gS(0,-17), gS(0,-6), gS(0,-18), gS(0,-22), gS(0,-12), gS(0,-94),
           ...
           gS(-1,-13), gS(11,13), gS(2,25), gS(-6,35), gS(-7,32), gS(8,23), gS(11,13), gS(-36,-15),
           gS(-13,-24), gS(3,0), gS(-3,16), gS(-18,25), gS(-14,23), gS(-21,17), gS(-1,1), gS(-47,-18),
           gS(-19,-26), gS(11,-6), gS(-12,8), gS(-31,19), gS(-26,18), gS(-23,9), gS(-1,-4), gS(-11,-25),
           gS(2,-28), gS(-4,-7), gS(-4,1), gS(-22,10), gS(-24,11), gS(-3,2), gS(-6,-5), gS(1,-30),
           gS(-16,-55), gS(4,-38), gS(-15,-17), gS(-35,-15), gS(10,-46), gS(-13,-25), gS(3,-36), gS(-2,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(54,69), gS(40,79), gS(39,67), gS(66,56), gS(65,61), gS(51,64), gS(0,85), gS(1,74),
           gS(2,32), gS(8,32), gS(25,15), gS(44,2), gS(45,3), gS(73,8), gS(27,26), gS(27,18),
           gS(-8,14), gS(2,11), gS(9,0), gS(16,0), gS(23,0), gS(23,0), gS(25,2), gS(-1,8),
           gS(-20,3), gS(-18,12), gS(-6,0), gS(12,-3), gS(11,-4), gS(12,-2), gS(-2,3), gS(-14,-2),
           gS(-23,-2), gS(-17,0), gS(-4,-5), gS(-4,0), gS(2,0), gS(3,-2), gS(0,-6), gS(-17,-8),
           gS(-32,5), gS(-15,5), gS(-13,7), gS(1,7), gS(0,10), gS(4,5), gS(-3,1), gS(-23,-4),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-3,10), gS(-7,15), gS(-7,7), gS(-2,0), gS(-2,1), gS(-5,4), gS(-5,19), gS(-3,13),
           gS(-2,-4), gS(-3,-1), gS(-10,-8), gS(0,-19), gS(-1,-13), gS(-6,-3), gS(-8,0), gS(-2,0),
           gS(0,-15), gS(-3,-9), gS(1,-13), gS(0,-25), gS(0,-20), gS(0,-6), gS(-6,-1), gS(0,0),
           gS(0,-26), gS(-3,-6), gS(-5,-10), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-26),
           gS(0,-39), gS(-1,-20), gS(-4,-7), gS(-9,-1), gS(-6,0), gS(1,-2), gS(1,-9), gS(0,-45),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-2,9), gS(-8,12), gS(-7,10), gS(-2,0), gS(-2,1), gS(-5,1), gS(-4,17), gS(-4,7),
           gS(0,-3), gS(0,0), gS(-2,-1), gS(1,-17), gS(-1,-14), gS(-2,-8), gS(-9,-3), gS(-1,0),
           gS(0,8), gS(0,0), gS(2,-7), gS(0,-10), gS(0,-8), gS(0,-8), gS(0,0), gS(0,-2),
           gS(4,0), gS(0,4), gS(0,2), gS(-4,3), gS(-2,5), gS(-2,7), gS(4,-5), gS(8,1),
           gS(6,23), gS(0,13), gS(0,20), gS(-1,17), gS(-3,14), gS(5,18), gS(6,13), gS(10,13),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-20,-8), gS(-4,-10), gS(1,-7), gS(1,-10), gS(12,-16), gS(8,-22), gS(5,-23), gS(-39,-11),
           gS(-4,-9), gS(2,-12), gS(3,-8), gS(11,-19), gS(14,-22), gS(14,-20), gS(-7,-10), gS(-3,-24),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-33,-1), gS(-43,-2), gS(-74,16), gS(-81,17), gS(-56,17), gS(-91,13), gS(-25,-7), gS(-27,-15),
           gS(-37,-1), gS(-17,0), gS(-10,0), gS(-12,11), gS(-11,8), gS(-12,3), gS(-25,-4), gS(-23,-7),
           gS(-3,0), gS(1,1), gS(0,3), gS(27,-3), gS(17,0), gS(22,0), gS(8,0), gS(9,-5),
           gS(-7,-2), gS(9,5), gS(5,2), gS(22,8), gS(16,9), gS(13,4), gS(8,0), gS(-1,-10),
           gS(7,-7), gS(0,3), gS(8,4), gS(20,6), gS(23,5), gS(6,3), gS(9,0), gS(8,-17),
           gS(4,-16), gS(20,-5), gS(10,-3), gS(10,6), gS(6,11), gS(21,-8), gS(18,-11), gS(9,-13),
           gS(17,-21), gS(12,-25), gS(16,-10), gS(5,0), gS(14,0), gS(15,-5), gS(21,-21), gS(8,-29),
           gS(-2,-32), gS(7,-7), gS(0,-3), gS(2,0), gS(7,-4), gS(-11,4), gS(0,-9), gS(-1,-25),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-157,-60), gS(-31,-5), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-76,2), gS(-29,-5), gS(-89,-64),
           gS(-28,-8), gS(-14,2), gS(1,0), gS(25,7), gS(12,5), gS(33,-10), gS(-11,-1), gS(-14,-16),
           gS(-10,-1), gS(12,2), gS(14,19), gS(33,8), gS(47,3), gS(47,5), gS(17,-1), gS(13,-13),
           gS(7,-1), gS(6,-1), gS(14,13), gS(30,15), gS(18,17), gS(34,10), gS(11,-3), gS(24,-10),
           gS(1,2), gS(14,5), gS(17,19), gS(23,17), gS(25,20), gS(29,11), gS(26,1), gS(11,0),
           gS(-7,-19), gS(11,-5), gS(10,7), gS(22,18), gS(24,15), gS(21,3), gS(26,-7), gS(3,-8),
           gS(-7,-26), gS(-10,4), gS(3,-4), gS(6,9), gS(12,6), gS(11,-3), gS(2,2), gS(2,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-9,-15), gS(0,0), gS(-4,23), gS(0,36), gS(-3,46), gS(0,40), gS(5,17), gS(-9,18),
           gS(-3,-17), gS(-7,8), gS(-5,19), gS(-4,40), gS(-9,54), gS(-7,40), gS(-5,30), gS(3,-3),
           gS(2,-27), gS(-5,0), gS(-1,11), gS(-2,38), gS(3,34), gS(-4,11), gS(9,4), gS(-4,-2),
           gS(-1,-35), gS(11,-23), gS(7,-6), gS(4,0), gS(4,0), gS(9,-6), gS(15,-11), gS(5,-27),
           gS(6,-53), gS(12,-57), gS(21,-58), gS(13,-33), gS(16,-30), gS(22,-64), gS(26,-80), gS(1,-44),
           gS(6,-62), gS(9,-70), gS(7,-76), gS(6,-58), gS(9,-64), gS(-3,-75), gS(0,-69), gS(12,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(85,112), gS(505,682), gS(354,378), gS(377,399), gS(999,1269),
};
