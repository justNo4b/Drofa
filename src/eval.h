...
const int ROOK_RESTRICT_KING = gS(-2,5);
...
const int ROOK_MOBILITY[15] = {
           gS(-27,-88), gS(-13,-51), gS(-7,-32), gS(0,-19), gS(3,-7), gS(0,5), gS(6,7),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-13,-25), gS(0,1), gS(-4,15), gS(-15,24), gS(-14,22), gS(-21,17), gS(-1,0), gS(-42,-20),
           gS(-13,-29), gS(12,-6), gS(-12,7), gS(-30,18), gS(-25,17), gS(-22,8), gS(0,-6), gS(-7,-28),
           gS(4,-29), gS(-1,-7), gS(-3,0), gS(-22,9), gS(-24,10), gS(-2,1), gS(-3,-6), gS(4,-32),
           gS(-14,-56), gS(6,-38), gS(-13,-17), gS(-35,-14), gS(10,-44), gS(-13,-24), gS(5,-35), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(52,69), gS(40,76), gS(36,66), gS(65,52), gS(61,58), gS(46,61), gS(0,82), gS(0,69),
           ...
           gS(-25,5), gS(-21,12), gS(-9,0), gS(9,-3), gS(9,-4), gS(8,-3), gS(-4,1), gS(-18,-5),
           gS(-26,-1), gS(-18,0), gS(-7,-4), gS(-4,0), gS(0,-1), gS(0,-2), gS(-3,-7), gS(-21,-10),
           gS(-35,6), gS(-17,6), gS(-14,7), gS(0,6), gS(0,9), gS(1,5), gS(-4,0), gS(-26,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,-1), gS(0,0), gS(-1,0), gS(0,-16), gS(0,-14), gS(-1,-8), gS(-9,-3), gS(0,1),
...
const int ROOK_PSQT_BLACK[64] = {
           gS(29,12), gS(16,21), gS(0,27), gS(0,21), gS(5,21), gS(12,20), gS(25,17), gS(37,14),
           gS(6,15), gS(0,16), gS(17,11), gS(35,3), gS(27,5), gS(27,4), gS(-7,15), gS(8,10),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-6,-21), gS(11,-7), gS(10,5), gS(20,16), gS(23,13), gS(22,1), gS(26,-9), gS(4,-11),
           gS(-5,-27), gS(-10,2), gS(4,-5), gS(7,7), gS(13,5), gS(14,-3), gS(1,1), gS(4,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-4,-16), gS(-7,9), gS(-5,19), gS(-4,40), gS(-8,53), gS(-5,36), gS(-4,26), gS(3,-4),
           ...
           gS(6,-62), gS(8,-69), gS(6,-76), gS(5,-58), gS(7,-63), gS(-3,-75), gS(0,-64), gS(13,-69),
};
