...
const int ROOK_RAMMED_FILE = gS(-6,-16);
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(62,35), gS(39,20), gS(42,39),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(15,23), gS(15,3), gS(25,7),
...
const int BISHOP_MOBILITY[14] = {
           gS(-7,-62), gS(2,-23), gS(9,-11), gS(14,-1), gS(16,7), gS(17,9), gS(17,11),
           gS(16,11), gS(15,11), gS(14,10), gS(16,7), gS(28,-1), gS(30,9), gS(54,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-33), gS(17,-6), gS(22,3), gS(26,10),
           gS(29,14), gS(33,10), gS(36,4), gS(39,-5),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-28,-85), gS(-14,-49), gS(-7,-30), gS(1,-17), gS(4,-6), gS(1,6), gS(6,7),
           gS(8,7), gS(12,12), gS(15,15), gS(16,20), gS(18,22), gS(22,20), gS(28,19),
           gS(50,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-158), gS(-6,-111), gS(-5,-73), gS(-4,-52), gS(-3,-34), gS(-2,-17),
           gS(-1,-4), gS(0,8), gS(0,19), gS(1,26), gS(2,31), gS(2,36), gS(2,38),
           gS(2,41), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(10,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,17), gS(0,12), gS(5,8), gS(10,13), gS(8,10),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,-2), gS(27,24), gS(17,35), gS(0,38), gS(1,39), gS(22,35), gS(12,28), gS(0,-3),
           gS(-1,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(5,24), gS(9,14), gS(-35,-15),
           gS(-13,-25), gS(1,0), gS(-3,16), gS(-15,25), gS(-14,24), gS(-21,18), gS(-1,1), gS(-44,-19),
           gS(-15,-28), gS(12,-6), gS(-12,8), gS(-30,19), gS(-25,18), gS(-22,9), gS(0,-5), gS(-8,-26),
           gS(2,-29), gS(-3,-7), gS(-3,0), gS(-22,10), gS(-24,10), gS(-3,1), gS(-6,-6), gS(2,-31),
           gS(-15,-55), gS(4,-39), gS(-15,-18), gS(-34,-15), gS(11,-47), gS(-12,-26), gS(4,-36), gS(-1,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(52,68), gS(40,78), gS(36,66), gS(64,53), gS(63,58), gS(48,64), gS(0,84), gS(1,74),
           gS(1,30), gS(9,30), gS(25,11), gS(42,0), gS(44,0), gS(72,5), gS(27,23), gS(27,16),
           gS(-11,15), gS(3,11), gS(7,0), gS(14,-1), gS(22,-2), gS(21,-1), gS(25,1), gS(-2,7),
           gS(-23,3), gS(-20,11), gS(-7,-1), gS(11,-4), gS(10,-5), gS(10,-3), gS(-3,2), gS(-16,-3),
           gS(-25,-2), gS(-18,0), gS(-6,-5), gS(-4,-1), gS(1,-1), gS(1,-3), gS(-1,-7), gS(-19,-8),
           gS(-35,5), gS(-16,6), gS(-14,6), gS(0,5), gS(0,9), gS(1,5), gS(-3,1), gS(-26,-3),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-7,16), gS(-9,8), gS(-2,0), gS(-2,2), gS(-6,5), gS(-4,20), gS(-4,13),
           gS(-2,-4), gS(-4,-1), gS(-10,-8), gS(0,-19), gS(-2,-13), gS(-6,-4), gS(-7,0), gS(-4,0),
           gS(0,-16), gS(-3,-9), gS(1,-13), gS(0,-25), gS(0,-22), gS(0,-6), gS(-5,-1), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-6,-9), gS(-5,0), gS(-6,-9), gS(-7,1), gS(2,-5), gS(0,-26),
           gS(0,-42), gS(-1,-20), gS(-5,-7), gS(-11,-1), gS(-7,0), gS(1,-2), gS(1,-10), gS(0,-47),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,9), gS(-8,12), gS(-8,11), gS(-3,0), gS(-2,1), gS(-6,1), gS(-2,19), gS(-4,7),
           ...
           gS(6,27), gS(0,14), gS(-1,22), gS(-1,19), gS(-4,16), gS(4,19), gS(6,14), gS(10,16),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,11), gS(15,21), gS(0,27), gS(0,20), gS(5,20), gS(10,20), gS(26,16), gS(37,13),
           gS(7,15), gS(0,16), gS(17,12), gS(35,3), gS(26,6), gS(28,3), gS(-6,15), gS(10,10),
           gS(3,17), gS(19,8), gS(19,10), gS(27,1), gS(43,-4), gS(36,-2), gS(29,0), gS(-3,12),
           gS(0,13), gS(0,13), gS(18,7), gS(21,1), gS(20,0), gS(20,-1), gS(6,1), gS(-1,3),
           gS(-13,9), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-2,0), gS(-5,5), gS(-19,4),
           gS(-15,0), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-10), gS(1,-9), gS(-12,-9),
           gS(-20,-7), gS(-4,-10), gS(1,-7), gS(1,-10), gS(12,-16), gS(9,-23), gS(5,-23), gS(-39,-10),
           gS(-5,-8), gS(1,-12), gS(2,-8), gS(12,-19), gS(14,-22), gS(13,-20), gS(-8,-10), gS(-3,-23),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-4,0), gS(0,1), gS(0,4), gS(24,-3), gS(15,0), gS(22,-1), gS(7,0), gS(8,-5),
           gS(-7,-1), gS(9,5), gS(4,2), gS(21,9), gS(15,10), gS(12,4), gS(7,0), gS(-1,-10),
           gS(6,-6), gS(-2,3), gS(8,5), gS(19,7), gS(23,5), gS(6,3), gS(8,0), gS(6,-17),
...
const int KNIGHT_PSQT_BLACK[64] = {
           gS(-159,-58), gS(-31,-4), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-79,2), gS(-29,-5), gS(-89,-64),
           gS(-31,-10), gS(-18,0), gS(-2,0), gS(21,5), gS(9,3), gS(29,-12), gS(-12,-2), gS(-17,-16),
           gS(-10,-1), gS(9,2), gS(13,19), gS(30,5), gS(44,0), gS(48,5), gS(15,-2), gS(13,-13),
           ...
           gS(-7,-19), gS(10,-5), gS(10,6), gS(20,17), gS(23,14), gS(21,3), gS(25,-8), gS(3,-9),
           gS(-6,-26), gS(-10,3), gS(4,-3), gS(7,9), gS(12,7), gS(13,-2), gS(1,1), gS(3,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,45), gS(0,37), gS(6,15), gS(-9,15),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,54), gS(-6,37), gS(-4,27), gS(4,-4),
           gS(1,-26), gS(-5,0), gS(0,11), gS(-2,38), gS(3,34), gS(-4,11), gS(8,4), gS(-4,-2),
           gS(-2,-32), gS(10,-24), gS(7,-6), gS(4,0), gS(4,0), gS(9,-6), gS(14,-11), gS(5,-27),
           gS(5,-52), gS(12,-57), gS(20,-58), gS(13,-33), gS(15,-30), gS(22,-64), gS(26,-80), gS(1,-44),
           gS(6,-62), gS(8,-70), gS(6,-76), gS(5,-57), gS(8,-64), gS(-3,-75), gS(0,-66), gS(12,-69),
};
/**
 * @brief Array indexed by [PieceType] of material values (in centipawns)
 */
const int MATERIAL_VALUES[5] = {
           gS(86,113), gS(509,684), gS(353,375), gS(378,397), gS(1002,1264),
};
