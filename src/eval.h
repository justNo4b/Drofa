 ...
 * 
 */ 
const int  KING_HIGH_DANGER  = gS(-17,-27);   // применять когда жив ферзь и мы не рокированы
...
const int BISHOP_MOBILITY[14] = {
           gS(-23,-103), gS(-11,-44), gS(-5,-18), gS(-1,-2), gS(1,11), gS(3,22), gS(3,28),
           gS(1,31), gS(3,34), gS(6,32), gS(11,29), gS(27,19), gS(45,28), gS(75,-3),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-23,-102), gS(-15,-66), gS(-10,-33), gS(-8,-12), gS(-9,6), gS(-10,20), gS(-5,24),
           gS(0,27), gS(3,31), gS(8,36), gS(11,40), gS(17,42), gS(22,42), gS(37,29),
           gS(89,0),
};

const int QUEEN_MOBILITY[28] = {
           gS(-42,-106), gS(-20,-171), gS(-8,-132), gS(-4,-76), gS(-2,-43), gS(-1,-21), gS(0,-3),
...
const int PASSER_SUPPORTED = gS(26,3);
...
const int KING_PASSER_DISTANCE_FRIENDLY[9] = {
           gS(0,0), gS(3,34), gS(-5,26), gS(-7,11),
           gS(-5,0), gS(-4,-4), gS(9,-9), gS(0,-19),
           gS(0,-10),
};

const int KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(45,44), gS(-14,18), gS(-2,-1),
           gS(-2,-13), gS(-1,-24), gS(5,-35), gS(14,-41),
           gS(0,-10),
};
...
const int PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-10,-27), gS(-17,-14), gS(-10,21),
           gS(14,55), gS(26,119), gS(73,132), gS(0,0),
};

const int PASSED_PAWN_FILES[8] = {
           gS(10,17), gS(4,16), gS(-1,3), gS(-2,0),
           gS(-5,-2), gS(-15,1), gS(-9,16), gS(9,12),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-52,-13), gS(-9,2), gS(-7,14), gS(-28,31), gS(-16,26), gS(-17,18), gS(-9,3), gS(-48,-11),
           gS(1,-9), gS(-2,6), gS(-22,16), gS(-61,26), gS(-44,21), gS(-43,22), gS(0,4), gS(-1,-18),
           gS(-26,-53), gS(0,-24), gS(-29,-3), gS(-32,-23), gS(-21,-36), gS(-54,-3), gS(-5,-24), gS(-16,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(61,72), gS(46,94), gS(65,90), gS(72,76), gS(80,76), gS(84,81), gS(-6,100), gS(-20,84),
           gS(-2,47), gS(23,49), gS(37,41), gS(42,20), gS(52,20), gS(89,29), gS(55,37), gS(9,34),
           gS(-3,19), gS(3,21), gS(4,18), gS(19,3), gS(27,6), gS(27,11), gS(9,19), gS(-2,9),
           gS(-12,3), gS(-8,10), gS(-5,2), gS(2,1), gS(8,2), gS(3,3), gS(0,3), gS(-12,-4),
           gS(-18,-2), gS(-17,0), gS(-14,4), gS(-13,5), gS(-6,8), gS(-6,8), gS(-1,-3), gS(-13,-12),
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-1,23), gS(-4,27), gS(17,23), gS(29,23), gS(26,24), gS(44,9), gS(9,22), gS(16,18),
           gS(-8,16), gS(31,2), gS(21,13), gS(43,2), gS(54,-3), gS(51,4), gS(70,-10), gS(16,8),
           gS(-8,9), gS(9,7), gS(17,9), gS(38,2), gS(31,2), gS(28,1), gS(28,0), gS(13,2),
           gS(-20,0), gS(-11,11), gS(-13,12), gS(-3,5), gS(-5,5), gS(-7,8), gS(5,5), gS(-9,-3),
           gS(-25,-14), gS(-8,-3), gS(-16,-4), gS(-8,-9), gS(-8,-8), gS(-9,-6), gS(9,-7), gS(-15,-17),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-49,1), gS(-13,4), gS(-8,7), gS(-14,15), gS(-4,13), gS(0,7), gS(-27,5), gS(-26,-4),
           gS(2,1), gS(1,7), gS(21,3), gS(7,9), gS(23,7), gS(8,9), gS(21,2), gS(15,0),
           gS(-11,0), gS(17,6), gS(4,6), gS(23,13), gS(20,13), gS(14,4), gS(18,3), gS(-5,0),
           gS(0,-12), gS(5,-1), gS(10,7), gS(17,7), gS(24,6), gS(2,6), gS(12,0), gS(3,-13),
           ...
           gS(5,-37), gS(2,-15), gS(1,-2), gS(0,-6), gS(0,-2), gS(0,-7), gS(-1,-10), gS(2,-38),
};
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-4,-9), gS(10,8), gS(15,30), gS(21,32), gS(24,35), gS(20,32), gS(27,12), gS(7,0),
           gS(-20,-33), gS(0,-5), gS(5,10), gS(13,25), gS(17,23), gS(13,8), gS(7,0), gS(-5,-25),
           gS(-21,-16), gS(-28,0), gS(-7,-9), gS(6,7), gS(1,8), gS(-1,-9), gS(-16,-3), gS(-11,-3),
           gS(-40,-46), gS(-13,-27), gS(-11,-17), gS(-8,4), gS(0,2), gS(-8,-10), gS(-11,-20), gS(-40,-45),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-3,3), gS(0,20), gS(0,34), gS(3,46), gS(9,55), gS(31,48), gS(8,50), gS(14,38),
           gS(-18,-3), gS(-56,36), gS(-17,26), gS(-41,72), gS(-44,108), gS(0,70), gS(-54,72), gS(-19,39),
           gS(-15,-17), gS(-8,-17), gS(-12,15), gS(-11,42), gS(1,60), gS(10,78), gS(29,45), gS(3,61),
           gS(-5,-33), gS(-3,0), gS(-7,2), gS(-15,46), gS(-14,65), gS(-7,71), gS(4,59), gS(8,30),
           ...
           gS(0,-67), gS(3,-79), gS(5,-85), gS(8,-64), gS(9,-71), gS(4,-87), gS(8,-84), gS(-2,-75),
};
