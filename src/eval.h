...
const int ROOK_TENSION_LINE = gS(22,0);
...
const int PASSED_PAWN_RANKS[7] = {
           ...
           gS(15,53), gS(28,78), gS(53,87),
};

const int PASSED_PAWN_FILES[4] = {
           gS(1,19), gS(-3,13), gS(0,5), gS(0,-4),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(6,0), gS(14,22), gS(14,1), gS(24,6),
...
const int ROOK_MOBILITY[15] = {
           gS(-26,-86), gS(-13,-49), gS(-6,-31), gS(0,-19), gS(3,-7), gS(1,5), gS(6,7),
           gS(7,7), gS(11,12), gS(13,15), gS(14,20), gS(17,23), gS(22,21), gS(28,19),
           gS(50,10),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-1,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,32), gS(4,24), gS(9,13), gS(-35,-15),
           ...
           gS(-15,-55), gS(4,-38), gS(-14,-17), gS(-35,-15), gS(10,-44), gS(-13,-25), gS(4,-35), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,77), gS(37,66), gS(65,53), gS(63,58), gS(47,62), gS(0,84), gS(0,71),
           gS(0,31), gS(8,29), gS(25,12), gS(42,0), gS(43,0), gS(69,4), gS(26,23), gS(25,13),
           gS(-12,16), gS(2,11), gS(6,1), gS(14,0), gS(20,-1), gS(19,-1), gS(24,1), gS(-4,5),
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-6,17), gS(-8,7), gS(-2,0), gS(-1,2), gS(-6,4), gS(-4,20), gS(-4,14),
           gS(-3,-4), gS(-3,-2), gS(-10,-8), gS(0,-19), gS(-1,-13), gS(-6,-4), gS(-7,0), gS(-4,0),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,10), gS(-7,11), gS(-8,11), gS(-2,0), gS(-1,1), gS(-6,1), gS(-1,20), gS(-4,7),
           gS(0,-2), gS(0,0), gS(-2,0), gS(1,-16), gS(0,-14), gS(-1,-8), gS(-9,-3), gS(0,0),
           gS(0,11), gS(0,0), gS(2,-6), gS(0,-8), gS(0,-6), gS(0,-7), gS(0,0), gS(0,0),
           gS(3,1), gS(0,5), gS(-1,3), gS(-4,3), gS(-2,5), gS(-2,9), gS(4,-4), gS(7,0),
           gS(5,26), gS(0,15), gS(-1,23), gS(-2,18), gS(-4,15), gS(3,19), gS(6,14), gS(9,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-16,-1), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(1,-9), gS(-12,-11),
           gS(-20,-9), gS(-4,-11), gS(0,-8), gS(0,-10), gS(11,-16), gS(8,-22), gS(5,-23), gS(-39,-12),
           gS(-4,-12), gS(1,-13), gS(2,-9), gS(10,-19), gS(13,-22), gS(13,-21), gS(-8,-10), gS(-3,-25),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,1), gS(0,3), gS(24,-3), gS(16,0), gS(20,0), gS(6,0), gS(7,-4),
           gS(-7,-2), gS(9,5), gS(3,2), gS(21,10), gS(16,10), gS(11,4), gS(6,1), gS(-2,-9),
           gS(5,-6), gS(-2,4), gS(7,5), gS(19,7), gS(23,5), gS(6,4), gS(8,0), gS(5,-16),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(5,-1), gS(7,0), gS(15,14), gS(31,16), gS(19,19), gS(35,12), gS(10,0), gS(22,-10),
           gS(0,0), gS(13,5), gS(18,20), gS(22,16), gS(23,20), gS(29,13), gS(24,0), gS(11,0),
           gS(-6,-20), gS(10,-6), gS(10,5), gS(20,16), gS(23,13), gS(22,1), gS(26,-9), gS(4,-10),
           gS(-5,-26), gS(-10,3), gS(4,-4), gS(7,8), gS(13,5), gS(13,-2), gS(1,1), gS(4,-15),
           gS(-40,-30), gS(-13,-16), gS(0,-5), gS(1,2), gS(9,4), gS(-1,-3), gS(-7,-6), gS(-19,-29),
};
...
const int MATERIAL_VALUES[5] = {
           gS(88,112), gS(512,681), gS(355,376), gS(378,397), gS(1002,1262),
};
