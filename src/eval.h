...
const int TEMPO = 10;
const int KING_HIGH_DANGER = gS(-45,-63);
...
const int KNIGHT_POS_PROUTPOST_JUMP = gS(8,6);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-18,0), gS(-11,6), gS(0,11),
           gS(5,30), gS(6,53), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(8,16), gS(0,7), gS(0,0), gS(-6,-1),
};
...
const int BACKWARD_OPEN_PAWN[7] = {
           gS(0,0), gS(-13,-12), gS(-7,-10), gS(-5,-9),
           gS(0,-4), gS(0,0), gS(0,0),
};

const int INCOMING_STORM_4TH[8] = {
           gS(0,2), gS(0,3), gS(3,3), gS(3,2), gS(2,-1), gS(-1,-6), gS(-5,-4), gS(-7,-4),
};

const int INCOMING_STORM_5TH[8] = {
           gS(1,3), gS(-7,11), gS(0,8), gS(2,3), gS(4,-6), gS(3,-13), gS(2,-10), gS(0,-5),
};

const int INCOMING_STORM_6TH[8] = {
           gS(-11,6), gS(-11,14), gS(2,10), gS(8,-2), gS(5,-10), gS(3,-12), gS(4,-9), gS(0,-2),
};
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-67,-40), gS(-53,-46), gS(-55,-66), gS(-50,-31),
};
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(61,36), gS(39,20), gS(42,45),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-6,2), gS(7,9), gS(0,11), gS(-1,4),
           gS(-8,5), gS(-21,0), gS(-4,17), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,19), gS(13,0), gS(24,0),
           gS(9,0), gS(-18,-1), gS(-4,15), gS(10,0),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-65), gS(3,-26), gS(10,-13), gS(15,-2), gS(17,6), gS(18,10), gS(17,13),
           gS(16,12), gS(15,13), gS(15,12), gS(17,9), gS(28,0), gS(30,10), gS(45,-9),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-35), gS(16,-8), gS(21,1), gS(25,9),
           gS(27,13), gS(30,10), gS(34,3), gS(36,-5),
};

const int KING_MOBILITY[9] = {
           gS(15,-30), gS(5,-5), gS(0,3), gS(-2,8), gS(-5,7),
           gS(-9,5), gS(0,3), gS(0,0), gS(13,-13),
};

const int ROOK_MOBILITY[15] = {
           gS(-29,-89), gS(-15,-52), gS(-8,-33), gS(0,-19), gS(2,-7), gS(0,5), gS(5,7),
           gS(6,7), gS(10,12), gS(12,16), gS(13,21), gS(15,23), gS(20,21), gS(26,21),
           gS(48,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-149), gS(-6,-111), gS(-5,-73), gS(-5,-53), gS(-4,-35), gS(-3,-18),
           gS(-2,-5), gS(0,6), gS(0,17), gS(0,24), gS(1,29), gS(2,34), gS(2,37),
           gS(2,40), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(9,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,16), gS(0,8), gS(5,4), gS(8,4), gS(0,1),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-85), gS(0,-22), gS(0,-5), gS(0,-5), gS(0,-17), gS(0,-20), gS(0,-10), gS(0,-94),
           gS(0,-11), gS(0,35), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-3,-19),
           gS(0,0), gS(27,26), gS(9,38), gS(0,39), gS(0,39), gS(17,36), gS(11,29), gS(0,0),
           gS(0,-11), gS(11,16), gS(-1,27), gS(-7,34), gS(-8,31), gS(0,26), gS(8,16), gS(-29,-14),
           gS(-9,-23), gS(0,3), gS(-4,15), gS(-14,21), gS(-14,20), gS(-21,16), gS(-1,2), gS(-37,-19),
           gS(-6,-29), gS(12,-5), gS(-11,6), gS(-30,14), gS(-26,13), gS(-22,7), gS(0,-5), gS(-5,-26),
           gS(6,-29), gS(0,-8), gS(-3,-2), gS(-22,4), gS(-24,5), gS(-3,-1), gS(-2,-8), gS(6,-31),
           gS(-12,-56), gS(8,-40), gS(-12,-21), gS(-35,-18), gS(9,-48), gS(-13,-28), gS(7,-37), gS(3,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(49,68), gS(40,74), gS(35,63), gS(64,48), gS(58,55), gS(39,60), gS(0,79), gS(0,67),
           gS(0,30), gS(6,27), gS(25,10), gS(37,0), gS(36,1), gS(67,5), gS(22,22), gS(23,13),
           gS(-18,12), gS(-1,8), gS(0,0), gS(7,0), gS(13,0), gS(10,0), gS(17,0), gS(-8,4),
           gS(-28,3), gS(-23,11), gS(-9,0), gS(5,-1), gS(4,-3), gS(5,-2), gS(-7,1), gS(-21,-4),
           gS(-28,0), gS(-21,0), gS(-9,-4), gS(-6,-2), gS(0,-2), gS(-1,-3), gS(-5,-7), gS(-23,-11),
           gS(-38,7), gS(-19,6), gS(-15,6), gS(0,5), gS(0,8), gS(0,4), gS(-5,0), gS(-29,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-3,16), gS(-2,10), gS(0,7), gS(0,3), gS(0,1), gS(-1,1), gS(0,1), gS(0,7),
           gS(-6,12), gS(-6,18), gS(-11,8), gS(-1,0), gS(0,2), gS(-8,5), gS(-5,21), gS(-6,14),
           gS(-2,-5), gS(-3,-4), gS(-11,-9), gS(-1,-18), gS(0,-16), gS(-8,-3), gS(-6,0), gS(-5,0),
           gS(0,-20), gS(-4,-10), gS(2,-15), gS(0,-25), gS(0,-24), gS(0,-6), gS(-5,-1), gS(0,0),
           gS(0,-26), gS(-3,-3), gS(-8,-6), gS(-5,0), gS(-7,-9), gS(-8,0), gS(2,-6), gS(0,-28),
           gS(0,-45), gS(-1,-20), gS(-6,-6), gS(-14,0), gS(-10,0), gS(0,-2), gS(0,-9), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-4,11), gS(-7,12), gS(-8,12), gS(-2,0), gS(0,1), gS(-8,2), gS(-2,21), gS(-5,8),
           gS(0,-1), gS(0,-1), gS(0,0), gS(0,-14), gS(0,-15), gS(-2,-7), gS(-9,-3), gS(0,1),
           gS(0,13), gS(0,0), gS(0,-5), gS(0,-6), gS(0,-4), gS(0,-7), gS(0,0), gS(0,0),
           gS(2,4), gS(-1,6), gS(-2,3), gS(-6,4), gS(-2,6), gS(-3,10), gS(3,-2), gS(6,3),
           gS(3,32), gS(-1,17), gS(-3,25), gS(-2,19), gS(-4,16), gS(2,20), gS(5,14), gS(8,20),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,19), gS(0,26), gS(0,19), gS(5,19), gS(10,20), gS(23,17), gS(36,14),
           gS(6,15), gS(0,15), gS(16,11), gS(35,3), gS(27,5), gS(25,4), gS(-7,15), gS(7,11),
           gS(1,16), gS(17,8), gS(18,9), gS(26,1), gS(40,-3), gS(32,-1), gS(24,1), gS(-5,13),
           gS(0,12), gS(2,13), gS(19,7), gS(21,1), gS(21,1), gS(21,0), gS(8,4), gS(0,3),
           gS(-13,7), gS(-9,12), gS(0,7), gS(0,5), gS(1,3), gS(-1,2), gS(-4,5), gS(-19,4),
           gS(-16,-1), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-2,-2), gS(0,-9), gS(1,-8), gS(-12,-11),
           gS(-21,-9), gS(-5,-11), gS(0,-8), gS(0,-10), gS(11,-16), gS(8,-22), gS(4,-23), gS(-39,-11),
           gS(-5,-13), gS(0,-14), gS(1,-10), gS(10,-21), gS(13,-23), gS(12,-22), gS(-9,-11), gS(-3,-26),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(4,-5), gS(-3,4), gS(7,6), gS(20,7), gS(23,6), gS(6,5), gS(7,0), gS(5,-14),
           gS(2,-14), gS(19,-4), gS(10,-2), gS(10,6), gS(6,11), gS(21,-7), gS(17,-10), gS(7,-11),
           gS(14,-19), gS(11,-24), gS(15,-10), gS(3,0), gS(13,0), gS(15,-6), gS(20,-21), gS(7,-29),
           gS(-3,-32), gS(6,-5), gS(-2,-3), gS(1,0), gS(6,-4), gS(-12,4), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-165,-55), gS(-31,-3), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-83,2), gS(-29,-4), gS(-90,-64),
           gS(-34,-9), gS(-21,0), gS(-4,0), gS(19,6), gS(8,3), gS(25,-12), gS(-12,-2), gS(-21,-16),
           gS(-10,-1), gS(4,3), gS(10,20), gS(27,6), gS(41,1), gS(45,5), gS(10,-1), gS(13,-13),
           gS(5,-1), gS(13,1), gS(20,15), gS(36,18), gS(24,22), gS(40,13), gS(16,3), gS(23,-10),
           gS(0,0), gS(13,5), gS(20,19), gS(24,17), gS(25,21), gS(31,13), gS(25,1), gS(11,0),
           gS(-8,-22), gS(9,-7), gS(9,5), gS(20,15), gS(23,13), gS(22,1), gS(25,-9), gS(2,-11),
           gS(-6,-27), gS(-12,1), gS(3,-6), gS(5,6), gS(11,4), gS(12,-4), gS(0,0), gS(1,-15),
           gS(-40,-30), gS(-14,-17), gS(0,-5), gS(0,1), gS(7,3), gS(-2,-4), gS(-8,-8), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,7), gS(0,16), gS(-8,24), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-14,2), gS(-28,22), gS(-13,25), gS(-26,44), gS(-40,63), gS(-21,30), gS(-13,28), gS(1,10),
           gS(-10,-15), gS(0,0), gS(-4,23), gS(0,35), gS(0,43), gS(3,32), gS(7,12), gS(-6,7),
           gS(-4,-16), gS(-4,9), gS(-3,19), gS(-2,40), gS(-5,53), gS(0,33), gS(0,25), gS(5,-4),
           gS(0,-26), gS(-6,0), gS(-1,11), gS(-3,38), gS(3,34), gS(-3,10), gS(8,4), gS(-5,-3),
           gS(-4,-32), gS(9,-23), gS(5,-5), gS(3,0), gS(3,0), gS(7,-4), gS(13,-11), gS(3,-26),
           gS(2,-52), gS(10,-57), gS(18,-57), gS(10,-33), gS(13,-29), gS(20,-64), gS(24,-79), gS(0,-44),
...
const int MATERIAL_VALUES[5] = {
           gS(92,113), gS(515,682), gS(359,377), gS(381,396), gS(1004,1255),
};
