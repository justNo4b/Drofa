...
const int PAWN_PUSH_THREAT = gS(10,3);
...
const int KING_PAWNLESS_FLANG = gS(-13,-59);
...
const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-10,-8), gS(-7,4), gS(-2,41),
           gS(15,53), gS(23,77), gS(50,86),
};

const int PASSED_PAWN_FILES[4] = {
           gS(1,19), gS(-3,14), gS(0,5), gS(-2,-3),
};

const int PASSED_PAWN_FREE[7] = {
           gS(0,0), gS(-7,8), gS(-11,2), gS(-8,5),
           gS(-1,8), gS(4,23), gS(66,22),
};
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-17,0), gS(-9,7), gS(1,12),
           gS(4,30), gS(5,50), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(8,16), gS(-1,7), gS(0,0), gS(-7,-2),
};
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,34), gS(16,36), gS(16,31),
};
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(16,12), gS(15,13), gS(15,12), gS(17,9), gS(28,0), gS(30,10), gS(48,-10),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-34), gS(17,-8), gS(21,1), gS(25,9),
           gS(28,13), gS(31,10), gS(34,4), gS(37,-4),
};
...
const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-152), gS(-6,-111), gS(-5,-73), gS(-5,-53), gS(-4,-35), gS(-3,-18),
           gS(-2,-5), gS(0,6), gS(0,17), gS(0,24), gS(1,30), gS(2,34), gS(2,37),
           gS(2,40), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(9,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,16), gS(0,9), gS(5,5), gS(8,7), gS(2,4),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-88), gS(0,-25), gS(0,-8), gS(0,-5), gS(0,-17), gS(0,-21), gS(0,-11), gS(0,-94),
           gS(0,-12), gS(0,34), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-20),
           gS(0,0), gS(27,25), gS(11,37), gS(0,39), gS(0,40), gS(17,36), gS(11,28), gS(0,-1),
           ...
           gS(-9,-29), gS(12,-6), gS(-11,6), gS(-30,17), gS(-25,15), gS(-22,8), gS(0,-6), gS(-6,-27),
...
const int PAWN_PSQT_BLACK[64] = {
           ...
           gS(50,69), gS(40,75), gS(35,65), gS(65,50), gS(59,56), gS(42,60), gS(0,80), gS(0,68),
           gS(0,32), gS(7,28), gS(25,10), gS(39,-1), gS(38,0), gS(68,3), gS(23,22), gS(25,13),
           gS(-16,15), gS(0,9), gS(1,0), gS(9,-2), gS(14,-3), gS(13,-2), gS(19,-1), gS(-7,3),
           gS(-26,4), gS(-22,11), gS(-10,0), gS(7,-3), gS(6,-4), gS(6,-3), gS(-6,1), gS(-20,-5),
           gS(-27,-1), gS(-20,0), gS(-8,-4), gS(-5,0), gS(0,0), gS(-1,-2), gS(-4,-6), gS(-22,-10),
           gS(-36,6), gS(-18,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,5), gS(-5,0), gS(-28,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-5,12), gS(-7,18), gS(-10,8), gS(-1,0), gS(-1,2), gS(-7,5), gS(-4,21), gS(-5,14),
           gS(-3,-4), gS(-3,-3), gS(-10,-8), gS(0,-19), gS(0,-15), gS(-6,-4), gS(-6,0), gS(-5,0),
           gS(0,-18), gS(-4,-9), gS(1,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-6,-1), gS(0,0),
           gS(0,-27), gS(-3,-4), gS(-7,-7), gS(-4,0), gS(-6,-9), gS(-8,0), gS(2,-6), gS(0,-27),
           gS(0,-45), gS(-1,-21), gS(-5,-7), gS(-13,0), gS(-8,0), gS(0,-2), gS(0,-9), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,14), gS(-1,1), gS(0,-4), gS(0,-7), gS(0,-5), gS(0,-8), gS(-1,0), gS(0,0),
           gS(3,2), gS(-1,6), gS(-1,3), gS(-5,4), gS(-2,6), gS(-3,10), gS(3,-2), gS(6,2),
           gS(4,30), gS(0,16), gS(-2,24), gS(-1,19), gS(-4,16), gS(2,20), gS(5,14), gS(8,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,20), gS(0,27), gS(0,20), gS(5,20), gS(11,20), gS(24,17), gS(36,14),
           gS(6,15), gS(0,16), gS(17,12), gS(35,3), gS(27,6), gS(26,4), gS(-7,15), gS(8,11),
           gS(2,17), gS(19,8), gS(19,9), gS(26,1), gS(41,-3), gS(34,-1), gS(26,1), gS(-4,13),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-4,0), gS(0,0), gS(-1,3), gS(21,-2), gS(13,0), gS(19,-1), gS(4,0), gS(5,-3),
           gS(-8,-1), gS(13,5), gS(3,2), gS(21,11), gS(16,11), gS(11,4), gS(11,2), gS(-1,-7),
           gS(5,-5), gS(-3,4), gS(8,6), gS(20,7), gS(23,5), gS(7,4), gS(7,0), gS(5,-14),
           gS(2,-14), gS(20,-4), gS(10,-3), gS(11,6), gS(6,10), gS(22,-8), gS(18,-10), gS(7,-11),
           gS(15,-19), gS(11,-24), gS(16,-10), gS(4,0), gS(13,0), gS(15,-6), gS(21,-21), gS(7,-29),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(4,-1), gS(12,0), gS(17,15), gS(35,17), gS(23,20), gS(38,12), gS(14,1), gS(21,-10),
           ...
           gS(-5,-27), gS(-10,1), gS(3,-5), gS(6,7), gS(12,5), gS(12,-4), gS(0,0), gS(2,-15),
           gS(-40,-30), gS(-14,-16), gS(0,-5), gS(0,1), gS(7,4), gS(-2,-3), gS(-8,-7), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,8), gS(0,17), gS(-8,24), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-14,2), gS(-28,22), gS(-13,25), gS(-27,45), gS(-42,65), gS(-21,31), gS(-14,31), gS(1,10),
           gS(-10,-15), gS(0,0), gS(-4,23), gS(0,35), gS(0,43), gS(3,33), gS(7,12), gS(-6,10),
           gS(-4,-16), gS(-4,9), gS(-4,19), gS(-2,40), gS(-6,53), gS(-1,35), gS(0,25), gS(4,-4),
           gS(0,-26), gS(-6,0), gS(0,11), gS(-3,38), gS(3,34), gS(-2,10), gS(9,4), gS(-4,-3),
           gS(-4,-32), gS(9,-24), gS(5,-5), gS(3,0), gS(3,0), gS(7,-4), gS(14,-11), gS(3,-26),
...
const int MATERIAL_VALUES[5] = {
           gS(91,113), gS(515,682), gS(358,377), gS(381,396), gS(1003,1258),
};
