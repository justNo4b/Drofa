...
const int PASSED_PAWN_POS_ADVANCE[7] = {
           ...
           gS(9,27), gS(32,57), gS(67,107),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-3,-23), gS(17,1), gS(0,-18), gS(-7,-7),
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(61,36), gS(39,21), gS(41,45),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-7,2), gS(6,9), gS(0,11), gS(0,4),
...
const int KING_PAWN_TENSION[3] = {
           gS(6,0), gS(-2,0), gS(-3,0),
};

const int KING_BLOCKED_TENSION[3] = {
           gS(13,4), gS(-13,-4), gS(0,0),
};
...
const int KING_MOBILITY[9] = {
           gS(14,-30), gS(5,-2), gS(0,5), gS(-2,9), gS(-5,7),
           gS(-8,4), gS(0,2), gS(0,-2), gS(13,-16),
};

const int ROOK_MOBILITY[15] = {
           gS(-28,-90), gS(-15,-52), gS(-8,-32), gS(0,-19), gS(2,-7), gS(0,5), gS(4,7),
           gS(6,7), gS(9,12), gS(12,16), gS(13,21), gS(15,23), gS(20,21), gS(25,21),
           gS(48,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-149), gS(-6,-111), gS(-5,-74), gS(-4,-54), gS(-4,-36), gS(-3,-18),
           gS(-2,-6), gS(0,6), gS(0,17), gS(0,24), gS(1,29), gS(2,34), gS(2,37),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,0), gS(27,26), gS(8,38), gS(0,39), gS(0,40), gS(16,36), gS(11,29), gS(0,-1),
           gS(0,-12), gS(11,15), gS(-1,26), gS(-7,35), gS(-8,32), gS(0,25), gS(8,16), gS(-30,-15),
           gS(-10,-24), gS(0,2), gS(-4,15), gS(-14,23), gS(-14,21), gS(-21,16), gS(-1,1), gS(-38,-21),
           gS(-6,-30), gS(13,-6), gS(-11,6), gS(-30,16), gS(-25,15), gS(-22,7), gS(0,-6), gS(-6,-28),
           gS(6,-31), gS(0,-8), gS(-2,0), gS(-21,7), gS(-23,8), gS(-2,0), gS(-2,-8), gS(5,-34),
           gS(-12,-57), gS(8,-40), gS(-11,-20), gS(-35,-16), gS(10,-46), gS(-13,-26), gS(7,-37), gS(1,-70),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(49,68), gS(40,73), gS(34,63), gS(65,48), gS(58,55), gS(39,60), gS(0,79), gS(0,67),
           gS(-1,30), gS(5,26), gS(23,8), gS(34,-2), gS(33,-1), gS(62,0), gS(19,19), gS(18,11),
           gS(-18,15), gS(-1,9), gS(0,0), gS(8,-2), gS(13,-3), gS(11,-2), gS(17,0), gS(-9,4),
           gS(-28,5), gS(-24,12), gS(-10,0), gS(5,-3), gS(4,-4), gS(5,-3), gS(-8,1), gS(-22,-4),
           gS(-28,-1), gS(-21,0), gS(-8,-3), gS(-5,0), gS(0,0), gS(0,-2), gS(-4,-6), gS(-23,-10),
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-7,12), gS(-8,19), gS(-12,8), gS(-3,0), gS(-2,2), gS(-11,5), gS(-7,21), gS(-9,14),
           gS(-3,-5), gS(-3,-3), gS(-11,-8), gS(0,-19), gS(0,-15), gS(-6,-4), gS(-5,-1), gS(-5,0),
           gS(0,-18), gS(-4,-9), gS(2,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-5,0), gS(0,0),
           gS(0,-27), gS(-3,-3), gS(-7,-6), gS(-4,0), gS(-7,-9), gS(-8,0), gS(2,-6), gS(0,-28),
           gS(0,-45), gS(-1,-21), gS(-6,-6), gS(-14,0), gS(-9,0), gS(0,-2), gS(0,-9), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-5,11), gS(-9,13), gS(-9,13), gS(-4,0), gS(-2,1), gS(-11,1), gS(-3,21), gS(-8,8),
           ...
           gS(3,32), gS(-1,16), gS(-3,25), gS(-2,20), gS(-4,16), gS(2,20), gS(5,14), gS(8,20),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           gS(-36,-1), gS(-43,-2), gS(-74,16), gS(-81,16), gS(-54,15), gS(-91,13), gS(-27,-6), gS(-28,-17),
           gS(-37,-2), gS(-19,-1), gS(-14,0), gS(-12,9), gS(-13,6), gS(-17,3), gS(-26,-6), gS(-25,-7),
           gS(-5,0), gS(0,0), gS(-2,3), gS(20,-2), gS(12,1), gS(19,-1), gS(4,0), gS(5,-3),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-11,-1), gS(4,3), gS(10,20), gS(27,6), gS(41,1), gS(45,5), gS(10,-1), gS(13,-13),
           ...
           gS(-8,-22), gS(9,-8), gS(9,5), gS(20,15), gS(23,13), gS(22,1), gS(25,-10), gS(2,-12),
           gS(-7,-27), gS(-12,1), gS(3,-6), gS(5,6), gS(11,4), gS(12,-5), gS(0,0), gS(1,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-10,-15), gS(-1,0), gS(-4,23), gS(0,35), gS(0,43), gS(4,31), gS(7,12), gS(-6,7),
           ...
           gS(4,-62), gS(6,-68), gS(5,-75), gS(3,-58), gS(6,-63), gS(-4,-75), gS(0,-62), gS(13,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(90,112), gS(515,682), gS(358,377), gS(380,395), gS(1004,1255),
};
