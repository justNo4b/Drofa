...
const int ROOK_XRAY_KING_CAMP = gS(7,-8);
...
const int KING_PASSER_DISTANCE_ENEMY[8] = {
           ...
           gS(1,13), gS(-3,23), gS(0,24), gS(-8,21),
};
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-67,-40), gS(-54,-45), gS(-55,-66), gS(-50,-31),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(18,33), gS(15,35), gS(15,31),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-5,2), gS(6,9), gS(0,11), gS(0,4),
           gS(-8,5), gS(-20,0), gS(-5,17), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(7,0), gS(14,20), gS(13,0), gS(24,0),
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-65), gS(3,-25), gS(10,-13), gS(15,-2), gS(17,6), gS(18,10), gS(17,12),
...
const int ROOK_MOBILITY[15] = {
           ...
           gS(6,7), gS(9,12), gS(12,16), gS(13,21), gS(15,23), gS(20,21), gS(26,20),
           gS(48,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-149), gS(-6,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-18),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,0), gS(27,25), gS(8,38), gS(0,39), gS(0,40), gS(17,36), gS(11,28), gS(0,-1),
           gS(0,-12), gS(11,15), gS(-1,26), gS(-7,35), gS(-8,32), gS(0,25), gS(8,15), gS(-30,-15),
           gS(-10,-24), gS(0,2), gS(-4,15), gS(-14,23), gS(-14,22), gS(-21,16), gS(-1,1), gS(-38,-20),
           gS(-6,-29), gS(12,-6), gS(-11,6), gS(-30,16), gS(-25,15), gS(-22,7), gS(0,-6), gS(-6,-28),
           gS(5,-30), gS(0,-8), gS(-3,0), gS(-22,8), gS(-23,8), gS(-2,0), gS(-1,-8), gS(4,-33),
           gS(-13,-56), gS(8,-41), gS(-13,-19), gS(-35,-16), gS(10,-46), gS(-13,-27), gS(8,-39), gS(1,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(49,68), gS(40,73), gS(35,63), gS(65,48), gS(58,55), gS(39,60), gS(0,79), gS(0,67),
           gS(0,32), gS(6,28), gS(25,10), gS(37,-1), gS(36,0), gS(67,3), gS(22,21), gS(24,13),
           gS(-18,15), gS(-2,9), gS(0,0), gS(8,-2), gS(13,-3), gS(11,-2), gS(17,-1), gS(-9,3),
           gS(-28,4), gS(-24,11), gS(-11,0), gS(5,-3), gS(4,-4), gS(5,-3), gS(-8,1), gS(-22,-5),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,-1), gS(0,0), gS(0,0), gS(1,-16), gS(0,-14), gS(0,-8), gS(-9,-4), gS(0,1),
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(2,16), gS(17,8), gS(18,9), gS(26,1), gS(40,-3), gS(32,-1), gS(25,1), gS(-5,13),
           gS(0,12), gS(2,13), gS(19,7), gS(21,1), gS(21,1), gS(21,0), gS(8,4), gS(0,3),
           gS(-13,7), gS(-9,12), gS(0,7), gS(0,5), gS(1,3), gS(-1,2), gS(-4,5), gS(-19,4),
           gS(-15,-1), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(0,-8), gS(-12,-11),
           gS(-20,-10), gS(-5,-11), gS(0,-8), gS(0,-10), gS(11,-16), gS(6,-21), gS(4,-23), gS(-40,-11),
           gS(-4,-14), gS(1,-15), gS(1,-10), gS(10,-20), gS(13,-24), gS(10,-20), gS(-10,-11), gS(-4,-26),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(4,-5), gS(-3,4), gS(7,6), gS(20,7), gS(23,6), gS(6,4), gS(7,0), gS(5,-14),
           gS(2,-14), gS(19,-4), gS(10,-3), gS(10,6), gS(6,11), gS(21,-7), gS(17,-10), gS(7,-11),
           gS(14,-19), gS(11,-24), gS(15,-10), gS(4,0), gS(13,0), gS(15,-6), gS(20,-21), gS(7,-29),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-8,-22), gS(9,-7), gS(9,4), gS(20,15), gS(23,13), gS(21,1), gS(25,-10), gS(2,-12),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-10,-15), gS(0,0), gS(-4,23), gS(0,35), gS(0,43), gS(3,31), gS(7,12), gS(-6,7),
           ...
           gS(-4,-31), gS(9,-23), gS(5,-5), gS(3,0), gS(2,0), gS(7,-4), gS(13,-11), gS(3,-26),
           gS(3,-52), gS(10,-57), gS(18,-57), gS(10,-33), gS(13,-29), gS(20,-64), gS(24,-79), gS(0,-44),
           gS(4,-62), gS(6,-68), gS(4,-75), gS(4,-58), gS(6,-63), gS(-4,-75), gS(0,-62), gS(13,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(91,113), gS(514,683), gS(358,377), gS(381,395), gS(1004,1255),
};
