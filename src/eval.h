...
const int BISHOP_MOBILITY[14] = {
           gS(-19,-103), gS(-7,-43), gS(-2,-16), gS(0,-1), gS(3,12), gS(4,22), gS(4,27),
           gS(2,29), gS(3,31), gS(6,28), gS(11,23), gS(27,13), gS(44,24), gS(75,-10),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-8,-75), gS(1,-29), gS(4,-4), gS(6,10), gS(9,19),
           gS(12,26), gS(16,26), gS(23,19), gS(33,4),
};

const int KING_MOBILITY[9] = {
           gS(12,-1), gS(15,-2), gS(9,5), gS(5,9), gS(-2,8),
           gS(-8,5), gS(-6,3), gS(-17,-2), gS(-12,-15),
};

const int ROOK_MOBILITY[15] = {
           gS(-21,-102), gS(-13,-66), gS(-9,-33), gS(-7,-13), gS(-8,5), gS(-10,19), gS(-4,23),
           gS(0,26), gS(4,31), gS(9,36), gS(11,41), gS(17,43), gS(21,43), gS(36,30),
           gS(89,0),
};

const int QUEEN_MOBILITY[28] = {
           gS(-39,-104), gS(-18,-167), gS(-6,-133), gS(-3,-78), gS(-1,-44), gS(0,-22), gS(1,-4),
           gS(3,7), gS(6,17), gS(7,23), gS(9,30), gS(10,35), gS(10,39), gS(9,45),
           gS(8,51), gS(5,55), gS(4,57), gS(3,58), gS(4,58), gS(9,53), gS(12,49),
...
const int MINOR_BEHIND_PAWN = gS(5,21);

const int MINOR_BEHIND_PASSER = gS(8,12);

const int KING_AHEAD_PASSER = gS(-13,10);
...
const int BISHOP_OWN_PAWNS[9] = {
           gS(5,19), gS(4,14), gS(4,6), gS(2,0),
           gS(0,-6), gS(-3,-12), gS(-8,-13), gS(-14,-6),
           gS(-8,-1),
};
...
const int PASSED_PAWN_RANKS[8] = {
           ...
           gS(14,55), gS(24,119), gS(74,131), gS(0,0),
};

const int PASSED_PAWN_FILES[8] = {
           gS(9,15), gS(5,16), gS(0,4), gS(-1,0),
           gS(-4,-1), gS(-15,2), gS(-7,17), gS(11,11),
};


const int KING_PSQT_BLACK[64] = {
           gS(-13,-95), gS(-2,-47), gS(-1,-33), gS(0,-18), gS(-2,-32), gS(-3,-27), gS(-4,-25), gS(-12,-87),
           ...
           gS(-22,-34), gS(22,1), gS(26,18), gS(-15,33), gS(1,29), gS(11,20), gS(23,4), gS(-53,-22),
           gS(-52,-16), gS(-9,1), gS(-7,11), gS(-28,26), gS(-16,23), gS(-16,16), gS(-9,2), gS(-52,-13),
           gS(0,-13), gS(-1,4), gS(-24,15), gS(-64,24), gS(-45,19), gS(-46,22), gS(0,2), gS(-3,-22),
           gS(-27,-56), gS(3,-29), gS(-29,-7), gS(-37,-28), gS(-27,-38), gS(-55,-8), gS(-4,-28), gS(-14,-74),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(60,72), gS(50,98), gS(68,93), gS(74,79), gS(81,77), gS(84,81), gS(-8,101), gS(-23,82),
           gS(-2,48), gS(29,54), gS(41,45), gS(44,24), gS(55,25), gS(95,31), gS(62,39), gS(9,33),
           gS(-4,20), gS(5,26), gS(7,22), gS(22,7), gS(30,10), gS(30,15), gS(12,22), gS(-4,8),
           gS(-15,4), gS(-6,13), gS(-3,5), gS(4,4), gS(10,4), gS(5,6), gS(2,6), gS(-15,-5),
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-2,27), gS(-6,32), gS(16,28), gS(27,29), gS(24,30), gS(42,13), gS(8,25), gS(15,21),
           gS(-9,19), gS(31,5), gS(20,16), gS(42,5), gS(53,0), gS(50,7), gS(70,-8), gS(14,11),
           gS(-8,10), gS(8,9), gS(16,11), gS(37,4), gS(30,4), gS(28,3), gS(30,0), gS(12,5),
           gS(-20,0), gS(-11,10), gS(-14,12), gS(-3,4), gS(-5,3), gS(-8,8), gS(6,4), gS(-11,-2),
           ...
           gS(-16,-15), gS(-9,-13), gS(-6,-11), gS(0,-18), gS(0,-18), gS(-3,-8), gS(0,-17), gS(-11,-24),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-52,4), gS(-44,8), gS(-77,16), gS(-80,24), gS(-68,19), gS(-92,16), gS(-15,0), gS(-49,0),
           gS(-48,0), gS(-12,2), gS(-7,8), gS(-14,16), gS(-5,15), gS(0,6), gS(-27,5), gS(-21,-5),
           gS(2,0), gS(3,8), gS(22,2), gS(8,9), gS(23,7), gS(9,9), gS(24,1), gS(16,-2),
           gS(-9,0), gS(18,5), gS(5,7), gS(21,15), gS(20,15), gS(15,4), gS(20,2), gS(-6,0),
           gS(0,-14), gS(7,0), gS(11,8), gS(18,10), gS(24,8), gS(4,6), gS(13,0), gS(3,-15),
           gS(-1,-17), gS(10,-8), gS(7,-3), gS(13,2), gS(9,4), gS(11,-7), gS(12,-10), gS(13,-13),
           gS(7,-31), gS(9,-33), gS(10,-16), gS(4,-1), gS(7,-3), gS(9,-16), gS(16,-30), gS(4,-42),
           gS(5,-38), gS(1,-15), gS(2,-3), gS(0,-7), gS(1,-2), gS(0,-9), gS(-1,-10), gS(1,-39),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-143,-68), gS(-36,-18), gS(-65,12), gS(-14,0), gS(0,1), gS(-53,14), gS(-29,-10), gS(-88,-70),
           ...
           gS(0,-10), gS(7,5), gS(26,27), gS(25,38), gS(17,34), gS(38,22), gS(15,8), gS(8,-7),
           gS(-5,-8), gS(9,8), gS(14,29), gS(20,31), gS(23,33), gS(19,31), gS(24,11), gS(6,0),
           gS(-19,-34), gS(1,-7), gS(5,7), gS(13,22), gS(17,21), gS(12,5), gS(7,-2), gS(-5,-27),
           gS(-21,-17), gS(-28,-1), gS(-7,-12), gS(6,4), gS(1,7), gS(0,-11), gS(-16,-3), gS(-11,-4),
           gS(-40,-46), gS(-12,-29), gS(-11,-18), gS(-8,2), gS(0,1), gS(-7,-12), gS(-10,-21), gS(-40,-45),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-4,3), gS(0,19), gS(0,33), gS(3,44), gS(9,54), gS(31,49), gS(8,50), gS(15,35),
           ...
           gS(0,-58), gS(10,-42), gS(4,-22), gS(4,-31), gS(3,-29), gS(0,-12), gS(15,-33), gS(4,-47),
