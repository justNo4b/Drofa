...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-15,2), gS(-9,8), gS(0,15),
           gS(5,31), gS(16,35), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[8] = {
           gS(8,5), gS(-2,3), gS(0,1), gS(-5,-3),
           gS(-6,-1), gS(0,0), gS(-1,1), gS(8,4),
};
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(16,11), gS(15,11), gS(15,10), gS(16,8), gS(28,0), gS(30,10), gS(55,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-33), gS(17,-6), gS(22,3), gS(26,10),
           gS(29,14), gS(33,10), gS(36,4), gS(39,-4),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-2,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(6,24), gS(11,13), gS(-35,-15),
...
const int PAWN_PSQT_BLACK[64] = {
           ...
           gS(1,30), gS(9,30), gS(25,12), gS(42,0), gS(44,1), gS(71,6), gS(27,24), gS(26,16),
           gS(-10,14), gS(2,11), gS(7,0), gS(15,-1), gS(22,-2), gS(21,0), gS(25,1), gS(-2,7),
           gS(-21,3), gS(-20,12), gS(-7,0), gS(11,-3), gS(10,-4), gS(11,-3), gS(-3,2), gS(-15,-3),
           gS(-23,-2), gS(-17,0), gS(-6,-4), gS(-4,0), gS(1,-1), gS(1,-2), gS(-1,-6), gS(-18,-8),
           gS(-33,5), gS(-15,5), gS(-14,6), gS(0,6), gS(0,9), gS(2,5), gS(-2,1), gS(-24,-4),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-6,16), gS(-8,7), gS(-2,0), gS(-1,2), gS(-6,4), gS(-4,20), gS(-4,13),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,9), gS(-7,11), gS(-8,10), gS(-2,0), gS(-1,1), gS(-6,1), gS(-2,19), gS(-4,7),
...
const int MATERIAL_VALUES[5] = {
           gS(86,113), gS(507,683), gS(353,376), gS(377,397), gS(1001,1266),
};
