...
const int KING_HIGH_DANGER = gS(-49,-62);
...
const int DOUBLED_PAWN_PENALTY = gS(-5,-34);

const int DOUBLED_CAN_BE_TRADED = gS(-8,-17);

const int ISOLATED_PAWN_PENALTY = gS(-10,-2);

const int ISOLATED_CAN_BE_TRADED = gS(-7,-5);
...
const int PAWN_CONNECTED[7] = {
           ...
           gS(19,25), gS(43,57), gS(6,42),
};

const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-9,-8), gS(-5,7), gS(0,43),
           gS(15,53), gS(25,77), gS(54,86),
};

const int PASSED_PAWN_FILES[8] = {
           gS(0,22), gS(-1,13), gS(0,3), gS(1,-9),
           gS(-5,-6), gS(-5,3), gS(-5,14), gS(0,15),
};

const int PASSED_PAWN_FREE[7] = {
           gS(0,0), gS(-7,8), gS(-11,2), gS(-8,5),
           gS(0,9), gS(7,24), gS(63,25),
};

const int PASSED_PAWN_POS_ADVANCE[7] = {
           gS(0,0), gS(4,5), gS(5,1), gS(6,13),
           gS(13,27), gS(34,56), gS(47,113),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-3,-20), gS(17,3), gS(1,-20), gS(-8,-7),
           gS(-10,-9), gS(-19,-9), gS(-18,-13), gS(-16,-11),
};

const int KING_PASSER_DISTANCE_FRIENDLY[8] = {
           gS(0,0), gS(4,35), gS(-9,27), gS(-7,9),
           gS(-4,0), gS(0,0), gS(14,-1), gS(13,-2),
};

const int KING_PASSER_DISTANCE_ENEMY[8] = {
           gS(0,0), gS(-46,-2), gS(8,-18), gS(0,0),
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-66,-41), gS(-50,-48), gS(-54,-67), gS(-49,-29),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-5,2), gS(3,9), gS(3,13), gS(0,10),
           gS(-9,5), gS(-20,0), gS(-6,14), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(9,0), gS(12,22), gS(19,5), gS(24,12),
           gS(10,0), gS(-16,-1), gS(-3,11), gS(10,0),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-7,-65), gS(2,-25), gS(9,-13), gS(15,-2), gS(17,7), gS(18,9), gS(18,12),
           gS(17,12), gS(17,12), gS(17,11), gS(18,8), gS(32,0), gS(33,11), gS(59,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-3,-94), gS(8,-34), gS(15,-7), gS(21,3), gS(26,11),
           gS(30,16), gS(34,14), gS(38,8), gS(42,-1),
};

const int KING_MOBILITY[9] = {
           gS(13,-23), gS(5,-4), gS(0,4), gS(-2,9), gS(-5,8),
           gS(-9,6), gS(0,5), gS(0,0), gS(13,-18),
};

const int ROOK_MOBILITY[15] = {
           gS(-26,-86), gS(-12,-48), gS(-6,-30), gS(2,-17), gS(4,-5), gS(2,6), gS(7,7),
           gS(9,8), gS(13,12), gS(15,16), gS(17,20), gS(19,23), gS(23,21), gS(29,20),
           gS(52,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-163), gS(-6,-111), gS(-5,-71), gS(-4,-50), gS(-3,-33), gS(-2,-15),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-2,-20), gS(0,33), gS(5,33), gS(1,32), gS(1,15), gS(0,33), gS(0,31), gS(-4,-22),
           gS(0,-2), gS(27,24), gS(22,35), gS(3,38), gS(6,39), gS(27,35), gS(15,28), gS(0,-3),
           gS(-2,-13), gS(11,13), gS(5,24), gS(-6,35), gS(-6,33), gS(10,23), gS(13,14), gS(-36,-14),
           gS(-15,-24), gS(5,0), gS(-3,16), gS(-20,26), gS(-15,24), gS(-21,18), gS(-1,2), gS(-49,-17),
           gS(-22,-26), gS(11,-6), gS(-13,9), gS(-32,20), gS(-27,19), gS(-23,10), gS(-1,-4), gS(-13,-24),
           gS(1,-29), gS(-4,-6), gS(-4,1), gS(-22,11), gS(-24,11), gS(-4,2), gS(-7,-5), gS(0,-31),
           gS(-18,-55), gS(3,-38), gS(-16,-17), gS(-35,-15), gS(10,-46), gS(-14,-25), gS(2,-36), gS(-3,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(54,69), gS(40,78), gS(40,68), gS(66,58), gS(66,62), gS(53,64), gS(0,84), gS(1,75),
           gS(3,33), gS(11,34), gS(28,20), gS(48,9), gS(50,10), gS(76,14), gS(32,27), gS(29,20),
           gS(-8,14), gS(1,13), gS(14,3), gS(20,6), gS(27,5), gS(28,1), gS(24,3), gS(0,7),
           gS(-21,1), gS(-17,7), gS(-7,0), gS(12,1), gS(12,0), gS(12,-2), gS(0,-2), gS(-15,-5),
           gS(-25,-4), gS(-19,-2), gS(-5,-5), gS(-2,1), gS(3,1), gS(4,-3), gS(-1,-9), gS(-20,-10),
           gS(-29,6), gS(-14,3), gS(-13,9), gS(1,9), gS(0,12), gS(5,6), gS(0,0), gS(-19,-3),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-1,10), gS(-3,13), gS(-5,7), gS(-1,0), gS(0,2), gS(-2,4), gS(-2,17), gS(-2,12),
           gS(-3,-4), gS(-3,0), gS(-8,-8), gS(0,-18), gS(-1,-12), gS(-5,-5), gS(-7,1), gS(-2,0),
           gS(0,-13), gS(-3,-9), gS(1,-12), gS(0,-24), gS(0,-19), gS(-1,-6), gS(-5,-1), gS(0,0),
           gS(0,-24), gS(-3,-6), gS(-5,-10), gS(-4,0), gS(-6,-8), gS(-6,1), gS(2,-5), gS(0,-23),
           gS(0,-36), gS(-1,-18), gS(-4,-6), gS(-9,0), gS(-6,0), gS(0,-2), gS(1,-9), gS(1,-43),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-1,9), gS(-4,10), gS(-4,9), gS(-1,0), gS(0,1), gS(-2,1), gS(-1,15), gS(-3,7),
           gS(0,-3), gS(0,0), gS(-1,-2), gS(1,-17), gS(0,-13), gS(0,-8), gS(-9,-4), gS(0,0),
           gS(0,7), gS(0,0), gS(3,-6), gS(0,-10), gS(0,-9), gS(0,-8), gS(0,-1), gS(0,-4),
           gS(5,1), gS(0,5), gS(0,2), gS(-3,3), gS(-2,5), gS(-1,6), gS(4,-5), gS(9,0),
           gS(6,20), gS(0,12), gS(0,20), gS(-2,17), gS(-3,14), gS(4,18), gS(5,12), gS(9,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(27,12), gS(15,21), gS(0,28), gS(0,21), gS(6,20), gS(14,20), gS(27,16), gS(39,14),
           gS(7,15), gS(0,16), gS(18,12), gS(34,4), gS(26,6), gS(29,3), gS(-5,14), gS(11,10),
           gS(4,17), gS(20,9), gS(18,11), gS(27,1), gS(43,-4), gS(38,-2), gS(30,0), gS(-2,12),
           gS(1,13), gS(0,13), gS(17,8), gS(21,1), gS(20,0), gS(20,-1), gS(7,2), gS(0,4),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-38,-1), gS(-17,0), gS(-10,0), gS(-12,11), gS(-11,8), gS(-12,2), gS(-25,-4), gS(-23,-7),
           gS(-3,0), gS(2,1), gS(2,4), gS(27,-2), gS(19,0), gS(21,0), gS(8,0), gS(9,-6),
           gS(-7,-2), gS(10,5), gS(6,2), gS(24,7), gS(18,9), gS(14,4), gS(8,0), gS(-1,-10),
           gS(8,-7), gS(0,4), gS(8,4), gS(20,6), gS(23,5), gS(6,3), gS(9,0), gS(8,-18),
           gS(4,-16), gS(21,-6), gS(11,-3), gS(11,6), gS(6,10), gS(21,-8), gS(18,-11), gS(8,-13),
           gS(17,-21), gS(12,-25), gS(16,-10), gS(5,0), gS(15,0), gS(15,-6), gS(21,-21), gS(8,-30),
           gS(-2,-32), gS(8,-7), gS(0,-3), gS(2,0), gS(7,-4), gS(-10,4), gS(0,-9), gS(-1,-25),
};
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-10,-1), gS(13,2), gS(16,20), gS(33,9), gS(48,3), gS(48,7), gS(18,-1), gS(13,-13),
           gS(8,-1), gS(5,-1), gS(15,13), gS(30,16), gS(18,17), gS(34,11), gS(10,-3), gS(25,-10),
           gS(1,2), gS(14,5), gS(17,20), gS(23,17), gS(25,21), gS(29,12), gS(26,1), gS(11,0),
           gS(-7,-19), gS(11,-5), gS(9,7), gS(22,19), gS(24,16), gS(21,3), gS(26,-8), gS(3,-8),
           gS(-7,-26), gS(-10,4), gS(3,-4), gS(6,9), gS(12,7), gS(11,-3), gS(1,2), gS(2,-15),
           gS(-40,-34), gS(-13,-16), gS(-2,-6), gS(0,1), gS(8,3), gS(-4,-5), gS(-7,-6), gS(-21,-31),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,17), gS(-4,26), gS(-9,31), gS(1,16), gS(-9,23), gS(-11,17),
           gS(-13,1), gS(-28,25), gS(-13,25), gS(-30,53), gS(-46,72), gS(-25,39), gS(-18,44), gS(1,17),
           gS(-9,-15), gS(0,0), gS(-4,23), gS(0,37), gS(-3,47), gS(0,42), gS(5,18), gS(-10,20),
           gS(-2,-18), gS(-7,8), gS(-5,18), gS(-5,40), gS(-9,55), gS(-7,42), gS(-6,32), gS(3,-2),
           gS(2,-27), gS(-5,0), gS(-1,10), gS(-3,38), gS(3,33), gS(-5,11), gS(9,4), gS(-4,-2),
           gS(-1,-37), gS(11,-25), gS(7,-6), gS(5,0), gS(4,0), gS(9,-6), gS(15,-11), gS(5,-27),
           gS(6,-55), gS(12,-57), gS(21,-58), gS(14,-34), gS(16,-31), gS(23,-65), gS(26,-80), gS(1,-46),
           gS(6,-62), gS(9,-70), gS(7,-76), gS(6,-59), gS(9,-64), gS(-3,-76), gS(0,-71), gS(12,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(83,112), gS(501,684), gS(353,378), gS(374,400), gS(997,1274),
};
