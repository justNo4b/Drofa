...
const int KING_HIGH_DANGER = gS(-50,-66);
...
const int BISHOP_ATT_OUTPOSTED_KNIGHT = gS(13,6);

const int BISHOP_ATT_OUTPOSTED_BISHOP = gS(6,4);

const int BISHOP_ATT_GENPOST_KNIGHT = gS(0,0);

const int BISHOP_ATT_GENPOST_BISHOP = gS(0,0);

const int KNIGHT_POS_PROUTPOST_JUMP = gS(8,7);

const int KNIGHT_POS_GENOUTPOST_JUMP = gS(6,9);

const int KNIGHT_ATT_OUTPOSTED_KNIGHT = gS(16,4);

const int KNIGHT_ATT_OUTPOSTED_BISHOP = gS(15,11);

const int KNIGHT_ATT_GENPOST_KNIGHT

const int KNIGHT_ATT_GENPOST_BISHOP = gS(0,0);
...
const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-9,-9), gS(-6,5), gS(-1,41),
           gS(15,53), gS(27,78), gS(53,87),
};

const int PASSED_PAWN_FILES[8] = {
           gS(0,20), gS(-1,12), gS(1,5), gS(1,-6),
           gS(-5,-3), gS(-4,4), gS(-5,12), gS(0,15),
};
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-14,3), gS(-9,8), gS(-1,15),
           gS(3,32), gS(15,39), gS(0,0),
};
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,33), gS(17,35), gS(16,31),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(7,0), gS(14,23), gS(15,3), gS(25,7),
...
const int BISHOP_MOBILITY[14] = {
           gS(-6,-63), gS(2,-24), gS(9,-12), gS(14,-2), gS(17,6), gS(18,9), gS(17,12),
           gS(17,11), gS(16,12), gS(15,10), gS(16,8), gS(28,0), gS(30,10), gS(54,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-33), gS(17,-6), gS(22,2), gS(26,10),
...
const int ROOK_MOBILITY[15] = {
           gS(-27,-85), gS(-13,-48), gS(-6,-30), gS(1,-18), gS(4,-6), gS(1,6), gS(6,7),
           gS(8,7), gS(12,12), gS(14,15), gS(16,20), gS(18,22), gS(22,20), gS(28,19),
           gS(50,9),
};
...
const int QUEEN_MOBILITY[28] = {
           ...
           gS(16,24), gS(9,25), gS(19,17), gS(0,12), gS(5,8), gS(10,13), gS(8,10),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,-2), gS(27,24), gS(17,35), gS(0,38), gS(1,39), gS(22,35), gS(13,28), gS(0,-3),
           gS(-2,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(5,24), gS(10,13), gS(-35,-15),
           gS(-14,-24), gS(2,0), gS(-3,16), gS(-15,25), gS(-13,24), gS(-21,18), gS(-1,1), gS(-44,-18),
           gS(-16,-27), gS(11,-6), gS(-11,7), gS(-30,19), gS(-25,18), gS(-22,9), gS(0,-5), gS(-8,-26),
           gS(2,-29), gS(-3,-7), gS(-3,1), gS(-22,10), gS(-24,11), gS(-3,2), gS(-6,-6), gS(2,-31),
           gS(-16,-55), gS(4,-39), gS(-15,-18), gS(-34,-15), gS(11,-46), gS(-13,-26), gS(3,-36), gS(-1,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(52,68), gS(40,78), gS(36,66), gS(65,53), gS(64,58), gS(48,64), gS(0,85), gS(1,74),
           gS(0,30), gS(8,29), gS(25,11), gS(41,0), gS(43,0), gS(71,5), gS(27,23), gS(26,16),
           gS(-10,14), gS(2,11), gS(7,0), gS(15,-1), gS(22,-2), gS(21,-1), gS(25,1), gS(-2,6),
           gS(-22,3), gS(-20,12), gS(-7,-1), gS(10,-3), gS(10,-5), gS(11,-3), gS(-3,2), gS(-15,-3),
           gS(-23,-3), gS(-18,0), gS(-6,-4), gS(-4,-1), gS(1,-1), gS(1,-3), gS(-1,-7), gS(-17,-9),
           gS(-34,5), gS(-16,5), gS(-14,6), gS(0,5), gS(0,8), gS(2,4), gS(-3,1), gS(-25,-4),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-3,10), gS(-6,17), gS(-9,7), gS(-2,0), gS(-2,2), gS(-6,4), gS(-5,20), gS(-4,13),
           gS(-2,-4), gS(-4,-1), gS(-10,-8), gS(0,-19), gS(-1,-13), gS(-6,-4), gS(-7,0), gS(-3,0),
           gS(0,-16), gS(-3,-9), gS(1,-13), gS(0,-25), gS(0,-22), gS(0,-6), gS(-6,-1), gS(0,0),
           gS(0,-26), gS(-3,-5), gS(-6,-9), gS(-5,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-27),
           gS(0,-42), gS(-1,-20), gS(-5,-7), gS(-11,-1), gS(-7,0), gS(1,-2), gS(1,-9), gS(0,-47),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-2,9), gS(-7,11), gS(-8,10), gS(-2,0), gS(-2,1), gS(-6,1), gS(-2,20), gS(-3,7),
           gS(0,-2), gS(0,0), gS(-1,-1), gS(0,-17), gS(0,-14), gS(-1,-8), gS(-9,-3), gS(0,0),
           gS(0,11), gS(0,1), gS(2,-6), gS(0,-10), gS(0,-8), gS(0,-8), gS(0,0), gS(0,-1),
           gS(4,0), gS(0,5), gS(0,3), gS(-4,3), gS(-2,5), gS(-2,9), gS(4,-4), gS(8,0),
           gS(6,26), gS(0,15), gS(-1,22), gS(-1,17), gS(-4,14), gS(4,19), gS(6,14), gS(10,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-16,0), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(1,-9), gS(-13,-10),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(1,1), gS(0,4), gS(24,-3), gS(16,0), gS(22,0), gS(8,0), gS(8,-5),
           gS(-7,-1), gS(9,5), gS(4,2), gS(21,9), gS(16,9), gS(12,4), gS(7,0), gS(-1,-10),
           gS(6,-6), gS(-2,3), gS(7,4), gS(19,7), gS(22,4), gS(5,3), gS(8,0), gS(6,-17),
           gS(4,-16), gS(20,-5), gS(10,-2), gS(10,6), gS(6,11), gS(21,-7), gS(18,-10), gS(9,-13),
           gS(16,-20), gS(12,-23), gS(16,-9), gS(5,0), gS(14,0), gS(15,-5), gS(21,-20), gS(8,-29),
           gS(-2,-32), gS(8,-6), gS(-1,-2), gS(2,0), gS(7,-4), gS(-11,4), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-159,-58), gS(-31,-4), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-79,2), gS(-29,-5), gS(-89,-64),
           gS(-31,-9), gS(-17,0), gS(-1,0), gS(21,5), gS(9,3), gS(29,-12), gS(-11,-1), gS(-17,-16),
           gS(-10,-1), gS(9,2), gS(14,19), gS(30,5), gS(44,0), gS(48,5), gS(15,-1), gS(13,-13),
           gS(5,-1), gS(7,0), gS(15,14), gS(32,15), gS(20,17), gS(35,11), gS(12,-2), gS(23,-10),
           ...
           gS(-6,-26), gS(-10,3), gS(4,-3), gS(6,9), gS(13,7), gS(13,-2), gS(1,1), gS(3,-15),
           gS(-40,-29), gS(-13,-15), gS(-1,-4), gS(1,2), gS(9,4), gS(-2,-3), gS(-7,-5), gS(-19,-30),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,12), gS(-4,21), gS(-9,26), gS(0,11), gS(-9,18), gS(-11,16),
           gS(-13,1), gS(-27,25), gS(-13,25), gS(-29,48), gS(-47,67), gS(-24,34), gS(-16,38), gS(1,12),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,46), gS(0,37), gS(6,15), gS(-9,15),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,54), gS(-6,37), gS(-4,27), gS(3,-3),
...
const int MATERIAL_VALUES[5] = {
           gS(86,114), gS(508,683), gS(354,375), gS(378,396), gS(1002,1265),
};
