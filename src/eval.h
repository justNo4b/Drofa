...
const int PASSER_BLOCKED = gS(7,-1);
...
const int ROOK_REAR_SUPPORT = gS(6,18);
...
const int ROOK_MOBILITY[15] = {
           gS(-26,-87), gS(-12,-50), gS(-6,-30), gS(1,-17), gS(3,-5), gS(1,7), gS(6,8),
           gS(8,9), gS(12,14), gS(15,17), gS(18,22), gS(21,24), gS(26,22), gS(32,22),
           gS(55,13),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-18,-24), gS(7,0), gS(-3,16), gS(-24,27), gS(-18,25), gS(-22,18), gS(0,2), gS(-51,-16),
           gS(-28,-23), gS(8,-4), gS(-17,10), gS(-39,22), gS(-35,21), gS(-28,12), gS(-5,-2), gS(-19,-21),
           gS(0,-26), gS(-3,-4), gS(0,1), gS(-22,12), gS(-22,12), gS(-2,2), gS(-6,-3), gS(-1,-28),
           gS(-19,-53), gS(3,-36), gS(-16,-16), gS(-31,-16), gS(14,-46), gS(-11,-26), gS(2,-34), gS(-2,-66),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,68), gS(40,79), gS(42,68), gS(65,58), gS(65,63), gS(56,64), gS(-2,87), gS(0,75),
           gS(2,34), gS(10,35), gS(24,21), gS(47,9), gS(47,10), gS(72,15), gS(32,29), gS(27,20),
           gS(-8,14), gS(0,15), gS(11,3), gS(18,7), gS(25,6), gS(25,2), gS(23,4), gS(0,7),
           gS(-21,0), gS(-18,7), gS(-7,0), gS(11,1), gS(12,0), gS(11,-2), gS(0,-1), gS(-14,-6),
           gS(-23,-5), gS(-20,-2), gS(-4,-4), gS(-4,2), gS(2,2), gS(3,-2), gS(0,-9), gS(-18,-11),
           gS(-27,4), gS(-13,3), gS(-12,9), gS(0,10), gS(-1,13), gS(6,6), gS(0,0), gS(-17,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-2,6), gS(-1,5), gS(0,1), gS(0,1), gS(0,0), gS(-1,0), gS(0,0), gS(0,1),
           gS(-1,7), gS(-2,7), gS(-4,4), gS(-1,0), gS(0,1), gS(-2,1), gS(-2,10), gS(-1,8),
           gS(-3,-2), gS(-3,0), gS(-6,-7), gS(0,-18), gS(-1,-12), gS(-4,-5), gS(-8,0), gS(-2,0),
           gS(-1,-9), gS(-3,-7), gS(0,-12), gS(0,-22), gS(-1,-17), gS(-1,-6), gS(-5,0), gS(-1,0),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-4,1), gS(-2,1), gS(0,0), gS(0,0), gS(0,0), gS(-1,0), gS(0,0), gS(0,0),
           gS(-1,6), gS(-3,6), gS(-3,5), gS(-1,0), gS(0,0), gS(-3,0), gS(-1,8), gS(-2,4),
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(6,16), gS(0,17), gS(18,12), gS(33,5), gS(26,7), gS(32,3), gS(0,14), gS(12,11),
           ...
           gS(-14,8), gS(-11,13), gS(-2,9), gS(-1,6), gS(0,4), gS(-1,2), gS(-4,6), gS(-19,4),
           ...
           gS(-6,-10), gS(0,-13), gS(2,-9), gS(10,-20), gS(14,-23), gS(13,-21), gS(-8,-11), gS(-3,-25),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(19,-22), gS(12,-25), gS(17,-11), gS(6,0), gS(15,0), gS(15,-6), gS(21,-23), gS(9,-32),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-40,-36), gS(-14,-16), gS(-2,-7), gS(0,0), gS(7,2), gS(-5,-5), gS(-9,-7), gS(-23,-33),
};
...
const int MATERIAL_VALUES[5] = {
           gS(83,113), gS(491,686), gS(347,381), gS(370,403), gS(991,1285),
};
