...
const int KING_LOW_DANGER = gS(65,-62);
...
const int PASSER_BLOCKED = gS(5,-3);
...
const int PAWN_CONNECTED[7] = {
           gS(0,0), gS(4,0), gS(7,5), gS(8,11),
           gS(20,25), gS(39,57), gS(5,35),
};

const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-5,-8), gS(-2,7), gS(0,44),
           gS(15,54), gS(21,78), gS(51,86),
};

const int PASSED_PAWN_FILES[8] = {
           gS(0,23), gS(0,13), gS(1,4), gS(1,-8),
           gS(-4,-6), gS(-4,3), gS(-3,14), gS(1,16),
};

const int PASSED_PAWN_FREE[7] = {
           gS(0,0), gS(-7,8), gS(-11,2), gS(-8,5),
           gS(-1,9), gS(5,26), gS(52,26),
};

const int PASSED_PAWN_POS_ADVANCE[7] = {
           gS(0,0), gS(4,5), gS(5,1), gS(6,13),
           gS(10,28), gS(26,56), gS(33,115),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-8,-22), gS(16,3), gS(0,-19), gS(-8,-6),
           gS(-11,-7), gS(-20,-8), gS(-18,-11), gS(-17,-9),
};

const int KING_PASSER_DISTANCE_FRIENDLY[8] = {
           gS(0,0), gS(3,36), gS(-8,27), gS(-6,9),
           gS(-3,0), gS(-1,0), gS(15,-1), gS(13,-1),
};

const int KING_PASSER_DISTANCE_ENEMY[8] = {
           gS(0,0), gS(-44,-1), gS(10,-18), gS(0,0),
           gS(3,11), gS(-2,21), gS(0,23), gS(-9,21),
};

const int KNIGHT_PASSER_DISTANCE_ENEMY[4] = {
           gS(-6,-8), gS(1,2), gS(7,8), gS(13,11),
};
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-65,-39), gS(-50,-44), gS(-53,-67), gS(-49,-25),
};
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(60,29), gS(38,14), gS(42,24),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-4,2), gS(4,10), gS(4,9), gS(0,14),
           gS(-7,5), gS(-18,-5), gS(-6,9), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(10,0), gS(12,24), gS(19,6), gS(23,17),
           gS(10,0), gS(-13,-3), gS(-2,7), gS(10,0),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-10,-68), gS(0,-27), gS(6,-14), gS(12,-3), gS(15,6), gS(17,10), gS(17,14),
           gS(18,13), gS(19,15), gS(21,13), gS(23,11), gS(37,2), gS(36,16), gS(63,-8),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-4,-90), gS(8,-34), gS(15,-8), gS(20,2), gS(25,10),
           gS(29,16), gS(33,14), gS(37,8), gS(41,0),
};

const int KING_MOBILITY[9] = {
           gS(19,-16), gS(10,-3), gS(4,3), gS(0,8), gS(-4,6),
           gS(-11,5), gS(-5,4), gS(-10,0), gS(0,-17),
};

const int ROOK_MOBILITY[15] = {
           gS(-26,-87), gS(-13,-50), gS(-6,-31), gS(1,-18), gS(3,-5), gS(1,7), gS(6,8),
           gS(9,9), gS(12,14), gS(15,18), gS(18,22), gS(21,24), gS(26,22), gS(32,22),
           gS(55,13),
};

const int QUEEN_MOBILITY[28] = {
           gS(-15,-114), gS(-10,-167), gS(-9,-111), gS(-8,-68), gS(-7,-46), gS(-6,-30), gS(-4,-15),
           gS(-2,-2), gS(-1,9), gS(0,20), gS(1,26), gS(2,32), gS(4,35), gS(5,38),
           gS(5,41), gS(6,44), gS(6,46), gS(9,42), gS(10,41), gS(12,39), gS(14,33),
...
const int KING_PSQT_BLACK[64] = {
           gS(-3,-96), gS(0,-38), gS(0,-21), gS(0,-7), gS(0,-22), gS(0,-21), gS(0,-14), gS(-2,-94),
           gS(-4,-22), gS(0,32), gS(5,31), gS(1,29), gS(1,14), gS(0,32), gS(0,31), gS(-4,-21),
           gS(0,-2), gS(27,24), gS(24,35), gS(5,38), gS(8,39), gS(29,34), gS(17,28), gS(0,-3),
           gS(-4,-13), gS(12,13), gS(9,24), gS(-5,35), gS(-4,32), gS(13,23), gS(15,13), gS(-38,-14),
           gS(-18,-24), gS(7,0), gS(-3,16), gS(-24,27), gS(-18,24), gS(-21,18), gS(0,2), gS(-51,-16),
           gS(-28,-22), gS(8,-4), gS(-17,10), gS(-39,22), gS(-35,21), gS(-28,12), gS(-5,-2), gS(-20,-21),
           gS(0,-26), gS(-3,-4), gS(0,1), gS(-22,12), gS(-23,12), gS(-2,2), gS(-7,-3), gS(-1,-28),
           gS(-19,-53), gS(3,-36), gS(-16,-16), gS(-31,-16), gS(14,-46), gS(-11,-25), gS(2,-34), gS(-2,-66),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,80), gS(42,68), gS(65,58), gS(65,62), gS(56,64), gS(-2,87), gS(0,76),
           gS(1,34), gS(10,35), gS(24,22), gS(47,9), gS(48,10), gS(72,15), gS(32,29), gS(26,20),
           gS(-8,14), gS(0,15), gS(11,4), gS(19,7), gS(26,6), gS(25,2), gS(23,5), gS(0,7),
           gS(-20,0), gS(-17,7), gS(-6,0), gS(12,1), gS(12,0), gS(12,-2), gS(0,-1), gS(-14,-6),
           gS(-22,-5), gS(-19,-1), gS(-4,-4), gS(-4,3), gS(2,2), gS(2,-1), gS(0,-9), gS(-17,-11),
           gS(-26,4), gS(-13,4), gS(-12,9), gS(0,10), gS(-1,13), gS(6,6), gS(1,0), gS(-16,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-1,6), gS(-2,6), gS(-3,4), gS(0,0), gS(0,1), gS(-2,1), gS(-1,10), gS(-1,7),
           gS(-3,-2), gS(-3,0), gS(-5,-6), gS(0,-17), gS(-1,-12), gS(-4,-5), gS(-8,0), gS(-2,0),
           gS(-1,-8), gS(-3,-6), gS(0,-11), gS(0,-22), gS(-1,-17), gS(-1,-6), gS(-4,0), gS(-1,0),
           gS(0,-18), gS(-4,-4), gS(-4,-8), gS(-4,0), gS(-5,-4), gS(-5,1), gS(0,-5), gS(0,-17),
           gS(0,-26), gS(-2,-14), gS(-4,-2), gS(-6,0), gS(-5,4), gS(0,0), gS(1,-3), gS(0,-33),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-1,5), gS(-3,5), gS(-3,4), gS(0,0), gS(0,0), gS(-2,0), gS(0,8), gS(-2,4),
           gS(0,-3), gS(-1,0), gS(-2,-4), gS(0,-17), gS(0,-13), gS(-1,-7), gS(-8,-4), gS(-2,0),
           gS(0,2), gS(0,-2), gS(2,-7), gS(0,-13), gS(0,-11), gS(0,-8), gS(-1,-1), gS(-1,-4),
           gS(2,-2), gS(0,3), gS(0,0), gS(-3,2), gS(-2,3), gS(-2,5), gS(2,-4), gS(4,-3),
           gS(3,11), gS(0,6), gS(0,16), gS(-2,11), gS(-3,13), gS(3,17), gS(4,10), gS(6,2),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(0,13), gS(0,13), gS(16,9), gS(21,2), gS(21,1), gS(21,0), gS(8,3), gS(0,4),
           gS(-14,8), gS(-11,13), gS(-2,9), gS(-1,6), gS(0,4), gS(-1,1), gS(-4,6), gS(-19,4),
           ...
           gS(-5,-10), gS(0,-13), gS(2,-9), gS(10,-20), gS(14,-23), gS(13,-21), gS(-8,-11), gS(-3,-25),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-33,0), gS(-43,-1), gS(-73,16), gS(-81,18), gS(-60,18), gS(-91,13), gS(-20,-6), gS(-27,-11),
           ...
           gS(7,-6), gS(-1,3), gS(11,2), gS(19,6), gS(23,3), gS(5,4), gS(10,0), gS(9,-17),
           gS(3,-15), gS(22,-7), gS(11,-5), gS(12,5), gS(6,10), gS(21,-8), gS(18,-10), gS(10,-11),
           gS(19,-22), gS(12,-25), gS(17,-11), gS(6,0), gS(15,-1), gS(14,-6), gS(21,-23), gS(8,-32),
           gS(-1,-34), gS(10,-10), gS(0,-2), gS(3,-1), gS(8,-4), gS(-11,4), gS(0,-9), gS(0,-26),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-150,-62), gS(-31,-9), gS(-75,8), gS(-13,-2), gS(0,0), gS(-69,2), gS(-29,-4), gS(-89,-63),
           gS(-26,-9), gS(-11,2), gS(4,0), gS(29,8), gS(16,6), gS(34,-9), gS(-10,0), gS(-9,-16),
           gS(-10,-1), gS(15,1), gS(18,21), gS(30,11), gS(52,2), gS(38,6), gS(14,-2), gS(12,-13),
           gS(8,-2), gS(7,1), gS(16,15), gS(32,18), gS(23,15), gS(36,10), gS(13,-6), gS(24,-10),
           gS(0,1), gS(13,4), gS(16,21), gS(24,18), gS(25,23), gS(29,14), gS(26,1), gS(11,0),
           gS(-9,-18), gS(9,-5), gS(9,6), gS(21,19), gS(24,16), gS(20,3), gS(25,-6), gS(1,-8),
           gS(-7,-24), gS(-10,4), gS(1,-5), gS(6,8), gS(11,7), gS(9,-3), gS(0,2), gS(0,-14),
           gS(-40,-36), gS(-15,-16), gS(-2,-7), gS(0,0), gS(7,2), gS(-6,-5), gS(-9,-7), gS(-23,-33),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,12), gS(-2,20), gS(-3,30), gS(-6,36), gS(7,21), gS(-7,26), gS(-9,19),
           gS(-13,0), gS(-28,25), gS(-10,25), gS(-28,56), gS(-42,78), gS(-19,44), gS(-15,50), gS(3,20),
           gS(-9,-16), gS(0,-1), gS(-3,22), gS(3,40), gS(0,51), gS(3,49), gS(9,22), gS(-4,26),
           gS(-3,-20), gS(-8,5), gS(-3,15), gS(-2,41), gS(-7,57), gS(-4,47), gS(-4,35), gS(5,1),
           gS(0,-30), gS(-5,0), gS(-2,6), gS(-4,37), gS(2,31), gS(-6,14), gS(8,4), gS(-5,0),
           gS(-2,-40), gS(9,-28), gS(4,-8), gS(3,-3), gS(2,-2), gS(7,-8), gS(12,-12), gS(4,-29),
           gS(3,-58), gS(8,-57), gS(18,-63), gS(11,-38), gS(13,-35), gS(19,-68), gS(22,-81), gS(0,-49),
           gS(1,-63), gS(5,-73), gS(4,-76), gS(3,-62), gS(5,-65), gS(-6,-78), gS(0,-74), gS(8,-70),
};
...
const int MATERIAL_VALUES[5] = {
           gS(82,112), gS(491,687), gS(348,382), gS(370,404), gS(991,1287),
};
