...
const int ROOK_RESTRICT_KING = gS(7,11);
...
const int KING_PASSER_DISTANCE_FRIENDLY[8] = {
           gS(0,0), gS(3,34), gS(-9,27), gS(-6,10),
           gS(-3,1), gS(0,0), gS(14,0), gS(12,-1),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-93), gS(0,-27), gS(0,-10), gS(0,-6), gS(0,-17), gS(0,-22), gS(0,-13), gS(0,-94),
           gS(0,-16), gS(0,34), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-22),
           gS(0,-2), gS(27,24), gS(13,36), gS(0,39), gS(0,40), gS(18,36), gS(11,28), gS(0,-3),
           gS(-1,-14), gS(11,13), gS(-1,25), gS(-7,34), gS(-8,32), gS(1,24), gS(7,14), gS(-35,-16),
           gS(-13,-25), gS(0,1), gS(-4,15), gS(-15,23), gS(-14,22), gS(-21,17), gS(-1,0), gS(-41,-20),
           gS(-11,-30), gS(12,-6), gS(-12,6), gS(-30,17), gS(-25,16), gS(-22,8), gS(0,-6), gS(-6,-28),
           gS(4,-29), gS(0,-7), gS(-2,0), gS(-21,9), gS(-23,10), gS(-2,1), gS(-3,-6), gS(4,-32),
           gS(-13,-56), gS(7,-38), gS(-12,-17), gS(-34,-14), gS(10,-43), gS(-13,-24), gS(6,-35), gS(0,-66),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(51,69), gS(40,76), gS(36,66), gS(65,51), gS(60,58), gS(44,61), gS(0,82), gS(0,69),
           gS(0,32), gS(8,28), gS(25,11), gS(40,-1), gS(40,0), gS(69,3), gS(24,22), gS(25,13),
           gS(-14,17), gS(1,11), gS(4,1), gS(13,-1), gS(18,-1), gS(16,0), gS(22,1), gS(-5,5),
           gS(-25,5), gS(-21,12), gS(-9,0), gS(8,-2), gS(8,-4), gS(7,-3), gS(-5,1), gS(-19,-4),
           gS(-26,-1), gS(-19,0), gS(-7,-4), gS(-4,0), gS(0,0), gS(0,-2), gS(-4,-6), gS(-21,-10),
           gS(-36,6), gS(-17,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,4), gS(-4,0), gS(-27,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(3,3), gS(-1,6), gS(-1,4), gS(-4,4), gS(-2,5), gS(-2,10), gS(4,-3), gS(7,2),
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(5,14), gS(0,14), gS(16,10), gS(35,2), gS(27,4), gS(25,3), gS(-8,14), gS(7,10),
           ...
           gS(-13,7), gS(-11,12), gS(0,8), gS(-1,6), gS(1,3), gS(-2,1), gS(-5,5), gS(-19,4),
...
const int MATERIAL_VALUES[5] = {
           gS(89,111), gS(513,681), gS(356,375), gS(379,395), gS(1001,1259),
};
