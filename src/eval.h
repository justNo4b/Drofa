...
const int KING_MED_DANGER = gS(-23,-41);

const int KING_LOW_DANGER = gS(75,-77);

const int BISHOP_PAIR_BONUS = gS(31,52);

const int DOUBLED_PAWN_PENALTY = gS(-10,-23);
...
const int MINOR_BEHIND_PAWN = gS(3,8);
...
const int KING_OPEN_FILE = gS(-54,7);

const int KING_OWN_SEMI_FILE = gS(-23,15);
...
const int PASSED_PAWN_RANKS[7] = {
           ...
           gS(15,53), gS(27,78), gS(52,87),
};

const int PASSED_PAWN_FILES[4] = {
           gS(0,19), gS(-3,13), gS(0,5), gS(0,-4),
};
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(16,34), gS(15,35), gS(16,31),
};

const int ROOK_ATTACKED_BY[4] = {
           gS(0,0), gS(-3,19), gS(65,21), gS(43,42),
};

const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(62,35), gS(39,19), gS(42,39),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(7,0), gS(14,23), gS(14,1), gS(25,6),
...
const int BISHOP_MOBILITY[14] = {
           gS(-6,-62), gS(2,-23), gS(10,-11), gS(15,-1), gS(17,7), gS(18,9), gS(17,12),
           gS(16,11), gS(15,12), gS(15,10), gS(16,8), gS(28,0), gS(30,10), gS(53,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-33), gS(17,-6), gS(22,3), gS(26,9),
           gS(29,13), gS(33,10), gS(36,3), gS(39,-5),
};

const int KING_MOBILITY[9] = {
           gS(14,-30), gS(5,-6), gS(0,4), gS(-2,10), gS(-5,8),
           gS(-9,6), gS(0,5), gS(0,0), gS(15,-18),
};

const int ROOK_MOBILITY[15] = {
           gS(-25,-83), gS(-12,-45), gS(-6,-27), gS(1,-16), gS(3,-6), gS(0,5), gS(4,6),
           gS(6,5), gS(9,10), gS(12,13), gS(14,17), gS(17,20), gS(22,18), gS(27,17),
           gS(49,8),
};

const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-157), gS(-6,-111), gS(-5,-72), gS(-4,-51), gS(-3,-33), gS(-2,-16),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-13,-24), gS(2,0), gS(-3,16), gS(-14,25), gS(-14,23), gS(-21,17), gS(-1,1), gS(-43,-19),
           gS(-15,-28), gS(11,-6), gS(-12,7), gS(-30,19), gS(-25,18), gS(-22,9), gS(0,-5), gS(-7,-26),
           gS(2,-29), gS(-3,-7), gS(-3,0), gS(-22,10), gS(-24,10), gS(-3,1), gS(-6,-6), gS(1,-31),
           gS(-16,-55), gS(5,-39), gS(-15,-18), gS(-33,-15), gS(12,-45), gS(-11,-26), gS(3,-37), gS(-1,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(52,69), gS(40,78), gS(37,66), gS(64,53), gS(62,58), gS(47,62), gS(0,84), gS(0,71),
           gS(1,31), gS(8,29), gS(25,12), gS(41,0), gS(42,0), gS(69,4), gS(25,23), gS(26,13),
           gS(-10,16), gS(2,12), gS(6,1), gS(14,0), gS(20,-1), gS(19,-1), gS(24,1), gS(-2,5),
           gS(-22,4), gS(-20,12), gS(-7,0), gS(10,-2), gS(9,-4), gS(9,-3), gS(-4,2), gS(-16,-5),
           gS(-24,-1), gS(-18,0), gS(-6,-4), gS(-4,0), gS(0,-1), gS(0,-3), gS(-1,-7), gS(-18,-10),
           gS(-35,6), gS(-16,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,5), gS(-3,0), gS(-26,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-7,17), gS(-9,7), gS(-2,0), gS(-2,2), gS(-7,4), gS(-4,20), gS(-4,13),
           gS(-2,-5), gS(-4,-1), gS(-11,-8), gS(0,-19), gS(-2,-14), gS(-6,-4), gS(-7,0), gS(-3,0),
           gS(0,-17), gS(-3,-9), gS(0,-13), gS(0,-25), gS(0,-23), gS(0,-7), gS(-6,-1), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-7,-9), gS(-5,0), gS(-6,-8), gS(-7,0), gS(2,-6), gS(0,-27),
           gS(0,-42), gS(-1,-20), gS(-5,-7), gS(-12,0), gS(-7,0), gS(1,-2), gS(1,-9), gS(0,-48),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,9), gS(-8,11), gS(-9,11), gS(-2,0), gS(-2,1), gS(-7,1), gS(-2,19), gS(-4,7),
           gS(0,-3), gS(0,0), gS(-2,0), gS(0,-17), gS(0,-14), gS(-2,-8), gS(-10,-3), gS(0,0),
           gS(0,11), gS(0,1), gS(1,-5), gS(0,-9), gS(0,-7), gS(0,-8), gS(0,0), gS(0,-1),
           gS(4,1), gS(0,5), gS(-1,3), gS(-4,3), gS(-2,5), gS(-2,9), gS(4,-4), gS(8,0),
           gS(5,27), gS(0,15), gS(-1,23), gS(-1,18), gS(-4,16), gS(4,19), gS(6,14), gS(10,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(27,11), gS(15,20), gS(0,27), gS(0,20), gS(4,20), gS(11,20), gS(26,16), gS(37,13),
           gS(7,15), gS(0,16), gS(17,12), gS(34,3), gS(26,5), gS(27,3), gS(-5,15), gS(9,10),
           ...
           gS(-13,9), gS(-11,13), gS(0,8), gS(-1,5), gS(1,3), gS(-2,1), gS(-5,5), gS(-19,4),
           gS(-16,0), gS(-9,0), gS(-4,0), gS(-4,-3), gS(-3,-2), gS(0,-10), gS(1,-9), gS(-13,-10),
           gS(-21,-8), gS(-5,-10), gS(0,-7), gS(0,-10), gS(11,-16), gS(7,-22), gS(4,-23), gS(-39,-11),
           gS(-5,-10), gS(2,-12), gS(3,-8), gS(11,-19), gS(14,-22), gS(13,-21), gS(-8,-10), gS(-3,-24),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-33,-1), gS(-43,-2), gS(-74,16), gS(-81,16), gS(-56,16), gS(-91,13), gS(-25,-7), gS(-28,-15),
           gS(-37,-1), gS(-17,0), gS(-11,0), gS(-12,9), gS(-11,6), gS(-13,3), gS(-25,-4), gS(-23,-7),
           gS(-3,0), gS(0,1), gS(0,3), gS(24,-3), gS(16,0), gS(21,0), gS(7,0), gS(8,-5),
           gS(-7,-2), gS(9,5), gS(3,2), gS(21,9), gS(15,9), gS(12,4), gS(7,0), gS(-1,-10),
           gS(5,-6), gS(-2,3), gS(8,4), gS(19,7), gS(22,5), gS(6,3), gS(8,0), gS(6,-17),
           ...
           gS(-2,-32), gS(8,-6), gS(0,-1), gS(2,0), gS(7,-4), gS(-11,5), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-159,-58), gS(-31,-4), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-80,2), gS(-29,-5), gS(-89,-64),
           gS(-32,-9), gS(-17,0), gS(-2,0), gS(21,5), gS(9,3), gS(28,-12), gS(-11,-1), gS(-16,-16),
           gS(-10,-1), gS(9,2), gS(13,19), gS(30,5), gS(44,0), gS(47,5), gS(14,-1), gS(13,-13),
           ...
           gS(-7,-20), gS(10,-5), gS(10,6), gS(20,16), gS(23,14), gS(21,3), gS(25,-8), gS(3,-10),
           gS(-6,-26), gS(-10,3), gS(4,-3), gS(7,9), gS(13,7), gS(13,-2), gS(1,1), gS(3,-15),
           gS(-40,-30), gS(-13,-14), gS(0,-4), gS(2,3), gS(9,4), gS(-1,-2), gS(-7,-4), gS(-19,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,11), gS(-4,20), gS(-9,25), gS(0,10), gS(-9,17), gS(-11,15),
           gS(-13,1), gS(-27,25), gS(-13,25), gS(-29,48), gS(-46,67), gS(-24,33), gS(-16,37), gS(1,12),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,45), gS(0,36), gS(6,14), gS(-9,14),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,53), gS(-6,36), gS(-4,26), gS(3,-3),
           gS(1,-26), gS(-5,0), gS(-1,11), gS(-2,38), gS(3,34), gS(-4,10), gS(8,4), gS(-5,-2),
           gS(-2,-32), gS(10,-24), gS(6,-6), gS(4,0), gS(3,0), gS(8,-6), gS(14,-11), gS(5,-27),
           gS(5,-52), gS(12,-57), gS(20,-58), gS(12,-33), gS(15,-30), gS(21,-64), gS(26,-80), gS(1,-44),
           gS(6,-62), gS(8,-68), gS(7,-75), gS(6,-56), gS(9,-63), gS(-3,-75), gS(0,-65), gS(12,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(89,112), gS(504,679), gS(354,376), gS(378,397), gS(1003,1264),
};
