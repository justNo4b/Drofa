...
const int KNIGHT_CENTER_CONTROL = gS(3,1);
...
const int BISHOP_MOBILITY[14] = {
           gS(-6,-63), gS(3,-25), gS(10,-12), gS(15,-2), gS(17,6), gS(18,10), gS(16,12),
           gS(15,12), gS(14,13), gS(14,12), gS(16,9), gS(28,0), gS(30,10), gS(53,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(0,-93), gS(11,-34), gS(18,-7), gS(23,2), gS(26,10),
           gS(28,14), gS(31,11), gS(34,4), gS(37,-5),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-27,-86), gS(-13,-49), gS(-6,-31), gS(1,-19), gS(4,-7), gS(1,5), gS(6,7),
           gS(8,7), gS(11,12), gS(14,15), gS(15,20), gS(17,23), gS(22,21), gS(28,20),
           gS(50,10),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-1,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(4,24), gS(9,13), gS(-35,-15),
           ...
           gS(-15,-55), gS(4,-38), gS(-14,-17), gS(-34,-15), gS(10,-44), gS(-13,-25), gS(4,-35), gS(0,-67),
};
...
const int PAWN_PSQT_BLACK[64] = {
           ...
           gS(-23,4), gS(-20,12), gS(-8,0), gS(11,-2), gS(9,-4), gS(9,-3), gS(-4,2), gS(-17,-5),
           gS(-24,-1), gS(-17,0), gS(-7,-4), gS(-4,0), gS(0,0), gS(0,-2), gS(-1,-7), gS(-18,-10),
           gS(-34,6), gS(-16,6), gS(-13,7), gS(0,7), gS(0,9), gS(1,5), gS(-3,0), gS(-26,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-2,-4), gS(-3,-1), gS(-10,-8), gS(0,-19), gS(0,-14), gS(-5,-4), gS(-7,0), gS(-3,0),
           gS(0,-16), gS(-3,-8), gS(1,-13), gS(0,-25), gS(0,-22), gS(0,-6), gS(-6,0), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-7,-8), gS(-5,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-27),
           gS(0,-42), gS(-1,-21), gS(-5,-8), gS(-12,0), gS(-7,0), gS(1,-2), gS(1,-10), gS(0,-48),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,11), gS(0,1), gS(2,-5), gS(0,-9), gS(0,-7), gS(0,-7), gS(0,0), gS(0,0),
           gS(3,1), gS(0,5), gS(-1,3), gS(-4,3), gS(-2,6), gS(-2,9), gS(4,-4), gS(7,0),
           gS(5,27), gS(0,15), gS(-1,22), gS(-2,19), gS(-4,15), gS(3,19), gS(6,13), gS(9,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,12), gS(15,21), gS(0,27), gS(0,21), gS(5,20), gS(12,20), gS(27,16), gS(37,14),
           gS(7,15), gS(0,16), gS(17,12), gS(35,4), gS(26,6), gS(28,4), gS(-5,15), gS(10,11),
           gS(3,17), gS(20,9), gS(19,10), gS(27,1), gS(43,-3), gS(37,-1), gS(29,0), gS(-3,12),
           ...
           gS(-5,-12), gS(1,-13), gS(2,-9), gS(10,-19), gS(13,-22), gS(13,-21), gS(-8,-10), gS(-3,-25),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(5,-6), gS(-2,4), gS(7,5), gS(20,7), gS(23,5), gS(6,4), gS(8,0), gS(5,-16),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-32,-9), gS(-17,0), gS(-2,0), gS(20,5), gS(9,3), gS(28,-12), gS(-11,-1), gS(-17,-16),
           gS(-10,-1), gS(8,2), gS(12,19), gS(30,6), gS(44,0), gS(47,5), gS(14,-1), gS(13,-13),
           gS(5,-1), gS(7,0), gS(15,14), gS(33,17), gS(21,19), gS(35,12), gS(9,0), gS(22,-10),
           gS(1,0), gS(13,4), gS(17,20), gS(24,17), gS(25,21), gS(29,12), gS(24,0), gS(11,0),
           gS(-6,-20), gS(10,-6), gS(8,5), gS(20,16), gS(23,13), gS(20,1), gS(25,-9), gS(4,-10),
           gS(-5,-26), gS(-10,3), gS(4,-4), gS(6,8), gS(12,5), gS(13,-3), gS(1,1), gS(3,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(1,-26), gS(-6,0), gS(-1,11), gS(-2,38), gS(4,34), gS(-5,10), gS(8,4), gS(-5,-2),
           ...
           gS(6,-62), gS(8,-68), gS(7,-75), gS(5,-56), gS(8,-63), gS(-3,-75), gS(0,-65), gS(12,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(87,112), gS(512,681), gS(354,376), gS(379,397), gS(1002,1262),
};
