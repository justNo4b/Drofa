...
const int KING_HIGH_DANGER = gS(-46,-63);

const int KING_MED_DANGER = gS(-24,-39);

const int KING_LOW_DANGER = gS(74,-79);

const int BISHOP_PAIR_BONUS = gS(30,51);
...
const int BISHOP_ATT_OUTPOSTED_KNIGHT = gS(13,9);

const int BISHOP_ATT_OUTPOSTED_BISHOP = gS(10,8);

const int KNIGHT_POS_PROUTPOST_JUMP = gS(8,7);

const int KNIGHT_POS_GENOUTPOST_JUMP = gS(6,8);

const int KNIGHT_ATT_OUTPOSTED_KNIGHT = gS(21,6);

const int KNIGHT_ATT_OUTPOSTED_BISHOP = gS(23,17);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-17,1), gS(-9,6), gS(0,12),
           gS(5,30), gS(9,50), gS(0,0),
};
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,33), gS(18,36), gS(16,32),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,21), gS(14,0), gS(23,1),
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-65), gS(3,-26), gS(10,-13), gS(15,-3), gS(17,6), gS(18,9), gS(17,12),
           gS(16,12), gS(15,13), gS(14,12), gS(16,9), gS(28,0), gS(30,10), gS(49,-10),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-3,-94), gS(9,-35), gS(16,-8), gS(21,1), gS(25,9),
           gS(28,13), gS(32,10), gS(36,4), gS(39,-3),
};

const int KING_MOBILITY[9] = {
           gS(14,-30), gS(5,-4), gS(0,5), gS(-2,9), gS(-5,7),
           gS(-8,5), gS(0,3), gS(0,0), gS(14,-14),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,0), gS(27,25), gS(12,37), gS(0,39), gS(0,40), gS(18,36), gS(11,28), gS(0,-1),
           gS(0,-12), gS(11,14), gS(-1,26), gS(-7,35), gS(-8,32), gS(0,25), gS(8,14), gS(-31,-15),
           gS(-11,-24), gS(0,2), gS(-4,15), gS(-15,23), gS(-14,22), gS(-21,16), gS(-1,1), gS(-39,-20),
           gS(-10,-29), gS(12,-6), gS(-11,6), gS(-30,17), gS(-25,15), gS(-22,8), gS(0,-6), gS(-6,-27),
           gS(5,-29), gS(-1,-8), gS(-2,0), gS(-21,8), gS(-23,8), gS(-1,0), gS(-2,-7), gS(5,-32),
           gS(-13,-56), gS(7,-39), gS(-12,-18), gS(-34,-16), gS(11,-45), gS(-12,-26), gS(6,-36), gS(0,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(50,69), gS(40,75), gS(35,65), gS(65,50), gS(59,56), gS(43,60), gS(0,81), gS(0,69),
           gS(0,32), gS(8,28), gS(25,10), gS(41,-1), gS(40,0), gS(68,3), gS(24,22), gS(25,13),
           gS(-15,15), gS(0,9), gS(2,0), gS(10,-2), gS(16,-3), gS(14,-2), gS(20,-1), gS(-6,3),
           gS(-26,4), gS(-21,11), gS(-9,0), gS(8,-3), gS(8,-4), gS(7,-3), gS(-5,1), gS(-19,-5),
           gS(-27,-1), gS(-20,0), gS(-7,-4), gS(-5,0), gS(0,0), gS(0,-2), gS(-3,-6), gS(-21,-10),
           gS(-36,6), gS(-18,6), gS(-14,7), gS(0,6), gS(0,9), gS(1,5), gS(-5,0), gS(-27,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-5,12), gS(-7,18), gS(-9,8), gS(-1,0), gS(-1,2), gS(-6,5), gS(-4,21), gS(-4,14),
           gS(-3,-4), gS(-3,-3), gS(-10,-8), gS(0,-19), gS(0,-14), gS(-6,-4), gS(-6,0), gS(-4,0),
           gS(0,-18), gS(-3,-10), gS(2,-14), gS(0,-26), gS(0,-25), gS(0,-6), gS(-5,-2), gS(0,0),
           gS(0,-27), gS(-3,-4), gS(-7,-7), gS(-4,0), gS(-6,-9), gS(-7,0), gS(2,-6), gS(0,-27),
           gS(0,-44), gS(-1,-21), gS(-5,-7), gS(-13,0), gS(-8,0), gS(1,-2), gS(0,-9), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,11), gS(-8,12), gS(-8,12), gS(-2,0), gS(0,1), gS(-6,2), gS(-1,21), gS(-4,8),
           gS(0,-1), gS(0,0), gS(-1,0), gS(1,-16), gS(0,-14), gS(0,-8), gS(-9,-3), gS(0,1),
           gS(0,14), gS(0,0), gS(1,-5), gS(0,-8), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(3,2), gS(-1,6), gS(-1,3), gS(-5,4), gS(-2,6), gS(-2,10), gS(3,-3), gS(7,2),
           gS(4,30), gS(0,16), gS(-2,24), gS(-1,19), gS(-4,16), gS(3,20), gS(6,14), gS(9,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,20), gS(0,27), gS(0,20), gS(5,20), gS(12,20), gS(24,17), gS(37,14),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,0), gS(0,3), gS(22,-2), gS(14,1), gS(20,-1), gS(5,0), gS(6,-3),
           gS(-8,-1), gS(9,5), gS(3,2), gS(20,10), gS(15,10), gS(11,4), gS(6,2), gS(-3,-7),
           gS(5,-5), gS(-3,4), gS(7,6), gS(19,7), gS(22,5), gS(6,4), gS(7,0), gS(5,-15),
           gS(3,-15), gS(20,-4), gS(10,-3), gS(11,6), gS(7,10), gS(21,-8), gS(18,-10), gS(9,-12),
           gS(16,-19), gS(12,-25), gS(16,-10), gS(5,0), gS(14,0), gS(16,-6), gS(21,-22), gS(8,-29),
           gS(-2,-32), gS(8,-6), gS(-1,-3), gS(2,0), gS(7,-4), gS(-11,4), gS(0,-8), gS(-1,-24),
};
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-10,-1), gS(5,3), gS(11,20), gS(29,6), gS(42,1), gS(47,5), gS(11,0), gS(13,-13),
           gS(4,-1), gS(7,0), gS(15,14), gS(32,17), gS(20,19), gS(35,12), gS(10,1), gS(21,-10),
           gS(1,0), gS(13,5), gS(18,19), gS(23,16), gS(24,21), gS(29,13), gS(24,1), gS(11,0),
           gS(-6,-21), gS(10,-7), gS(10,4), gS(20,16), gS(23,13), gS(22,1), gS(25,-9), gS(4,-11),
...
const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,9), gS(0,18), gS(-8,25), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-13,2), gS(-27,24), gS(-13,25), gS(-27,46), gS(-43,66), gS(-21,32), gS(-14,32), gS(1,11),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,35), gS(0,44), gS(3,33), gS(8,13), gS(-5,11),
           ...
           gS(-3,-32), gS(9,-24), gS(5,-5), gS(3,0), gS(3,0), gS(7,-4), gS(13,-11), gS(4,-27),
...
const int MATERIAL_VALUES[5] = {
           gS(89,113), gS(514,682), gS(356,376), gS(380,396), gS(1002,1258),
};
