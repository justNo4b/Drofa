...
const int BISHOP_MOBILITY[14] = {
           gS(-23,-103), gS(-11,-44), gS(-5,-17), gS(-2,-2), gS(1,11), gS(2,22), gS(2,29),
           gS(1,31), gS(2,34), gS(5,32), gS(11,29), gS(27,19), gS(45,28), gS(75,-4),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-7,-72), gS(2,-25), gS(5,0), gS(8,14), gS(11,22),
           gS(13,28), gS(18,27), gS(24,19), gS(34,4),
};

const int KING_MOBILITY[9] = {
           gS(10,-2), gS(14,-6), gS(9,2), gS(6,6), gS(0,6),
           gS(-7,3), gS(-4,2), gS(-18,1), gS(-15,-10),
};

const int ROOK_MOBILITY[15] = {
           gS(-23,-103), gS(-15,-66), gS(-10,-33), gS(-8,-11), gS(-9,7), gS(-10,20), gS(-5,24),
           gS(0,27), gS(4,31), gS(8,37), gS(11,41), gS(16,42), gS(21,42), gS(36,29),
           gS(89,0),
};

const int QUEEN_MOBILITY[28] = {
           gS(-42,-107), gS(-20,-173), gS(-8,-132), gS(-5,-76), gS(-3,-43), gS(-1,-21), gS(0,-3),
           gS(2,8), gS(5,17), gS(7,23), gS(8,30), gS(9,34), gS(10,38), gS(9,43),
           gS(8,49), gS(6,53), gS(5,56), gS(4,57), gS(4,57), gS(9,53), gS(13,48),
...
const int PAWN_SUPPORTED = gS(12,4);

const int DOUBLED_PAWN_PENALTY = gS(-4,-25);
...
const int PAWN_CONNECTED = gS(3,2);
...
const int KING_PASSER_DISTANCE_FRIENDLY[9] = {
           gS(0,0), gS(3,35), gS(-2,26), gS(-6,11),
           gS(-4,0), gS(-3,-3), gS(10,-9), gS(0,-18),
           gS(0,-10),
};

const int KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(44,43), gS(-15,17), gS(-4,-1),
           gS(-4,-13), gS(-2,-24), gS(5,-35), gS(14,-42),
           gS(0,-10),
};
 ...
 */
const int ROOK_OPEN_FILE_BONUS [2] = {  gS(22,10), gS(21,11), };

/**
 * @brief Bonuses given to a player for each rook on an open file (opening/endgame)
 */
const int ROOK_SEMI_FILE_BONUS [2] = {  gS(6,3), gS(12,9), };
...
const int HANGING_PIECE[5] = {
           gS(-3,11), gS(-26,-15), gS(-27,-49), gS(-31,-77), gS(-18,-12),
};
/**
 * @brief Bonuses given to a player for having a passed pawn (opening/endgame)
 */
const int PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-11,-29), gS(-15,-17), gS(-8,21),
           gS(18,59), gS(26,119), gS(73,132), gS(0,0),
};

const int PASSED_PAWN_FILES[8] = {
           gS(10,17), gS(6,16), gS(0,4), gS(-1,0),
           gS(-4,-1), gS(-14,1), gS(-8,17), gS(9,13),
};

const int BACKWARD_PAWN_PENALTY[8] = {
           gS(0,0), gS(-2,-9), gS(-6,-6), gS(-1,0),
           gS(12,3), gS(0,0), gS(0,0), gS(0,0),
};


const int KING_PSQT_BLACK[64] = {
           gS(-13,-98), gS(0,-47), gS(0,-33), gS(0,-17), gS(0,-32), gS(0,-27), gS(-1,-25), gS(-12,-90),
           gS(-13,-37), gS(0,30), gS(5,22), gS(0,5), gS(0,2), gS(3,19), gS(0,37), gS(-12,-38),
           gS(-2,-6), gS(27,30), gS(33,29), gS(12,19), gS(12,15), gS(35,27), gS(26,30), gS(-7,-13),
           gS(-9,-10), gS(22,13), gS(30,27), gS(0,32), gS(7,26), gS(32,23), gS(28,11), gS(-39,-14),
           gS(-22,-33), gS(22,0), gS(25,19), gS(-15,36), gS(0,32), gS(8,20), gS(23,2), gS(-53,-24),
           gS(-52,-13), gS(-9,2), gS(-7,14), gS(-28,31), gS(-16,27), gS(-17,19), gS(-9,4), gS(-48,-11),
           gS(2,-9), gS(-1,6), gS(-23,17), gS(-61,26), gS(-44,21), gS(-43,23), gS(0,4), gS(-1,-18),
           gS(-26,-53), gS(0,-24), gS(-29,-3), gS(-32,-23), gS(-21,-36), gS(-54,-3), gS(-5,-24), gS(-15,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(61,72), gS(46,94), gS(65,90), gS(72,76), gS(80,76), gS(84,81), gS(-7,99), gS(-20,85),
           gS(-2,47), gS(22,49), gS(37,40), gS(41,20), gS(52,20), gS(89,29), gS(54,36), gS(10,35),
           gS(-5,16), gS(2,17), gS(3,15), gS(18,0), gS(27,3), gS(27,8), gS(7,14), gS(-3,6),
           gS(-12,4), gS(-7,10), gS(-4,2), gS(3,1), gS(8,2), gS(4,4), gS(0,3), gS(-11,-3),
           gS(-18,0), gS(-16,3), gS(-14,6), gS(-11,8), gS(-5,10), gS(-5,10), gS(0,-1), gS(-12,-10),
           gS(-15,2), gS(-12,5), gS(-17,16), gS(-9,16), gS(-14,22), gS(6,18), gS(5,1), gS(-12,-16),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,27), gS(23,33), gS(0,42), gS(8,38), gS(13,38), gS(25,37), gS(42,31), gS(53,27),
           gS(-1,24), gS(-4,27), gS(18,23), gS(29,23), gS(27,24), gS(44,9), gS(10,22), gS(16,18),
           gS(-8,17), gS(31,3), gS(21,13), gS(44,2), gS(54,-3), gS(51,4), gS(70,-10), gS(16,8),
           gS(-9,9), gS(8,7), gS(16,10), gS(37,2), gS(30,2), gS(28,1), gS(28,0), gS(13,2),
           gS(-20,0), gS(-12,11), gS(-14,12), gS(-4,5), gS(-5,5), gS(-7,8), gS(5,5), gS(-10,-3),
           gS(-25,-15), gS(-8,-3), gS(-16,-4), gS(-8,-9), gS(-8,-8), gS(-8,-6), gS(9,-7), gS(-15,-17),
           gS(-55,-8), gS(-18,-15), gS(-11,-10), gS(-5,-15), gS(-4,-15), gS(-2,-19), gS(-2,-20), gS(-53,-9),
           gS(-17,-12), gS(-11,-10), gS(-7,-8), gS(0,-15), gS(-1,-14), gS(-3,-4), gS(-1,-12), gS(-11,-21),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-51,5), gS(-44,8), gS(-80,17), gS(-82,23), gS(-70,19), gS(-93,15), gS(-15,0), gS(-48,0),
           gS(-49,1), gS(-13,4), gS(-8,7), gS(-14,15), gS(-4,13), gS(0,7), gS(-27,5), gS(-26,-3),
           gS(2,1), gS(1,8), gS(21,3), gS(7,8), gS(23,8), gS(8,9), gS(21,2), gS(15,0),
           gS(-11,0), gS(17,6), gS(3,6), gS(23,13), gS(20,13), gS(14,4), gS(19,3), gS(-5,0),
           gS(0,-12), gS(4,0), gS(10,7), gS(17,7), gS(24,7), gS(2,6), gS(12,0), gS(3,-13),
           gS(-1,-16), gS(10,-7), gS(5,-4), gS(12,2), gS(8,4), gS(10,-5), gS(11,-8), gS(14,-11),
           gS(8,-30), gS(7,-32), gS(10,-15), gS(2,-2), gS(6,-4), gS(8,-16), gS(17,-27), gS(5,-42),
           gS(5,-37), gS(2,-15), gS(1,-2), gS(0,-6), gS(0,-2), gS(0,-7), gS(-1,-10), gS(3,-38),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-146,-65), gS(-36,-20), gS(-68,11), gS(-14,0), gS(0,1), gS(-56,13), gS(-29,-12), gS(-91,-70),
           gS(-11,-24), gS(-12,-5), gS(30,-3), gS(50,18), gS(38,17), gS(52,-11), gS(-21,-3), gS(-7,-21),
           gS(-18,-18), gS(11,-2), gS(32,30), gS(35,28), gS(60,19), gS(45,24), gS(26,-9), gS(4,-17),
           gS(1,-11), gS(11,4), gS(29,27), gS(29,39), gS(22,32), gS(43,20), gS(20,4), gS(12,-8),
           gS(-4,-9), gS(10,9), gS(15,30), gS(21,33), gS(25,35), gS(20,32), gS(27,12), gS(7,0),
           gS(-20,-33), gS(0,-5), gS(5,10), gS(13,25), gS(17,23), gS(13,8), gS(7,0), gS(-5,-25),
           gS(-22,-16), gS(-28,0), gS(-7,-10), gS(5,6), gS(0,8), gS(-1,-9), gS(-16,-3), gS(-12,-3),
           gS(-40,-46), gS(-14,-27), gS(-11,-17), gS(-9,4), gS(0,2), gS(-8,-11), gS(-11,-20), gS(-40,-45),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-3,3), gS(0,21), gS(0,35), gS(3,47), gS(9,55), gS(31,48), gS(8,51), gS(15,38),
           gS(-18,-4), gS(-56,36), gS(-17,26), gS(-41,72), gS(-43,107), gS(0,70), gS(-54,72), gS(-19,39),
           gS(-15,-17), gS(-8,-18), gS(-12,15), gS(-11,42), gS(1,60), gS(11,78), gS(30,45), gS(4,61),
           gS(-5,-33), gS(-3,0), gS(-8,1), gS(-15,45), gS(-14,65), gS(-7,71), gS(4,59), gS(9,30),
           gS(-1,-41), gS(2,-14), gS(-3,-9), gS(-10,28), gS(-6,27), gS(-6,24), gS(11,3), gS(3,8),
           gS(-1,-58), gS(9,-42), gS(3,-21), gS(2,-28), gS(2,-27), gS(0,-10), gS(15,-32), gS(5,-47),
           gS(-1,-66), gS(4,-61), gS(13,-76), gS(7,-46), gS(11,-49), gS(15,-88), gS(12,-83), gS(-10,-57),
           gS(0,-67), gS(3,-79), gS(5,-84), gS(8,-65), gS(9,-71), gS(4,-87), gS(8,-84), gS(-2,-75),
};
