...
const int PASSER_BLOCKED = gS(5,0);

const int PAWN_PUSH_THREAT = gS(12,14);
...
const int KING_MOBILITY[9] = {
           gS(13,-30), gS(5,-4), gS(0,4), gS(-2,9), gS(-5,7),
           gS(-8,5), gS(0,2), gS(0,-1), gS(13,-14),
};

const int ROOK_MOBILITY[15] = {
           gS(-28,-89), gS(-15,-52), gS(-8,-32), gS(0,-19), gS(2,-7), gS(0,5), gS(4,7),
           gS(6,7), gS(9,12), gS(12,16), gS(13,21), gS(15,23), gS(19,21), gS(25,21),
           gS(48,10),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-85), gS(0,-22), gS(0,-6), gS(0,-5), gS(0,-17), gS(0,-21), gS(0,-11), gS(0,-94),
           ...
           gS(0,-11), gS(11,15), gS(-1,27), gS(-7,35), gS(-8,32), gS(0,26), gS(8,16), gS(-29,-15),
           gS(-10,-24), gS(0,3), gS(-4,16), gS(-14,23), gS(-14,22), gS(-21,17), gS(-1,1), gS(-38,-20),
           gS(-6,-30), gS(12,-6), gS(-11,6), gS(-30,16), gS(-25,15), gS(-22,8), gS(0,-6), gS(-6,-28),
           gS(5,-30), gS(0,-9), gS(-2,-1), gS(-22,7), gS(-23,7), gS(-2,0), gS(-2,-8), gS(5,-34),
           gS(-13,-56), gS(7,-41), gS(-11,-20), gS(-34,-17), gS(10,-47), gS(-13,-27), gS(6,-38), gS(1,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(48,67), gS(39,73), gS(34,63), gS(64,48), gS(58,55), gS(39,59), gS(0,79), gS(0,66),
           gS(0,31), gS(6,27), gS(25,9), gS(38,-1), gS(37,0), gS(67,3), gS(22,21), gS(24,13),
           gS(-18,14), gS(-2,8), gS(0,0), gS(8,-2), gS(13,-3), gS(11,-2), gS(17,-1), gS(-9,3),
           gS(-28,5), gS(-24,12), gS(-10,0), gS(5,-3), gS(4,-4), gS(5,-3), gS(-8,1), gS(-22,-4),
           gS(-28,-1), gS(-21,0), gS(-8,-3), gS(-5,0), gS(0,0), gS(-1,-2), gS(-4,-6), gS(-23,-10),
           gS(-38,7), gS(-18,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,6), gS(-5,1), gS(-29,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-6,12), gS(-7,18), gS(-11,8), gS(0,0), gS(0,1), gS(-7,5), gS(-4,21), gS(-5,14),
           gS(-3,-4), gS(-3,-3), gS(-11,-8), gS(0,-19), gS(0,-16), gS(-6,-4), gS(-5,0), gS(-5,0),
...
const int ROOK_PSQT_BLACK[64] = {
           gS(29,10), gS(16,19), gS(0,26), gS(0,19), gS(5,19), gS(10,20), gS(23,17), gS(36,14),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(14,-18), gS(11,-24), gS(15,-10), gS(4,0), gS(13,0), gS(15,-6), gS(20,-21), gS(7,-28),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-8,-21), gS(9,-7), gS(9,5), gS(20,15), gS(23,13), gS(21,1), gS(25,-10), gS(2,-11),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-14,2), gS(-28,22), gS(-13,25), gS(-27,44), gS(-40,62), gS(-21,30), gS(-13,28), gS(1,10),
...
const int MATERIAL_VALUES[5] = {
           gS(91,112), gS(515,683), gS(358,378), gS(381,396), gS(1004,1256),
};
