...
const int  BISHOP_MOBILITY[14] = {
           gS(-18,-105), gS(-6,-46), gS(0,-19), gS(2,-2), gS(5,11), gS(6,22), gS(5,29),
           gS(4,31), gS(5,33), gS(8,31), gS(14,27), gS(30,17), gS(45,28), gS(77,-5),
};

const int  KNIGHT_MOBILITY[9] = {
           gS(-7,-75), gS(2,-29), gS(6,-4), gS(8,10), gS(11,19),
           gS(14,26), gS(18,25), gS(25,17), gS(35,1),
};

const int  KING_MOBILITY[9] = {
           gS(10,-1), gS(14,-2), gS(8,4), gS(4,9), gS(-2,8),
           gS(-7,5), gS(-5,3), gS(-15,-2), gS(-9,-15),
};

const int  ROOK_MOBILITY[15] = {
           gS(-18,-102), gS(-11,-66), gS(-7,-33), gS(-5,-13), gS(-7,5), gS(-8,20), gS(-3,23),
           gS(1,26), gS(5,31), gS(10,35), gS(11,40), gS(16,42), gS(19,42), gS(34,28),
           gS(87,0),
};

const int  QUEEN_MOBILITY[28] = {
           gS(-38,-102), gS(-17,-164), gS(-5,-132), gS(-2,-78), gS(0,-45), gS(1,-23), gS(2,-5),
           gS(4,7), gS(6,17), gS(8,23), gS(9,30), gS(10,35), gS(10,40), gS(9,45),
           gS(7,51), gS(5,55), gS(4,57), gS(3,57), gS(3,57), gS(8,53), gS(11,48),
...
const int  PASSER_BLOCKED = gS(3,45);
...
const int  BISHOP_PROTECTOR = gS(3,0);
...
const int  KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(48,74), gS(-16,13), gS(-4,-3),
           gS(-4,-16), gS(-3,-27), gS(4,-38), gS(13,-45),
           gS(0,-10),
};
...
const int  PASSED_PAWN_RANKS[8] = {
           ...
           gS(14,55), gS(25,117), gS(78,128), gS(0,0),
};

const int  PASSED_PAWN_FILES[8] = {
           gS(10,15), gS(6,16), gS(0,4), gS(0,0),
           gS(-3,-1), gS(-16,3), gS(-7,17), gS(11,11),
};
...
const int  KING_PSQT_BLACK[64] = {
           ...
           gS(-3,-3), gS(27,38), gS(33,33), gS(12,20), gS(12,17), gS(35,35), gS(27,42), gS(-7,-8),
           ...
           gS(-52,-15), gS(-9,1), gS(-7,11), gS(-27,26), gS(-15,23), gS(-15,16), gS(-9,2), gS(-53,-12),
           gS(0,-12), gS(-2,4), gS(-24,15), gS(-63,24), gS(-44,19), gS(-46,22), gS(0,2), gS(-3,-21),
           gS(-26,-55), gS(3,-28), gS(-30,-6), gS(-38,-27), gS(-29,-36), gS(-56,-6), gS(-5,-27), gS(-15,-74),
};

const int  PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(62,72), gS(50,97), gS(69,93), gS(75,79), gS(82,77), gS(84,81), gS(-8,101), gS(-22,83),
           gS(-3,47), gS(29,53), gS(42,44), gS(45,24), gS(55,25), gS(97,31), gS(64,38), gS(9,33),
           gS(-5,20), gS(5,26), gS(7,22), gS(22,7), gS(30,10), gS(31,14), gS(12,21), gS(-4,8),
           gS(-16,4), gS(-6,13), gS(-4,4), gS(4,3), gS(9,3), gS(5,5), gS(2,5), gS(-15,-5),
           gS(-20,-2), gS(-16,2), gS(-13,6), gS(-12,6), gS(-4,9), gS(-3,8), gS(1,-3), gS(-15,-13),
           gS(-18,1), gS(-12,5), gS(-18,15), gS(-10,16), gS(-14,21), gS(6,17), gS(7,0), gS(-18,-17),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int  ROOK_PSQT_BLACK[64] = {
           gS(29,26), gS(22,32), gS(0,41), gS(7,36), gS(10,36), gS(23,35), gS(39,30), gS(50,27),
           ...
           gS(-23,-16), gS(-7,-4), gS(-14,-6), gS(-5,-12), gS(-4,-12), gS(-11,-9), gS(7,-9), gS(-16,-19),
           gS(-52,-11), gS(-15,-18), gS(-8,-14), gS(-1,-19), gS(0,-19), gS(-2,-23), gS(-2,-24), gS(-55,-11),
           gS(-14,-13), gS(-7,-12), gS(-4,-10), gS(2,-17), gS(1,-17), gS(-1,-8), gS(0,-16), gS(-10,-23),
};

const int  BISHOP_PSQT_BLACK[64] = {
           gS(-50,6), gS(-43,8), gS(-75,17), gS(-79,24), gS(-66,19), gS(-91,16), gS(-15,0), gS(-48,0),
           gS(-48,1), gS(-10,4), gS(-7,8), gS(-14,17), gS(-6,15), gS(0,8), gS(-26,6), gS(-21,-4),
           gS(4,1), gS(5,8), gS(25,3), gS(8,9), gS(25,7), gS(11,9), gS(26,2), gS(17,-2),
           gS(-9,0), gS(20,5), gS(5,5), gS(22,15), gS(19,14), gS(16,3), gS(20,1), gS(-6,0),
           gS(0,-12), gS(7,-1), gS(12,8), gS(19,7), gS(26,7), gS(4,5), gS(15,-1), gS(3,-15),
           gS(0,-17), gS(11,-7), gS(8,-4), gS(14,1), gS(10,2), gS(12,-6), gS(13,-9), gS(14,-11),
           gS(8,-29), gS(9,-33), gS(11,-16), gS(4,-2), gS(8,-4), gS(8,-16), gS(16,-27), gS(2,-40),
           gS(6,-37), gS(1,-15), gS(1,-4), gS(0,-7), gS(1,-3), gS(-1,-8), gS(-1,-10), gS(2,-37),
};
...
const int  KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-18,-18), gS(12,-4), gS(33,30), gS(32,30), gS(60,19), gS(46,24), gS(29,-12), gS(5,-16),
           gS(0,-10), gS(8,5), gS(26,28), gS(25,39), gS(15,36), gS(39,22), gS(16,8), gS(8,-7),
           gS(-5,-9), gS(10,8), gS(14,30), gS(21,31), gS(23,33), gS(20,32), gS(25,11), gS(7,-1),
           gS(-19,-34), gS(0,-7), gS(5,8), gS(13,22), gS(17,21), gS(13,5), gS(7,-2), gS(-5,-27),
           gS(-21,-17), gS(-28,-2), gS(-7,-13), gS(7,4), gS(1,6), gS(0,-12), gS(-17,-3), gS(-11,-4),
           gS(-40,-46), gS(-13,-29), gS(-11,-19), gS(-8,1), gS(0,0), gS(-7,-12), gS(-11,-21), gS(-40,-45),
};

const int  QUEEN_PSQT_BLACK[64] = {
           gS(-5,3), gS(0,19), gS(0,33), gS(3,43), gS(9,53), gS(31,48), gS(8,48), gS(14,34),
           gS(-18,0), gS(-56,41), gS(-17,30), gS(-41,73), gS(-50,111), gS(-1,71), gS(-57,72), gS(-19,39),
           gS(-15,-15), gS(-7,-15), gS(-10,16), gS(-13,43), gS(0,60), gS(7,77), gS(24,47), gS(-6,60),
           gS(-4,-31), gS(-2,1), gS(-9,6), gS(-18,50), gS(-16,66), gS(-13,73), gS(0,58), gS(1,31),
           gS(1,-41), gS(4,-13), gS(-3,-8), gS(-9,28), gS(-5,27), gS(-11,26), gS(9,3), gS(-1,7),
           gS(0,-58), gS(12,-42), gS(5,-22), gS(5,-31), gS(4,-28), gS(1,-12), gS(15,-33), gS(4,-47),
           gS(1,-66), gS(8,-63), gS(18,-79), gS(11,-49), gS(16,-53), gS(18,-92), gS(15,-85), gS(-10,-57),
           gS(3,-70), gS(7,-82), gS(9,-88), gS(13,-68), gS(14,-73), gS(8,-89), gS(10,-84), gS(0,-74),
};
