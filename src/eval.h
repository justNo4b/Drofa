...
const int KING_PAWN_TENSION = gS(-9,-5);

const int KING_BLOCKED_TENSION = gS(-24,-11);
...
const int PASSED_PASSED_DISTANCE[8] = {
           gS(-2,-22), gS(17,2), gS(0,-17), gS(-7,-6),
...
const int KING_PASSER_DISTANCE_ENEMY[8] = {
           gS(0,0), gS(-49,-1), gS(8,-15), gS(0,2),
           gS(0,13), gS(-4,23), gS(0,24), gS(-8,21),
};
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(18,34), gS(16,35), gS(15,31),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-6,2), gS(7,9), gS(0,11), gS(0,4),
           gS(-7,5), gS(-21,0), gS(-5,17), gS(0,0),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-65), gS(3,-25), gS(10,-12), gS(15,-2), gS(17,7), gS(18,10), gS(17,13),
           gS(16,12), gS(15,13), gS(15,12), gS(17,9), gS(28,0), gS(30,10), gS(43,-9),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-3,-94), gS(9,-35), gS(16,-8), gS(20,1), gS(24,8),
           gS(27,13), gS(30,9), gS(33,3), gS(35,-5),
};

const int KING_MOBILITY[9] = {
           gS(15,-30), gS(5,-2), gS(0,5), gS(-2,9), gS(-5,6),
...
const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-147), gS(-6,-111), gS(-5,-74), gS(-4,-54), gS(-4,-36), gS(-3,-18),
           gS(-1,-6), gS(0,6), gS(0,17), gS(0,24), gS(1,29), gS(1,34), gS(2,37),
           gS(2,39), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(9,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,16), gS(0,8), gS(5,4), gS(8,2), gS(0,0),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-85), gS(0,-20), gS(0,-5), gS(0,-5), gS(0,-17), gS(0,-21), gS(0,-11), gS(0,-94),
           gS(0,-12), gS(0,35), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-20),
           gS(0,0), gS(27,26), gS(6,38), gS(0,39), gS(0,40), gS(16,36), gS(11,29), gS(0,-1),
           gS(0,-12), gS(11,15), gS(-1,26), gS(-7,34), gS(-8,32), gS(0,25), gS(6,16), gS(-30,-15),
           gS(-10,-24), gS(0,2), gS(-4,15), gS(-13,22), gS(-14,21), gS(-21,16), gS(-1,1), gS(-38,-21),
           gS(-5,-30), gS(13,-6), gS(-11,6), gS(-29,16), gS(-25,15), gS(-21,7), gS(0,-6), gS(-6,-28),
           gS(6,-31), gS(0,-8), gS(-2,0), gS(-21,7), gS(-23,8), gS(-2,0), gS(-2,-8), gS(5,-34),
           gS(-12,-57), gS(8,-40), gS(-11,-20), gS(-35,-16), gS(10,-45), gS(-13,-26), gS(7,-37), gS(1,-70),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(48,67), gS(40,73), gS(34,63), gS(65,48), gS(58,55), gS(37,60), gS(0,78), gS(0,67),
           gS(-1,30), gS(4,25), gS(22,7), gS(33,-2), gS(31,-1), gS(60,0), gS(18,18), gS(17,11),
           gS(-18,16), gS(-2,9), gS(0,0), gS(7,-2), gS(12,-3), gS(10,-1), gS(16,0), gS(-9,4),
           gS(-28,5), gS(-25,12), gS(-10,0), gS(4,-2), gS(3,-4), gS(5,-3), gS(-9,1), gS(-22,-4),
           gS(-28,-1), gS(-21,1), gS(-9,-3), gS(-5,0), gS(0,0), gS(0,-2), gS(-4,-6), gS(-23,-10),
           gS(-38,7), gS(-19,7), gS(-14,7), gS(0,6), gS(0,9), gS(0,6), gS(-5,1), gS(-29,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-3,16), gS(-3,11), gS(0,8), gS(0,3), gS(0,1), gS(0,1), gS(0,1), gS(0,7),
           gS(-7,12), gS(-8,19), gS(-12,8), gS(-2,0), gS(-2,2), gS(-10,6), gS(-6,21), gS(-8,14),
           gS(-3,-5), gS(-4,-3), gS(-11,-8), gS(0,-19), gS(0,-15), gS(-6,-4), gS(-5,-1), gS(-4,0),
           gS(0,-18), gS(-3,-9), gS(1,-14), gS(0,-25), gS(0,-25), gS(0,-6), gS(-5,0), gS(0,0),
           gS(0,-27), gS(-3,-3), gS(-8,-6), gS(-4,0), gS(-7,-10), gS(-8,0), gS(2,-6), gS(0,-28),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,0), gS(-1,0), gS(0,0), gS(0,-16), gS(0,-14), gS(0,-8), gS(-9,-4), gS(0,1),
           gS(0,15), gS(0,2), gS(0,-3), gS(0,-7), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(2,4), gS(-1,6), gS(-2,3), gS(-6,5), gS(-2,6), gS(-2,10), gS(3,-2), gS(6,3),
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-21,-9), gS(-5,-11), gS(0,-8), gS(0,-11), gS(11,-16), gS(7,-22), gS(4,-23), gS(-40,-11),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-35,-10), gS(-21,0), gS(-4,0), gS(19,6), gS(7,3), gS(25,-12), gS(-13,-2), gS(-22,-16),
           ...
           gS(-9,-22), gS(9,-8), gS(9,4), gS(20,15), gS(23,13), gS(21,1), gS(25,-10), gS(2,-12),
           gS(-7,-27), gS(-12,1), gS(2,-6), gS(5,6), gS(11,4), gS(11,-5), gS(0,0), gS(1,-15),
           gS(-40,-30), gS(-15,-17), gS(-1,-5), gS(0,0), gS(7,3), gS(-3,-5), gS(-9,-8), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,7), gS(0,16), gS(-7,24), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-14,2), gS(-28,22), gS(-13,25), gS(-26,43), gS(-39,62), gS(-21,30), gS(-12,26), gS(1,10),
           gS(-10,-15), gS(-1,0), gS(-4,23), gS(0,35), gS(0,43), gS(4,31), gS(7,12), gS(-5,6),
           gS(-3,-16), gS(-4,9), gS(-3,19), gS(-1,39), gS(-5,53), gS(0,33), gS(0,25), gS(5,-4),
...
const int MATERIAL_VALUES[5] = {
           gS(93,112), gS(516,682), gS(360,377), gS(381,395), gS(1004,1254),
};
