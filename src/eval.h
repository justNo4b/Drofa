...
const int BISHOP_MOBILITY[14] = {
           gS(-18,-104), gS(-6,-44), gS(-1,-17), gS(1,-2), gS(4,11), gS(5,21), gS(5,27),
           gS(3,29), gS(4,31), gS(7,28), gS(12,24), gS(28,13), gS(45,26), gS(76,-8),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-7,-75), gS(1,-29), gS(4,-4), gS(7,10), gS(10,19),
           gS(12,26), gS(17,25), gS(23,18), gS(33,3),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-20,-102), gS(-13,-66), gS(-9,-33), gS(-7,-13), gS(-8,5), gS(-9,19), gS(-4,23),
           gS(0,26), gS(4,31), gS(9,36), gS(11,40), gS(17,43), gS(21,43), gS(37,30),
           gS(89,0),
};

const int QUEEN_MOBILITY[28] = {
           gS(-39,-103), gS(-18,-165), gS(-6,-133), gS(-3,-78), gS(-1,-45), gS(0,-22), gS(1,-4),
           gS(3,7), gS(6,17), gS(8,23), gS(9,30), gS(10,35), gS(10,39), gS(10,45),
           gS(8,51), gS(6,55), gS(5,57), gS(4,58), gS(4,58), gS(9,53), gS(12,49),
...
const int BISHOP_RAMMED_PENALTY = gS(-1,-7);

const int BISHOP_CENTER_CONTROL = gS(10,8);

const int MINOR_BEHIND_PAWN = gS(8,11);
...
const int KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(48,74), gS(-16,13), gS(-5,-3),
           gS(-5,-16), gS(-3,-27), gS(5,-38), gS(14,-45),
           gS(0,-10),
};
...
const int BISHOP_OWN_PAWNS[4] = {
           gS(2,15), gS(2,3), gS(-1,-8), gS(-6,-17),
};

const int HANGING_PIECE[5] = {
           gS(-11,-2), gS(-26,-17), gS(-25,-52), gS(-32,-72), gS(-18,-12),
};
/**
...
const int PASSED_PAWN_RANKS[8] = {
           ...
           gS(14,55), gS(24,118), gS(76,129), gS(0,0),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-3,-3), gS(28,39), gS(33,34), gS(12,20), gS(12,18), gS(35,36), gS(28,42), gS(-7,-8),
           gS(-9,-10), gS(22,21), gS(29,29), gS(0,32), gS(8,27), gS(33,27), gS(30,21), gS(-36,-10),
           gS(-22,-34), gS(22,2), gS(26,18), gS(-15,33), gS(2,29), gS(12,20), gS(24,5), gS(-53,-21),
           gS(-52,-15), gS(-9,1), gS(-7,11), gS(-28,26), gS(-16,23), gS(-16,16), gS(-9,2), gS(-52,-12),
           gS(0,-13), gS(-2,5), gS(-24,15), gS(-64,24), gS(-45,19), gS(-46,22), gS(0,2), gS(-3,-22),
           gS(-27,-56), gS(2,-29), gS(-30,-7), gS(-38,-27), gS(-28,-38), gS(-55,-7), gS(-5,-28), gS(-15,-74),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(61,72), gS(50,97), gS(69,93), gS(75,79), gS(81,77), gS(84,81), gS(-8,101), gS(-23,83),
           gS(-3,48), gS(29,53), gS(41,44), gS(44,24), gS(55,25), gS(95,30), gS(63,38), gS(9,33),
           gS(-4,20), gS(5,26), gS(7,22), gS(22,7), gS(30,10), gS(30,14), gS(12,21), gS(-4,9),
           gS(-15,4), gS(-6,13), gS(-4,5), gS(4,4), gS(10,4), gS(4,5), gS(2,5), gS(-15,-5),
           gS(-19,-2), gS(-15,3), gS(-13,6), gS(-11,7), gS(-4,9), gS(-3,9), gS(2,-3), gS(-15,-12),
           gS(-17,1), gS(-12,5), gS(-17,16), gS(-10,16), gS(-14,22), gS(5,17), gS(7,0), gS(-17,-17),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,26), gS(22,32), gS(0,41), gS(8,36), gS(11,36), gS(24,36), gS(40,31), gS(51,27),
           gS(-2,27), gS(-6,32), gS(15,28), gS(26,30), gS(23,31), gS(41,13), gS(7,25), gS(15,21),
           gS(-9,19), gS(31,4), gS(20,16), gS(42,5), gS(53,0), gS(49,8), gS(70,-8), gS(13,11),
           gS(-8,10), gS(9,9), gS(17,11), gS(38,4), gS(31,4), gS(28,3), gS(30,0), gS(12,5),
           gS(-20,0), gS(-11,10), gS(-13,12), gS(-3,4), gS(-4,3), gS(-8,8), gS(6,5), gS(-11,-2),
           gS(-24,-17), gS(-8,-5), gS(-15,-6), gS(-7,-12), gS(-6,-12), gS(-9,-9), gS(9,-9), gS(-15,-19),
           gS(-54,-12), gS(-16,-19), gS(-10,-14), gS(-3,-19), gS(-2,-20), gS(-1,-23), gS(-2,-24), gS(-55,-11),
           gS(-16,-15), gS(-9,-13), gS(-6,-11), gS(0,-18), gS(0,-18), gS(-2,-8), gS(0,-17), gS(-11,-24),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-51,5), gS(-44,8), gS(-76,16), gS(-80,23), gS(-67,19), gS(-92,16), gS(-15,0), gS(-49,0),
           gS(-48,1), gS(-11,2), gS(-7,8), gS(-15,16), gS(-6,15), gS(0,7), gS(-27,5), gS(-21,-5),
           gS(3,0), gS(4,8), gS(23,2), gS(9,9), gS(24,7), gS(10,9), gS(25,1), gS(17,-3),
           gS(-9,0), gS(19,4), gS(5,6), gS(22,14), gS(20,15), gS(15,3), gS(20,1), gS(-6,0),
           gS(0,-14), gS(7,0), gS(11,8), gS(18,9), gS(25,7), gS(4,6), gS(14,-1), gS(3,-15),
           gS(0,-17), gS(11,-8), gS(7,-4), gS(14,1), gS(10,4), gS(11,-7), gS(12,-10), gS(13,-13),
           gS(8,-30), gS(9,-33), gS(11,-16), gS(4,-1), gS(8,-4), gS(9,-16), gS(17,-29), gS(4,-41),
           gS(5,-38), gS(2,-15), gS(2,-3), gS(1,-7), gS(1,-3), gS(0,-9), gS(-1,-10), gS(2,-38),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-143,-69), gS(-36,-19), gS(-64,12), gS(-14,0), gS(0,1), gS(-52,14), gS(-29,-11), gS(-87,-70),
           gS(-11,-24), gS(-12,-4), gS(31,-4), gS(49,17), gS(37,17), gS(53,-12), gS(-21,-2), gS(-7,-21),
           gS(-19,-18), gS(12,-4), gS(32,29), gS(32,30), gS(58,19), gS(45,24), gS(28,-12), gS(4,-16),
           gS(0,-10), gS(7,5), gS(26,27), gS(25,38), gS(17,35), gS(39,22), gS(15,8), gS(8,-7),
           gS(-5,-8), gS(10,8), gS(14,29), gS(20,31), gS(23,33), gS(19,31), gS(24,11), gS(6,0),
           gS(-19,-34), gS(1,-7), gS(5,7), gS(13,22), gS(17,21), gS(13,5), gS(7,-2), gS(-5,-27),
           gS(-21,-17), gS(-28,-1), gS(-7,-12), gS(6,4), gS(1,7), gS(0,-11), gS(-17,-3), gS(-11,-4),
           gS(-40,-46), gS(-12,-29), gS(-11,-18), gS(-8,2), gS(0,1), gS(-7,-12), gS(-10,-21), gS(-40,-45),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-4,3), gS(0,19), gS(0,33), gS(3,44), gS(9,53), gS(31,49), gS(8,49), gS(15,35),
           gS(-18,0), gS(-57,41), gS(-17,30), gS(-41,74), gS(-47,112), gS(0,72), gS(-56,72), gS(-18,40),
           gS(-15,-15), gS(-8,-16), gS(-11,16), gS(-12,43), gS(0,61), gS(10,78), gS(27,48), gS(0,61),
           ...
           gS(0,-58), gS(10,-42), gS(4,-22), gS(4,-31), gS(3,-29), gS(1,-12), gS(16,-33), gS(4,-47),
           gS(0,-67), gS(7,-64), gS(16,-80), gS(10,-50), gS(13,-54), gS(17,-92), gS(14,-86), gS(-10,-57),
           gS(2,-70), gS(5,-82), gS(7,-88), gS(11,-69), gS(11,-75), gS(6,-90), gS(9,-85), gS(-1,-75),
};
