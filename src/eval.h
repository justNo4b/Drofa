...
const int ROOK_RESTRICT_KING = gS(8,10);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-16,1), gS(-10,7), gS(0,12),
           gS(4,30), gS(9,50), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(9,16), gS(0,8), gS(0,1), gS(-6,-2),
};
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(16,12), gS(15,13), gS(15,12), gS(16,9), gS(28,0), gS(30,10), gS(49,-10),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(9,-35), gS(16,-8), gS(21,1), gS(25,9),
           gS(28,13), gS(31,10), gS(35,4), gS(38,-5),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-92), gS(0,-26), gS(0,-9), gS(0,-6), gS(0,-17), gS(0,-22), gS(0,-13), gS(0,-94),
           gS(0,-15), gS(0,34), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-22),
           gS(0,-1), gS(27,24), gS(12,36), gS(0,39), gS(0,40), gS(17,36), gS(10,28), gS(0,-3),
           gS(0,-14), gS(10,13), gS(-1,25), gS(-7,34), gS(-8,32), gS(0,24), gS(6,14), gS(-34,-16),
           gS(-12,-25), gS(0,1), gS(-4,15), gS(-15,23), gS(-14,22), gS(-21,16), gS(-1,0), gS(-40,-21),
           gS(-10,-30), gS(12,-7), gS(-11,6), gS(-30,17), gS(-25,16), gS(-22,8), gS(0,-6), gS(-5,-29),
           gS(5,-29), gS(0,-8), gS(-2,0), gS(-21,9), gS(-23,10), gS(-2,1), gS(-2,-6), gS(5,-32),
           gS(-12,-56), gS(8,-38), gS(-11,-17), gS(-34,-13), gS(10,-43), gS(-13,-23), gS(6,-35), gS(1,-66),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(51,69), gS(40,75), gS(35,65), gS(65,51), gS(59,58), gS(43,61), gS(0,82), gS(0,69),
           gS(0,32), gS(8,28), gS(25,10), gS(40,-1), gS(39,0), gS(68,3), gS(24,21), gS(25,13),
           gS(-14,17), gS(1,11), gS(3,1), gS(12,0), gS(17,-1), gS(16,0), gS(22,1), gS(-6,5),
           gS(-26,5), gS(-22,12), gS(-9,0), gS(8,-2), gS(7,-4), gS(7,-3), gS(-5,1), gS(-19,-4),
           gS(-27,-1), gS(-19,0), gS(-7,-3), gS(-5,0), gS(0,-1), gS(0,-2), gS(-4,-7), gS(-22,-10),
           gS(-37,7), gS(-18,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,4), gS(-4,0), gS(-27,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(0,-17), gS(-3,-9), gS(2,-14), gS(0,-25), gS(0,-25), gS(0,-6), gS(-5,-2), gS(0,0),
           gS(0,-27), gS(-3,-3), gS(-7,-7), gS(-4,0), gS(-6,-9), gS(-8,1), gS(2,-5), gS(0,-27),
           gS(0,-44), gS(-1,-20), gS(-5,-7), gS(-13,0), gS(-8,0), gS(0,-2), gS(0,-9), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,13), gS(0,0), gS(1,-4), gS(0,-8), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(2,3), gS(-1,6), gS(-1,4), gS(-5,4), gS(-2,6), gS(-2,10), gS(4,-4), gS(7,2),
           gS(4,30), gS(0,17), gS(-2,24), gS(-2,20), gS(-4,16), gS(2,20), gS(5,14), gS(9,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,21), gS(0,27), gS(0,21), gS(5,21), gS(12,20), gS(24,17), gS(37,14),
           gS(5,13), gS(0,14), gS(16,10), gS(35,1), gS(26,3), gS(25,2), gS(-8,14), gS(6,9),
           ...
           gS(-13,8), gS(-11,12), gS(0,8), gS(-1,6), gS(1,3), gS(-2,1), gS(-5,5), gS(-19,4),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,0), gS(0,3), gS(22,-2), gS(14,0), gS(20,-1), gS(6,0), gS(6,-3),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-6,-21), gS(10,-7), gS(10,4), gS(20,15), gS(24,13), gS(22,1), gS(26,-10), gS(4,-11),
...
const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,8), gS(0,18), gS(-7,24), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-13,2), gS(-27,23), gS(-13,25), gS(-26,45), gS(-43,66), gS(-21,32), gS(-13,32), gS(1,11),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,35), gS(0,44), gS(3,33), gS(8,13), gS(-6,11),
...
const int MATERIAL_VALUES[5] = {
           gS(90,111), gS(513,680), gS(356,375), gS(379,395), gS(1001,1258),
};
