...
const int DOUBLED_PAWN_PENALTY = gS(-8,-22);
...
const int KNIGHT_FORK_TEMPO = gS(-6,-3);
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-67,-39), gS(-50,-46), gS(-53,-66), gS(-49,-31),
};

const int KNIGHT_CHECKING_FORK[5] = {
           gS(2,13), gS(5,16), gS(0,0), gS(0,15), gS(5,0),
};
...
const int ROOK_ATTACKED_BY[4] = {
           gS(0,0), gS(-3,19), gS(65,19), gS(43,40),
};

const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(61,36), gS(39,20), gS(41,42),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-6,2), gS(6,10), gS(0,10), gS(-1,6),
...
const int KNIGHT_MOBILITY[9] = {
           ...
           gS(28,13), gS(32,10), gS(35,4), gS(38,-5),
};
...
const int ROOK_MOBILITY[15] = {
           ...
           gS(7,7), gS(11,12), gS(13,15), gS(14,21), gS(16,23), gS(21,21), gS(27,20),
           gS(49,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-155), gS(-6,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-17),
           gS(-1,-5), gS(0,7), gS(0,17), gS(0,24), gS(1,30), gS(2,35), gS(2,38),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,-2), gS(27,24), gS(14,36), gS(0,39), gS(0,40), gS(19,36), gS(11,28), gS(0,-3),
           gS(-1,-14), gS(11,13), gS(-1,26), gS(-7,35), gS(-8,33), gS(2,24), gS(7,14), gS(-35,-16),
           gS(-13,-25), gS(0,1), gS(-4,15), gS(-15,24), gS(-14,23), gS(-21,17), gS(-1,1), gS(-41,-20),
           gS(-12,-29), gS(12,-6), gS(-12,7), gS(-30,18), gS(-25,17), gS(-22,8), gS(0,-5), gS(-6,-28),
           gS(4,-29), gS(0,-7), gS(-2,0), gS(-21,10), gS(-23,10), gS(-2,1), gS(-3,-6), gS(4,-32),
           gS(-14,-56), gS(7,-38), gS(-12,-17), gS(-34,-15), gS(10,-44), gS(-13,-25), gS(6,-36), gS(0,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(51,69), gS(40,76), gS(35,65), gS(65,51), gS(60,58), gS(45,61), gS(0,82), gS(0,69),
           gS(0,31), gS(8,28), gS(25,10), gS(41,-1), gS(41,0), gS(69,3), gS(25,22), gS(25,13),
           gS(-14,16), gS(2,10), gS(5,0), gS(13,-1), gS(18,-1), gS(17,-1), gS(22,0), gS(-5,5),
           gS(-25,5), gS(-20,11), gS(-8,0), gS(9,-3), gS(8,-4), gS(7,-3), gS(-5,1), gS(-19,-5),
           gS(-26,-1), gS(-18,0), gS(-7,-4), gS(-4,-1), gS(0,-1), gS(0,-3), gS(-3,-7), gS(-21,-10),
           gS(-36,6), gS(-16,6), gS(-14,6), gS(0,6), gS(0,8), gS(1,4), gS(-4,0), gS(-27,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(0,-18), gS(-3,-10), gS(2,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-5,-2), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-7,-7), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-27),
           gS(0,-44), gS(-1,-22), gS(-5,-7), gS(-13,0), gS(-8,0), gS(1,-2), gS(1,-9), gS(0,-49),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,0), gS(0,0), gS(-1,0), gS(1,-16), gS(0,-14), gS(-1,-8), gS(-9,-3), gS(0,1),
           gS(0,13), gS(0,0), gS(1,-5), gS(0,-8), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(3,2), gS(-1,5), gS(-1,4), gS(-4,4), gS(-2,6), gS(-2,10), gS(4,-3), gS(7,2),
           gS(5,29), gS(0,15), gS(-2,24), gS(-1,20), gS(-4,16), gS(3,20), gS(6,14), gS(9,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(2,17), gS(19,8), gS(19,10), gS(27,2), gS(43,-3), gS(36,-1), gS(27,1), gS(-4,13),
           gS(0,12), gS(0,12), gS(18,7), gS(21,1), gS(20,0), gS(20,-1), gS(6,2), gS(0,3),
           gS(-13,7), gS(-11,12), gS(0,7), gS(-1,6), gS(1,3), gS(-2,1), gS(-5,5), gS(-19,4),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,0), gS(0,3), gS(23,-3), gS(15,0), gS(20,-1), gS(6,0), gS(7,-3),
           gS(-8,-1), gS(9,5), gS(2,2), gS(20,10), gS(15,11), gS(11,4), gS(6,2), gS(-3,-7),
           gS(5,-6), gS(-3,4), gS(7,6), gS(19,7), gS(23,5), gS(6,4), gS(7,0), gS(5,-15),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-33,-9), gS(-19,0), gS(-2,0), gS(19,6), gS(9,3), gS(27,-12), gS(-12,-2), gS(-19,-16),
           gS(-10,-1), gS(6,3), gS(11,20), gS(29,6), gS(42,1), gS(47,5), gS(13,-1), gS(13,-13),
           gS(5,-1), gS(6,0), gS(15,15), gS(31,17), gS(19,19), gS(35,12), gS(10,1), gS(21,-10),
           gS(1,0), gS(13,5), gS(18,19), gS(22,16), gS(23,20), gS(29,13), gS(24,1), gS(11,0),
           gS(-6,-21), gS(11,-7), gS(10,5), gS(20,15), gS(24,13), gS(22,1), gS(26,-9), gS(4,-11),
           gS(-5,-27), gS(-10,2), gS(5,-5), gS(7,7), gS(13,5), gS(14,-3), gS(1,0), gS(4,-15),
           gS(-40,-29), gS(-12,-16), gS(0,-5), gS(2,2), gS(9,4), gS(-1,-3), gS(-6,-6), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(-1,10), gS(-2,20), gS(-8,25), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-13,2), gS(-28,24), gS(-13,25), gS(-28,47), gS(-45,66), gS(-22,33), gS(-14,34), gS(1,11),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,35), gS(-1,44), gS(3,35), gS(8,13), gS(-7,13),
           ...
           gS(-3,-32), gS(10,-24), gS(5,-5), gS(3,0), gS(3,0), gS(7,-5), gS(14,-11), gS(4,-27),
           gS(4,-52), gS(12,-57), gS(19,-57), gS(12,-33), gS(14,-29), gS(21,-64), gS(25,-79), gS(0,-44),
           gS(6,-62), gS(8,-69), gS(6,-76), gS(4,-57), gS(7,-63), gS(-3,-75), gS(0,-63), gS(13,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(88,112), gS(512,681), gS(355,375), gS(378,395), gS(1001,1259),
};
