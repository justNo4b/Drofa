...
const int KING_LOW_DANGER = gS(73,-79);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-17,1), gS(-10,7), gS(0,11),
           gS(4,29), gS(9,51), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(9,17), gS(0,8), gS(0,1), gS(-6,-2),
};
...
const int ROOK_RESTRICT_KING[4] = {
           gS(0,5), gS(-5,-4), gS(1,0), gS(12,15),
};
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,34), gS(16,35), gS(15,31),
};
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(61,36), gS(39,20), gS(41,44),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-6,2), gS(6,9), gS(0,10), gS(-1,6),
           gS(-8,5), gS(-21,0), gS(-6,17), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,21), gS(13,0), gS(23,0),
           gS(9,0), gS(-18,0), gS(-5,15), gS(10,0),
};
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(16,12), gS(15,13), gS(15,12), gS(16,9), gS(28,0), gS(30,10), gS(48,-10),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(9,-35), gS(16,-8), gS(21,1), gS(25,9),
           gS(28,13), gS(31,10), gS(35,3), gS(38,-5),
};

const int KING_MOBILITY[9] = {
           gS(14,-30), gS(5,-4), gS(0,5), gS(-2,10), gS(-5,8),
           gS(-8,6), gS(0,4), gS(0,0), gS(15,-19),
};

const int ROOK_MOBILITY[15] = {
           gS(-27,-89), gS(-14,-52), gS(-7,-32), gS(0,-19), gS(3,-7), gS(0,5), gS(5,7),
           gS(7,7), gS(10,12), gS(13,15), gS(14,20), gS(16,23), gS(21,21), gS(26,20),
           gS(47,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-152), gS(-6,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-18),
           gS(-1,-5), gS(0,6), gS(0,17), gS(0,24), gS(1,30), gS(2,34), gS(2,37),
           gS(2,40), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(9,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,16), gS(0,8), gS(5,4), gS(8,7), gS(2,4),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-92), gS(0,-25), gS(0,-8), gS(0,-6), gS(0,-17), gS(0,-22), gS(0,-13), gS(0,-94),
           gS(0,-15), gS(0,34), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-22),
           gS(0,-1), gS(27,24), gS(11,36), gS(0,39), gS(0,40), gS(16,36), gS(10,28), gS(0,-3),
           gS(0,-14), gS(10,13), gS(-1,25), gS(-7,34), gS(-8,32), gS(0,24), gS(6,14), gS(-34,-16),
           gS(-12,-25), gS(0,1), gS(-4,15), gS(-15,23), gS(-14,22), gS(-21,16), gS(-1,0), gS(-39,-21),
           gS(-9,-30), gS(12,-7), gS(-11,6), gS(-30,17), gS(-25,16), gS(-22,8), gS(0,-6), gS(-4,-29),
           gS(5,-29), gS(0,-8), gS(-2,0), gS(-21,9), gS(-23,10), gS(-2,1), gS(-2,-7), gS(5,-32),
           gS(-12,-56), gS(8,-38), gS(-11,-17), gS(-34,-13), gS(10,-43), gS(-13,-24), gS(7,-35), gS(1,-66),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(50,69), gS(40,75), gS(35,65), gS(65,51), gS(58,58), gS(42,61), gS(0,81), gS(0,69),
           gS(0,31), gS(8,27), gS(24,10), gS(39,-1), gS(38,0), gS(67,3), gS(24,21), gS(24,13),
           gS(-15,17), gS(0,11), gS(2,1), gS(11,0), gS(17,-1), gS(15,0), gS(21,0), gS(-7,5),
           gS(-27,5), gS(-22,12), gS(-10,0), gS(7,-2), gS(7,-4), gS(6,-3), gS(-6,1), gS(-20,-5),
           gS(-27,-1), gS(-20,0), gS(-8,-4), gS(-5,-1), gS(0,-1), gS(0,-3), gS(-4,-7), gS(-22,-10),
           gS(-37,6), gS(-18,6), gS(-15,6), gS(0,5), gS(0,8), gS(0,4), gS(-4,0), gS(-28,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-6,12), gS(-7,18), gS(-10,8), gS(-1,0), gS(-1,2), gS(-7,5), gS(-4,21), gS(-5,14),
           gS(-3,-4), gS(-3,-3), gS(-10,-8), gS(0,-19), gS(0,-15), gS(-6,-4), gS(-6,0), gS(-4,0),
           gS(0,-17), gS(-3,-9), gS(1,-14), gS(0,-25), gS(0,-25), gS(0,-6), gS(-5,-2), gS(0,0),
           gS(0,-27), gS(-3,-3), gS(-8,-7), gS(-4,0), gS(-7,-9), gS(-8,1), gS(2,-5), gS(0,-28),
           gS(0,-45), gS(-1,-21), gS(-6,-7), gS(-13,0), gS(-9,0), gS(0,-2), gS(0,-9), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-4,11), gS(-8,12), gS(-9,12), gS(-2,0), gS(-1,1), gS(-7,2), gS(-1,21), gS(-4,8),
           gS(0,0), gS(0,0), gS(-1,0), gS(0,-16), gS(0,-14), gS(-1,-8), gS(-9,-3), gS(0,1),
           gS(0,13), gS(0,0), gS(0,-4), gS(0,-8), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(2,3), gS(-1,6), gS(-2,4), gS(-5,4), gS(-2,6), gS(-2,10), gS(4,-4), gS(7,2),
           gS(4,30), gS(0,16), gS(-3,25), gS(-2,20), gS(-5,16), gS(2,20), gS(5,14), gS(8,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,21), gS(0,27), gS(0,21), gS(5,21), gS(12,20), gS(24,17), gS(37,14),
           gS(5,13), gS(0,14), gS(16,10), gS(35,1), gS(26,4), gS(25,3), gS(-8,14), gS(6,9),
           gS(3,17), gS(19,9), gS(19,10), gS(27,2), gS(42,-3), gS(35,-1), gS(27,1), gS(-4,13),
           gS(0,12), gS(0,12), gS(18,7), gS(21,1), gS(20,0), gS(20,-1), gS(6,2), gS(0,3),
           gS(-13,7), gS(-11,12), gS(0,7), gS(-1,5), gS(1,3), gS(-2,1), gS(-5,5), gS(-19,4),
           gS(-15,-1), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(1,-9), gS(-11,-11),
...
const int BISHOP_PSQT_BLACK[64] = {
           gS(-34,-1), gS(-43,-2), gS(-74,16), gS(-81,16), gS(-53,16), gS(-91,13), gS(-26,-6), gS(-28,-16),
           gS(-37,-2), gS(-18,-1), gS(-12,0), gS(-12,9), gS(-12,6), gS(-15,3), gS(-26,-5), gS(-24,-7),
           gS(-3,0), gS(0,0), gS(0,3), gS(21,-2), gS(14,0), gS(20,-1), gS(6,0), gS(6,-3),
           gS(-8,-1), gS(9,5), gS(3,2), gS(20,10), gS(15,11), gS(11,4), gS(6,2), gS(-2,-7),
           gS(5,-5), gS(-3,4), gS(7,6), gS(19,7), gS(23,5), gS(6,4), gS(7,0), gS(5,-15),
           gS(4,-15), gS(20,-4), gS(11,-3), gS(11,5), gS(7,10), gS(22,-8), gS(18,-10), gS(9,-12),
           gS(16,-20), gS(12,-24), gS(17,-10), gS(5,0), gS(15,-1), gS(16,-6), gS(22,-22), gS(8,-29),
           gS(-2,-32), gS(8,-6), gS(0,-3), gS(2,0), gS(7,-4), gS(-10,3), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-162,-54), gS(-31,-3), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-80,2), gS(-29,-4), gS(-90,-64),
           gS(-33,-9), gS(-18,0), gS(-2,0), gS(20,6), gS(9,3), gS(27,-12), gS(-12,-2), gS(-19,-16),
           gS(-10,-1), gS(6,3), gS(11,20), gS(29,6), gS(42,1), gS(47,5), gS(12,-1), gS(13,-13),
           gS(4,-1), gS(7,0), gS(15,14), gS(31,17), gS(19,19), gS(35,12), gS(10,1), gS(21,-10),
           gS(1,0), gS(13,5), gS(18,19), gS(22,17), gS(24,21), gS(29,13), gS(24,1), gS(11,0),
           gS(-6,-21), gS(10,-7), gS(10,4), gS(20,15), gS(23,13), gS(22,1), gS(26,-10), gS(4,-11),
           gS(-5,-27), gS(-10,2), gS(4,-5), gS(7,7), gS(13,4), gS(14,-4), gS(1,0), gS(4,-15),
           gS(-40,-30), gS(-13,-16), gS(0,-5), gS(2,2), gS(9,4), gS(-1,-3), gS(-7,-6), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,8), gS(0,17), gS(-7,23), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-13,2), gS(-27,23), gS(-13,25), gS(-26,44), gS(-42,65), gS(-20,31), gS(-13,31), gS(1,11),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,35), gS(0,44), gS(4,33), gS(8,13), gS(-5,10),
           gS(-4,-16), gS(-7,9), gS(-5,19), gS(-4,40), gS(-8,53), gS(-4,34), gS(-3,25), gS(3,-4),
           gS(0,-26), gS(-6,0), gS(-1,11), gS(-3,38), gS(3,34), gS(-4,10), gS(8,4), gS(-5,-3),
           gS(-3,-32), gS(9,-24), gS(5,-4), gS(3,0), gS(3,0), gS(7,-5), gS(14,-11), gS(4,-27),
           gS(3,-51), gS(11,-57), gS(19,-57), gS(11,-33), gS(14,-29), gS(21,-64), gS(25,-79), gS(0,-44),
...
const int MATERIAL_VALUES[5] = {
           gS(91,111), gS(513,681), gS(357,375), gS(379,395), gS(1001,1257),
};
