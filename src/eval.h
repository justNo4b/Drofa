 ...
 */
extern U64 KING_PAWN_MASKS[2][2][10];
...
const int BISHOP_MOBILITY[14] = {
           gS(-24,-103), gS(-13,-43), gS(-7,-17), gS(-3,-1), gS(0,12), gS(1,23), gS(0,30),
           gS(0,32), gS(0,36), gS(4,34), gS(10,32), gS(27,21), gS(44,32), gS(75,-2),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-7,-71), gS(1,-24), gS(5,0), gS(7,13), gS(10,21),
           gS(12,27), gS(16,26), gS(22,18), gS(31,3),
};

const int KING_MOBILITY[9] = {
           gS(11,-1), gS(14,-3), gS(9,0), gS(5,4), gS(-1,3),
...
const int QUEEN_MOBILITY[28] = {
           gS(-44,-115), gS(-21,-186), gS(-9,-133), gS(-6,-76), gS(-4,-43), gS(-2,-21), gS(-1,-3),
...
const int TEMPO = 5;
const int KING_HIGH_DANGER = gS(-18,-65);

const int KING_MED_DANGER = gS(-4,-28);
...
const int HANGING_PIECE[5] = {
           gS(-2,11), gS(-26,-15), gS(-26,-48), gS(-30,-76), gS(-18,-13),
};
...
const int KING_PAWN_SHIELD_KS[10] = {
           gS(1,-7), gS(3,17), gS(9,12), gS(-5,22),
           gS(0,9), gS(-2,-28), gS(6,-6), gS(6,6),
           gS(-10,-28), gS(-10,5),
};

const int KING_PAWN_SHIELD_QS[10] = {
           gS(11,10), gS(-5,28), gS(20,8), gS(1,21),
           gS(9,5), gS(0,-5), gS(-10,5), gS(8,0),
           gS(-6,-6), gS(-3,0),
};
...
const int PAWN_CONNECTED[7] = {
           ...
           gS(16,33), gS(16,36), gS(1,6),
};

const int PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-14,-12), gS(-17,1), gS(-10,37),
           gS(20,47), gS(36,74), gS(75,92), gS(0,0),
};

const int PASSED_PAWN_FILES[8] = {
           gS(11,12), gS(7,11), gS(1,-1), gS(0,-5),
           gS(-3,-7), gS(-13,-3), gS(-7,12), gS(8,8),
};

const int PASSED_PAWN_FREE[7] = {
           gS(0,0), gS(-7,8), gS(-11,2), gS(-8,5),
           gS(-9,9), gS(-13,29), gS(17,31),
};

const int PASSED_PAWN_POS_ADVANCE[7] = {
           gS(0,0), gS(4,5), gS(5,1), gS(6,13),
           gS(0,28), gS(0,69), gS(1,88),
};


const int KING_PSQT_BLACK[64] = {
           gS(-13,-103), gS(0,-47), gS(0,-33), gS(0,-15), gS(0,-32), gS(0,-27), gS(0,-25), gS(-12,-94),
           gS(-13,-37), gS(0,25), gS(5,19), gS(0,4), gS(0,0), gS(3,16), gS(0,32), gS(-12,-38),
           gS(-2,-6), gS(28,28), gS(34,29), gS(12,18), gS(12,15), gS(36,27), gS(26,30), gS(-7,-12),
           gS(-9,-9), gS(22,14), gS(30,29), gS(0,34), gS(7,28), gS(32,25), gS(28,13), gS(-38,-12),
           gS(-22,-31), gS(24,1), gS(26,21), gS(-14,39), gS(0,34), gS(6,23), gS(28,3), gS(-47,-22),
           gS(-45,-13), gS(-1,0), gS(-2,13), gS(-27,31), gS(-14,27), gS(-13,18), gS(0,1), gS(-31,-14),
           gS(-12,-10), gS(-23,8), gS(-15,13), gS(-54,24), gS(-36,18), gS(-35,20), gS(-21,7), gS(-19,-18),
           gS(-29,-57), gS(-2,-26), gS(-33,-3), gS(-24,-25), gS(-15,-36), gS(-43,-5), gS(-3,-25), gS(-15,-73),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(62,66), gS(42,83), gS(60,81), gS(69,69), gS(77,68), gS(80,72), gS(-3,88), gS(-14,78),
           gS(0,45), gS(25,41), gS(39,35), gS(44,17), gS(53,18), gS(91,26), gS(56,32), gS(13,35),
           gS(-2,19), gS(2,15), gS(4,13), gS(19,-2), gS(27,1), gS(27,5), gS(8,12), gS(0,9),
           gS(-11,4), gS(-8,6), gS(-5,-1), gS(1,-2), gS(8,-2), gS(3,0), gS(0,0), gS(-8,-4),
           gS(-17,-1), gS(-19,0), gS(-16,3), gS(-14,5), gS(-7,8), gS(-8,7), gS(-5,-5), gS(-13,-10),
           gS(-13,3), gS(-10,4), gS(-14,16), gS(-6,16), gS(-12,23), gS(6,18), gS(7,2), gS(-7,-13),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-9,19), gS(30,4), gS(20,14), gS(42,2), gS(53,-2), gS(55,3), gS(71,-10), gS(18,9),
           gS(-9,12), gS(8,9), gS(16,11), gS(38,4), gS(31,4), gS(28,3), gS(28,1), gS(14,5),
           gS(-20,2), gS(-12,13), gS(-13,14), gS(-3,7), gS(-4,6), gS(-6,9), gS(5,6), gS(-8,-1),
           gS(-24,-15), gS(-7,-3), gS(-15,-3), gS(-7,-8), gS(-7,-7), gS(-8,-6), gS(9,-7), gS(-14,-17),
           gS(-55,-13), gS(-18,-18), gS(-10,-13), gS(-4,-16), gS(-3,-16), gS(-1,-20), gS(-3,-21), gS(-54,-12),
           gS(-16,-17), gS(-10,-14), gS(-6,-11), gS(0,-17), gS(0,-16), gS(-2,-7), gS(-1,-15), gS(-10,-25),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(0,4), gS(0,9), gS(15,5), gS(4,9), gS(22,7), gS(4,11), gS(21,3), gS(13,0),
           gS(-12,0), gS(14,5), gS(2,6), gS(22,12), gS(19,13), gS(14,3), gS(17,2), gS(-4,0),
           gS(-2,-10), gS(3,-1), gS(10,7), gS(16,8), gS(24,7), gS(2,6), gS(10,0), gS(0,-11),
           gS(-2,-17), gS(10,-8), gS(6,-3), gS(13,3), gS(9,4), gS(10,-4), gS(10,-8), gS(12,-11),
           gS(9,-34), gS(8,-32), gS(10,-15), gS(3,-2), gS(7,-3), gS(8,-14), gS(17,-27), gS(5,-45),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-17,-21), gS(-13,-6), gS(19,-1), gS(45,17), gS(38,17), gS(47,-10), gS(-21,-3), gS(-11,-21),
           ...
           gS(-3,-8), gS(11,8), gS(16,31), gS(23,34), gS(27,36), gS(21,32), gS(27,11), gS(8,0),
           ...
           gS(-40,-48), gS(-12,-29), gS(-10,-17), gS(-8,4), gS(0,3), gS(-8,-9), gS(-10,-20), gS(-41,-46),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-2,3), gS(0,21), gS(0,38), gS(4,52), gS(10,64), gS(31,49), gS(4,48), gS(13,33),
           gS(-18,-7), gS(-54,28), gS(-16,19), gS(-41,68), gS(-37,101), gS(0,70), gS(-53,65), gS(-18,31),
           gS(-14,-19), gS(-8,-19), gS(-10,11), gS(-9,41), gS(2,60), gS(15,78), gS(34,41), gS(7,56),
           gS(-5,-33), gS(-4,0), gS(-7,1), gS(-15,45), gS(-14,66), gS(-7,71), gS(5,57), gS(9,28),
           gS(-2,-41), gS(1,-13), gS(-4,-7), gS(-11,29), gS(-8,29), gS(-7,26), gS(9,3), gS(2,10),
           gS(-2,-58), gS(7,-40), gS(1,-19), gS(0,-26), gS(0,-24), gS(0,-9), gS(13,-29), gS(3,-43),
           gS(-3,-66), gS(3,-59), gS(12,-75), gS(6,-45), gS(9,-49), gS(13,-85), gS(10,-81), gS(-12,-57),
           gS(-2,-66), gS(1,-78), gS(3,-82), gS(7,-65), gS(7,-71), gS(2,-85), gS(5,-84), gS(-4,-75),
};
