...
const int PASSER_BLOCKED = gS(4,-2);

const int PAWN_PUSH_THREAT = gS(8,1);
...
const int MINOR_BEHIND_PAWN = gS(3,7);

const int MINOR_BEHIND_PASSER = gS(8,-2);

const int MINOR_BLOCK_OWN_PAWN = gS(-6,-1);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-17,1), gS(-9,7), gS(1,12),
           gS(5,30), gS(7,50), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(9,16), gS(-1,7), gS(0,0), gS(-7,-2),
};

const int BACKWARD_PAWN[7] = {
           gS(0,0), gS(-4,-9), gS(0,-9), gS(-4,-9),
...
const int HANGING_PIECE[5] = {
           gS(0,18), gS(-67,-40), gS(-53,-45), gS(-55,-66), gS(-50,-31),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,34), gS(15,36), gS(16,31),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,20), gS(14,0), gS(23,1),
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-64), gS(3,-26), gS(10,-13), gS(15,-2), gS(17,6), gS(18,9), gS(17,12),
           gS(16,12), gS(15,13), gS(15,12), gS(17,9), gS(28,0), gS(30,10), gS(49,-10),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-34), gS(17,-8), gS(21,1), gS(25,9),
           gS(28,13), gS(31,10), gS(35,4), gS(38,-4),
};

const int KING_MOBILITY[9] = {
           gS(13,-30), gS(5,-4), gS(0,5), gS(-2,9), gS(-5,7),
           gS(-8,5), gS(0,3), gS(0,-1), gS(14,-15),
};

const int ROOK_MOBILITY[15] = {
           gS(-28,-88), gS(-15,-51), gS(-8,-32), gS(0,-19), gS(2,-7), gS(0,5), gS(5,7),
           gS(6,7), gS(10,12), gS(12,16), gS(13,21), gS(16,23), gS(20,21), gS(26,20),
           gS(49,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-153), gS(-6,-111), gS(-5,-73), gS(-5,-53), gS(-4,-35), gS(-3,-18),
           gS(-2,-5), gS(0,6), gS(0,17), gS(0,24), gS(1,30), gS(2,34), gS(2,37),
           gS(2,40), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(9,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,16), gS(0,9), gS(5,5), gS(8,8), gS(3,5),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-89), gS(0,-26), gS(0,-9), gS(0,-5), gS(0,-17), gS(0,-21), gS(0,-11), gS(0,-94),
           gS(0,-12), gS(0,34), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-20),
           gS(0,0), gS(27,25), gS(12,37), gS(0,39), gS(0,40), gS(17,36), gS(11,28), gS(0,-1),
           gS(0,-12), gS(11,15), gS(-1,26), gS(-7,35), gS(-8,32), gS(0,25), gS(8,15), gS(-31,-15),
           gS(-11,-24), gS(0,2), gS(-4,15), gS(-15,23), gS(-14,22), gS(-21,17), gS(-1,1), gS(-39,-20),
           gS(-10,-29), gS(12,-6), gS(-11,6), gS(-30,17), gS(-25,16), gS(-22,8), gS(0,-6), gS(-6,-27),
           gS(5,-29), gS(-1,-8), gS(-2,0), gS(-21,8), gS(-23,8), gS(-2,0), gS(-2,-7), gS(5,-32),
           gS(-13,-56), gS(7,-39), gS(-12,-19), gS(-34,-16), gS(10,-46), gS(-12,-26), gS(6,-37), gS(1,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(50,69), gS(40,75), gS(35,65), gS(65,50), gS(59,56), gS(43,60), gS(0,81), gS(0,69),
           gS(0,32), gS(8,28), gS(25,10), gS(40,-1), gS(39,0), gS(68,3), gS(24,22), gS(26,13),
           gS(-15,15), gS(0,9), gS(2,0), gS(10,-2), gS(15,-3), gS(14,-2), gS(20,-1), gS(-6,4),
           gS(-26,5), gS(-21,11), gS(-9,0), gS(8,-3), gS(7,-4), gS(7,-3), gS(-5,1), gS(-19,-5),
           gS(-27,-1), gS(-20,0), gS(-7,-3), gS(-5,0), gS(0,0), gS(0,-2), gS(-3,-6), gS(-21,-10),
           gS(-36,7), gS(-17,6), gS(-14,7), gS(0,6), gS(0,9), gS(1,5), gS(-4,0), gS(-27,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-5,12), gS(-7,18), gS(-10,8), gS(-1,0), gS(-1,2), gS(-7,5), gS(-4,21), gS(-4,14),
           gS(-3,-4), gS(-3,-3), gS(-10,-8), gS(0,-19), gS(0,-15), gS(-6,-4), gS(-6,0), gS(-4,0),
           gS(0,-18), gS(-3,-9), gS(2,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-5,-1), gS(0,0),
           gS(0,-27), gS(-3,-4), gS(-7,-7), gS(-4,0), gS(-6,-9), gS(-7,0), gS(2,-6), gS(0,-27),
           gS(0,-44), gS(-1,-21), gS(-5,-7), gS(-13,0), gS(-8,0), gS(1,-2), gS(1,-10), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,11), gS(-8,12), gS(-8,12), gS(-2,0), gS(-1,1), gS(-7,2), gS(-1,21), gS(-4,8),
           gS(0,-1), gS(0,0), gS(-1,0), gS(1,-16), gS(0,-14), gS(-1,-8), gS(-9,-3), gS(0,1),
           gS(0,14), gS(0,1), gS(1,-4), gS(0,-7), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(3,2), gS(-1,6), gS(-1,3), gS(-5,4), gS(-2,6), gS(-2,10), gS(3,-3), gS(7,2),
           gS(4,30), gS(0,16), gS(-2,24), gS(-1,19), gS(-4,16), gS(3,20), gS(6,13), gS(9,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,20), gS(0,27), gS(0,20), gS(5,20), gS(11,20), gS(24,17), gS(36,14),
           gS(6,16), gS(0,16), gS(17,12), gS(35,3), gS(27,6), gS(26,4), gS(-7,15), gS(8,11),
           gS(2,17), gS(19,8), gS(19,10), gS(26,1), gS(41,-3), gS(34,-1), gS(26,1), gS(-4,13),
           gS(0,12), gS(1,13), gS(19,7), gS(21,1), gS(20,0), gS(20,0), gS(7,3), gS(0,3),
           gS(-13,7), gS(-10,12), gS(0,7), gS(0,5), gS(1,3), gS(-2,2), gS(-4,5), gS(-19,4),
           gS(-15,-1), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-2,-2), gS(0,-9), gS(1,-9), gS(-12,-11),
           gS(-20,-9), gS(-5,-11), gS(0,-8), gS(0,-10), gS(12,-16), gS(8,-22), gS(5,-24), gS(-39,-11),
           gS(-5,-12), gS(1,-14), gS(1,-9), gS(11,-20), gS(13,-23), gS(12,-22), gS(-8,-11), gS(-3,-26),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-4,0), gS(0,0), gS(-1,3), gS(21,-3), gS(13,0), gS(19,-1), gS(4,0), gS(5,-3),
           gS(-8,-1), gS(12,5), gS(3,2), gS(21,11), gS(16,11), gS(11,4), gS(10,2), gS(-2,-7),
           gS(5,-5), gS(-3,4), gS(8,6), gS(20,7), gS(23,5), gS(8,4), gS(7,0), gS(5,-14),
           gS(2,-15), gS(20,-4), gS(11,-3), gS(11,6), gS(7,10), gS(22,-8), gS(18,-10), gS(7,-12),
           gS(16,-19), gS(11,-24), gS(16,-10), gS(4,0), gS(14,0), gS(15,-6), gS(21,-21), gS(8,-29),
           gS(-3,-32), gS(7,-6), gS(-1,-3), gS(2,0), gS(7,-4), gS(-11,3), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-163,-55), gS(-31,-3), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-81,2), gS(-29,-4), gS(-90,-64),
           gS(-33,-9), gS(-19,0), gS(-2,0), gS(20,6), gS(9,3), gS(26,-12), gS(-12,-2), gS(-20,-16),
           gS(-10,-1), gS(5,3), gS(10,20), gS(28,6), gS(42,1), gS(46,5), gS(11,-1), gS(13,-13),
           gS(4,-1), gS(11,0), gS(17,15), gS(34,17), gS(22,20), gS(37,12), gS(13,1), gS(21,-10),
           gS(0,0), gS(13,5), gS(20,19), gS(24,17), gS(25,21), gS(32,13), gS(24,1), gS(11,0),
           gS(-8,-21), gS(10,-7), gS(10,4), gS(20,16), gS(23,13), gS(22,1), gS(25,-9), gS(2,-11),
           gS(-5,-27), gS(-10,2), gS(4,-5), gS(6,7), gS(12,5), gS(13,-4), gS(0,0), gS(2,-15),
           gS(-40,-30), gS(-14,-16), gS(0,-5), gS(1,2), gS(8,4), gS(-2,-3), gS(-8,-7), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,9), gS(0,18), gS(-8,24), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-14,2), gS(-28,23), gS(-13,25), gS(-27,46), gS(-43,65), gS(-21,32), gS(-14,32), gS(1,10),
           gS(-10,-15), gS(0,0), gS(-4,23), gS(0,35), gS(0,43), gS(3,33), gS(7,12), gS(-6,11),
           gS(-4,-16), gS(-5,9), gS(-4,19), gS(-3,40), gS(-7,53), gS(-2,35), gS(-1,25), gS(4,-4),
           gS(0,-26), gS(-6,0), gS(0,11), gS(-3,38), gS(3,34), gS(-2,10), gS(9,4), gS(-4,-3),
           gS(-4,-32), gS(10,-24), gS(5,-5), gS(3,0), gS(3,0), gS(7,-4), gS(14,-11), gS(3,-27),
           gS(3,-52), gS(10,-57), gS(18,-57), gS(11,-33), gS(13,-29), gS(20,-64), gS(25,-79), gS(0,-44),
           gS(4,-62), gS(6,-69), gS(4,-76), gS(3,-58), gS(6,-63), gS(-4,-75), gS(0,-62), gS(13,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(88,112), gS(514,682), gS(357,376), gS(380,396), gS(1002,1258),
};
