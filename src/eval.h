...
const int  KING_LOW_DANGER   = gS(0,11);   // слабый пешечный щит
...
const int BISHOP_MOBILITY[14] = {
           gS(-19,-105), gS(-7,-46), gS(-2,-19), gS(0,-3), gS(3,11), gS(5,22), gS(4,28),
           gS(3,30), gS(4,32), gS(7,30), gS(13,26), gS(29,17), gS(45,28), gS(77,-6),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-7,-76), gS(1,-31), gS(5,-6), gS(7,8), gS(10,17),
           gS(13,24), gS(17,24), gS(24,16), gS(33,2),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-20,-102), gS(-12,-67), gS(-8,-34), gS(-7,-13), gS(-8,5), gS(-9,19), gS(-4,23),
           gS(0,26), gS(4,31), gS(9,36), gS(11,40), gS(17,42), gS(22,43), gS(37,29),
           gS(88,0),
};

const int QUEEN_MOBILITY[28] = {
           gS(-39,-102), gS(-18,-164), gS(-6,-132), gS(-3,-78), gS(-1,-45), gS(0,-23), gS(1,-4),
           gS(3,7), gS(6,17), gS(8,23), gS(9,30), gS(10,35), gS(10,39), gS(10,45),
           gS(8,51), gS(6,55), gS(5,57), gS(4,57), gS(4,58), gS(9,53), gS(12,48),
...
const int BISHOP_RAMMED_PENALTY = gS(-1,-1);
...
const int KNIGHT_RAMMED_ADJ = gS(0,12);
...
const int KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(47,74), gS(-16,13), gS(-5,-3),
 ...
 */
const int ROOK_OPEN_FILE_BONUS [2] = { gS(23,9), gS(24,10), };

/**
 * @brief Bonuses given to a player for each rook on an open file (opening/endgame)
 */
const int ROOK_SEMI_FILE_BONUS [2] = {  gS(6,9), gS(17,9), };
...
const int PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-11,-30), gS(-16,-15), gS(-8,20),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,-12), gS(-2,5), gS(-24,15), gS(-64,24), gS(-45,19), gS(-46,22), gS(0,2), gS(-3,-21),
           gS(-27,-56), gS(2,-28), gS(-30,-6), gS(-38,-27), gS(-28,-37), gS(-55,-7), gS(-5,-27), gS(-15,-73),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(62,72), gS(50,97), gS(69,93), gS(75,79), gS(81,77), gS(84,81), gS(-8,101), gS(-22,83),
           gS(-3,47), gS(29,53), gS(41,44), gS(44,24), gS(55,25), gS(96,30), gS(64,38), gS(9,33),
           gS(-5,20), gS(5,26), gS(7,22), gS(21,7), gS(30,10), gS(30,14), gS(12,22), gS(-4,8),
           gS(-15,4), gS(-6,13), gS(-4,4), gS(4,3), gS(9,4), gS(4,5), gS(2,5), gS(-15,-5),
           gS(-19,-2), gS(-15,2), gS(-13,6), gS(-11,7), gS(-4,9), gS(-3,9), gS(2,-3), gS(-15,-13),
           gS(-18,0), gS(-12,5), gS(-17,15), gS(-10,16), gS(-14,22), gS(5,17), gS(7,0), gS(-18,-17),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,26), gS(22,32), gS(0,41), gS(7,36), gS(11,36), gS(24,36), gS(40,30), gS(51,27),
           gS(-2,27), gS(-6,32), gS(15,28), gS(26,30), gS(23,31), gS(41,13), gS(6,25), gS(14,21),
           gS(-8,19), gS(32,4), gS(20,16), gS(42,5), gS(53,0), gS(48,8), gS(70,-8), gS(13,11),
           gS(-7,10), gS(9,9), gS(18,11), gS(39,4), gS(32,4), gS(28,4), gS(30,0), gS(11,5),
           gS(-20,-1), gS(-11,10), gS(-13,12), gS(-3,4), gS(-4,3), gS(-8,8), gS(5,5), gS(-11,-2),
           gS(-24,-17), gS(-8,-5), gS(-15,-6), gS(-7,-12), gS(-6,-12), gS(-9,-8), gS(9,-9), gS(-15,-19),
           gS(-53,-11), gS(-16,-19), gS(-10,-14), gS(-3,-19), gS(-2,-20), gS(-1,-23), gS(-2,-24), gS(-55,-11),
           gS(-16,-15), gS(-9,-13), gS(-6,-11), gS(0,-18), gS(0,-18), gS(-2,-8), gS(0,-16), gS(-11,-23),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-51,5), gS(-43,8), gS(-76,17), gS(-79,23), gS(-66,19), gS(-91,16), gS(-15,0), gS(-48,0),
           gS(-48,1), gS(-11,3), gS(-7,8), gS(-15,17), gS(-7,15), gS(0,8), gS(-27,5), gS(-21,-4),
           gS(3,0), gS(4,7), gS(24,3), gS(8,9), gS(24,7), gS(10,8), gS(25,1), gS(16,-2),
           gS(-10,0), gS(19,4), gS(5,5), gS(22,14), gS(19,14), gS(16,3), gS(20,1), gS(-6,0),
           gS(0,-12), gS(6,-2), gS(11,7), gS(18,7), gS(25,7), gS(3,5), gS(13,-1), gS(3,-15),
           gS(0,-17), gS(11,-7), gS(7,-4), gS(14,1), gS(9,3), gS(11,-6), gS(12,-9), gS(14,-11),
           gS(8,-29), gS(9,-33), gS(11,-16), gS(3,-2), gS(8,-4), gS(9,-16), gS(17,-27), gS(4,-40),
           gS(6,-37), gS(2,-15), gS(1,-4), gS(1,-7), gS(0,-3), gS(0,-8), gS(-1,-10), gS(3,-37),
};
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-19,-18), gS(12,-4), gS(32,29), gS(32,30), gS(58,19), gS(45,23), gS(28,-12), gS(4,-16),
           gS(0,-10), gS(8,5), gS(26,27), gS(25,38), gS(17,35), gS(39,22), gS(15,8), gS(8,-7),
           gS(-4,-9), gS(10,8), gS(14,29), gS(21,31), gS(23,33), gS(20,31), gS(24,11), gS(6,0),
           gS(-18,-34), gS(1,-7), gS(5,7), gS(13,22), gS(17,20), gS(13,5), gS(7,-2), gS(-5,-27),
           gS(-21,-17), gS(-28,-2), gS(-7,-13), gS(7,4), gS(2,6), gS(0,-12), gS(-17,-4), gS(-11,-5),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-15,-15), gS(-7,-15), gS(-11,16), gS(-12,43), gS(0,60), gS(9,78), gS(27,48), gS(-1,61),
           gS(-5,-32), gS(-3,0), gS(-9,5), gS(-17,50), gS(-15,66), gS(-10,74), gS(1,59), gS(5,32),
           gS(0,-41), gS(3,-13), gS(-3,-8), gS(-10,28), gS(-6,27), gS(-9,26), gS(10,3), gS(1,7),
           gS(0,-58), gS(10,-42), gS(4,-22), gS(4,-31), gS(3,-29), gS(1,-12), gS(15,-33), gS(4,-47),
           gS(0,-66), gS(7,-63), gS(16,-80), gS(9,-50), gS(14,-54), gS(17,-92), gS(14,-86), gS(-10,-57),
           gS(2,-70), gS(5,-82), gS(7,-88), gS(11,-69), gS(11,-75), gS(6,-90), gS(9,-84), gS(-1,-74),
};
