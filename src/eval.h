...
const int BISHOP_MOBILITY[14] = {
           gS(-23,-103), gS(-11,-44), gS(-5,-18), gS(-2,-2), gS(1,11), gS(2,21), gS(2,28),
           gS(1,31), gS(2,33), gS(5,32), gS(10,29), gS(26,18), gS(44,28), gS(74,-4),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-7,-70), gS(2,-24), gS(5,0), gS(8,14), gS(11,22),
           gS(14,28), gS(19,27), gS(25,19), gS(35,4),
};

const int KING_MOBILITY[9] = {
           gS(9,-2), gS(14,-7), gS(9,1), gS(6,6), gS(0,6),
           gS(-6,3), gS(-4,3), gS(-19,1), gS(-15,-10),
};

const int ROOK_MOBILITY[15] = {
           gS(-23,-102), gS(-15,-66), gS(-10,-32), gS(-8,-12), gS(-9,6), gS(-11,20), gS(-5,23),
           gS(0,26), gS(4,31), gS(9,36), gS(11,40), gS(17,42), gS(21,42), gS(37,29),
           gS(89,0),
};

const int QUEEN_MOBILITY[28] = {
           gS(-43,-107), gS(-21,-173), gS(-8,-132), gS(-5,-75), gS(-3,-42), gS(-1,-21), gS(0,-3),
           gS(2,8), gS(5,17), gS(7,23), gS(8,30), gS(9,34), gS(10,38), gS(9,43),
           gS(8,49), gS(6,53), gS(4,56), gS(4,56), gS(4,57), gS(9,53), gS(12,48),
...
const int PASSER_BLOCKED = gS(0,46);

const int PAWN_DISTORTION = gS(0,0);

const int PAWN_CONNECTED = gS(4,3);

const int PAWN_PUSH_THREAT = gS(2,0);
...
const int KING_ATTACK_PAWN = gS(23,42);
...
const int KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(43,43), gS(-14,18), gS(-3,-1),
           gS(-3,-13), gS(-1,-24), gS(5,-35), gS(15,-42),
           gS(0,-10),
};
...
const int HANGING_PIECE[5] = {
           gS(-2,11), gS(-28,-15), gS(-32,-47), gS(-36,-76), gS(-22,-13),
};
/**
 * @brief Bonuses given to a player for having a passed pawn (opening/endgame)
 */
const int PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-10,-28), gS(-15,-14), gS(-8,21),
           gS(16,55), gS(26,119), gS(72,132), gS(0,0),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(-13,-98), gS(0,-47), gS(0,-33), gS(0,-16), gS(0,-32), gS(0,-27), gS(0,-25), gS(-12,-90),
           gS(-13,-37), gS(0,29), gS(5,22), gS(0,5), gS(0,2), gS(3,18), gS(0,37), gS(-12,-37),
           gS(-2,-6), gS(27,30), gS(33,29), gS(12,19), gS(12,15), gS(35,26), gS(26,29), gS(-7,-13),
           ...
           gS(-52,-13), gS(-9,2), gS(-7,14), gS(-29,31), gS(-17,27), gS(-18,19), gS(-9,4), gS(-48,-11),
           gS(1,-9), gS(-1,6), gS(-22,16), gS(-61,26), gS(-44,21), gS(-43,23), gS(0,4), gS(0,-18),
           gS(-26,-52), gS(1,-24), gS(-29,-3), gS(-32,-23), gS(-22,-36), gS(-54,-3), gS(-5,-24), gS(-15,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(61,72), gS(45,93), gS(64,89), gS(71,76), gS(79,75), gS(83,80), gS(-7,99), gS(-19,84),
           gS(-2,46), gS(23,48), gS(36,40), gS(41,20), gS(51,20), gS(88,29), gS(54,36), gS(10,34),
           gS(-3,19), gS(3,21), gS(4,18), gS(19,2), gS(27,6), gS(27,11), gS(8,18), gS(-2,9),
           gS(-12,3), gS(-8,9), gS(-4,1), gS(2,0), gS(8,1), gS(3,3), gS(0,3), gS(-11,-4),
           gS(-18,-2), gS(-17,0), gS(-14,4), gS(-13,5), gS(-6,8), gS(-6,7), gS(-1,-4), gS(-13,-12),
           gS(-15,0), gS(-12,3), gS(-17,14), gS(-8,14), gS(-14,20), gS(6,16), gS(4,0), gS(-12,-17),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,27), gS(23,33), gS(0,42), gS(8,38), gS(13,37), gS(25,37), gS(41,31), gS(52,27),
           gS(-1,23), gS(-4,27), gS(18,22), gS(29,23), gS(27,24), gS(44,9), gS(10,21), gS(17,18),
           gS(-8,16), gS(31,2), gS(21,13), gS(44,2), gS(54,-3), gS(52,4), gS(70,-10), gS(16,8),
           gS(-8,9), gS(9,7), gS(17,9), gS(38,2), gS(31,2), gS(29,1), gS(29,0), gS(13,2),
           gS(-20,0), gS(-11,11), gS(-13,12), gS(-3,5), gS(-4,5), gS(-7,8), gS(6,5), gS(-9,-3),
           gS(-25,-15), gS(-8,-3), gS(-16,-4), gS(-8,-9), gS(-7,-8), gS(-8,-6), gS(10,-6), gS(-15,-17),
           gS(-56,-9), gS(-18,-16), gS(-11,-10), gS(-5,-15), gS(-4,-15), gS(-2,-19), gS(-2,-20), gS(-53,-9),
           gS(-19,-11), gS(-11,-10), gS(-8,-7), gS(-1,-15), gS(-2,-14), gS(-4,-4), gS(-2,-12), gS(-12,-21),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-51,5), gS(-43,8), gS(-80,17), gS(-81,23), gS(-69,18), gS(-92,15), gS(-15,0), gS(-48,0),
           gS(-49,0), gS(-12,3), gS(-8,7), gS(-14,15), gS(-4,13), gS(0,6), gS(-27,5), gS(-27,-4),
           gS(1,1), gS(0,8), gS(21,3), gS(7,8), gS(23,7), gS(8,9), gS(21,2), gS(14,0),
           gS(-11,0), gS(18,6), gS(4,6), gS(24,12), gS(20,13), gS(15,4), gS(18,3), gS(-5,0),
           gS(-1,-12), gS(5,-1), gS(10,7), gS(18,7), gS(25,6), gS(2,7), gS(13,0), gS(2,-13),
           gS(-3,-16), gS(10,-7), gS(5,-4), gS(12,2), gS(8,4), gS(10,-5), gS(11,-8), gS(12,-10),
           gS(7,-30), gS(7,-32), gS(9,-15), gS(2,-2), gS(6,-3), gS(7,-15), gS(17,-27), gS(4,-42),
           gS(3,-37), gS(1,-15), gS(0,-2), gS(0,-6), gS(-1,-2), gS(-1,-7), gS(-3,-10), gS(1,-38),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-145,-65), gS(-35,-20), gS(-67,11), gS(-14,0), gS(0,1), gS(-55,13), gS(-28,-12), gS(-92,-70),
           gS(-11,-24), gS(-12,-5), gS(31,-3), gS(51,17), gS(39,17), gS(52,-11), gS(-21,-3), gS(-7,-21),
           gS(-18,-18), gS(12,-1), gS(32,30), gS(36,28), gS(61,19), gS(45,25), gS(26,-8), gS(3,-17),
           gS(2,-11), gS(11,4), gS(29,26), gS(30,38), gS(22,32), gS(43,20), gS(20,4), gS(12,-8),
           gS(-4,-8), gS(11,8), gS(16,30), gS(22,32), gS(26,34), gS(21,32), gS(28,12), gS(7,0),
           gS(-21,-33), gS(1,-5), gS(5,10), gS(13,25), gS(17,23), gS(13,8), gS(8,0), gS(-5,-25),
           gS(-22,-16), gS(-28,0), gS(-7,-10), gS(5,7), gS(0,9), gS(-1,-9), gS(-16,-3), gS(-12,-3),
           gS(-41,-46), gS(-15,-26), gS(-12,-17), gS(-9,4), gS(-1,2), gS(-8,-10), gS(-12,-19), gS(-41,-45),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-3,3), gS(0,21), gS(0,35), gS(3,47), gS(9,56), gS(31,48), gS(8,51), gS(15,39),
           gS(-18,-4), gS(-56,35), gS(-17,26), gS(-41,72), gS(-42,107), gS(0,70), gS(-54,72), gS(-18,39),
           gS(-15,-17), gS(-8,-18), gS(-11,14), gS(-10,41), gS(2,60), gS(11,78), gS(30,45), gS(3,60),
           gS(-5,-34), gS(-3,0), gS(-7,1), gS(-14,44), gS(-13,64), gS(-6,70), gS(4,59), gS(8,30),
           gS(-1,-41), gS(3,-13), gS(-2,-9), gS(-9,27), gS(-5,27), gS(-6,25), gS(11,3), gS(3,8),
           gS(-2,-58), gS(9,-42), gS(3,-21), gS(2,-28), gS(2,-27), gS(0,-9), gS(16,-31), gS(5,-46),
           gS(-3,-66), gS(4,-61), gS(13,-76), gS(7,-46), gS(10,-49), gS(15,-87), gS(11,-83), gS(-11,-57),
           gS(-1,-66), gS(2,-78), gS(4,-84), gS(6,-64), gS(8,-71), gS(3,-86), gS(7,-84), gS(-4,-75),
};
