...
const int  BISHOP_MOBILITY[14] = {
           gS(-22,-109), gS(-9,-50), gS(-3,-22), gS(0,-5), gS(4,8), gS(7,21), gS(8,28),
           gS(7,31), gS(9,35), gS(14,33), gS(20,30), gS(38,22), gS(50,34), gS(81,0),
};

const int  KNIGHT_MOBILITY[9] = {
           gS(-8,-76), gS(1,-30), gS(4,-4), gS(7,9), gS(10,18),
           gS(13,25), gS(18,24), gS(24,16), gS(35,1),
};

const int  KING_MOBILITY[9] = {
           gS(12,0), gS(14,0), gS(7,7), gS(2,11), gS(-4,8),
           gS(-8,5), gS(-5,3), gS(-14,-3), gS(-7,-16),
};

const int  ROOK_MOBILITY[15] = {
           gS(-18,-98), gS(-12,-66), gS(-8,-33), gS(-6,-13), gS(-7,5), gS(-8,19), gS(-2,22),
           gS(1,25), gS(6,30), gS(11,34), gS(12,39), gS(17,41), gS(21,41), gS(35,27),
           gS(88,0),
};
...
const int  KING_PASSER_DISTANCE_FRIENDLY[9] = {
           gS(0,0), gS(8,28), gS(-4,24), gS(-9,9),
           gS(-6,-1), gS(-5,-5), gS(9,-9), gS(-1,-19),
           gS(0,-10),
};

const int  KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(41,80), gS(-19,13), gS(-5,-3),
...
const int  HANGING_PIECE[5] = {
           gS(0,0), gS(-27,-18), gS(-24,-52), gS(-30,-70), gS(-18,-11),
};
/**
 * @brief Bonuses given to a player for having a passed pawn (opening/endgame)
 */
const int  PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-13,-27), gS(-17,-14), gS(-8,20),
           gS(16,53), gS(28,115), gS(79,121), gS(0,0),
};

const int  PASSED_PAWN_FILES[8] = {
           gS(12,14), gS(8,16), gS(1,4), gS(0,2),
           gS(-3,0), gS(-16,3), gS(-6,18), gS(12,11),
};
...
const int  KING_PSQT_BLACK[64] = {
           ...
           gS(-3,-4), gS(25,37), gS(29,32), gS(10,19), gS(10,16), gS(30,34), gS(25,39), gS(-7,-9),
           gS(-9,-10), gS(20,20), gS(27,27), gS(0,29), gS(7,25), gS(31,25), gS(30,19), gS(-34,-11),
           gS(-21,-34), gS(22,3), gS(27,17), gS(-15,32), gS(3,28), gS(13,19), gS(25,5), gS(-51,-22),
           gS(-51,-15), gS(-8,3), gS(-7,12), gS(-26,26), gS(-14,23), gS(-15,17), gS(-8,3), gS(-52,-12),
           gS(-1,-11), gS(-3,7), gS(-24,17), gS(-62,25), gS(-44,20), gS(-45,23), gS(-2,5), gS(-4,-20),
           gS(-28,-56), gS(3,-27), gS(-29,-5), gS(-37,-26), gS(-27,-35), gS(-54,-6), gS(-5,-26), gS(-16,-73),
};

const int  PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(63,75), gS(52,96), gS(70,93), gS(75,78), gS(82,77), gS(83,81), gS(-6,100), gS(-21,87),
           gS(-3,46), gS(30,51), gS(43,43), gS(45,24), gS(55,25), gS(99,30), gS(64,36), gS(9,33),
           gS(-5,21), gS(4,26), gS(6,23), gS(21,7), gS(29,11), gS(31,15), gS(12,22), gS(-4,9),
           gS(-15,5), gS(-7,14), gS(-1,6), gS(3,5), gS(8,5), gS(9,7), gS(1,7), gS(-15,-3),
           gS(-20,-1), gS(-14,3), gS(-12,8), gS(-8,8), gS(-1,11), gS(-1,10), gS(3,-2), gS(-15,-10),
           gS(-18,2), gS(-11,6), gS(-17,16), gS(-9,17), gS(-14,22), gS(6,18), gS(8,0), gS(-18,-15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int  ROOK_PSQT_BLACK[64] = {
           gS(28,26), gS(22,31), gS(0,39), gS(6,35), gS(10,35), gS(23,34), gS(38,29), gS(49,26),
           gS(-3,27), gS(-8,32), gS(14,28), gS(23,29), gS(20,30), gS(39,12), gS(5,24), gS(13,20),
           gS(-9,19), gS(33,4), gS(20,16), gS(42,5), gS(52,0), gS(46,7), gS(69,-9), gS(11,11),
           gS(-6,10), gS(11,9), gS(19,11), gS(40,4), gS(33,3), gS(26,4), gS(29,0), gS(10,5),
           gS(-18,0), gS(-10,11), gS(-12,12), gS(-3,5), gS(-4,4), gS(-9,8), gS(4,4), gS(-13,-2),
...
const int  BISHOP_PSQT_BLACK[64] = {
           gS(-42,12), gS(-39,9), gS(-72,11), gS(-77,17), gS(-63,13), gS(-89,10), gS(-13,0), gS(-43,5),
           gS(-47,2), gS(-3,8), gS(-5,8), gS(-20,12), gS(-15,10), gS(0,8), gS(-20,11), gS(-21,-3),
           gS(-1,-4), gS(4,6), gS(29,7), gS(8,8), gS(24,7), gS(16,13), gS(24,0), gS(11,-7),
           gS(-14,-6), gS(14,-2), gS(3,4), gS(21,11), gS(17,11), gS(13,0), gS(14,-6), gS(-10,-5),
           gS(-2,-16), gS(2,-8), gS(9,6), gS(17,4), gS(23,4), gS(4,2), gS(10,-6), gS(0,-18),
           gS(0,-18), gS(12,-5), gS(12,0), gS(16,1), gS(11,2), gS(16,0), gS(14,-7), gS(14,-10),
           gS(13,-24), gS(15,-22), gS(13,-13), gS(4,-6), gS(9,-5), gS(11,-12), gS(24,-12), gS(12,-32),
           gS(15,-26), gS(5,-11), gS(2,-7), gS(0,-11), gS(0,-7), gS(3,-4), gS(2,-6), gS(12,-25),
};
...
const int  KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-20,-19), gS(10,-5), gS(30,28), gS(29,29), gS(56,19), gS(45,22), gS(28,-12), gS(3,-16),
           gS(-1,-11), gS(6,4), gS(24,26), gS(23,37), gS(11,35), gS(36,21), gS(14,7), gS(7,-8),
           gS(-5,-10), gS(9,7), gS(12,28), gS(15,30), gS(18,34), gS(18,31), gS(24,11), gS(6,-1),
           gS(-18,-34), gS(0,-7), gS(4,8), gS(14,22), gS(18,20), gS(11,6), gS(5,-1), gS(-6,-25),
           gS(-20,-16), gS(-25,0), gS(-6,-12), gS(7,3), gS(3,7), gS(0,-10), gS(-13,0), gS(-8,-2),
           gS(-37,-44), gS(-11,-28), gS(-9,-19), gS(-7,0), gS(0,-1), gS(-5,-8), gS(-9,-19), gS(-37,-42),
};

const int  QUEEN_PSQT_BLACK[64] = {
           gS(-5,3), gS(0,19), gS(0,32), gS(5,41), gS(11,50), gS(31,46), gS(10,46), gS(15,33),
           gS(-18,-1), gS(-57,40), gS(-17,29), gS(-41,71), gS(-50,110), gS(-1,69), gS(-55,67), gS(-19,39),
           gS(-15,-15), gS(-7,-15), gS(-11,16), gS(-14,43), gS(0,60), gS(7,77), gS(24,48), gS(-7,60),
           gS(-4,-31), gS(-2,1), gS(-10,6), gS(-16,49), gS(-15,66), gS(-14,73), gS(-1,59), gS(1,32),
           gS(1,-41), gS(3,-13), gS(-3,-8), gS(-9,28), gS(-5,27), gS(-12,26), gS(9,3), gS(-1,7),
           gS(0,-58), gS(11,-42), gS(5,-22), gS(4,-31), gS(3,-28), gS(0,-13), gS(15,-33), gS(3,-46),
           gS(1,-66), gS(8,-63), gS(17,-79), gS(10,-49), gS(15,-53), gS(17,-92), gS(15,-84), gS(-11,-55),
           gS(3,-70), gS(7,-82), gS(8,-88), gS(13,-69), gS(13,-74), gS(7,-89), gS(9,-82), gS(-1,-72),
};
