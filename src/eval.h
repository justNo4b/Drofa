...
const int KING_HIGH_DANGER = gS(-50,-60);
...
const int KING_OPEN_FILE = gS(-56,8);
...
const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-8,-8), gS(-4,7), gS(0,44),
           gS(16,54), gS(25,77), gS(54,86),
};

const int PASSED_PAWN_FILES[8] = {
           gS(1,23), gS(0,13), gS(2,4), gS(2,-9),
...
const int PASSED_PASSED_DISTANCE[8] = {
           gS(-7,-22), gS(17,3), gS(1,-19), gS(-8,-7),
           gS(-11,-8), gS(-20,-9), gS(-19,-12), gS(-17,-10),
};
...
const int KING_PASSER_DISTANCE_ENEMY[8] = {
           gS(0,0), gS(-45,-1), gS(10,-18), gS(0,0),
           gS(2,11), gS(-2,21), gS(1,23), gS(-8,22),
};
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-66,-40), gS(-50,-46), gS(-53,-66), gS(-49,-26),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(16,30), gS(15,35), gS(13,28),
};
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(63,31), gS(40,15), gS(43,26),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-5,2), gS(4,10), gS(4,10), gS(-1,13),
           gS(-8,5), gS(-19,-4), gS(-6,10), gS(0,0),
};
...
const int PINNED_BY_BISHOP[5] = {
           gS(0,0), gS(-13,-8), gS(-36,-27), gS(0,0), gS(-2,0),
};

const int PINNED_BY_ROOK[5] = {
           gS(0,0), gS(0,0), gS(-16,-16), gS(-18,-20), gS(-5,-3),
};

const int PINNED_BY_QUEEN[5] = {
           gS(0,0), gS(-17,-6), gS(-22,-6), gS(-7,-7), gS(-3,-1),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-8,-66), gS(1,-26), gS(8,-13), gS(14,-2), gS(16,7), gS(17,10), gS(17,13),
           gS(17,12), gS(16,14), gS(17,12), gS(19,10), gS(34,0), gS(35,15), gS(63,-9),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-3,-91), gS(9,-34), gS(15,-7), gS(21,3), gS(26,11),
           gS(29,16), gS(34,14), gS(38,8), gS(41,0),
};

const int KING_MOBILITY[9] = {
           gS(15,-18), gS(6,-4), gS(1,3), gS(-1,9), gS(-5,7),
           gS(-9,6), gS(-1,4), gS(-3,0), gS(5,-17),
};

const int ROOK_MOBILITY[15] = {
           gS(-25,-86), gS(-12,-48), gS(-6,-30), gS(2,-17), gS(4,-5), gS(2,7), gS(7,8),
           gS(9,9), gS(13,13), gS(15,17), gS(17,22), gS(19,24), gS(23,22), gS(30,21),
           gS(54,12),
};

const int QUEEN_MOBILITY[28] = {
           gS(-12,-114), gS(-7,-166), gS(-6,-111), gS(-5,-68), gS(-4,-47), gS(-3,-30), gS(-2,-15),
           gS(-1,-2), gS(0,10), gS(0,21), gS(1,27), gS(2,32), gS(2,36), gS(3,38),
           gS(2,41), gS(2,43), gS(2,45), gS(6,41), gS(8,39), gS(11,38), gS(13,32),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-27,-23), gS(9,-4), gS(-15,10), gS(-36,22), gS(-31,21), gS(-26,12), gS(-3,-3), gS(-18,-22),
           gS(0,-27), gS(-4,-5), gS(-1,1), gS(-20,11), gS(-22,11), gS(-2,2), gS(-7,-4), gS(-1,-29),
           gS(-20,-54), gS(2,-37), gS(-17,-16), gS(-34,-15), gS(11,-46), gS(-14,-25), gS(1,-35), gS(-4,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(54,69), gS(40,80), gS(42,68), gS(66,59), gS(66,63), gS(56,64), gS(-1,86), gS(0,76),
           gS(3,34), gS(10,35), gS(26,22), gS(48,10), gS(49,11), gS(74,15), gS(32,28), gS(28,20),
           gS(-8,14), gS(1,14), gS(12,3), gS(20,7), gS(27,5), gS(27,2), gS(24,4), gS(0,6),
           gS(-20,0), gS(-17,7), gS(-6,0), gS(12,1), gS(12,0), gS(12,-2), gS(0,-2), gS(-14,-6),
           gS(-23,-5), gS(-19,-2), gS(-4,-4), gS(-3,2), gS(2,2), gS(3,-2), gS(0,-9), gS(-17,-12),
           gS(-27,4), gS(-13,4), gS(-13,9), gS(0,10), gS(-1,12), gS(5,6), gS(0,0), gS(-17,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-1,7), gS(-2,8), gS(-3,5), gS(-1,0), gS(0,1), gS(-2,2), gS(-1,12), gS(-1,9),
           gS(-3,-3), gS(-3,0), gS(-6,-6), gS(0,-17), gS(-1,-12), gS(-4,-5), gS(-8,0), gS(-2,0),
           gS(-1,-10), gS(-3,-7), gS(0,-12), gS(0,-22), gS(0,-17), gS(-1,-6), gS(-5,-1), gS(0,0),
           gS(0,-20), gS(-4,-5), gS(-5,-9), gS(-4,0), gS(-6,-6), gS(-6,1), gS(0,-5), gS(0,-19),
           gS(0,-29), gS(-2,-15), gS(-4,-3), gS(-8,0), gS(-6,1), gS(0,-2), gS(1,-6), gS(0,-36),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-1,6), gS(-3,7), gS(-3,5), gS(-1,0), gS(0,1), gS(-2,0), gS(0,10), gS(-2,5),
           gS(0,-3), gS(0,0), gS(-2,-3), gS(1,-17), gS(0,-13), gS(-1,-7), gS(-9,-4), gS(-2,0),
           gS(0,4), gS(0,-1), gS(2,-6), gS(0,-12), gS(0,-10), gS(0,-8), gS(-1,-1), gS(0,-5),
           gS(3,-1), gS(0,4), gS(0,1), gS(-3,3), gS(-2,3), gS(-2,6), gS(3,-5), gS(5,-2),
           gS(4,13), gS(0,8), gS(0,17), gS(-2,13), gS(-3,12), gS(4,17), gS(4,10), gS(6,4),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(25,12), gS(15,21), gS(0,28), gS(0,21), gS(7,20), gS(16,20), gS(29,16), gS(38,13),
           gS(6,15), gS(0,16), gS(17,12), gS(33,4), gS(26,6), gS(32,2), gS(-2,13), gS(11,10),
           gS(4,17), gS(20,9), gS(18,11), gS(28,1), gS(43,-4), gS(40,-3), gS(32,0), gS(-1,12),
           gS(1,14), gS(0,14), gS(17,9), gS(21,2), gS(20,0), gS(21,-1), gS(7,2), gS(0,4),
           gS(-13,9), gS(-11,14), gS(-1,10), gS(-1,6), gS(0,4), gS(-2,1), gS(-5,6), gS(-19,5),
           gS(-16,0), gS(-8,0), gS(-4,0), gS(-3,-2), gS(-3,-2), gS(0,-9), gS(2,-8), gS(-12,-10),
           gS(-20,-8), gS(-4,-10), gS(0,-7), gS(0,-10), gS(11,-15), gS(9,-22), gS(6,-23), gS(-39,-10),
           gS(-4,-9), gS(2,-12), gS(3,-8), gS(11,-19), gS(14,-23), gS(14,-21), gS(-7,-10), gS(-3,-23),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-33,0), gS(-43,-1), gS(-74,16), gS(-81,18), gS(-60,18), gS(-91,13), gS(-21,-6), gS(-27,-12),
           gS(-37,0), gS(-17,0), gS(-10,0), gS(-12,12), gS(-10,8), gS(-8,2), gS(-26,-4), gS(-22,-6),
           gS(-4,0), gS(0,3), gS(0,4), gS(19,-1), gS(19,0), gS(5,0), gS(4,0), gS(12,-5),
           gS(-9,-1), gS(5,6), gS(1,3), gS(22,7), gS(15,9), gS(13,2), gS(9,0), gS(-1,-10),
           gS(6,-6), gS(-1,3), gS(9,3), gS(20,6), gS(23,3), gS(7,3), gS(9,0), gS(9,-17),
           gS(4,-16), gS(22,-7), gS(11,-4), gS(12,5), gS(7,10), gS(22,-8), gS(19,-10), gS(10,-12),
           gS(18,-22), gS(13,-25), gS(18,-11), gS(6,0), gS(16,0), gS(16,-6), gS(23,-22), gS(9,-31),
           gS(-1,-33), gS(9,-9), gS(0,-2), gS(4,-1), gS(8,-4), gS(-9,4), gS(0,-8), gS(0,-25),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-151,-63), gS(-31,-9), gS(-76,8), gS(-13,-2), gS(0,0), gS(-70,2), gS(-29,-5), gS(-89,-64),
           gS(-27,-10), gS(-12,2), gS(3,0), gS(29,8), gS(16,5), gS(34,-9), gS(-10,0), gS(-11,-17),
           gS(-10,-2), gS(15,1), gS(17,20), gS(28,10), gS(50,2), gS(37,6), gS(13,-3), gS(11,-13),
           gS(8,-2), gS(7,1), gS(15,15), gS(30,17), gS(18,16), gS(34,9), gS(9,-6), gS(22,-11),
           gS(1,2), gS(13,5), gS(17,21), gS(24,17), gS(25,22), gS(29,13), gS(25,1), gS(12,0),
           gS(-7,-18), gS(11,-5), gS(10,8), gS(22,20), gS(24,17), gS(22,4), gS(26,-7), gS(3,-8),
           gS(-7,-24), gS(-10,4), gS(3,-5), gS(7,9), gS(13,7), gS(13,-3), gS(1,3), gS(1,-14),
           gS(-40,-36), gS(-13,-15), gS(-1,-6), gS(1,1), gS(8,3), gS(-3,-4), gS(-7,-6), gS(-23,-33),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,11), gS(-3,19), gS(-4,29), gS(-7,35), gS(6,20), gS(-8,25), gS(-11,18),
           gS(-13,0), gS(-28,25), gS(-12,24), gS(-30,55), gS(-44,76), gS(-22,43), gS(-17,49), gS(1,19),
           gS(-9,-15), gS(0,-1), gS(-4,22), gS(1,39), gS(-3,49), gS(0,47), gS(4,20), gS(-9,24),
           gS(-3,-20), gS(-9,6), gS(-4,16), gS(-5,40), gS(-11,55), gS(-8,45), gS(-7,34), gS(1,0),
           gS(0,-29), gS(-5,0), gS(-1,7), gS(-3,37), gS(2,32), gS(-5,13), gS(8,4), gS(-5,-1),
           gS(-1,-40), gS(11,-27), gS(7,-7), gS(6,-2), gS(4,-1), gS(9,-7), gS(15,-11), gS(5,-29),
           gS(5,-57), gS(11,-56), gS(21,-61), gS(14,-36), gS(16,-33), gS(22,-67), gS(26,-80), gS(1,-48),
           gS(4,-62), gS(8,-72), gS(7,-75), gS(7,-60), gS(9,-64), gS(-4,-77), gS(0,-74), gS(9,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(83,113), gS(498,687), gS(350,381), gS(371,403), gS(993,1285),
};
