...
const int KING_MED_DANGER = gS(-24,-41);
...
const int BISHOP_FORWARD_PAWNS_SCAN = gS(-4,1);

const int BISHOP_CENTER_CONTROL = gS(8,8);
...
const int PASSED_PAWN_RANKS[7] = {
           ...
           gS(15,53), gS(27,79), gS(52,87),
};

const int PASSED_PAWN_FILES[4] = {
           gS(0,19), gS(-3,13), gS(0,5), gS(-1,-4),
};
...
const int HANGING_PIECE[5] = {
           gS(0,18), gS(-66,-41), gS(-50,-47), gS(-53,-66), gS(-49,-30),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,33), gS(16,35), gS(15,31),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-7,2), gS(7,10), gS(0,12), gS(0,6),
           gS(-8,5), gS(-22,0), gS(-5,17), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(7,0), gS(15,23), gS(14,2), gS(25,6),
...
const int BISHOP_MOBILITY[14] = {
           gS(-6,-62), gS(3,-23), gS(10,-11), gS(15,-1), gS(17,7), gS(18,9), gS(17,12),
           gS(16,11), gS(15,12), gS(15,10), gS(16,8), gS(28,0), gS(30,10), gS(53,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-33), gS(17,-6), gS(22,2), gS(26,9),
           gS(29,13), gS(32,10), gS(36,3), gS(39,-5),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-27,-85), gS(-14,-48), gS(-7,-30), gS(0,-18), gS(3,-6), gS(1,6), gS(6,7),
           gS(8,7), gS(11,12), gS(14,15), gS(15,20), gS(18,22), gS(22,20), gS(27,19),
           gS(50,9),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(4,24), gS(10,13), gS(-35,-15),
           gS(-13,-24), gS(2,0), gS(-3,16), gS(-14,25), gS(-14,23), gS(-21,18), gS(-1,1), gS(-43,-19),
           gS(-15,-27), gS(11,-6), gS(-12,8), gS(-30,19), gS(-25,18), gS(-22,9), gS(0,-5), gS(-7,-26),
...
const int PAWN_PSQT_BLACK[64] = {
           ...
           gS(0,31), gS(8,29), gS(25,12), gS(42,0), gS(42,0), gS(69,4), gS(25,23), gS(26,13),
           gS(-11,16), gS(2,12), gS(6,1), gS(14,0), gS(20,-1), gS(19,0), gS(24,1), gS(-3,5),
           gS(-23,4), gS(-21,13), gS(-7,0), gS(10,-2), gS(9,-4), gS(9,-3), gS(-4,2), gS(-16,-5),
           gS(-24,-1), gS(-17,0), gS(-6,-3), gS(-4,0), gS(0,0), gS(0,-2), gS(-1,-7), gS(-19,-10),
           gS(-35,6), gS(-16,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,5), gS(-4,0), gS(-25,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-7,17), gS(-9,7), gS(-2,0), gS(-2,2), gS(-6,4), gS(-4,20), gS(-4,13),
           gS(-3,-4), gS(-4,-1), gS(-11,-8), gS(0,-19), gS(-2,-13), gS(-6,-4), gS(-7,0), gS(-4,0),
           gS(0,-17), gS(-3,-8), gS(1,-13), gS(0,-25), gS(0,-22), gS(0,-6), gS(-6,0), gS(0,0),
           gS(0,-26), gS(-4,-5), gS(-7,-9), gS(-5,0), gS(-6,-8), gS(-7,0), gS(1,-6), gS(0,-26),
           gS(0,-42), gS(-1,-20), gS(-5,-7), gS(-12,0), gS(-8,0), gS(1,-2), gS(1,-9), gS(0,-48),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,-3), gS(-1,0), gS(-2,0), gS(0,-17), gS(-1,-14), gS(-2,-8), gS(-10,-3), gS(0,0),
           gS(0,11), gS(0,1), gS(1,-5), gS(0,-9), gS(0,-7), gS(0,-8), gS(0,0), gS(0,-1),
           gS(3,1), gS(0,5), gS(0,3), gS(-4,3), gS(-2,5), gS(-2,9), gS(4,-4), gS(7,1),
           gS(5,26), gS(0,15), gS(-1,23), gS(-1,18), gS(-4,16), gS(4,19), gS(5,14), gS(10,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,1), gS(0,3), gS(24,-3), gS(15,0), gS(21,0), gS(6,0), gS(8,-5),
           gS(-7,-2), gS(8,5), gS(3,2), gS(21,9), gS(15,10), gS(11,4), gS(7,0), gS(-2,-10),
           gS(5,-6), gS(-2,3), gS(9,4), gS(19,7), gS(23,5), gS(6,3), gS(7,0), gS(5,-17),
           gS(4,-16), gS(20,-5), gS(11,-2), gS(12,6), gS(7,11), gS(22,-7), gS(18,-10), gS(9,-13),
           gS(16,-21), gS(12,-24), gS(16,-9), gS(5,0), gS(14,0), gS(15,-5), gS(21,-20), gS(8,-30),
           gS(-2,-32), gS(8,-7), gS(-1,-3), gS(2,0), gS(7,-4), gS(-12,4), gS(0,-8), gS(0,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-159,-58), gS(-31,-4), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-80,2), gS(-29,-5), gS(-89,-64),
           gS(-32,-9), gS(-17,0), gS(-1,0), gS(20,5), gS(9,3), gS(28,-12), gS(-11,-1), gS(-17,-16),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-13,1), gS(-27,25), gS(-13,25), gS(-29,47), gS(-47,66), gS(-24,33), gS(-16,37), gS(1,12),
           ...
           gS(-2,-32), gS(10,-23), gS(6,-6), gS(4,0), gS(4,0), gS(8,-5), gS(14,-11), gS(5,-27),
...
const int MATERIAL_VALUES[5] = {
           gS(87,112), gS(508,682), gS(354,376), gS(378,396), gS(1003,1263),
};
