...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(0,32), gS(1,35), gS(4,34), gS(11,31), gS(27,21), gS(45,30), gS(75,-1),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-22,-104), gS(-14,-68), gS(-9,-33), gS(-7,-12), gS(-8,6), gS(-10,19), gS(-4,22),
           gS(0,26), gS(4,30), gS(9,36), gS(11,40), gS(17,42), gS(22,42), gS(37,30),
           gS(89,2),
};

const int QUEEN_MOBILITY[28] = {
           gS(-44,-112), gS(-21,-180), gS(-9,-133), gS(-6,-76), gS(-4,-43), gS(-2,-21), gS(0,-3),
           gS(1,8), gS(3,17), gS(5,23), gS(6,30), gS(8,34), gS(8,38), gS(7,43),
           gS(6,49), gS(4,53), gS(3,56), gS(2,56), gS(2,56), gS(8,52), gS(12,47),
...
const int KING_ATTACK_PAWN = gS(30,42);

const int KING_PASSER_DISTANCE_FRIENDLY[9] = {
           gS(0,0), gS(3,35), gS(-2,27), gS(-5,12),
           gS(-3,0), gS(-2,-4), gS(11,-8), gS(0,-18),
           gS(0,-10),
};

const int KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(38,44), gS(-12,18), gS(-1,-1),
           gS(-1,-13), gS(0,-24), gS(6,-35), gS(15,-42),
           gS(0,-10),
};
...
const int ROOK_ATTACKED_BY[5] = {
           gS(0,0), gS(-3,0), gS(24,15), gS(22,12), gS(-2,5),
};

const int QUEEN_ATTACKED_BY[5] = {
           gS(0,0), gS(13,4), gS(16,14), gS(16,10), gS(-2,3),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(0,-10), gS(0,15), gS(9,17), gS(-7,25),
           gS(0,8), gS(-2,-30), gS(6,-1), gS(3,4),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,6), gS(-7,20), gS(19,7), gS(0,16),
           gS(10,5), gS(-4,-5), gS(-10,5), gS(5,0),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-22,-33), gS(23,0), gS(26,19), gS(-14,37), gS(0,32), gS(6,21), gS(27,2), gS(-49,-23),
           gS(-48,-12), gS(-4,3), gS(-4,14), gS(-27,32), gS(-14,27), gS(-13,19), gS(0,2), gS(-35,-12),
           gS(-11,-8), gS(-21,11), gS(-16,16), gS(-55,26), gS(-37,20), gS(-35,22), gS(-20,8), gS(-18,-16),
           gS(-27,-55), gS(0,-25), gS(-31,-3), gS(-25,-23), gS(-16,-34), gS(-44,-3), gS(-3,-25), gS(-15,-70),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(62,74), gS(43,89), gS(62,87), gS(69,73), gS(79,72), gS(82,77), gS(-5,95), gS(-15,87),
           gS(-1,46), gS(22,43), gS(36,36), gS(40,15), gS(50,16), gS(88,25), gS(53,32), gS(12,34),
           gS(-1,20), gS(3,18), gS(5,15), gS(20,0), gS(28,4), gS(28,9), gS(9,15), gS(1,9),
           gS(-10,4), gS(-7,7), gS(-3,0), gS(3,0), gS(9,0), gS(4,2), gS(1,1), gS(-8,-4),
           gS(-16,-1), gS(-17,0), gS(-13,3), gS(-12,4), gS(-5,7), gS(-5,7), gS(-4,-5), gS(-13,-11),
           gS(-14,2), gS(-12,2), gS(-16,14), gS(-7,14), gS(-14,20), gS(6,15), gS(4,-1), gS(-10,-15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(27,25), gS(22,31), gS(0,40), gS(8,35), gS(13,35), gS(25,36), gS(41,30), gS(52,26),
           gS(-3,23), gS(-5,26), gS(16,21), gS(29,21), gS(27,22), gS(45,7), gS(11,20), gS(16,17),
           ...
           gS(-20,0), gS(-12,11), gS(-14,13), gS(-3,5), gS(-4,5), gS(-7,8), gS(5,5), gS(-8,-3),
           gS(-24,-14), gS(-7,-3), gS(-15,-3), gS(-7,-8), gS(-7,-7), gS(-8,-6), gS(9,-6), gS(-14,-17),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-50,1), gS(-21,6), gS(-10,7), gS(-15,14), gS(-8,11), gS(0,6), gS(-30,5), gS(-26,-3),
           gS(1,1), gS(0,8), gS(16,4), gS(4,8), gS(22,7), gS(4,9), gS(21,2), gS(14,0),
           gS(-12,0), gS(14,4), gS(2,5), gS(22,12), gS(18,13), gS(14,3), gS(16,2), gS(-4,0),
           gS(-2,-12), gS(3,-1), gS(11,6), gS(16,7), gS(24,6), gS(2,5), gS(10,0), gS(0,-12),
           ...
           gS(6,-36), gS(2,-14), gS(1,-1), gS(0,-5), gS(0,-1), gS(0,-5), gS(-1,-9), gS(3,-38),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-145,-64), gS(-36,-20), gS(-68,11), gS(-14,0), gS(0,1), gS(-56,13), gS(-29,-12), gS(-95,-70),
           gS(-15,-25), gS(-14,-7), gS(23,-4), gS(47,16), gS(38,17), gS(50,-12), gS(-21,-3), gS(-9,-22),
           gS(-17,-19), gS(6,-1), gS(30,30), gS(32,28), gS(55,18), gS(44,25), gS(24,-8), gS(4,-17),
           gS(3,-11), gS(11,3), gS(29,27), gS(30,39), gS(22,32), gS(42,20), gS(21,3), gS(13,-9),
           gS(-4,-9), gS(10,9), gS(16,31), gS(22,34), gS(27,36), gS(21,32), gS(27,11), gS(7,0),
           gS(-18,-33), gS(1,-5), gS(6,11), gS(14,26), gS(18,24), gS(14,8), gS(7,0), gS(-4,-25),
           gS(-21,-16), gS(-27,0), gS(-6,-8), gS(7,9), gS(2,11), gS(0,-6), gS(-15,-1), gS(-11,-3),
           gS(-40,-46), gS(-13,-27), gS(-11,-16), gS(-8,5), gS(0,3), gS(-8,-9), gS(-10,-20), gS(-41,-45),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-2,3), gS(0,21), gS(0,38), gS(4,51), gS(11,61), gS(31,49), gS(4,48), gS(13,35),
           gS(-18,-7), gS(-55,31), gS(-17,22), gS(-41,69), gS(-39,103), gS(0,70), gS(-54,68), gS(-19,34),
           gS(-15,-19), gS(-8,-19), gS(-11,12), gS(-10,40), gS(2,60), gS(13,77), gS(33,41), gS(5,56),
           gS(-5,-33), gS(-3,0), gS(-7,1), gS(-15,45), gS(-14,65), gS(-7,70), gS(4,57), gS(8,28),
           gS(-2,-41), gS(2,-13), gS(-3,-9), gS(-10,28), gS(-6,27), gS(-6,25), gS(10,3), gS(2,8),
           gS(-2,-58), gS(8,-41), gS(2,-19), gS(1,-26), gS(1,-25), gS(0,-9), gS(14,-30), gS(4,-44),
           gS(-3,-66), gS(3,-58), gS(12,-74), gS(6,-43), gS(10,-47), gS(13,-84), gS(10,-81), gS(-12,-57),
           gS(-1,-66), gS(1,-78), gS(3,-81), gS(7,-64), gS(7,-70), gS(2,-85), gS(6,-84), gS(-3,-75),
};
