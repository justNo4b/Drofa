...
const int KNIGHT_POS_PROUTPOST_JUMP = gS(8,8);

const int KNIGHT_POS_GENOUTPOST_JUMP = gS(6,9);

const int KNIGHT_PROT_OUTPOST_ADJ = gS(0,6);

const int KNIGHT_GEN_OUTPOST_ADJ = gS(0,3);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           ...
           gS(5,31), gS(14,45), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(16,12), gS(-4,8), gS(0,0), gS(-7,-3),
};
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-66,-41), gS(-51,-45), gS(-54,-66), gS(-49,-30),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(16,34), gS(16,35), gS(15,31),
};

const int ROOK_ATTACKED_BY[4] = {
           gS(0,0), gS(-2,19), gS(65,20), gS(43,41),
};

const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(62,35), gS(40,19), gS(42,40),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-7,2), gS(6,10), gS(0,11), gS(0,5),
           gS(-8,5), gS(-21,0), gS(-6,16), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(7,0), gS(14,21), gS(14,0), gS(24,5),
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-64), gS(4,-25), gS(11,-13), gS(16,-2), gS(18,6), gS(18,10), gS(17,13),
           gS(16,12), gS(15,13), gS(14,12), gS(16,9), gS(28,0), gS(30,10), gS(52,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-34), gS(17,-8), gS(22,1), gS(26,9),
           gS(29,13), gS(33,10), gS(36,4), gS(39,-4),
};
...
const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-5,-156), gS(-5,-111), gS(-4,-72), gS(-4,-51), gS(-3,-33), gS(-2,-16),
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-93), gS(0,-29), gS(0,-12), gS(0,-7), gS(0,-18), gS(0,-22), gS(0,-13), gS(0,-94),
           gS(0,-16), gS(0,33), gS(5,33), gS(0,32), gS(1,15), gS(0,34), gS(0,31), gS(-4,-22),
           gS(0,-2), gS(27,24), gS(15,35), gS(0,38), gS(0,39), gS(20,35), gS(11,28), gS(0,-3),
           gS(-1,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,32), gS(3,24), gS(9,13), gS(-35,-15),
           gS(-13,-24), gS(1,0), gS(-3,15), gS(-15,24), gS(-14,23), gS(-21,17), gS(-1,1), gS(-43,-19),
           gS(-14,-29), gS(11,-6), gS(-12,7), gS(-30,18), gS(-25,17), gS(-22,8), gS(0,-5), gS(-6,-27),
           gS(3,-29), gS(-1,-7), gS(-3,0), gS(-22,9), gS(-23,10), gS(-2,1), gS(-3,-6), gS(4,-32),
           gS(-15,-55), gS(5,-38), gS(-14,-17), gS(-35,-15), gS(9,-44), gS(-14,-25), gS(5,-35), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(52,69), gS(40,77), gS(37,66), gS(65,52), gS(62,58), gS(46,62), gS(0,83), gS(0,70),
           gS(0,31), gS(7,29), gS(25,11), gS(41,-1), gS(41,0), gS(69,3), gS(25,22), gS(25,12),
           gS(-12,16), gS(1,11), gS(5,0), gS(13,-1), gS(19,-1), gS(18,-1), gS(23,0), gS(-4,4),
           gS(-24,4), gS(-21,12), gS(-8,0), gS(9,-3), gS(9,-4), gS(8,-3), gS(-5,1), gS(-17,-5),
           gS(-25,-2), gS(-18,0), gS(-6,-4), gS(-4,0), gS(0,-1), gS(0,-2), gS(-2,-7), gS(-19,-11),
           gS(-35,6), gS(-17,6), gS(-14,7), gS(0,6), gS(0,9), gS(1,4), gS(-4,0), gS(-26,-6),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-7,18), gS(-8,7), gS(-1,0), gS(-1,2), gS(-6,4), gS(-4,21), gS(-4,13),
           gS(-3,-4), gS(-3,-1), gS(-10,-8), gS(0,-19), gS(-1,-13), gS(-6,-4), gS(-7,0), gS(-3,0),
           gS(0,-16), gS(-3,-9), gS(1,-13), gS(0,-26), gS(0,-23), gS(0,-6), gS(-6,0), gS(0,0),
           gS(0,-27), gS(-3,-4), gS(-7,-8), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-27),
           gS(0,-42), gS(-1,-21), gS(-5,-8), gS(-12,0), gS(-7,0), gS(0,-2), gS(0,-10), gS(0,-48),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,9), gS(-8,11), gS(-8,11), gS(-2,0), gS(-1,1), gS(-6,1), gS(-2,20), gS(-4,7),
           gS(0,-1), gS(0,0), gS(-1,0), gS(1,-16), gS(0,-14), gS(0,-8), gS(-9,-2), gS(0,0),
           gS(0,12), gS(0,1), gS(2,-5), gS(0,-8), gS(0,-7), gS(0,-7), gS(0,0), gS(0,0),
           gS(3,2), gS(0,6), gS(-1,3), gS(-4,3), gS(-2,5), gS(-2,9), gS(4,-4), gS(7,1),
           gS(4,27), gS(0,16), gS(-1,23), gS(-2,19), gS(-4,15), gS(3,19), gS(5,14), gS(9,16),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,12), gS(15,21), gS(0,27), gS(0,21), gS(5,20), gS(12,20), gS(27,16), gS(37,14),
           gS(7,15), gS(0,16), gS(17,12), gS(35,4), gS(26,6), gS(28,4), gS(-5,15), gS(10,10),
           gS(3,17), gS(20,9), gS(19,10), gS(27,1), gS(43,-3), gS(36,-1), gS(29,1), gS(-3,12),
           gS(0,13), gS(0,13), gS(18,8), gS(21,1), gS(20,0), gS(20,-1), gS(6,2), gS(0,3),
           gS(-13,7), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-2,1), gS(-5,5), gS(-19,4),
           gS(-16,-1), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(0,-9), gS(-13,-11),
           gS(-21,-10), gS(-4,-11), gS(0,-8), gS(0,-10), gS(12,-16), gS(8,-22), gS(5,-23), gS(-40,-11),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,1), gS(0,3), gS(24,-3), gS(16,0), gS(21,0), gS(6,0), gS(7,-3),
           gS(-7,-1), gS(9,6), gS(3,2), gS(21,10), gS(16,11), gS(11,4), gS(7,2), gS(-2,-8),
...
const int KNIGHT_PSQT_BLACK[64] = {
           gS(-160,-57), gS(-31,-3), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-79,2), gS(-29,-4), gS(-89,-64),
           gS(-32,-9), gS(-18,0), gS(-1,0), gS(21,5), gS(9,3), gS(27,-12), gS(-11,-1), gS(-18,-16),
           gS(-10,-1), gS(7,2), gS(11,18), gS(29,5), gS(42,0), gS(46,3), gS(13,-2), gS(13,-13),
           gS(5,-1), gS(7,0), gS(15,13), gS(31,16), gS(19,18), gS(35,11), gS(10,0), gS(21,-11),
           gS(1,0), gS(13,5), gS(18,19), gS(23,17), gS(23,21), gS(29,12), gS(24,1), gS(11,-1),
           gS(-6,-21), gS(11,-6), gS(10,6), gS(21,16), gS(24,14), gS(22,2), gS(26,-8), gS(4,-10),
           gS(-5,-26), gS(-10,3), gS(5,-3), gS(7,9), gS(13,6), gS(13,-2), gS(1,1), gS(4,-15),
           gS(-40,-30), gS(-12,-16), gS(0,-5), gS(1,2), gS(9,4), gS(-1,-3), gS(-6,-6), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,10), gS(-4,19), gS(-9,24), gS(0,9), gS(-9,16), gS(-12,15),
           gS(-13,1), gS(-27,24), gS(-13,25), gS(-29,46), gS(-46,66), gS(-24,32), gS(-16,36), gS(1,10),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,44), gS(0,35), gS(6,13), gS(-9,13),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,53), gS(-6,35), gS(-5,25), gS(2,-3),
           gS(2,-26), gS(-6,0), gS(-1,11), gS(-2,38), gS(3,34), gS(-5,10), gS(8,4), gS(-5,-2),
           gS(-2,-32), gS(11,-23), gS(7,-5), gS(4,0), gS(4,0), gS(8,-5), gS(15,-11), gS(4,-26),
           gS(5,-51), gS(13,-57), gS(21,-57), gS(13,-32), gS(15,-29), gS(22,-64), gS(26,-78), gS(1,-44),
           gS(6,-62), gS(9,-68), gS(7,-75), gS(5,-56), gS(9,-63), gS(-3,-75), gS(0,-64), gS(12,-69),
};
/**
 * @brief Array indexed by [PieceType] of material values (in centipawns)
 */
const int MATERIAL_VALUES[5] = {
           gS(88,113), gS(514,681), gS(356,376), gS(379,396), gS(1002,1261),
};
