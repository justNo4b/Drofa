...
const int  BISHOP_MOBILITY[14] = {
           ...
           gS(7,31), gS(10,35), gS(14,33), gS(21,30), gS(38,21), gS(50,34), gS(81,0),
};

const int  KNIGHT_MOBILITY[9] = {
           gS(-8,-75), gS(0,-29), gS(4,-4), gS(6,9), gS(9,18),
           gS(12,24), gS(16,23), gS(23,16), gS(34,0),
};

const int  KING_MOBILITY[9] = {
           gS(13,1), gS(14,1), gS(7,7), gS(2,11), gS(-4,8),
           gS(-8,5), gS(-5,2), gS(-14,-3), gS(-7,-17),
};

const int  ROOK_MOBILITY[15] = {
           gS(-18,-98), gS(-12,-66), gS(-8,-34), gS(-5,-13), gS(-6,5), gS(-8,19), gS(-2,22),
           gS(1,25), gS(6,29), gS(11,34), gS(12,38), gS(17,41), gS(20,41), gS(35,27),
           gS(87,0),
};

const int  QUEEN_MOBILITY[28] = {
           gS(-36,-92), gS(-17,-148), gS(-4,-129), gS(-1,-79), gS(0,-46), gS(1,-23), gS(3,-6),
           gS(4,7), gS(7,17), gS(9,24), gS(10,31), gS(11,35), gS(11,40), gS(10,45),
           gS(8,51), gS(5,55), gS(4,57), gS(3,58), gS(3,57), gS(8,53), gS(11,49),
           gS(11,43), gS(10,39), gS(21,29), gS(12,24), gS(20,23), gS(26,29), gS(24,26),
};
...
const int  DOUBLED_PAWN_PENALTY = gS(-13,-26);

const int  ISOLATED_PAWN_PENALTY = gS(-7,-11);
...
const int  SPACE = gS(5,5);

const int  KING_PASSER_DISTANCE_FRIENDLY[9] = {
           gS(0,0), gS(8,26), gS(-5,23), gS(-10,9),
           gS(-7,-2), gS(-6,-6), gS(8,-10), gS(-2,-20),
           gS(0,-10),
};

const int  KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(41,81), gS(-19,14), gS(-4,-3),
           gS(-3,-15), gS(-1,-26), gS(6,-38), gS(14,-45),
           gS(0,-10),
};
 ...
 * @brief Bonuses given to a player for each rook on an open file (opening/endgame)
 */
const int ROOK_SEMI_FILE_BONUS [2] = {  gS(6,7), gS(17,11), };


const int  HANGING_PIECE[5] = {
           gS(0,0), gS(-26,-18), gS(-23,-52), gS(-30,-69), gS(-17,-10),
};
/**
 * @brief Bonuses given to a player for having a passed pawn (opening/endgame)
 */
const int  PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-13,-25), gS(-17,-12), gS(-8,20),
           gS(17,53), gS(28,113), gS(70,110), gS(0,0),
};

const int  PASSED_PAWN_FILES[8] = {
           gS(14,16), gS(7,16), gS(0,3), gS(-2,1),
           gS(-4,0), gS(-18,2), gS(-8,17), gS(13,12),
};


const int  KING_PSQT_BLACK[64] = {
           gS(-13,-86), gS(-7,-44), gS(-6,-31), gS(-5,-19), gS(-7,-30), gS(-8,-26), gS(-9,-25), gS(-12,-78),
           gS(-13,-37), gS(0,34), gS(6,23), gS(0,5), gS(0,4), gS(4,22), gS(-1,44), gS(-12,-36),
           gS(-3,-3), gS(25,37), gS(27,32), gS(9,19), gS(9,16), gS(28,34), gS(25,40), gS(-7,-8),
           gS(-9,-9), gS(19,20), gS(26,28), gS(-1,29), gS(8,25), gS(31,25), gS(29,19), gS(-33,-11),
           gS(-20,-34), gS(21,3), gS(27,17), gS(-15,31), gS(3,27), gS(13,19), gS(25,5), gS(-51,-22),
           gS(-50,-15), gS(-8,3), gS(-6,12), gS(-26,26), gS(-14,23), gS(-14,16), gS(-5,3), gS(-52,-13),
           gS(0,-11), gS(-3,7), gS(-24,16), gS(-63,25), gS(-44,20), gS(-45,23), gS(-2,5), gS(-4,-21),
           gS(-28,-57), gS(3,-27), gS(-29,-6), gS(-37,-26), gS(-28,-36), gS(-55,-6), gS(-5,-26), gS(-16,-74),
};

const int  PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(66,83), gS(49,90), gS(68,89), gS(73,74), gS(80,74), gS(81,79), gS(-8,96), gS(-18,94),
           gS(-4,48), gS(19,39), gS(34,33), gS(35,15), gS(46,15), gS(90,20), gS(55,25), gS(8,36),
           gS(-5,23), gS(-4,17), gS(0,15), gS(14,0), gS(22,3), gS(25,8), gS(3,13), gS(-4,13),
           gS(-14,9), gS(-14,7), gS(-3,2), gS(0,0), gS(4,0), gS(6,3), gS(-4,0), gS(-13,1),
           gS(-13,8), gS(-10,8), gS(-5,15), gS(-1,15), gS(5,17), gS(6,17), gS(8,3), gS(-7,0),
           gS(-10,13), gS(-7,13), gS(-9,25), gS(-2,26), gS(-6,31), gS(14,27), gS(13,7), gS(-10,-4),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int  ROOK_PSQT_BLACK[64] = {
           gS(29,26), gS(22,31), gS(0,40), gS(7,35), gS(10,35), gS(23,34), gS(39,30), gS(49,26),
           gS(-3,27), gS(-8,32), gS(14,28), gS(23,29), gS(20,30), gS(39,12), gS(5,24), gS(13,20),
           gS(-9,19), gS(32,4), gS(20,16), gS(42,5), gS(52,0), gS(46,7), gS(70,-9), gS(11,11),
           gS(-6,10), gS(10,9), gS(19,11), gS(40,3), gS(33,3), gS(26,3), gS(28,0), gS(10,4),
           gS(-18,0), gS(-10,11), gS(-12,12), gS(-4,5), gS(-5,4), gS(-9,7), gS(4,4), gS(-13,-2),
           ...
           gS(-14,-14), gS(-7,-13), gS(-4,-10), gS(2,-18), gS(1,-18), gS(-1,-9), gS(0,-17), gS(-10,-23),
};

const int  BISHOP_PSQT_BLACK[64] = {
           gS(-42,13), gS(-38,9), gS(-70,11), gS(-76,16), gS(-62,13), gS(-88,9), gS(-13,0), gS(-42,6),
           gS(-46,2), gS(-2,8), gS(-5,8), gS(-20,12), gS(-14,10), gS(0,9), gS(-20,11), gS(-20,-3),
           gS(0,-4), gS(4,6), gS(29,7), gS(8,8), gS(24,7), gS(16,12), gS(24,0), gS(12,-7),
           gS(-14,-6), gS(14,-2), gS(3,4), gS(21,11), gS(17,11), gS(13,0), gS(15,-6), gS(-10,-5),
           gS(-2,-17), gS(2,-8), gS(9,6), gS(16,4), gS(22,4), gS(4,2), gS(10,-7), gS(0,-19),
           gS(0,-18), gS(12,-5), gS(12,0), gS(17,1), gS(12,2), gS(16,0), gS(14,-7), gS(14,-10),
           gS(13,-24), gS(15,-22), gS(13,-13), gS(4,-6), gS(9,-5), gS(11,-12), gS(24,-12), gS(11,-32),
           gS(15,-26), gS(5,-11), gS(2,-7), gS(0,-11), gS(0,-7), gS(3,-4), gS(1,-6), gS(12,-25),
};

const int  KNIGHT_PSQT_BLACK[64] = {
           gS(-137,-73), gS(-33,-22), gS(-58,8), gS(-15,-1), gS(-2,0), gS(-46,10), gS(-26,-14), gS(-79,-66),
           gS(-12,-25), gS(-12,-6), gS(30,-5), gS(47,16), gS(35,15), gS(53,-13), gS(-21,-4), gS(-8,-22),
           gS(-20,-19), gS(10,-5), gS(30,28), gS(30,29), gS(56,19), gS(45,22), gS(28,-13), gS(2,-16),
           gS(-2,-11), gS(6,4), gS(24,26), gS(22,37), gS(11,35), gS(36,21), gS(14,7), gS(6,-8),
           gS(-6,-10), gS(8,7), gS(11,28), gS(14,30), gS(17,34), gS(17,31), gS(23,11), gS(5,-2),
           gS(-18,-34), gS(0,-7), gS(4,8), gS(14,22), gS(18,20), gS(11,6), gS(5,-1), gS(-6,-25),
           gS(-21,-16), gS(-26,0), gS(-6,-12), gS(7,3), gS(3,7), gS(0,-10), gS(-14,0), gS(-9,-2),
           gS(-38,-43), gS(-11,-28), gS(-10,-19), gS(-8,0), gS(0,0), gS(-5,-8), gS(-9,-19), gS(-39,-41),
};

const int  QUEEN_PSQT_BLACK[64] = {
           gS(-5,3), gS(0,20), gS(1,31), gS(6,40), gS(12,49), gS(32,46), gS(11,45), gS(16,33),
           gS(-17,-1), gS(-57,40), gS(-18,30), gS(-40,70), gS(-50,109), gS(-1,69), gS(-54,66), gS(-18,38),
           gS(-15,-15), gS(-7,-15), gS(-11,16), gS(-14,43), gS(0,60), gS(7,77), gS(24,48), gS(-7,61),
           gS(-4,-31), gS(-3,1), gS(-11,6), gS(-17,49), gS(-16,66), gS(-14,73), gS(-1,59), gS(1,32),
           gS(1,-42), gS(2,-14), gS(-3,-8), gS(-10,28), gS(-6,26), gS(-12,25), gS(8,3), gS(-1,7),
           ...
           gS(3,-70), gS(7,-82), gS(8,-88), gS(12,-68), gS(13,-73), gS(7,-89), gS(9,-81), gS(-1,-71),
};
