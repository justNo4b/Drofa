...
const int BISHOP_MOBILITY[14] = {
           gS(-24,-102), gS(-13,-43), gS(-7,-16), gS(-3,-1), gS(0,12), gS(1,23), gS(0,30),
...
const int KING_MOBILITY[9] = {
           ...
           gS(-6,1), gS(0,0), gS(-15,0), gS(-19,-10),
};

const int ROOK_MOBILITY[15] = {
           gS(-22,-105), gS(-14,-69), gS(-9,-35), gS(-7,-14), gS(-8,4), gS(-10,18), gS(-4,21),
           gS(0,25), gS(5,30), gS(9,35), gS(12,40), gS(17,44), gS(21,45), gS(36,33),
           gS(89,4),
};
...
const int QUEEN_MOBILITY[28] = {
           ...
           gS(5,49), gS(3,53), gS(2,56), gS(2,56), gS(1,57), gS(7,52), gS(12,47),
           gS(10,42), gS(8,40), gS(21,28), gS(11,24), gS(20,23), gS(26,29), gS(24,26),
};
...
const int ROOK_RAMMED_LINE = gS(-6,-8);
...
const int KING_PASSER_DISTANCE_FRIENDLY[9] = {
           ...
           gS(-2,-3), gS(-1,-8), gS(12,-13), gS(2,-24),
           gS(0,-10),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(0,-8), gS(1,14), gS(9,10), gS(-7,20),
           gS(-2,7), gS(-1,-30), gS(4,-9), gS(4,5),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(9,10), gS(-6,27), gS(18,7), gS(-1,20),
...
const int PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-14,-11), gS(-16,1), gS(-10,37),
           gS(20,47), gS(35,74), gS(75,92), gS(0,0),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-13,-10), gS(-22,9), gS(-15,13), gS(-54,24), gS(-36,18), gS(-35,20), gS(-22,7), gS(-18,-18),
           gS(-29,-57), gS(-1,-26), gS(-32,-3), gS(-23,-25), gS(-14,-37), gS(-43,-5), gS(-4,-25), gS(-16,-72),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(62,66), gS(42,83), gS(60,81), gS(69,69), gS(77,68), gS(80,72), gS(-3,88), gS(-14,78),
           gS(1,46), gS(25,41), gS(40,35), gS(44,17), gS(53,19), gS(91,26), gS(56,32), gS(14,35),
           gS(-2,19), gS(2,15), gS(4,13), gS(19,-1), gS(28,1), gS(27,5), gS(8,12), gS(0,9),
           gS(-12,4), gS(-8,6), gS(-5,-1), gS(1,-2), gS(8,-2), gS(2,0), gS(0,0), gS(-9,-4),
           gS(-18,-1), gS(-19,0), gS(-16,3), gS(-14,5), gS(-7,7), gS(-8,7), gS(-6,-5), gS(-14,-10),
           gS(-13,3), gS(-10,4), gS(-14,16), gS(-6,16), gS(-12,23), gS(8,18), gS(7,2), gS(-9,-13),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-9,12), gS(8,9), gS(16,11), gS(38,4), gS(31,4), gS(28,3), gS(27,0), gS(13,5),
           gS(-19,2), gS(-12,13), gS(-13,14), gS(-3,7), gS(-4,6), gS(-7,9), gS(5,6), gS(-8,-1),
           gS(-23,-14), gS(-7,-3), gS(-15,-3), gS(-7,-8), gS(-6,-7), gS(-8,-6), gS(9,-7), gS(-14,-17),
           gS(-54,-13), gS(-18,-17), gS(-10,-12), gS(-3,-16), gS(-3,-16), gS(-2,-20), gS(-3,-21), gS(-53,-12),
           gS(-16,-16), gS(-10,-14), gS(-6,-11), gS(0,-17), gS(0,-17), gS(-3,-6), gS(-2,-15), gS(-11,-25),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-2,-17), gS(10,-8), gS(6,-3), gS(13,3), gS(8,4), gS(10,-4), gS(10,-8), gS(12,-11),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-17,-21), gS(-13,-6), gS(19,-1), gS(45,17), gS(38,17), gS(47,-10), gS(-21,-3), gS(-11,-20),
           ...
           gS(-18,-33), gS(1,-5), gS(7,10), gS(14,26), gS(18,24), gS(15,8), gS(8,0), gS(-3,-25),
           gS(-21,-18), gS(-27,-1), gS(-5,-10), gS(7,8), gS(2,10), gS(0,-7), gS(-15,-2), gS(-11,-6),
           gS(-40,-48), gS(-12,-29), gS(-10,-17), gS(-8,4), gS(0,3), gS(-7,-9), gS(-10,-20), gS(-41,-46),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-2,3), gS(0,21), gS(0,38), gS(4,52), gS(10,64), gS(31,49), gS(4,48), gS(13,34),
           gS(-18,-7), gS(-54,28), gS(-16,19), gS(-41,67), gS(-38,101), gS(0,70), gS(-53,65), gS(-18,31),
           gS(-14,-19), gS(-8,-19), gS(-10,11), gS(-10,41), gS(2,60), gS(14,78), gS(34,42), gS(7,56),
           gS(-5,-33), gS(-4,0), gS(-7,1), gS(-15,45), gS(-14,66), gS(-7,71), gS(4,57), gS(9,28),
           gS(-2,-41), gS(1,-13), gS(-4,-7), gS(-11,29), gS(-7,29), gS(-7,26), gS(9,3), gS(2,9),
           gS(-2,-58), gS(7,-40), gS(1,-19), gS(0,-25), gS(0,-24), gS(0,-9), gS(13,-30), gS(3,-43),
