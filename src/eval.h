...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-63), gS(3,-25), gS(10,-12), gS(15,-2), gS(17,6), gS(18,10), gS(17,12),
           gS(16,12), gS(14,13), gS(14,12), gS(16,9), gS(28,0), gS(30,10), gS(53,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-34), gS(17,-7), gS(22,2), gS(26,9),
           gS(29,14), gS(32,11), gS(36,5), gS(39,-4),
};

const int KING_MOBILITY[9] = {
           gS(14,-30), gS(5,-5), gS(0,4), gS(-2,9), gS(-5,7),
           gS(-8,5), gS(0,3), gS(0,0), gS(15,-15),
};

const int ROOK_MOBILITY[15] = {
           gS(-27,-85), gS(-13,-49), gS(-6,-31), gS(1,-19), gS(4,-7), gS(1,5), gS(6,7),
           gS(8,7), gS(11,12), gS(13,15), gS(15,20), gS(17,23), gS(22,21), gS(28,19),
           gS(50,10),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-92), gS(0,-30), gS(0,-13), gS(0,-6), gS(0,-18), gS(0,-22), gS(0,-13), gS(0,-94),
           gS(0,-15), gS(0,33), gS(5,33), gS(0,32), gS(1,15), gS(0,34), gS(0,31), gS(-4,-22),
           gS(0,-1), gS(27,24), gS(16,36), gS(0,39), gS(1,40), gS(21,35), gS(11,28), gS(0,-3),
           gS(0,-13), gS(11,13), gS(0,26), gS(-6,36), gS(-7,33), gS(4,24), gS(9,13), gS(-34,-15),
           gS(-12,-24), gS(1,0), gS(-3,16), gS(-15,25), gS(-14,23), gS(-21,17), gS(-1,0), gS(-43,-18),
           gS(-15,-27), gS(11,-6), gS(-12,7), gS(-30,18), gS(-25,17), gS(-22,8), gS(0,-6), gS(-7,-27),
           gS(2,-29), gS(-3,-7), gS(-3,0), gS(-21,8), gS(-23,9), gS(-2,0), gS(-4,-7), gS(3,-31),
           gS(-16,-55), gS(4,-38), gS(-14,-17), gS(-35,-15), gS(10,-45), gS(-13,-26), gS(4,-35), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,77), gS(37,66), gS(65,52), gS(62,58), gS(47,62), gS(0,83), gS(0,71),
           gS(0,31), gS(8,29), gS(25,11), gS(42,0), gS(42,0), gS(69,4), gS(26,22), gS(25,13),
           gS(-11,16), gS(2,11), gS(6,0), gS(14,-1), gS(20,-1), gS(19,-1), gS(23,1), gS(-3,5),
           gS(-23,4), gS(-20,12), gS(-7,0), gS(10,-2), gS(9,-4), gS(9,-3), gS(-4,2), gS(-17,-4),
           gS(-24,-1), gS(-17,0), gS(-6,-3), gS(-4,0), gS(0,0), gS(0,-2), gS(-1,-7), gS(-19,-10),
           gS(-34,6), gS(-16,6), gS(-14,7), gS(0,7), gS(0,10), gS(1,5), gS(-3,0), gS(-25,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,9), gS(-7,11), gS(-8,12), gS(-2,0), gS(-1,1), gS(-6,1), gS(-2,20), gS(-4,7),
           ...
           gS(5,26), gS(0,14), gS(-1,23), gS(-2,18), gS(-4,15), gS(3,19), gS(6,13), gS(9,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,12), gS(15,21), gS(0,27), gS(0,21), gS(5,20), gS(12,20), gS(27,16), gS(38,14),
           gS(7,15), gS(0,16), gS(17,12), gS(35,4), gS(26,5), gS(28,4), gS(-5,15), gS(10,11),
           gS(3,17), gS(20,9), gS(19,10), gS(27,1), gS(43,-4), gS(37,-1), gS(29,0), gS(-3,12),
           gS(0,13), gS(0,13), gS(18,8), gS(21,1), gS(20,0), gS(20,-1), gS(6,2), gS(0,3),
           gS(-13,8), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-2,1), gS(-5,5), gS(-19,4),
           gS(-16,0), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(1,-9), gS(-13,-11),
           gS(-21,-9), gS(-4,-11), gS(0,-8), gS(0,-10), gS(12,-16), gS(8,-22), gS(5,-23), gS(-39,-11),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,1), gS(0,3), gS(24,-3), gS(16,0), gS(21,0), gS(6,0), gS(7,-4),
           gS(-7,-2), gS(9,5), gS(3,2), gS(21,10), gS(16,10), gS(11,4), gS(6,1), gS(-2,-9),
           gS(5,-6), gS(-2,4), gS(7,6), gS(19,7), gS(23,5), gS(6,4), gS(8,0), gS(5,-16),
           gS(4,-15), gS(20,-4), gS(11,-2), gS(11,6), gS(7,11), gS(22,-7), gS(18,-10), gS(9,-12),
           gS(16,-20), gS(12,-24), gS(16,-9), gS(5,0), gS(15,0), gS(16,-5), gS(22,-21), gS(8,-29),
           gS(-2,-32), gS(8,-7), gS(0,-4), gS(2,0), gS(7,-4), gS(-10,3), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-159,-57), gS(-31,-4), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-79,2), gS(-29,-5), gS(-89,-64),
           gS(-32,-9), gS(-18,0), gS(-1,0), gS(21,5), gS(9,3), gS(28,-12), gS(-11,-1), gS(-17,-16),
           gS(-10,-1), gS(8,2), gS(12,19), gS(30,6), gS(44,0), gS(47,5), gS(14,-1), gS(13,-13),
           gS(5,-1), gS(7,0), gS(15,14), gS(31,17), gS(19,19), gS(35,12), gS(9,0), gS(22,-10),
           gS(1,0), gS(13,5), gS(18,20), gS(22,16), gS(23,21), gS(29,13), gS(24,0), gS(11,0),
           gS(-7,-20), gS(10,-6), gS(10,5), gS(20,16), gS(23,13), gS(22,1), gS(26,-9), gS(4,-10),
           gS(-5,-26), gS(-10,3), gS(4,-4), gS(7,8), gS(13,6), gS(13,-2), gS(1,1), gS(3,-15),
           gS(-40,-30), gS(-12,-16), gS(0,-5), gS(1,2), gS(9,4), gS(-1,-3), gS(-6,-6), gS(-19,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,11), gS(-4,20), gS(-9,25), gS(0,10), gS(-9,17), gS(-12,15),
           gS(-13,1), gS(-27,24), gS(-13,25), gS(-30,47), gS(-47,66), gS(-24,33), gS(-16,37), gS(1,11),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,44), gS(0,36), gS(6,13), gS(-9,14),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,52), gS(-6,36), gS(-5,26), gS(2,-3),
...
const int MATERIAL_VALUES[5] = {
           gS(87,112), gS(512,681), gS(355,376), gS(378,397), gS(1002,1262),
};
