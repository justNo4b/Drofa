...
const int  KING_SAFE         = gS(4,27);   // хороший пешечный щит
...
const int  KNIGHT_MOBILITY[9] = {
           ...
           gS(12,25), gS(16,24), gS(24,16), gS(34,1),
};

const int  KING_MOBILITY[9] = {
           gS(12,0), gS(14,0), gS(7,7), gS(2,11), gS(-4,9),
           gS(-8,5), gS(-5,3), gS(-14,-2), gS(-7,-16),
};

const int  ROOK_MOBILITY[15] = {
           gS(-18,-98), gS(-12,-67), gS(-8,-33), gS(-6,-13), gS(-6,5), gS(-8,19), gS(-2,22),
           gS(1,25), gS(6,29), gS(11,34), gS(12,38), gS(17,41), gS(20,41), gS(35,27),
           gS(87,0),
};

const int  QUEEN_MOBILITY[28] = {
           gS(-36,-91), gS(-18,-145), gS(-5,-128), gS(-1,-79), gS(0,-46), gS(1,-23), gS(3,-6),
           gS(4,7), gS(7,16), gS(9,23), gS(10,30), gS(11,35), gS(11,39), gS(10,45),
           gS(8,51), gS(5,55), gS(4,57), gS(3,57), gS(3,57), gS(8,53), gS(10,49),
           gS(11,43), gS(10,38), gS(21,28), gS(11,24), gS(20,23), gS(26,29), gS(24,26),
};
...
const int  DOUBLED_PAWN_PENALTY = gS(-13,-28);

const int  ISOLATED_PAWN_PENALTY = gS(-8,-14);

const int  BACKWARD_PAWN_PENALTY = gS(-1,-8);

const int  PAWN_BLOCKED = gS(2,25);

const int  PASSER_BLOCKED = gS(2,43);

const int  BISHOP_RAMMED_PENALTY = gS(-2,-9);

const int  KING_PASSER_DISTANCE_FRIENDLY[9] = {
           gS(0,0), gS(8,26), gS(-4,23), gS(-9,9),
           gS(-7,-2), gS(-6,-5), gS(8,-10), gS(-2,-20),
           gS(0,-10),
};

const int  KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(40,81), gS(-19,14), gS(-4,-2),
 ...
 */
const int ROOK_OPEN_FILE_BONUS [2] = { gS(24,7), gS(25,10), };
...
const int  HANGING_PIECE[5] = {
           gS(0,0), gS(-26,-18), gS(-23,-52), gS(-30,-68), gS(-18,-9),
};
/**
 * @brief Bonuses given to a player for having a passed pawn (opening/endgame)
 */
const int  PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-14,-27), gS(-18,-14), gS(-8,20),
           gS(17,53), gS(29,113), gS(73,114), gS(0,0),
};

const int  PASSED_PAWN_FILES[8] = {
           gS(14,15), gS(8,15), gS(0,4), gS(-2,1),
           gS(-4,0), gS(-19,3), gS(-7,16), gS(13,12),
};


const int  KING_PSQT_BLACK[64] = {
           gS(-13,-84), gS(-7,-44), gS(-6,-30), gS(-5,-18), gS(-7,-29), gS(-8,-25), gS(-9,-25), gS(-12,-77),
           gS(-13,-37), gS(0,34), gS(5,23), gS(0,6), gS(0,4), gS(3,22), gS(-1,44), gS(-12,-35),
           gS(-3,-3), gS(24,37), gS(26,32), gS(8,19), gS(9,16), gS(27,34), gS(24,40), gS(-7,-8),
           gS(-9,-9), gS(19,20), gS(26,27), gS(-1,29), gS(7,25), gS(30,25), gS(28,19), gS(-32,-11),
           gS(-19,-34), gS(20,3), gS(26,17), gS(-14,31), gS(3,27), gS(13,19), gS(26,5), gS(-50,-22),
           gS(-49,-15), gS(-8,3), gS(-6,12), gS(-26,26), gS(-13,22), gS(-14,16), gS(-6,2), gS(-51,-12),
           gS(0,-11), gS(-3,7), gS(-23,16), gS(-62,24), gS(-44,19), gS(-45,23), gS(-2,4), gS(-4,-21),
           gS(-28,-56), gS(3,-28), gS(-29,-6), gS(-37,-27), gS(-27,-36), gS(-54,-7), gS(-4,-27), gS(-16,-74),
};

const int  PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(64,80), gS(50,92), gS(69,90), gS(73,76), gS(81,75), gS(81,80), gS(-7,98), gS(-19,92),
           gS(-4,48), gS(25,44), gS(39,37), gS(40,19), gS(51,19), gS(95,25), gS(60,31), gS(8,35),
           gS(-5,23), gS(1,23), gS(5,20), gS(20,4), gS(27,8), gS(30,12), gS(9,20), gS(-3,13),
           gS(-14,10), gS(-9,13), gS(0,5), gS(4,4), gS(9,4), gS(10,7), gS(1,7), gS(-13,1),
           gS(-18,4), gS(-15,4), gS(-10,9), gS(-5,10), gS(1,13), gS(1,12), gS(3,-1), gS(-12,-4),
           gS(-15,8), gS(-12,8), gS(-14,19), gS(-6,21), gS(-10,27), gS(9,22), gS(8,2), gS(-15,-8),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int  ROOK_PSQT_BLACK[64] = {
           ...
           gS(-22,-16), gS(-7,-4), gS(-14,-5), gS(-5,-11), gS(-4,-11), gS(-11,-8), gS(7,-9), gS(-16,-18),
...
const int  BISHOP_PSQT_BLACK[64] = {
           gS(-42,12), gS(-38,8), gS(-69,10), gS(-75,16), gS(-61,12), gS(-87,9), gS(-13,0), gS(-41,5),
           gS(-46,2), gS(-2,8), gS(-5,8), gS(-20,11), gS(-14,10), gS(0,9), gS(-20,11), gS(-20,-3),
           gS(-1,-4), gS(4,6), gS(28,7), gS(8,8), gS(24,7), gS(16,12), gS(24,0), gS(11,-7),
           ...
           gS(0,-18), gS(12,-5), gS(12,0), gS(16,1), gS(11,2), gS(16,0), gS(14,-6), gS(14,-9),
           gS(13,-24), gS(15,-21), gS(13,-13), gS(4,-6), gS(9,-5), gS(11,-12), gS(24,-12), gS(12,-32),
           gS(15,-26), gS(5,-10), gS(2,-7), gS(0,-11), gS(0,-7), gS(3,-4), gS(1,-6), gS(12,-25),
};

const int  KNIGHT_PSQT_BLACK[64] = {
           gS(-136,-73), gS(-32,-22), gS(-56,8), gS(-14,-1), gS(-2,0), gS(-44,10), gS(-25,-14), gS(-77,-65),
           gS(-12,-25), gS(-12,-6), gS(30,-5), gS(47,16), gS(35,15), gS(53,-13), gS(-21,-4), gS(-8,-22),
           gS(-20,-19), gS(10,-6), gS(29,28), gS(29,29), gS(56,19), gS(45,21), gS(28,-13), gS(1,-16),
           gS(-2,-11), gS(6,4), gS(23,26), gS(22,37), gS(10,35), gS(35,21), gS(14,7), gS(6,-8),
           gS(-6,-10), gS(8,7), gS(12,28), gS(15,30), gS(17,33), gS(17,31), gS(23,11), gS(5,-1),
           gS(-19,-34), gS(0,-7), gS(3,8), gS(13,22), gS(17,20), gS(10,6), gS(5,-1), gS(-6,-25),
           gS(-21,-16), gS(-25,0), gS(-6,-12), gS(7,3), gS(3,7), gS(0,-10), gS(-14,0), gS(-8,-2),
           gS(-37,-43), gS(-11,-28), gS(-10,-19), gS(-8,0), gS(0,0), gS(-5,-7), gS(-9,-19), gS(-38,-41),
};

const int  QUEEN_PSQT_BLACK[64] = {
           gS(-5,3), gS(0,19), gS(1,31), gS(6,39), gS(12,49), gS(32,45), gS(11,45), gS(15,32),
           gS(-18,-1), gS(-57,40), gS(-17,29), gS(-39,69), gS(-49,108), gS(0,68), gS(-54,64), gS(-18,37),
           gS(-15,-15), gS(-7,-15), gS(-11,16), gS(-14,42), gS(0,60), gS(7,77), gS(24,47), gS(-7,61),
           gS(-4,-31), gS(-3,1), gS(-11,6), gS(-17,49), gS(-16,66), gS(-14,73), gS(-1,59), gS(0,32),
           gS(0,-41), gS(2,-13), gS(-3,-7), gS(-9,28), gS(-6,27), gS(-12,26), gS(8,3), gS(-1,7),
           gS(0,-58), gS(11,-42), gS(5,-22), gS(4,-30), gS(3,-28), gS(0,-13), gS(15,-33), gS(3,-45),
           gS(0,-66), gS(8,-63), gS(17,-79), gS(10,-49), gS(15,-53), gS(17,-92), gS(14,-84), gS(-11,-54),
           gS(3,-70), gS(7,-82), gS(8,-88), gS(12,-68), gS(13,-73), gS(7,-89), gS(9,-80), gS(-1,-69),
};
