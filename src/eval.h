...
const int KNIGHT_CHECKING_FORK[5] = {
           gS(1,11), gS(3,10), gS(0,0), gS(-1,9), gS(3,0),
};
...
const int KNIGHT_MOBILITY[9] = {
           gS(-1,-94), gS(10,-34), gS(17,-7), gS(21,2), gS(25,9),
           gS(29,13), gS(32,10), gS(36,4), gS(38,-5),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-26,-88), gS(-13,-51), gS(-6,-32), gS(0,-19), gS(3,-7), gS(1,5), gS(6,7),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-1,-14), gS(11,13), gS(-1,26), gS(-7,35), gS(-8,33), gS(3,24), gS(8,14), gS(-35,-16),
           gS(-13,-25), gS(0,1), gS(-4,15), gS(-15,24), gS(-14,23), gS(-21,17), gS(-1,1), gS(-42,-20),
           gS(-13,-29), gS(12,-6), gS(-12,7), gS(-30,18), gS(-25,17), gS(-22,8), gS(0,-6), gS(-7,-28),
           gS(4,-29), gS(-1,-7), gS(-3,0), gS(-22,10), gS(-24,10), gS(-2,1), gS(-3,-6), gS(4,-32),
           gS(-14,-56), gS(6,-38), gS(-13,-17), gS(-35,-15), gS(10,-44), gS(-13,-25), gS(5,-36), gS(0,-68),
};
...
const int PAWN_PSQT_BLACK[64] = {
           ...
           gS(-25,4), gS(-20,12), gS(-8,0), gS(9,-3), gS(9,-4), gS(8,-3), gS(-4,1), gS(-18,-5),
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(3,17), gS(19,8), gS(19,10), gS(27,2), gS(43,-3), gS(36,-1), gS(27,1), gS(-4,13),
           gS(0,12), gS(0,13), gS(18,7), gS(21,1), gS(20,0), gS(20,-1), gS(6,2), gS(0,3),
           gS(-13,7), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-3,1), gS(-5,5), gS(-19,4),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-10,-1), gS(7,3), gS(11,20), gS(30,6), gS(42,1), gS(47,5), gS(13,-1), gS(13,-13),
           gS(5,-1), gS(6,0), gS(15,15), gS(30,17), gS(19,19), gS(34,12), gS(10,1), gS(21,-10),
           gS(1,0), gS(13,5), gS(18,19), gS(23,16), gS(23,20), gS(29,13), gS(24,1), gS(11,0),
           gS(-6,-21), gS(11,-7), gS(10,5), gS(20,16), gS(24,13), gS(22,1), gS(26,-9), gS(4,-11),
           gS(-5,-27), gS(-10,3), gS(5,-5), gS(7,8), gS(13,5), gS(14,-3), gS(1,1), gS(4,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(6,-62), gS(8,-69), gS(6,-76), gS(5,-57), gS(8,-63), gS(-3,-75), gS(0,-64), gS(13,-69),
};
