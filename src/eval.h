...
const int KING_HIGH_DANGER = gS(-49,-64);

const int KING_MED_DANGER = gS(-24,-38);

const int KING_LOW_DANGER = gS(71,-77);
...
const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-9,-8), gS(-6,6), gS(-1,43),
           gS(16,54), gS(27,77), gS(54,86),
};
...
const int PASSED_PAWN_FREE[7] = {
           ...
           gS(0,8), gS(7,23), gS(64,23),
};

const int PASSED_PAWN_POS_ADVANCE[7] = {
           gS(0,0), gS(4,5), gS(5,1), gS(6,13),
           gS(12,28), gS(36,60), gS(52,110),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-5,-23), gS(17,4), gS(1,-19), gS(-7,-7),
           gS(-10,-8), gS(-19,-9), gS(-17,-13), gS(-15,-11),
};

const int KING_PASSER_DISTANCE_FRIENDLY[8] = {
           gS(0,0), gS(1,34), gS(-11,27), gS(-7,9),
           gS(-4,0), gS(-4,0), gS(10,-3), gS(11,-3),
};

const int KING_PASSER_DISTANCE_FRIENDLY_NOTEMPO[8] = {
           gS(0,0), gS(6,36), gS(-6,27), gS(-5,10),
           gS(-2,1), gS(4,0), gS(18,1), gS(15,-1),
};

const int KING_PASSER_DISTANCE_ENEMY[8] = {
           gS(0,0), gS(-49,-7), gS(4,-17), gS(-2,0),
           gS(0,11), gS(-4,20), gS(0,22), gS(-9,20),
};

const int KING_PASSER_DISTANCE_ENEMY_NOTEMPO[8] = {
           gS(0,0), gS(-43,3), gS(14,-17), gS(3,0),
           gS(5,11), gS(-1,22), gS(2,22), gS(-7,21),
};

const int KNIGHT_PASSER_DISTANCE_ENEMY[4] = {
           gS(-9,-9), gS(0,2), gS(7,8), gS(13,12),
};

const int KNIGHT_PASSER_DISTANCE_ENEMY_NOTEMPO[4] = {
           gS(-3,-7), gS(2,3), gS(7,8), gS(13,11),
};

const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-14,0), gS(-8,7), gS(-1,14),
           gS(4,28), gS(15,27), gS(0,0),
};
...
const int HANGING_PIECE[5] = {
           gS(0,18), gS(-65,-40), gS(-50,-45), gS(-53,-65), gS(-47,-30),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(16,32), gS(15,34), gS(15,30),
};

const int ROOK_ATTACKED_BY[4] = {
           gS(0,0), gS(-3,18), gS(63,19), gS(41,40),
};

const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(59,34), gS(37,19), gS(40,35),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           ...
           gS(10,0), gS(-18,0), gS(-3,14), gS(10,0),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-7,-65), gS(1,-25), gS(9,-13), gS(14,-2), gS(16,6), gS(18,9), gS(17,12),
           gS(17,11), gS(17,12), gS(17,11), gS(18,9), gS(31,0), gS(32,11), gS(57,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(9,-35), gS(16,-8), gS(21,2), gS(26,10),
           gS(30,15), gS(34,13), gS(38,7), gS(42,-1),
};

const int KING_MOBILITY[9] = {
           gS(14,-26), gS(5,-4), gS(0,4), gS(-2,10), gS(-5,8),
           gS(-9,6), gS(0,4), gS(0,0), gS(15,-18),
};

const int ROOK_MOBILITY[15] = {
           gS(-26,-86), gS(-12,-48), gS(-6,-30), gS(1,-17), gS(4,-6), gS(1,6), gS(7,7),
           gS(9,8), gS(12,12), gS(15,15), gS(16,20), gS(19,22), gS(23,21), gS(28,20),
           gS(52,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-161), gS(-6,-111), gS(-5,-73), gS(-4,-52), gS(-3,-34), gS(-2,-16),
           gS(-1,-3), gS(0,9), gS(0,19), gS(1,26), gS(2,31), gS(2,35), gS(3,38),
           gS(2,41), gS(3,43), gS(2,46), gS(5,41), gS(7,39), gS(10,37), gS(13,30),
           gS(16,24), gS(9,27), gS(19,18), gS(1,15), gS(8,11), gS(13,16), gS(11,13),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-1,-13), gS(11,13), gS(2,25), gS(-6,35), gS(-7,33), gS(8,24), gS(11,13), gS(-36,-15),
           gS(-14,-25), gS(3,0), gS(-3,16), gS(-18,26), gS(-14,24), gS(-21,18), gS(-1,1), gS(-47,-18),
           gS(-18,-27), gS(11,-6), gS(-12,8), gS(-31,19), gS(-26,18), gS(-23,10), gS(-1,-4), gS(-11,-25),
           gS(2,-29), gS(-4,-7), gS(-4,1), gS(-22,10), gS(-24,11), gS(-3,2), gS(-6,-5), gS(1,-31),
           gS(-17,-55), gS(4,-39), gS(-15,-18), gS(-35,-15), gS(11,-46), gS(-13,-25), gS(3,-36), gS(-2,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(54,69), gS(40,79), gS(38,67), gS(65,55), gS(64,60), gS(51,64), gS(0,85), gS(1,74),
           gS(3,31), gS(9,32), gS(25,14), gS(44,2), gS(45,3), gS(73,8), gS(29,26), gS(27,18),
           gS(-8,15), gS(2,12), gS(9,0), gS(16,0), gS(23,-1), gS(23,0), gS(25,2), gS(0,8),
           gS(-20,4), gS(-18,12), gS(-6,0), gS(12,-3), gS(12,-4), gS(12,-3), gS(-2,3), gS(-14,-2),
           gS(-22,-2), gS(-17,0), gS(-4,-5), gS(-3,0), gS(2,-1), gS(4,-3), gS(0,-6), gS(-17,-8),
           gS(-32,6), gS(-15,6), gS(-13,7), gS(1,6), gS(0,10), gS(4,5), gS(-3,1), gS(-23,-3),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-3,12), gS(-2,10), gS(0,7), gS(0,2), gS(0,1), gS(-1,1), gS(0,1), gS(0,6),
           gS(-3,10), gS(-6,15), gS(-8,7), gS(-2,0), gS(-2,2), gS(-5,4), gS(-4,19), gS(-3,13),
           gS(-2,-5), gS(-3,-1), gS(-10,-9), gS(0,-19), gS(-1,-13), gS(-6,-4), gS(-7,0), gS(-2,0),
           gS(0,-15), gS(-3,-9), gS(2,-13), gS(0,-25), gS(0,-21), gS(0,-6), gS(-5,-1), gS(0,0),
           gS(1,-27), gS(-3,-5), gS(-5,-10), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-26),
           gS(0,-40), gS(-1,-20), gS(-4,-8), gS(-9,-2), gS(-6,0), gS(1,-3), gS(1,-9), gS(0,-45),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-6,7), gS(-5,7), gS(-1,1), gS(0,0), gS(0,0), gS(-2,0), gS(0,0), gS(-2,0),
           gS(-2,9), gS(-7,12), gS(-7,11), gS(-2,0), gS(-1,1), gS(-5,1), gS(-3,17), gS(-4,7),
           gS(0,-3), gS(0,0), gS(-2,-1), gS(1,-17), gS(0,-14), gS(-1,-8), gS(-9,-4), gS(0,0),
           gS(1,9), gS(0,0), gS(3,-7), gS(0,-10), gS(0,-8), gS(0,-8), gS(0,0), gS(0,-2),
           gS(5,1), gS(0,5), gS(0,2), gS(-4,4), gS(-2,6), gS(-2,7), gS(4,-5), gS(9,1),
           gS(6,24), gS(0,14), gS(0,20), gS(-1,17), gS(-3,14), gS(5,17), gS(6,13), gS(10,13),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,12), gS(15,21), gS(0,28), gS(0,21), gS(6,20), gS(12,20), gS(27,16), gS(38,14),
           gS(7,15), gS(0,16), gS(17,12), gS(34,4), gS(26,6), gS(28,4), gS(-6,15), gS(11,10),
           ...
           gS(-13,8), gS(-11,13), gS(0,8), gS(-2,6), gS(1,3), gS(-2,1), gS(-5,6), gS(-19,4),
           gS(-16,0), gS(-8,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(1,-9), gS(-12,-11),
           gS(-20,-8), gS(-4,-10), gS(1,-8), gS(1,-10), gS(12,-16), gS(9,-23), gS(6,-23), gS(-39,-11),
           gS(-4,-9), gS(2,-12), gS(3,-8), gS(11,-19), gS(14,-22), gS(14,-20), gS(-7,-10), gS(-3,-23),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-33,-1), gS(-43,-2), gS(-74,16), gS(-81,17), gS(-56,17), gS(-91,13), gS(-26,-7), gS(-28,-15),
           gS(-37,-1), gS(-17,0), gS(-10,0), gS(-12,11), gS(-11,8), gS(-13,3), gS(-25,-4), gS(-23,-7),
           gS(-3,0), gS(1,1), gS(0,3), gS(26,-3), gS(17,0), gS(22,-1), gS(7,0), gS(9,-5),
           gS(-7,-2), gS(9,5), gS(5,2), gS(22,8), gS(16,9), gS(12,4), gS(8,1), gS(-1,-10),
           gS(7,-7), gS(-1,4), gS(8,4), gS(19,6), gS(22,5), gS(6,3), gS(8,0), gS(7,-17),
           gS(4,-16), gS(20,-5), gS(10,-3), gS(10,6), gS(6,11), gS(21,-8), gS(18,-11), gS(9,-13),
           gS(17,-21), gS(12,-24), gS(16,-10), gS(5,0), gS(14,0), gS(15,-6), gS(21,-21), gS(8,-30),
           gS(-2,-32), gS(8,-7), gS(0,-2), gS(2,0), gS(7,-4), gS(-11,4), gS(0,-9), gS(0,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-157,-59), gS(-31,-5), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-76,2), gS(-29,-5), gS(-89,-64),
           gS(-28,-8), gS(-14,2), gS(1,0), gS(25,7), gS(12,5), gS(33,-10), gS(-11,-1), gS(-14,-16),
           gS(-10,-1), gS(11,2), gS(14,19), gS(33,8), gS(47,3), gS(47,5), gS(17,-1), gS(13,-13),
           gS(6,-1), gS(6,-1), gS(14,12), gS(30,15), gS(18,16), gS(34,10), gS(11,-3), gS(23,-10),
           gS(1,2), gS(14,4), gS(17,19), gS(23,17), gS(25,20), gS(29,11), gS(26,1), gS(11,0),
           gS(-7,-19), gS(11,-5), gS(10,7), gS(22,19), gS(24,16), gS(22,3), gS(26,-8), gS(3,-8),
           gS(-7,-26), gS(-10,4), gS(3,-5), gS(6,9), gS(12,6), gS(11,-3), gS(2,2), gS(2,-15),
           gS(-40,-32), gS(-13,-16), gS(-2,-6), gS(0,1), gS(8,3), gS(-3,-4), gS(-7,-6), gS(-20,-30),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,15), gS(-4,24), gS(-9,29), gS(0,14), gS(-9,21), gS(-11,17),
           gS(-13,1), gS(-28,25), gS(-13,25), gS(-30,51), gS(-47,70), gS(-25,37), gS(-18,41), gS(1,15),
           gS(-9,-15), gS(0,0), gS(-4,23), gS(0,36), gS(-3,46), gS(0,40), gS(6,16), gS(-9,18),
           gS(-3,-17), gS(-7,8), gS(-5,19), gS(-5,40), gS(-9,54), gS(-7,40), gS(-5,30), gS(3,-3),
           ...
           gS(6,-53), gS(12,-57), gS(21,-58), gS(13,-33), gS(16,-30), gS(22,-64), gS(26,-80), gS(1,-45),
...
const int MATERIAL_VALUES[5] = {
           gS(83,113), gS(504,682), gS(353,378), gS(376,398), gS(998,1268),
};
