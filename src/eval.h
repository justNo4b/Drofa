...
const int KING_HIGH_DANGER = gS(-48,-60);

const int KING_MED_DANGER = gS(-23,-41);

const int KING_LOW_DANGER = gS(74,-78);

const int BISHOP_PAIR_BONUS = gS(32,53);
...
const int KNIGHT_PASSER_DISTANCE_ENEMY[4] = {
           gS(-5,-10), gS(1,2), gS(7,8), gS(13,12),
};

const int KNIGHT_KING_DISTANCE_ENEMY[4] = {
           gS(1,-11), gS(3,1), gS(0,4), gS(-1,-2),
};

const int KNIGHT_KING_DISTANCE_FRIENDLY[4] = {
           gS(1,2), gS(5,0), gS(-2,0), gS(-6,-5),
};
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(16,34), gS(16,36), gS(15,32),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-7,2), gS(6,9), gS(0,11), gS(0,5),
           gS(-7,5), gS(-22,0), gS(-6,16), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(6,0), gS(13,22), gS(14,1), gS(24,6),
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-63), gS(3,-25), gS(10,-12), gS(15,-2), gS(17,7), gS(17,10), gS(16,13),
           gS(15,12), gS(14,13), gS(14,12), gS(15,9), gS(28,0), gS(30,10), gS(53,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-33), gS(17,-7), gS(22,2), gS(26,9),
           gS(29,13), gS(33,10), gS(36,4), gS(39,-4),
};

const int KING_MOBILITY[9] = {
           gS(15,-29), gS(6,-4), gS(0,5), gS(-2,10), gS(-5,8),
           gS(-8,5), gS(0,4), gS(-1,0), gS(15,-19),
};

const int ROOK_MOBILITY[15] = {
           gS(-27,-85), gS(-13,-49), gS(-6,-31), gS(1,-19), gS(4,-7), gS(1,5), gS(6,7),
           gS(8,7), gS(11,12), gS(13,15), gS(14,20), gS(17,23), gS(22,21), gS(28,19),
           gS(50,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-5,-157), gS(-5,-111), gS(-4,-72), gS(-4,-51), gS(-3,-33), gS(-2,-16),
           gS(-1,-3), gS(0,8), gS(0,19), gS(0,26), gS(1,31), gS(1,36), gS(2,38),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-1,-13), gS(11,13), gS(0,25), gS(-6,34), gS(-7,32), gS(4,24), gS(9,13), gS(-35,-15),
           gS(-13,-24), gS(1,0), gS(-3,15), gS(-15,23), gS(-14,22), gS(-21,17), gS(-1,1), gS(-43,-19),
           gS(-15,-28), gS(12,-6), gS(-11,7), gS(-30,17), gS(-25,16), gS(-22,8), gS(0,-5), gS(-7,-27),
           gS(3,-29), gS(-2,-6), gS(-2,0), gS(-22,9), gS(-23,10), gS(0,0), gS(-3,-6), gS(4,-31),
           gS(-15,-55), gS(5,-38), gS(-16,-16), gS(-36,-15), gS(8,-43), gS(-12,-26), gS(4,-35), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,77), gS(37,66), gS(65,53), gS(63,58), gS(47,62), gS(0,83), gS(0,71),
           gS(0,31), gS(8,29), gS(25,12), gS(42,0), gS(43,0), gS(70,4), gS(26,23), gS(25,13),
           gS(-11,16), gS(2,11), gS(6,1), gS(14,0), gS(20,-1), gS(19,-1), gS(23,1), gS(-3,5),
           gS(-23,4), gS(-20,12), gS(-8,0), gS(10,-3), gS(9,-4), gS(9,-3), gS(-4,2), gS(-17,-5),
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-6,18), gS(-8,7), gS(-1,0), gS(-1,2), gS(-6,4), gS(-4,20), gS(-4,13),
           gS(-3,-4), gS(-3,-1), gS(-10,-8), gS(0,-19), gS(-1,-13), gS(-6,-4), gS(-7,0), gS(-3,0),
           gS(0,-16), gS(-3,-8), gS(1,-13), gS(0,-25), gS(0,-22), gS(0,-6), gS(-6,0), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-7,-9), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-27),
           gS(0,-42), gS(-1,-21), gS(-5,-8), gS(-12,0), gS(-7,0), gS(0,-2), gS(1,-10), gS(0,-48),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,9), gS(-7,11), gS(-8,12), gS(-1,0), gS(-1,1), gS(-6,1), gS(-2,20), gS(-4,7),
           gS(0,-2), gS(0,0), gS(-2,0), gS(1,-16), gS(0,-14), gS(-1,-8), gS(-9,-2), gS(0,0),
           gS(0,12), gS(0,1), gS(2,-5), gS(0,-9), gS(0,-6), gS(0,-8), gS(0,0), gS(0,0),
           gS(3,1), gS(0,5), gS(-1,3), gS(-4,3), gS(-2,5), gS(-2,9), gS(4,-4), gS(7,0),
           gS(5,26), gS(0,15), gS(-1,22), gS(-2,19), gS(-4,15), gS(3,19), gS(6,13), gS(9,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,12), gS(15,21), gS(0,27), gS(0,21), gS(5,20), gS(12,20), gS(27,16), gS(37,14),
           gS(7,16), gS(0,16), gS(17,12), gS(35,4), gS(26,6), gS(28,4), gS(-5,15), gS(10,11),
           gS(3,17), gS(20,9), gS(19,10), gS(27,1), gS(43,-4), gS(37,-1), gS(29,1), gS(-3,12),
           ...
           gS(-21,-9), gS(-4,-11), gS(0,-8), gS(0,-10), gS(12,-16), gS(8,-22), gS(5,-23), gS(-40,-11),
           gS(-5,-12), gS(1,-13), gS(2,-9), gS(11,-19), gS(13,-22), gS(13,-21), gS(-8,-10), gS(-3,-25),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-33,-1), gS(-43,-2), gS(-74,16), gS(-81,16), gS(-55,16), gS(-91,13), gS(-25,-7), gS(-28,-15),
           ...
           gS(-7,-2), gS(9,5), gS(3,2), gS(21,10), gS(16,10), gS(11,4), gS(6,1), gS(-2,-9),
           gS(5,-6), gS(-2,4), gS(7,6), gS(19,7), gS(23,5), gS(6,4), gS(8,0), gS(5,-16),
           gS(4,-15), gS(20,-4), gS(11,-2), gS(11,6), gS(7,10), gS(22,-7), gS(18,-10), gS(9,-12),
           gS(16,-20), gS(12,-24), gS(16,-9), gS(5,0), gS(15,0), gS(15,-5), gS(21,-21), gS(8,-29),
           gS(-2,-32), gS(8,-7), gS(0,-4), gS(2,0), gS(7,-4), gS(-11,3), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-159,-57), gS(-31,-3), gS(-80,8), gS(-12,-2), gS(0,0), gS(-79,2), gS(-29,-4), gS(-89,-63),
           gS(-31,-8), gS(-17,0), gS(0,0), gS(21,6), gS(9,4), gS(30,-11), gS(-11,-1), gS(-16,-16),
           gS(-9,0), gS(9,3), gS(13,19), gS(30,6), gS(44,1), gS(48,6), gS(15,0), gS(13,-13),
           gS(7,0), gS(9,0), gS(16,14), gS(32,16), gS(19,18), gS(35,12), gS(10,0), gS(22,-11),
           gS(5,1), gS(13,5), gS(16,19), gS(19,15), gS(19,19), gS(25,12), gS(22,0), gS(8,-1),
           gS(-1,-20), gS(10,-7), gS(8,3), gS(17,14), gS(20,11), gS(19,0), gS(22,-10), gS(1,-11),
           gS(-3,-26), gS(-10,3), gS(5,-4), gS(7,7), gS(13,4), gS(14,-3), gS(1,0), gS(3,-15),
           gS(-39,-29), gS(-12,-13), gS(0,-4), gS(2,2), gS(8,4), gS(-1,-3), gS(-7,-4), gS(-18,-28),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,11), gS(-4,20), gS(-9,25), gS(0,10), gS(-9,17), gS(-12,15),
           gS(-13,1), gS(-27,24), gS(-13,25), gS(-29,47), gS(-47,66), gS(-24,33), gS(-16,37), gS(1,11),
           ...
           gS(-2,-32), gS(11,-23), gS(7,-5), gS(4,0), gS(4,0), gS(8,-5), gS(15,-11), gS(4,-27),
           gS(5,-52), gS(13,-57), gS(21,-57), gS(13,-32), gS(15,-29), gS(22,-64), gS(27,-79), gS(1,-44),
           gS(6,-62), gS(9,-68), gS(7,-75), gS(5,-56), gS(9,-63), gS(-3,-75), gS(0,-65), gS(12,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(88,112), gS(513,682), gS(354,375), gS(379,397), gS(1002,1263),
};
