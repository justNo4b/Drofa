...
const int  BISHOP_MOBILITY[14] = {
           gS(-18,-105), gS(-6,-46), gS(0,-18), gS(2,-2), gS(5,11), gS(6,22), gS(6,29),
...
const int  KING_MOBILITY[9] = {
           gS(11,-1), gS(14,-2), gS(8,4), gS(4,9), gS(-2,8),
           gS(-8,5), gS(-5,3), gS(-15,-2), gS(-9,-15),
};

const int  ROOK_MOBILITY[15] = {
           gS(-19,-102), gS(-11,-66), gS(-7,-33), gS(-5,-12), gS(-7,5), gS(-8,20), gS(-3,23),
           gS(1,26), gS(5,31), gS(10,35), gS(11,40), gS(16,42), gS(20,42), gS(34,28),
           gS(87,0),
};
...
const int  KNIGHT_ATTACKING_OUTPOST = gS(9,-4);
...
const int  PASSED_PAWN_RANKS[8] = {
           ...
           gS(14,55), gS(26,117), gS(79,129), gS(0,0),
};
...
const int  KING_PSQT_BLACK[64] = {
           ...
           gS(-1,-12), gS(-2,5), gS(-24,15), gS(-63,24), gS(-44,19), gS(-45,22), gS(0,2), gS(-4,-21),
           gS(-27,-56), gS(2,-29), gS(-30,-6), gS(-38,-27), gS(-29,-37), gS(-56,-7), gS(-5,-27), gS(-16,-74),
};
...
const int  PAWN_PSQT_BLACK[64] = {
           ...
           gS(-5,20), gS(5,25), gS(7,22), gS(22,6), gS(30,10), gS(31,14), gS(12,21), gS(-4,8),
           gS(-15,4), gS(-6,13), gS(-4,4), gS(4,3), gS(9,3), gS(5,5), gS(2,5), gS(-15,-5),
           gS(-20,-2), gS(-16,2), gS(-13,6), gS(-12,6), gS(-4,9), gS(-3,8), gS(2,-3), gS(-15,-13),
           gS(-18,0), gS(-12,5), gS(-18,15), gS(-10,16), gS(-14,21), gS(6,17), gS(7,0), gS(-18,-17),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int  ROOK_PSQT_BLACK[64] = {
           ...
           gS(-18,0), gS(-10,11), gS(-12,12), gS(-1,4), gS(-2,3), gS(-9,8), gS(4,4), gS(-13,-2),
...
const int  BISHOP_PSQT_BLACK[64] = {
           gS(-50,6), gS(-43,8), gS(-76,17), gS(-79,23), gS(-66,19), gS(-91,16), gS(-15,0), gS(-49,0),
           gS(-48,1), gS(-10,4), gS(-7,8), gS(-14,17), gS(-7,15), gS(0,8), gS(-26,6), gS(-21,-4),
           gS(4,0), gS(4,7), gS(25,3), gS(8,9), gS(25,7), gS(11,9), gS(26,2), gS(17,-2),
           gS(-9,0), gS(20,5), gS(5,5), gS(22,15), gS(19,14), gS(16,3), gS(20,1), gS(-7,0),
           gS(0,-12), gS(7,-2), gS(11,8), gS(18,7), gS(25,7), gS(4,5), gS(14,-1), gS(3,-15),
           gS(0,-17), gS(11,-7), gS(7,-4), gS(14,1), gS(9,3), gS(12,-6), gS(13,-9), gS(14,-11),
           gS(8,-29), gS(9,-33), gS(11,-16), gS(4,-2), gS(8,-3), gS(9,-16), gS(18,-27), gS(4,-40),
           gS(6,-37), gS(1,-15), gS(1,-4), gS(1,-7), gS(1,-3), gS(0,-8), gS(-2,-10), gS(3,-37),
};

const int  KNIGHT_PSQT_BLACK[64] = {
           gS(-143,-69), gS(-35,-19), gS(-64,11), gS(-14,0), gS(0,1), gS(-52,13), gS(-28,-11), gS(-87,-70),
           gS(-10,-24), gS(-11,-5), gS(32,-4), gS(49,17), gS(37,16), gS(54,-12), gS(-21,-3), gS(-7,-21),
           gS(-19,-18), gS(12,-4), gS(33,30), gS(31,31), gS(59,19), gS(45,24), gS(28,-12), gS(4,-16),
           gS(0,-10), gS(8,5), gS(27,28), gS(25,39), gS(15,36), gS(39,22), gS(16,8), gS(7,-7),
           gS(-4,-9), gS(10,8), gS(15,30), gS(21,31), gS(24,34), gS(20,32), gS(26,11), gS(7,-1),
           gS(-18,-34), gS(1,-7), gS(5,8), gS(13,22), gS(17,20), gS(13,5), gS(7,-2), gS(-4,-27),
           gS(-21,-17), gS(-28,-2), gS(-6,-13), gS(7,4), gS(1,6), gS(0,-12), gS(-17,-3), gS(-11,-4),
...
const int  QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-18,0), gS(-57,41), gS(-17,30), gS(-41,73), gS(-50,111), gS(-1,71), gS(-57,72), gS(-19,39),
