...
const int PASSED_PAWN_RANKS[7] = {
           ...
           gS(16,54), gS(28,79), gS(53,87),
};

const int PASSED_PAWN_FILES[8] = {
           gS(0,21), gS(-1,12), gS(1,5), gS(1,-5),
           gS(-5,-3), gS(-4,4), gS(-4,13), gS(0,15),
};
...
const int CANDIDATE_PASSED_PAWN[6] = {
           gS(0,0), gS(-15,3), gS(-9,8), gS(0,14),
           gS(2,32), gS(14,41),
};

const int CANDIDATE_ENEMY_KING_DISTANCE[8] = {
           gS(0,0), gS(5,1), gS(3,-2), gS(-3,0),
           gS(-1,3), gS(0,6), gS(1,3), gS(0,0),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-7,3), gS(6,10), gS(0,12), gS(0,6),
           gS(-8,5), gS(-22,0), gS(-5,17), gS(0,0),
};
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(16,11), gS(15,11), gS(15,10), gS(16,8), gS(28,-1), gS(29,9), gS(54,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-1,-93), gS(10,-33), gS(17,-6), gS(22,3), gS(26,10),
           gS(29,14), gS(33,10), gS(36,3), gS(39,-5),
};

const int KING_MOBILITY[9] = {
           gS(14,-29), gS(5,-5), gS(0,4), gS(-2,10), gS(-6,8),
...
const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-158), gS(-5,-111), gS(-5,-73), gS(-4,-52), gS(-3,-34), gS(-2,-17),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-2,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(5,24), gS(9,14), gS(-35,-15),
           gS(-13,-25), gS(0,1), gS(-3,16), gS(-15,25), gS(-14,24), gS(-21,18), gS(-1,1), gS(-44,-19),
           ...
           gS(-16,-55), gS(4,-39), gS(-15,-18), gS(-34,-15), gS(11,-47), gS(-13,-26), gS(3,-36), gS(-1,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,68), gS(40,78), gS(36,66), gS(64,53), gS(64,58), gS(48,64), gS(0,85), gS(1,74),
           gS(1,30), gS(9,29), gS(25,11), gS(42,0), gS(43,0), gS(71,5), gS(27,24), gS(26,16),
           gS(-10,15), gS(3,11), gS(8,0), gS(15,-1), gS(22,-2), gS(21,0), gS(25,1), gS(-1,7),
           gS(-21,3), gS(-20,12), gS(-7,0), gS(11,-3), gS(10,-4), gS(11,-3), gS(-3,2), gS(-15,-3),
           gS(-23,-2), gS(-18,0), gS(-6,-4), gS(-4,-1), gS(1,-1), gS(1,-2), gS(-2,-6), gS(-18,-8),
           gS(-34,5), gS(-15,5), gS(-14,7), gS(0,6), gS(0,9), gS(2,5), gS(-3,2), gS(-25,-3),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-7,17), gS(-9,7), gS(-3,0), gS(-2,2), gS(-6,5), gS(-5,20), gS(-4,13),
           gS(-2,-5), gS(-4,-1), gS(-10,-8), gS(0,-20), gS(-1,-13), gS(-6,-4), gS(-7,0), gS(-3,0),
           gS(0,-17), gS(-3,-9), gS(1,-13), gS(0,-26), gS(0,-22), gS(0,-6), gS(-5,-1), gS(0,0),
           gS(0,-27), gS(-3,-5), gS(-6,-9), gS(-5,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-27),
           gS(0,-41), gS(-1,-20), gS(-5,-7), gS(-11,-1), gS(-7,0), gS(1,-2), gS(1,-10), gS(0,-48),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,9), gS(-8,12), gS(-9,11), gS(-3,0), gS(-2,1), gS(-6,1), gS(-2,20), gS(-4,7),
           gS(0,-2), gS(0,0), gS(-2,-1), gS(1,-17), gS(0,-14), gS(-2,-8), gS(-10,-3), gS(0,0),
           gS(0,11), gS(0,0), gS(2,-6), gS(0,-9), gS(0,-7), gS(0,-8), gS(0,0), gS(0,-1),
           gS(4,1), gS(0,5), gS(0,3), gS(-4,3), gS(-2,6), gS(-2,9), gS(4,-3), gS(8,0),
           gS(6,26), gS(0,14), gS(-1,22), gS(-1,19), gS(-4,16), gS(4,19), gS(6,14), gS(10,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(3,17), gS(20,9), gS(19,10), gS(27,1), gS(43,-4), gS(37,-2), gS(29,1), gS(-3,12),
           ...
           gS(-21,-8), gS(-4,-10), gS(0,-8), gS(0,-10), gS(12,-16), gS(8,-23), gS(5,-23), gS(-39,-11),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-7,-2), gS(9,5), gS(4,2), gS(22,9), gS(15,10), gS(12,4), gS(7,0), gS(-1,-10),
           gS(6,-6), gS(-2,3), gS(8,4), gS(19,7), gS(23,5), gS(6,3), gS(8,0), gS(6,-17),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-10,-1), gS(9,2), gS(13,19), gS(30,5), gS(44,0), gS(47,5), gS(15,-2), gS(13,-13),
           ...
           gS(-40,-29), gS(-13,-15), gS(0,-4), gS(1,3), gS(9,4), gS(-2,-3), gS(-7,-5), gS(-19,-30),
};
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,54), gS(-5,37), gS(-4,27), gS(4,-4),
...
const int MATERIAL_VALUES[5] = {
           gS(85,113), gS(508,682), gS(354,375), gS(377,396), gS(1002,1263),
};
