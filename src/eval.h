...
const int KING_LOW_DANGER = gS(73,-77);

const int BISHOP_PAIR_BONUS = gS(32,50);
...
const int PASSED_PAWN_RANKS[7] = {
           ...
           gS(16,53), gS(28,78), gS(54,87),
};

const int PASSED_PAWN_FILES[8] = {
           gS(0,21), gS(-2,12), gS(1,5), gS(1,-5),
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(7,0), gS(14,23), gS(15,4), gS(25,8),
           gS(10,0), gS(-18,-1), gS(-3,14), gS(10,0),
};

const int BISHOP_WEAK_PAWNS[5] = {
           gS(4,-8), gS(-1,-2), gS(-2,2), gS(-2,6), gS(0,7),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-6,-62), gS(2,-24), gS(9,-12), gS(14,-1), gS(17,6), gS(18,9), gS(17,11),
           gS(16,11), gS(15,12), gS(15,11), gS(16,8), gS(28,0), gS(30,10), gS(55,-11),
};
...
const int QUEEN_MOBILITY[28] = {
           ...
           gS(2,41), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(10,37), gS(13,29),
           gS(16,23), gS(9,25), gS(19,16), gS(0,13), gS(6,9), gS(11,14), gS(9,11),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-2,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(6,23), gS(11,13), gS(-35,-15),
           gS(-14,-24), gS(1,0), gS(-3,16), gS(-16,25), gS(-14,24), gS(-21,18), gS(-1,1), gS(-45,-18),
           gS(-17,-27), gS(11,-6), gS(-12,8), gS(-30,19), gS(-25,18), gS(-23,10), gS(-1,-5), gS(-9,-26),
...
const int PAWN_PSQT_BLACK[64] = {
           ...
           gS(1,30), gS(9,30), gS(25,12), gS(42,0), gS(44,0), gS(71,6), gS(27,25), gS(26,17),
           gS(-9,15), gS(2,11), gS(8,0), gS(15,-1), gS(22,-2), gS(22,0), gS(25,1), gS(-1,7),
           gS(-21,3), gS(-19,12), gS(-6,0), gS(11,-3), gS(10,-4), gS(11,-3), gS(-3,2), gS(-15,-3),
           gS(-23,-2), gS(-17,0), gS(-6,-4), gS(-4,-1), gS(1,-1), gS(1,-2), gS(-1,-6), gS(-18,-8),
           gS(-33,5), gS(-15,6), gS(-14,7), gS(0,6), gS(0,9), gS(2,5), gS(-2,1), gS(-24,-3),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-2,-4), gS(-3,-1), gS(-10,-8), gS(0,-20), gS(-1,-13), gS(-6,-4), gS(-7,0), gS(-3,0),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-2,9), gS(-7,11), gS(-8,10), gS(-2,0), gS(-2,1), gS(-6,1), gS(-2,19), gS(-4,7),
           gS(0,-3), gS(0,0), gS(-2,-1), gS(0,-17), gS(0,-14), gS(-2,-8), gS(-9,-3), gS(0,0),
           gS(0,10), gS(0,0), gS(2,-7), gS(0,-10), gS(0,-8), gS(0,-8), gS(0,0), gS(0,-1),
           gS(4,0), gS(0,5), gS(0,3), gS(-4,4), gS(-2,6), gS(-2,9), gS(4,-4), gS(8,0),
           gS(6,25), gS(0,13), gS(-1,21), gS(-1,17), gS(-4,14), gS(4,19), gS(6,14), gS(10,14),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-20,-8), gS(-4,-10), gS(0,-7), gS(0,-10), gS(12,-16), gS(8,-23), gS(5,-23), gS(-39,-11),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(1,1), gS(0,3), gS(24,-3), gS(16,0), gS(22,0), gS(8,0), gS(8,-5),
           gS(-7,-1), gS(9,5), gS(4,2), gS(22,9), gS(16,10), gS(12,4), gS(8,0), gS(-1,-10),
           gS(6,-7), gS(-1,3), gS(8,4), gS(19,7), gS(23,5), gS(6,3), gS(8,0), gS(7,-17),
           ...
           gS(-2,-32), gS(8,-7), gS(-1,-2), gS(2,0), gS(7,-3), gS(-11,4), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-158,-58), gS(-31,-5), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-78,2), gS(-29,-5), gS(-89,-64),
           gS(-31,-9), gS(-17,0), gS(-1,0), gS(22,5), gS(9,3), gS(30,-12), gS(-11,-1), gS(-16,-16),
           gS(-10,-1), gS(10,2), gS(14,19), gS(31,6), gS(45,0), gS(47,5), gS(15,-1), gS(13,-13),
           ...
           gS(-40,-30), gS(-13,-15), gS(-1,-5), gS(1,2), gS(9,4), gS(-2,-3), gS(-7,-5), gS(-19,-30),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,13), gS(-4,22), gS(-9,27), gS(0,12), gS(-9,19), gS(-11,16),
           gS(-13,1), gS(-27,25), gS(-13,25), gS(-30,49), gS(-47,68), gS(-24,35), gS(-16,39), gS(1,13),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,46), gS(0,38), gS(6,15), gS(-9,16),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,54), gS(-6,38), gS(-4,28), gS(4,-3),
           ...
           gS(6,-62), gS(8,-70), gS(6,-76), gS(5,-57), gS(8,-64), gS(-3,-75), gS(0,-67), gS(12,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(86,113), gS(507,682), gS(353,376), gS(378,398), gS(1000,1266),
};
