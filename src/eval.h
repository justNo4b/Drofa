...
const int KING_LOW_DANGER = gS(65,-65);
...
const int PASSED_PASSED_DISTANCE[8] = {
           gS(-7,-22), gS(16,3), gS(0,-19), gS(-8,-6),
           gS(-11,-8), gS(-20,-8), gS(-18,-11), gS(-17,-9),
};
...
const int KING_PASSER_DISTANCE_ENEMY[8] = {
           ...
           gS(3,11), gS(-2,22), gS(-1,23), gS(-10,21),
};
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-65,-40), gS(-50,-45), gS(-54,-67), gS(-49,-26),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(16,33), gS(14,35), gS(14,30),
};
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(18,14), gS(19,15), gS(21,13), gS(24,11), gS(38,2), gS(36,15), gS(63,-8),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-4,-91), gS(8,-35), gS(15,-8), gS(20,2), gS(25,10),
           gS(29,16), gS(33,14), gS(37,8), gS(41,0),
};

const int KING_MOBILITY[9] = {
           gS(19,-17), gS(10,-3), gS(4,3), gS(0,8), gS(-4,6),
           gS(-11,5), gS(-5,4), gS(-9,0), gS(0,-17),
};
...
const int QUEEN_MOBILITY[28] = {
           ...
           gS(-3,-3), gS(-1,9), gS(0,20), gS(1,26), gS(2,32), gS(4,35), gS(5,38),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-17,-24), gS(7,0), gS(-3,16), gS(-24,27), gS(-18,25), gS(-21,18), gS(0,2), gS(-51,-16),
           gS(-28,-23), gS(8,-4), gS(-17,10), gS(-39,22), gS(-35,21), gS(-28,12), gS(-5,-2), gS(-19,-22),
           gS(0,-26), gS(-3,-4), gS(0,1), gS(-22,12), gS(-23,12), gS(-2,2), gS(-7,-3), gS(-1,-29),
           gS(-19,-53), gS(3,-37), gS(-16,-16), gS(-31,-16), gS(14,-46), gS(-11,-26), gS(2,-34), gS(-2,-66),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,79), gS(42,68), gS(65,58), gS(65,63), gS(56,64), gS(-2,86), gS(0,76),
           gS(2,34), gS(10,35), gS(24,22), gS(47,10), gS(47,11), gS(72,15), gS(31,28), gS(27,20),
           gS(-8,14), gS(0,15), gS(11,4), gS(18,7), gS(25,6), gS(25,2), gS(23,4), gS(0,7),
           gS(-21,0), gS(-18,7), gS(-7,0), gS(11,1), gS(11,0), gS(11,-2), gS(-1,-1), gS(-14,-6),
           gS(-23,-5), gS(-20,-2), gS(-4,-4), gS(-4,2), gS(2,2), gS(3,-2), gS(0,-9), gS(-18,-11),
           gS(-27,4), gS(-14,4), gS(-13,9), gS(0,10), gS(-2,13), gS(6,6), gS(0,0), gS(-17,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-1,7), gS(-3,7), gS(-4,4), gS(-1,0), gS(0,1), gS(-2,1), gS(-2,10), gS(-1,8),
           gS(-3,-2), gS(-3,0), gS(-6,-7), gS(0,-18), gS(-1,-12), gS(-5,-5), gS(-8,0), gS(-2,0),
           gS(-1,-9), gS(-3,-7), gS(0,-11), gS(0,-22), gS(-1,-17), gS(-1,-7), gS(-5,0), gS(-1,0),
           gS(0,-19), gS(-4,-4), gS(-5,-8), gS(-4,0), gS(-6,-5), gS(-6,0), gS(0,-5), gS(0,-18),
           gS(0,-27), gS(-2,-14), gS(-4,-2), gS(-7,0), gS(-6,3), gS(0,0), gS(0,-4), gS(0,-34),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-1,6), gS(-4,6), gS(-4,5), gS(-1,0), gS(0,0), gS(-3,0), gS(-1,8), gS(-2,4),
           gS(0,-3), gS(-1,0), gS(-2,-4), gS(0,-17), gS(0,-13), gS(-1,-8), gS(-9,-4), gS(-2,0),
           gS(0,3), gS(0,-2), gS(2,-7), gS(0,-13), gS(0,-11), gS(0,-9), gS(-1,-1), gS(-1,-5),
           gS(2,-2), gS(0,3), gS(0,0), gS(-3,3), gS(-2,3), gS(-2,5), gS(2,-5), gS(5,-3),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-38,0), gS(-17,0), gS(-10,0), gS(-12,12), gS(-9,9), gS(-7,2), gS(-26,-4), gS(-22,-5),
           gS(-4,0), gS(0,3), gS(1,4), gS(19,-1), gS(21,0), gS(5,0), gS(7,0), gS(11,-5),
           gS(-8,-1), gS(11,5), gS(2,3), gS(24,7), gS(15,9), gS(17,3), gS(9,0), gS(2,-9),
           gS(9,-6), gS(-1,3), gS(11,3), gS(19,6), gS(24,4), gS(5,4), gS(10,0), gS(11,-16),
           gS(5,-13), gS(22,-7), gS(11,-5), gS(11,5), gS(6,10), gS(21,-8), gS(18,-10), gS(10,-10),
           gS(18,-22), gS(12,-26), gS(16,-11), gS(5,0), gS(14,0), gS(14,-6), gS(21,-23), gS(8,-32),
           gS(-1,-33), gS(9,-9), gS(-1,-2), gS(3,-1), gS(7,-4), gS(-11,4), gS(0,-9), gS(0,-26),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-151,-62), gS(-31,-9), gS(-75,8), gS(-13,-2), gS(0,0), gS(-70,2), gS(-29,-4), gS(-89,-64),
           gS(-27,-9), gS(-12,2), gS(3,0), gS(29,8), gS(16,5), gS(34,-9), gS(-10,0), gS(-9,-16),
           gS(-10,-2), gS(15,1), gS(17,20), gS(29,10), gS(52,2), gS(38,6), gS(14,-2), gS(12,-13),
           gS(9,-1), gS(8,1), gS(17,15), gS(34,18), gS(24,15), gS(38,11), gS(14,-5), gS(27,-10),
           gS(1,1), gS(13,4), gS(16,22), gS(24,18), gS(26,24), gS(30,14), gS(26,1), gS(12,0),
           gS(-8,-18), gS(9,-5), gS(9,7), gS(20,20), gS(23,16), gS(20,4), gS(24,-7), gS(1,-8),
           gS(-8,-25), gS(-10,4), gS(1,-5), gS(5,7), gS(10,6), gS(9,-4), gS(0,2), gS(0,-14),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-9,-15), gS(0,-1), gS(-3,22), gS(3,40), gS(0,51), gS(3,49), gS(9,22), gS(-4,26),
           gS(-3,-20), gS(-8,5), gS(-3,16), gS(-2,41), gS(-7,57), gS(-4,47), gS(-5,35), gS(5,1),
...
const int MATERIAL_VALUES[5] = {
           gS(83,112), gS(491,687), gS(348,381), gS(371,403), gS(991,1284),
};
