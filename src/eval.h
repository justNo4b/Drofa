...
const int BISHOP_MOBILITY[14] = {
           gS(-24,-101), gS(-12,-42), gS(-6,-16), gS(-2,0), gS(0,13), gS(2,23), gS(1,30),
           gS(0,33), gS(1,36), gS(5,34), gS(11,32), gS(27,21), gS(44,33), gS(75,-2),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-4,-70), gS(2,-23), gS(4,0), gS(6,13), gS(9,21),
           gS(11,27), gS(15,25), gS(22,17), gS(31,2),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-22,-105), gS(-14,-69), gS(-9,-35), gS(-7,-14), gS(-8,4), gS(-9,18), gS(-4,21),
           gS(0,25), gS(4,30), gS(9,35), gS(11,40), gS(17,44), gS(21,44), gS(36,33),
           gS(89,3),
};

const int QUEEN_MOBILITY[28] = {
           gS(-44,-116), gS(-22,-188), gS(-10,-133), gS(-7,-76), gS(-5,-43), gS(-3,-21), gS(-1,-3),
           gS(0,8), gS(3,17), gS(5,23), gS(6,30), gS(7,34), gS(7,38), gS(7,43),
           gS(6,49), gS(3,53), gS(2,56), gS(2,56), gS(2,57), gS(7,52), gS(12,47),
           gS(10,42), gS(9,40), gS(21,28), gS(10,24), gS(20,23), gS(26,29), gS(24,26),
};
...
const int KING_PASSER_DISTANCE_FRIENDLY[9] = {
           gS(0,0), gS(8,34), gS(2,25), gS(0,11),
           gS(1,0), gS(1,-3), gS(16,-9), gS(5,-20),
           gS(0,-10),
};

const int KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(28,32), gS(-19,23), gS(-4,2),
           gS(-4,-10), gS(-3,-21), gS(3,-31), gS(12,-38),
           gS(0,-10),
};
...
const int HANGING_PIECE[5] = {
           gS(-2,12), gS(-30,-18), gS(-31,-51), gS(-35,-78), gS(-23,-15),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(0,-9), gS(1,14), gS(9,9), gS(-7,19),
           gS(-2,5), gS(-2,-30), gS(4,-9), gS(4,5),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,10), gS(-7,28), gS(17,7), gS(-1,21),
...
const int PAWN_CONNECTED[7] = {
           gS(0,0), gS(4,0), gS(8,2), gS(7,9),
           gS(16,33), gS(19,39), gS(1,9),
};

const int PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-10,-7), gS(-13,5), gS(-6,41),
           gS(24,51), gS(41,77), gS(80,95), gS(0,0),
};

const int PASSED_PAWN_FILES[8] = {
           gS(15,15), gS(9,12), gS(4,2), gS(2,-1),
           gS(0,-2), gS(-10,1), gS(-5,13), gS(12,12),
};

const int PASSED_PAWN_FREE[7] = {
           gS(0,0), gS(-7,8), gS(-11,2), gS(-8,5),
           gS(-8,10), gS(-12,30), gS(18,29),
};

const int PASSED_PAWN_POS_ADVANCE[7] = {
           gS(0,0), gS(4,5), gS(5,1), gS(6,13),
           gS(0,27), gS(-2,70), gS(-4,97),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-11,-17), gS(0,12), gS(-9,-5), gS(-10,1),
           gS(-11,1), gS(-8,0), gS(-12,-2), gS(-12,-2),
};


const int KING_PSQT_BLACK[64] = {
           gS(-13,-104), gS(0,-47), gS(0,-33), gS(0,-15), gS(0,-32), gS(0,-27), gS(0,-25), gS(-12,-94),
           gS(-13,-37), gS(0,25), gS(5,19), gS(0,3), gS(0,0), gS(3,16), gS(0,32), gS(-12,-38),
           ...
           gS(-12,-11), gS(-22,8), gS(-14,13), gS(-54,23), gS(-36,18), gS(-34,20), gS(-21,6), gS(-18,-19),
           gS(-28,-58), gS(-1,-27), gS(-32,-3), gS(-24,-26), gS(-15,-37), gS(-43,-5), gS(-4,-26), gS(-15,-74),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(63,65), gS(42,84), gS(60,81), gS(69,69), gS(77,68), gS(80,71), gS(-2,89), gS(-13,77),
           gS(0,46), gS(26,42), gS(39,35), gS(44,17), gS(53,18), gS(91,25), gS(56,33), gS(13,34),
           gS(-2,19), gS(3,15), gS(4,11), gS(19,-3), gS(28,0), gS(27,3), gS(8,13), gS(0,9),
           gS(-11,4), gS(-8,7), gS(-4,-2), gS(2,-3), gS(8,-3), gS(3,0), gS(0,0), gS(-9,-5),
           gS(-18,-1), gS(-19,0), gS(-16,3), gS(-14,4), gS(-7,7), gS(-8,6), gS(-6,-5), gS(-14,-11),
           gS(-13,3), gS(-10,5), gS(-14,15), gS(-6,16), gS(-12,22), gS(8,17), gS(7,2), gS(-10,-14),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(24,28), gS(20,33), gS(0,41), gS(8,36), gS(13,36), gS(25,36), gS(41,31), gS(52,27),
           ...
           gS(-55,-14), gS(-17,-18), gS(-10,-13), gS(-4,-17), gS(-3,-17), gS(-2,-21), gS(-2,-22), gS(-54,-13),
           gS(-17,-17), gS(-10,-15), gS(-6,-11), gS(0,-18), gS(-1,-17), gS(-3,-7), gS(-2,-16), gS(-11,-26),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(0,4), gS(0,9), gS(15,6), gS(4,9), gS(22,8), gS(4,12), gS(21,3), gS(13,0),
           gS(-11,0), gS(15,5), gS(2,6), gS(23,13), gS(20,13), gS(14,4), gS(17,2), gS(-4,1),
           gS(-3,-10), gS(3,-1), gS(10,7), gS(17,8), gS(24,7), gS(2,6), gS(11,0), gS(0,-11),
           gS(-3,-17), gS(10,-8), gS(6,-3), gS(12,3), gS(8,4), gS(10,-4), gS(11,-9), gS(12,-11),
           gS(9,-35), gS(8,-32), gS(10,-16), gS(3,-2), gS(7,-3), gS(8,-14), gS(17,-27), gS(5,-46),
           gS(5,-38), gS(2,-16), gS(0,-2), gS(0,-6), gS(0,-2), gS(-1,-6), gS(-1,-11), gS(2,-39),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-145,-63), gS(-37,-20), gS(-69,11), gS(-14,0), gS(0,0), gS(-56,13), gS(-30,-12), gS(-99,-70),
           gS(-17,-21), gS(-12,-6), gS(19,-1), gS(44,18), gS(38,17), gS(47,-10), gS(-21,-3), gS(-11,-20),
           gS(-17,-16), gS(5,0), gS(32,31), gS(32,31), gS(53,22), gS(44,27), gS(24,-6), gS(5,-15),
           gS(3,-10), gS(12,3), gS(30,27), gS(31,40), gS(23,33), gS(44,20), gS(22,3), gS(13,-8),
           gS(-4,-8), gS(12,8), gS(17,31), gS(24,34), gS(28,36), gS(22,32), gS(28,11), gS(6,0),
           gS(-19,-33), gS(2,-5), gS(7,10), gS(15,26), gS(18,24), gS(15,8), gS(8,0), gS(-4,-25),
           gS(-21,-19), gS(-27,-1), gS(-5,-10), gS(7,8), gS(2,10), gS(0,-7), gS(-14,-2), gS(-11,-6),
           gS(-40,-49), gS(-14,-29), gS(-11,-17), gS(-9,4), gS(-1,2), gS(-8,-10), gS(-12,-20), gS(-41,-47),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-2,3), gS(0,21), gS(0,38), gS(4,52), gS(10,64), gS(31,49), gS(4,48), gS(13,34),
           gS(-17,-7), gS(-53,27), gS(-15,19), gS(-40,67), gS(-37,100), gS(0,70), gS(-52,65), gS(-17,30),
           gS(-14,-19), gS(-7,-19), gS(-9,11), gS(-9,41), gS(2,60), gS(15,78), gS(34,42), gS(6,55),
           ...
           gS(-2,-66), gS(0,-78), gS(2,-82), gS(6,-65), gS(7,-71), gS(1,-85), gS(5,-84), gS(-4,-75),
};
