...
const int ISOLATED_PAWN_PENALTY = gS(-8,-6);
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-65,-40), gS(-49,-45), gS(-53,-67), gS(-49,-25),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-5,2), gS(3,10), gS(4,10), gS(-1,13),
           gS(-7,5), gS(-18,-4), gS(-5,10), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(10,0), gS(11,24), gS(19,6), gS(23,16),
...
const int KING_MOBILITY[9] = {
           gS(19,-17), gS(10,-3), gS(4,4), gS(0,8), gS(-4,6),
...
const int QUEEN_MOBILITY[28] = {
           gS(-15,-114), gS(-10,-167), gS(-10,-111), gS(-8,-69), gS(-7,-47), gS(-6,-31), gS(-4,-15),
           gS(-3,-3), gS(-1,9), gS(0,20), gS(1,26), gS(2,32), gS(4,35), gS(5,38),
           gS(5,41), gS(6,44), gS(6,46), gS(9,42), gS(11,41), gS(13,39), gS(14,32),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-18,-24), gS(7,0), gS(-3,16), gS(-24,27), gS(-18,25), gS(-22,18), gS(0,2), gS(-51,-17),
           gS(-28,-23), gS(8,-4), gS(-17,10), gS(-39,22), gS(-35,21), gS(-28,12), gS(-5,-2), gS(-19,-22),
           gS(0,-26), gS(-3,-4), gS(0,1), gS(-22,12), gS(-22,12), gS(-2,3), gS(-6,-3), gS(-1,-29),
           gS(-19,-53), gS(3,-36), gS(-16,-16), gS(-31,-16), gS(14,-46), gS(-11,-26), gS(2,-34), gS(-2,-66),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,80), gS(42,68), gS(65,58), gS(65,63), gS(56,64), gS(-2,86), gS(0,76),
           gS(2,34), gS(9,35), gS(24,21), gS(47,9), gS(47,10), gS(72,14), gS(31,28), gS(27,20),
           gS(-9,13), gS(0,13), gS(10,2), gS(18,6), gS(25,4), gS(25,1), gS(22,3), gS(0,5),
           gS(-20,1), gS(-18,7), gS(-7,0), gS(11,1), gS(12,0), gS(12,-2), gS(0,-1), gS(-14,-5),
           gS(-23,-4), gS(-20,-1), gS(-4,-4), gS(-3,3), gS(2,3), gS(3,-1), gS(0,-8), gS(-18,-10),
           gS(-27,4), gS(-14,4), gS(-12,9), gS(0,10), gS(-2,13), gS(5,6), gS(0,0), gS(-17,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-1,-9), gS(-3,-7), gS(0,-11), gS(0,-22), gS(-1,-17), gS(-1,-6), gS(-5,0), gS(0,0),
           gS(0,-19), gS(-4,-4), gS(-4,-9), gS(-4,0), gS(-6,-5), gS(-6,1), gS(0,-5), gS(0,-18),
           gS(0,-27), gS(-2,-15), gS(-5,-2), gS(-7,0), gS(-6,3), gS(0,0), gS(0,-4), gS(0,-34),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-1,6), gS(-4,6), gS(-3,5), gS(-1,0), gS(0,0), gS(-3,0), gS(-1,8), gS(-3,4),
           gS(0,-3), gS(-1,0), gS(-2,-4), gS(0,-17), gS(0,-13), gS(-1,-8), gS(-8,-4), gS(-2,0),
           gS(0,3), gS(0,-2), gS(2,-7), gS(0,-13), gS(0,-11), gS(0,-8), gS(-1,-1), gS(0,-5),
...
const int ROOK_PSQT_BLACK[64] = {
           gS(25,13), gS(15,22), gS(0,28), gS(1,21), gS(8,20), gS(17,20), gS(30,16), gS(40,14),
           gS(6,16), gS(0,17), gS(18,12), gS(33,5), gS(26,7), gS(32,2), gS(0,14), gS(11,11),
           gS(3,18), gS(20,9), gS(18,11), gS(29,1), gS(43,-3), gS(41,-2), gS(32,0), gS(0,12),
           ...
           gS(-22,-9), gS(-5,-10), gS(0,-7), gS(0,-10), gS(11,-15), gS(9,-22), gS(5,-23), gS(-39,-11),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-9,-1), gS(10,5), gS(1,3), gS(24,7), gS(14,9), gS(16,2), gS(8,1), gS(2,-9),
           ...
           gS(19,-22), gS(12,-25), gS(17,-11), gS(6,0), gS(15,-1), gS(15,-6), gS(21,-23), gS(8,-32),
           gS(-1,-34), gS(10,-9), gS(0,-2), gS(4,-1), gS(8,-4), gS(-11,4), gS(0,-9), gS(0,-26),
};
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-10,-1), gS(15,1), gS(17,21), gS(30,11), gS(52,2), gS(38,6), gS(14,-2), gS(12,-13),
           gS(8,-2), gS(7,1), gS(16,15), gS(32,18), gS(23,16), gS(36,9), gS(13,-6), gS(24,-10),
           gS(0,1), gS(13,4), gS(16,21), gS(24,18), gS(25,23), gS(29,14), gS(26,1), gS(11,0),
           gS(-8,-18), gS(10,-5), gS(9,6), gS(21,20), gS(24,16), gS(20,4), gS(25,-7), gS(1,-8),
           gS(-7,-24), gS(-10,4), gS(1,-5), gS(6,7), gS(11,7), gS(10,-3), gS(0,2), gS(0,-14),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-3,-20), gS(-8,5), gS(-3,15), gS(-2,41), gS(-8,57), gS(-4,47), gS(-5,35), gS(5,1),
...
const int MATERIAL_VALUES[5] = {
           gS(83,113), gS(491,687), gS(347,381), gS(371,403), gS(991,1285),
};
