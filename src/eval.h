...
const int KING_HIGH_DANGER = gS(-44,-63);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-18,0), gS(-11,6), gS(0,10),
           gS(4,31), gS(8,54), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(9,16), gS(0,7), gS(0,1), gS(-6,-1),
};

const int BACKWARD_PAWN[7] = {
           gS(0,0), gS(-1,-5), gS(2,-4), gS(-1,-7),
           gS(0,-4), gS(0,0), gS(0,0),
};

const int BACKWARD_OPEN_PAWN[7] = {
           gS(0,0), gS(-13,-11), gS(-6,-11), gS(-5,-10),
           gS(0,-5), gS(0,0), gS(0,0),
};

const int PAWN_STORM_UNBLOCKED[7] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-10,13), gS(-1,25), gS(7,22),
};

const int PAWN_STORM_BLOCKED[7] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(2,0), gS(-19,-6), gS(0,0),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-64), gS(3,-25), gS(10,-13), gS(15,-2), gS(17,6), gS(18,10), gS(17,12),
           gS(16,12), gS(15,13), gS(15,12), gS(17,9), gS(28,0), gS(30,10), gS(45,-9),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-35), gS(16,-8), gS(21,1), gS(24,9),
           gS(27,13), gS(30,9), gS(34,3), gS(36,-5),
};

const int KING_MOBILITY[9] = {
           gS(14,-30), gS(5,-3), gS(0,4), gS(-2,8), gS(-5,7),
           gS(-9,5), gS(0,2), gS(0,-1), gS(13,-14),
};

const int ROOK_MOBILITY[15] = {
           gS(-28,-89), gS(-15,-52), gS(-8,-32), gS(0,-19), gS(2,-7), gS(0,5), gS(4,7),
           gS(6,7), gS(9,12), gS(12,16), gS(13,21), gS(15,23), gS(20,21), gS(26,21),
           gS(48,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-149), gS(-6,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-18),
           gS(-1,-5), gS(0,6), gS(0,17), gS(0,24), gS(1,29), gS(2,34), gS(2,37),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,0), gS(27,26), gS(9,38), gS(0,39), gS(0,40), gS(17,37), gS(11,29), gS(0,-1),
           gS(0,-11), gS(11,16), gS(-1,27), gS(-7,35), gS(-8,33), gS(0,26), gS(8,16), gS(-29,-14),
           gS(-10,-23), gS(0,2), gS(-4,16), gS(-14,23), gS(-14,22), gS(-21,17), gS(-1,1), gS(-37,-20),
           gS(-6,-29), gS(12,-6), gS(-11,6), gS(-30,16), gS(-25,15), gS(-22,8), gS(0,-6), gS(-6,-28),
           gS(5,-31), gS(0,-9), gS(-2,-1), gS(-22,6), gS(-23,7), gS(-2,-1), gS(-2,-9), gS(5,-34),
           gS(-13,-57), gS(8,-41), gS(-11,-20), gS(-34,-18), gS(10,-47), gS(-13,-28), gS(6,-38), gS(1,-70),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(49,68), gS(40,73), gS(35,64), gS(65,49), gS(59,56), gS(40,60), gS(0,80), gS(0,67),
           gS(-1,30), gS(5,27), gS(24,9), gS(36,0), gS(35,0), gS(65,2), gS(21,21), gS(20,12),
           gS(-17,15), gS(-2,9), gS(0,0), gS(6,-1), gS(12,-2), gS(10,0), gS(17,0), gS(-9,4),
           gS(-28,5), gS(-24,11), gS(-10,-1), gS(5,-4), gS(4,-5), gS(5,-4), gS(-7,0), gS(-22,-5),
           gS(-28,-1), gS(-21,0), gS(-8,-4), gS(-6,0), gS(0,-1), gS(-1,-2), gS(-4,-7), gS(-23,-10),
           gS(-38,7), gS(-18,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,5), gS(-5,0), gS(-28,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-3,15), gS(-2,10), gS(0,7), gS(0,3), gS(0,1), gS(0,1), gS(0,1), gS(0,7),
           gS(-7,12), gS(-7,18), gS(-12,8), gS(-2,0), gS(-1,1), gS(-9,5), gS(-5,21), gS(-8,14),
           gS(-3,-4), gS(-3,-3), gS(-11,-8), gS(0,-18), gS(-1,-15), gS(-8,-3), gS(-6,-1), gS(-5,0),
           gS(0,-18), gS(-4,-8), gS(2,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-5,0), gS(0,0),
           gS(0,-26), gS(-3,-3), gS(-7,-6), gS(-5,0), gS(-7,-9), gS(-8,0), gS(2,-6), gS(0,-28),
           gS(0,-45), gS(-1,-20), gS(-6,-6), gS(-14,0), gS(-9,0), gS(0,-2), gS(0,-8), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-5,11), gS(-8,12), gS(-9,12), gS(-3,0), gS(-1,0), gS(-9,1), gS(-2,21), gS(-7,8),
           gS(0,-1), gS(0,0), gS(0,0), gS(0,-15), gS(-1,-13), gS(-2,-7), gS(-9,-4), gS(0,1),
           gS(0,15), gS(0,2), gS(0,-4), gS(0,-7), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(2,3), gS(-1,6), gS(-1,3), gS(-6,5), gS(-2,6), gS(-3,10), gS(3,-2), gS(6,3),
           gS(3,32), gS(-1,16), gS(-3,24), gS(-2,20), gS(-4,16), gS(2,20), gS(5,14), gS(8,20),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(1,17), gS(17,8), gS(18,9), gS(25,1), gS(40,-3), gS(32,-1), gS(24,1), gS(-5,13),
           ...
           gS(-21,-9), gS(-5,-11), gS(0,-8), gS(0,-10), gS(11,-16), gS(7,-22), gS(4,-23), gS(-39,-11),
           gS(-5,-13), gS(0,-14), gS(1,-10), gS(10,-20), gS(13,-23), gS(12,-22), gS(-9,-11), gS(-3,-26),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(2,-14), gS(19,-4), gS(10,-3), gS(10,6), gS(6,11), gS(21,-7), gS(17,-10), gS(7,-11),
           gS(14,-18), gS(11,-24), gS(15,-10), gS(3,0), gS(13,0), gS(14,-6), gS(20,-21), gS(7,-29),
           gS(-3,-32), gS(6,-6), gS(-2,-3), gS(1,0), gS(6,-4), gS(-12,4), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-165,-55), gS(-31,-3), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-82,2), gS(-29,-4), gS(-90,-64),
           ...
           gS(-8,-22), gS(9,-7), gS(9,5), gS(20,15), gS(23,13), gS(22,1), gS(25,-10), gS(2,-12),
           gS(-6,-27), gS(-11,1), gS(3,-6), gS(5,6), gS(11,4), gS(12,-4), gS(0,0), gS(1,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-14,2), gS(-28,22), gS(-13,25), gS(-26,43), gS(-40,62), gS(-21,30), gS(-13,28), gS(1,10),
...
const int MATERIAL_VALUES[5] = {
           gS(91,113), gS(515,682), gS(358,377), gS(381,395), gS(1004,1255),
};
