...
const int KING_HIGH_DANGER = gS(-45,-62);
...
const int DOUBLED_PAWN_PENALTY = gS(-12,-22);

const int UNOPPOSED_DOUBLED = gS(6,-1);

const int ISOLATED_PAWN_PENALTY = gS(-2,-3);

const int UNOPPOSED_ISOLATED = gS(-6,0);
...
const int KING_OPEN_FILE = gS(-58,9);
...
const int KING_PAWNLESS_FLANG = gS(-13,-52);
...
const int PASSED_PASSED_DISTANCE[8] = {
           gS(-4,-21), gS(16,2), gS(1,-18), gS(-7,-7),
           gS(-10,-8), gS(-19,-9), gS(-17,-13), gS(-15,-11),
};

const int KING_PASSER_DISTANCE_FRIENDLY[8] = {
           gS(0,0), gS(2,32), gS(-9,25), gS(-6,9),
           gS(-3,0), gS(0,0), gS(14,-1), gS(13,-1),
};

const int KING_PASSER_DISTANCE_ENEMY[8] = {
           gS(0,0), gS(-48,-2), gS(8,-15), gS(0,1),
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-17,2), gS(-10,7), gS(0,12),
           gS(4,30), gS(11,49), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(8,15), gS(-1,7), gS(0,0), gS(-6,-3),
};
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-67,-40), gS(-51,-46), gS(-53,-66), gS(-49,-31),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,33), gS(15,36), gS(15,31),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-6,2), gS(6,10), gS(0,11), gS(-1,6),
           gS(-8,5), gS(-21,0), gS(-6,17), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,21), gS(13,0), gS(23,3),
...
const int BISHOP_MOBILITY[14] = {
           gS(-6,-64), gS(3,-26), gS(10,-13), gS(15,-2), gS(17,6), gS(18,9), gS(17,12),
           gS(16,12), gS(15,13), gS(14,12), gS(16,9), gS(28,0), gS(30,10), gS(51,-11),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-34), gS(16,-7), gS(21,2), gS(25,9),
           gS(28,14), gS(32,11), gS(36,4), gS(39,-4),
};

const int KING_MOBILITY[9] = {
           gS(13,-30), gS(5,-4), gS(0,5), gS(-2,9), gS(-5,7),
           gS(-8,6), gS(0,4), gS(0,0), gS(15,-15),
};

const int ROOK_MOBILITY[15] = {
           gS(-27,-88), gS(-14,-51), gS(-7,-32), gS(0,-19), gS(3,-7), gS(0,5), gS(5,7),
           gS(7,7), gS(11,12), gS(13,16), gS(14,21), gS(16,23), gS(21,21), gS(26,20),
           gS(50,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-155), gS(-6,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-17),
           gS(-1,-5), gS(0,7), gS(0,17), gS(0,25), gS(1,30), gS(2,35), gS(2,38),
           gS(2,40), gS(2,43), gS(1,46), gS(5,41), gS(6,39), gS(9,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,16), gS(0,9), gS(5,5), gS(8,10), gS(5,7),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-91), gS(0,-28), gS(0,-11), gS(0,-6), gS(0,-17), gS(0,-22), gS(0,-12), gS(0,-94),
           gS(0,-14), gS(0,34), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-21),
           gS(0,0), gS(27,24), gS(14,36), gS(0,39), gS(0,40), gS(19,36), gS(11,28), gS(0,-2),
           gS(0,-13), gS(11,14), gS(-1,26), gS(-7,35), gS(-8,32), gS(2,24), gS(8,14), gS(-33,-15),
           gS(-11,-24), gS(0,2), gS(-4,15), gS(-15,23), gS(-14,22), gS(-21,16), gS(-1,1), gS(-41,-20),
           gS(-12,-29), gS(12,-6), gS(-12,6), gS(-30,17), gS(-25,16), gS(-22,8), gS(0,-6), gS(-6,-27),
           gS(4,-29), gS(-1,-8), gS(-3,0), gS(-22,8), gS(-23,9), gS(-2,0), gS(-3,-7), gS(4,-32),
           gS(-13,-56), gS(6,-39), gS(-12,-18), gS(-35,-15), gS(10,-45), gS(-13,-26), gS(6,-36), gS(0,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(52,69), gS(40,76), gS(36,65), gS(65,50), gS(60,57), gS(45,60), gS(0,82), gS(0,69),
           gS(0,32), gS(9,28), gS(25,10), gS(41,-1), gS(41,0), gS(69,3), gS(25,21), gS(26,13),
           gS(-12,17), gS(2,11), gS(5,0), gS(13,-1), gS(19,-1), gS(17,-1), gS(23,0), gS(-4,5),
           gS(-24,5), gS(-20,12), gS(-9,0), gS(9,-2), gS(9,-4), gS(8,-3), gS(-4,1), gS(-18,-4),
           gS(-25,-1), gS(-18,0), gS(-7,-4), gS(-4,0), gS(0,0), gS(0,-2), gS(-2,-7), gS(-20,-10),
           gS(-35,6), gS(-16,6), gS(-14,7), gS(0,6), gS(0,9), gS(1,5), gS(-3,1), gS(-25,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,12), gS(-6,19), gS(-9,8), gS(-1,0), gS(-1,2), gS(-7,5), gS(-4,21), gS(-3,14),
           gS(-2,-4), gS(-3,-2), gS(-10,-8), gS(0,-19), gS(0,-14), gS(-6,-4), gS(-5,0), gS(-3,0),
           gS(1,-18), gS(-2,-10), gS(2,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-4,-2), gS(0,0),
           gS(1,-27), gS(-2,-5), gS(-7,-7), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-28),
           gS(1,-44), gS(0,-21), gS(-5,-7), gS(-12,0), gS(-8,0), gS(1,-2), gS(1,-10), gS(1,-49),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-2,11), gS(-7,13), gS(-9,12), gS(-2,0), gS(-1,1), gS(-7,2), gS(0,21), gS(-3,8),
           gS(0,0), gS(0,0), gS(-1,0), gS(1,-16), gS(0,-14), gS(0,-8), gS(-9,-3), gS(0,1),
           gS(1,13), gS(0,0), gS(1,-4), gS(0,-8), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(4,2), gS(-1,6), gS(-1,4), gS(-4,5), gS(-2,6), gS(-2,10), gS(4,-4), gS(8,2),
           gS(6,29), gS(0,16), gS(-2,25), gS(-1,20), gS(-4,16), gS(3,20), gS(6,13), gS(10,17),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,20), gS(0,27), gS(0,21), gS(5,20), gS(12,20), gS(25,17), gS(37,14),
           gS(6,16), gS(0,16), gS(17,12), gS(35,4), gS(27,6), gS(27,4), gS(-6,16), gS(8,11),
           gS(2,17), gS(19,8), gS(19,10), gS(27,2), gS(42,-3), gS(36,-1), gS(27,1), gS(-4,13),
           gS(0,12), gS(0,13), gS(18,7), gS(21,1), gS(20,0), gS(20,-1), gS(6,2), gS(0,3),
           gS(-14,8), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-3,1), gS(-5,5), gS(-20,4),
           ...
           gS(-4,-12), gS(1,-14), gS(2,-9), gS(11,-20), gS(14,-23), gS(13,-22), gS(-8,-11), gS(-3,-25),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,0), gS(0,3), gS(23,-3), gS(15,0), gS(20,-1), gS(6,0), gS(6,-4),
           gS(-8,-1), gS(9,5), gS(3,2), gS(21,10), gS(15,10), gS(11,4), gS(7,2), gS(-3,-7),
           gS(5,-5), gS(-3,4), gS(7,6), gS(19,7), gS(23,5), gS(6,4), gS(8,0), gS(5,-15),
           gS(4,-15), gS(20,-4), gS(11,-3), gS(11,6), gS(7,10), gS(22,-8), gS(18,-10), gS(9,-12),
           gS(16,-19), gS(13,-25), gS(17,-10), gS(5,0), gS(15,0), gS(16,-6), gS(22,-22), gS(8,-29),
           gS(-2,-32), gS(8,-6), gS(0,-3), gS(2,0), gS(8,-4), gS(-10,3), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-162,-56), gS(-31,-3), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-80,2), gS(-29,-4), gS(-90,-64),
           gS(-33,-9), gS(-18,0), gS(-2,0), gS(21,6), gS(9,3), gS(27,-12), gS(-12,-2), gS(-19,-16),
           gS(-10,-1), gS(6,3), gS(11,20), gS(29,6), gS(43,1), gS(47,5), gS(13,-1), gS(13,-13),
           gS(4,-1), gS(7,0), gS(15,15), gS(31,17), gS(19,19), gS(35,12), gS(10,1), gS(21,-10),
           gS(0,0), gS(13,5), gS(18,20), gS(22,17), gS(24,21), gS(29,13), gS(24,1), gS(11,0),
           gS(-7,-21), gS(10,-7), gS(10,5), gS(20,16), gS(23,13), gS(22,1), gS(26,-9), gS(4,-11),
           gS(-5,-27), gS(-10,2), gS(4,-5), gS(7,7), gS(13,5), gS(13,-3), gS(1,1), gS(4,-15),
           gS(-40,-29), gS(-13,-16), gS(0,-5), gS(2,2), gS(9,4), gS(-1,-3), gS(-7,-6), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(-1,10), gS(-2,20), gS(-8,25), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-13,2), gS(-27,24), gS(-13,25), gS(-28,47), gS(-45,66), gS(-22,33), gS(-14,34), gS(1,11),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,35), gS(-1,44), gS(3,35), gS(7,13), gS(-7,13),
           gS(-4,-16), gS(-7,9), gS(-5,19), gS(-3,40), gS(-8,53), gS(-4,36), gS(-3,26), gS(3,-4),
           gS(0,-26), gS(-6,0), gS(-1,11), gS(-3,38), gS(3,34), gS(-4,10), gS(8,4), gS(-5,-3),
           gS(-3,-32), gS(10,-24), gS(6,-5), gS(3,0), gS(3,0), gS(8,-5), gS(14,-11), gS(4,-27),
           gS(4,-52), gS(11,-57), gS(19,-57), gS(12,-33), gS(14,-29), gS(21,-64), gS(26,-79), gS(0,-44),
           gS(5,-62), gS(8,-69), gS(6,-76), gS(4,-58), gS(7,-63), gS(-3,-75), gS(0,-63), gS(13,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(87,113), gS(512,682), gS(355,376), gS(378,396), gS(1001,1259),
};
