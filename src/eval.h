...
const int DOUBLED_PAWN_PENALTY = gS(-9,-24);
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-17,0), gS(-10,6), gS(0,11),
           gS(5,30), gS(9,49), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(9,15), gS(0,7), gS(0,0), gS(-6,-2),
};

const int BACKWARD_PAWN[7] = {
           gS(0,0), gS(-12,-11), gS(-6,-11), gS(-6,-9),
           gS(-1,-4), gS(0,0), gS(0,0),
};
...
const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-153), gS(-5,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-17),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,0), gS(27,24), gS(12,36), gS(0,39), gS(0,40), gS(18,36), gS(11,28), gS(0,-1),
           gS(0,-12), gS(11,14), gS(-1,26), gS(-7,35), gS(-8,32), gS(0,24), gS(8,14), gS(-31,-15),
           gS(-11,-24), gS(0,2), gS(-4,15), gS(-15,23), gS(-14,22), gS(-21,16), gS(-1,0), gS(-39,-20),
           ...
           gS(-13,-56), gS(7,-38), gS(-12,-18), gS(-34,-15), gS(11,-45), gS(-12,-26), gS(6,-36), gS(0,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(51,69), gS(40,75), gS(36,65), gS(65,50), gS(59,57), gS(43,60), gS(0,81), gS(0,69),
           gS(0,32), gS(8,27), gS(25,10), gS(40,-1), gS(40,0), gS(68,3), gS(24,21), gS(25,13),
           gS(-15,15), gS(0,9), gS(2,0), gS(10,-2), gS(16,-3), gS(14,-2), gS(20,-1), gS(-6,3),
           gS(-25,4), gS(-21,10), gS(-10,0), gS(8,-4), gS(7,-5), gS(6,-4), gS(-5,0), gS(-19,-5),
           gS(-27,-1), gS(-19,0), gS(-7,-4), gS(-5,0), gS(0,0), gS(0,-2), gS(-3,-6), gS(-21,-10),
           gS(-36,6), gS(-18,6), gS(-14,7), gS(0,6), gS(0,9), gS(1,5), gS(-4,0), gS(-27,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-5,12), gS(-6,18), gS(-9,8), gS(-1,0), gS(0,2), gS(-6,5), gS(-3,21), gS(-4,14),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,11), gS(-7,12), gS(-8,12), gS(-2,0), gS(0,1), gS(-6,2), gS(0,21), gS(-4,8),
           ...
           gS(4,29), gS(0,16), gS(-2,24), gS(-1,19), gS(-4,16), gS(3,20), gS(5,14), gS(8,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(3,17), gS(19,8), gS(19,10), gS(27,1), gS(42,-3), gS(34,-1), gS(26,1), gS(-4,13),
           gS(0,12), gS(0,13), gS(18,7), gS(21,1), gS(20,0), gS(19,-1), gS(6,2), gS(0,3),
           gS(-12,7), gS(-11,12), gS(0,7), gS(-1,5), gS(1,3), gS(-3,1), gS(-5,5), gS(-19,4),
           gS(-15,-1), gS(-9,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(1,-9), gS(-11,-11),
           gS(-20,-9), gS(-5,-11), gS(0,-8), gS(0,-10), gS(12,-16), gS(8,-22), gS(5,-23), gS(-39,-11),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,0), gS(0,3), gS(22,-2), gS(14,0), gS(20,-1), gS(5,0), gS(6,-3),
           gS(-8,-1), gS(9,5), gS(3,2), gS(20,10), gS(15,10), gS(11,4), gS(6,2), gS(-3,-7),
           gS(5,-5), gS(-3,4), gS(7,6), gS(19,7), gS(23,5), gS(6,4), gS(7,0), gS(5,-15),
           gS(3,-14), gS(20,-4), gS(11,-3), gS(11,6), gS(6,10), gS(22,-8), gS(18,-10), gS(9,-12),
           gS(16,-19), gS(12,-24), gS(16,-10), gS(5,0), gS(14,0), gS(16,-6), gS(21,-21), gS(8,-29),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(4,-1), gS(7,0), gS(15,14), gS(32,17), gS(19,19), gS(35,12), gS(10,1), gS(21,-10),
           gS(1,0), gS(13,5), gS(18,19), gS(23,17), gS(24,21), gS(29,13), gS(24,1), gS(11,0),
           gS(-7,-21), gS(10,-7), gS(10,4), gS(20,16), gS(24,13), gS(22,1), gS(26,-9), gS(4,-11),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-13,2), gS(-27,24), gS(-13,25), gS(-27,46), gS(-43,66), gS(-20,32), gS(-13,32), gS(1,11),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,35), gS(0,44), gS(3,34), gS(8,13), gS(-5,11),
           gS(-4,-16), gS(-7,9), gS(-5,19), gS(-3,40), gS(-8,53), gS(-4,35), gS(-3,25), gS(3,-4),
...
const int MATERIAL_VALUES[5] = {
           gS(90,114), gS(515,682), gS(357,376), gS(380,396), gS(1002,1259),
};
