...
const int PASSED_PAWN_RANKS[7] = {
           ...
           gS(16,53), gS(26,78), gS(52,86),
};

const int PASSED_PAWN_FILES[4] = {
           gS(1,18), gS(-3,14), gS(0,5), gS(-1,-3),
};
...
const int CANDIDATE_PASSED_PAWN[7] = {
           ...
           gS(5,30), gS(11,49), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(9,15), gS(-1,7), gS(0,0), gS(-6,-3),
};

const int BACKWARD_PAWN[7] = {
           gS(0,0), gS(-4,-10), gS(0,-9), gS(-8,-9),
           gS(-4,-5), gS(0,0), gS(0,0),
};
...
const int ROOK_MOBILITY[15] = {
           ...
           gS(7,7), gS(10,12), gS(13,16), gS(14,21), gS(16,23), gS(21,21), gS(27,20),
           gS(49,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-155), gS(-6,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-17),
           gS(-2,-5), gS(0,7), gS(0,17), gS(0,24), gS(1,30), gS(2,35), gS(2,38),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(4,-29), gS(-1,-7), gS(-2,0), gS(-21,8), gS(-23,9), gS(-2,0), gS(-3,-7), gS(4,-32),
           gS(-14,-56), gS(6,-38), gS(-12,-18), gS(-34,-15), gS(10,-45), gS(-13,-26), gS(6,-36), gS(0,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(51,69), gS(40,76), gS(36,65), gS(65,51), gS(60,57), gS(45,60), gS(0,82), gS(0,69),
           gS(0,32), gS(9,28), gS(25,10), gS(41,-1), gS(41,0), gS(69,3), gS(25,22), gS(26,13),
           gS(-14,15), gS(1,9), gS(4,0), gS(12,-2), gS(17,-3), gS(16,-2), gS(22,-1), gS(-6,4),
           gS(-25,5), gS(-20,11), gS(-9,0), gS(9,-2), gS(8,-4), gS(7,-3), gS(-4,1), gS(-19,-4),
           gS(-26,-1), gS(-19,0), gS(-7,-4), gS(-5,0), gS(0,0), gS(0,-2), gS(-4,-6), gS(-21,-10),
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(0,-44), gS(-1,-22), gS(-5,-7), gS(-12,0), gS(-8,0), gS(1,-2), gS(1,-9), gS(0,-49),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(5,29), gS(0,15), gS(-2,24), gS(-1,19), gS(-4,16), gS(3,20), gS(6,14), gS(9,18),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-13,8), gS(-11,13), gS(0,8), gS(-1,5), gS(1,3), gS(-3,1), gS(-5,5), gS(-19,4),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(0,0), gS(0,3), gS(23,-3), gS(15,0), gS(20,-1), gS(5,0), gS(7,-3),
           ...
           gS(16,-19), gS(12,-25), gS(17,-10), gS(5,0), gS(15,0), gS(16,-6), gS(22,-22), gS(8,-29),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-6,-21), gS(11,-7), gS(10,4), gS(20,16), gS(24,13), gS(22,1), gS(26,-9), gS(4,-11),
           gS(-5,-27), gS(-10,3), gS(4,-5), gS(7,7), gS(13,5), gS(13,-3), gS(1,1), gS(4,-15),
...
const int MATERIAL_VALUES[5] = {
           gS(88,113), gS(513,682), gS(355,376), gS(379,396), gS(1001,1259),
};
