...
const int KING_LOW_DANGER = gS(73,-76);
...
const int BISHOP_CONTROL_ENEMY_OUTPOST = gS(0,0);

const int KNIGHT_POS_PROUTPOST_JUMP = gS(8,7);

const int KNIGHT_POS_GENOUTPOST_JUMP = gS(6,8);

const int KNIGHT_CONTROL_ENEMY_OUTPOST
...
const int PASSED_PAWN_RANKS[7] = {
           ...
           gS(16,54), gS(27,77), gS(54,87),
};

const int PASSED_PAWN_FILES[8] = {
           gS(0,21), gS(-1,12), gS(1,5), gS(1,-6),
           gS(-5,-3), gS(-5,4), gS(-4,12), gS(0,14),
};
...
const int KING_PASSER_DISTANCE_ENEMY[8] = {
           ...
           gS(2,12), gS(-2,22), gS(0,23), gS(-8,21),
};
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-14,1), gS(-9,7), gS(-1,14),
           gS(4,29), gS(16,30), gS(0,0),
};
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(62,35), gS(39,19), gS(42,36),
};

const int KING_PAWN_SHIELD_KS[8] = {
           gS(-7,2), gS(6,10), gS(0,12), gS(0,8),
           gS(-8,5), gS(-21,0), gS(-5,16), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,23), gS(15,4), gS(25,9),
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(16,11), gS(15,12), gS(15,10), gS(16,8), gS(29,0), gS(30,10), gS(56,-11),
};
...
const int KING_MOBILITY[9] = {
           gS(14,-27), gS(5,-5), gS(0,4), gS(-2,10), gS(-5,8),
           gS(-9,6), gS(0,4), gS(0,0), gS(15,-18),
};

const int ROOK_MOBILITY[15] = {
           gS(-26,-85), gS(-13,-48), gS(-6,-30), gS(1,-18), gS(4,-6), gS(1,6), gS(7,7),
           gS(9,8), gS(12,12), gS(15,15), gS(16,20), gS(18,23), gS(23,20), gS(28,20),
           gS(51,10),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-6,-160), gS(-6,-111), gS(-5,-72), gS(-4,-51), gS(-3,-33), gS(-2,-16),
           gS(-1,-3), gS(0,9), gS(0,19), gS(1,26), gS(2,31), gS(2,36), gS(3,38),
           gS(2,41), gS(3,43), gS(1,46), gS(5,41), gS(7,39), gS(10,37), gS(13,30),
           gS(16,24), gS(9,26), gS(19,17), gS(0,14), gS(7,10), gS(12,15), gS(10,12),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-93), gS(0,-33), gS(0,-16), gS(0,-7), gS(0,-19), gS(0,-22), gS(0,-13), gS(0,-94),
           gS(0,-17), gS(0,33), gS(5,33), gS(0,32), gS(1,15), gS(0,34), gS(0,31), gS(-4,-22),
           gS(0,-2), gS(27,24), gS(19,35), gS(0,38), gS(3,39), gS(24,35), gS(13,28), gS(0,-3),
           gS(-2,-13), gS(11,13), gS(1,25), gS(-6,35), gS(-7,33), gS(7,23), gS(11,13), gS(-35,-15),
           gS(-14,-24), gS(2,0), gS(-3,16), gS(-17,25), gS(-14,24), gS(-21,18), gS(-1,1), gS(-46,-18),
           gS(-18,-27), gS(11,-6), gS(-12,8), gS(-31,19), gS(-25,18), gS(-23,10), gS(-1,-5), gS(-10,-25),
           gS(2,-29), gS(-4,-7), gS(-3,1), gS(-22,10), gS(-24,11), gS(-3,2), gS(-6,-6), gS(1,-31),
           gS(-16,-55), gS(4,-39), gS(-15,-18), gS(-35,-15), gS(11,-46), gS(-13,-25), gS(3,-36), gS(-1,-67),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,79), gS(38,66), gS(65,54), gS(64,59), gS(50,64), gS(0,85), gS(1,74),
           gS(2,31), gS(9,31), gS(25,13), gS(43,1), gS(45,2), gS(72,7), gS(28,25), gS(27,17),
           gS(-9,14), gS(2,11), gS(8,0), gS(15,-1), gS(23,-2), gS(22,-1), gS(25,1), gS(-1,7),
           gS(-21,3), gS(-19,12), gS(-6,0), gS(11,-3), gS(11,-4), gS(12,-3), gS(-2,2), gS(-14,-3),
           gS(-23,-2), gS(-17,0), gS(-6,-4), gS(-3,-1), gS(2,-1), gS(2,-3), gS(0,-6), gS(-17,-9),
           gS(-33,5), gS(-15,6), gS(-13,6), gS(0,6), gS(0,9), gS(3,4), gS(-2,1), gS(-24,-4),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-2,13), gS(-2,9), gS(0,6), gS(0,2), gS(0,1), gS(-1,1), gS(0,1), gS(0,6),
           gS(-3,10), gS(-6,15), gS(-8,7), gS(-2,0), gS(-1,2), gS(-5,4), gS(-4,19), gS(-3,13),
           gS(-2,-4), gS(-3,-1), gS(-10,-8), gS(0,-19), gS(-1,-13), gS(-6,-4), gS(-7,0), gS(-3,0),
           gS(0,-15), gS(-3,-9), gS(1,-13), gS(0,-25), gS(0,-22), gS(0,-6), gS(-5,-1), gS(0,0),
           gS(0,-26), gS(-3,-5), gS(-6,-9), gS(-4,0), gS(-6,-8), gS(-7,1), gS(2,-5), gS(0,-26),
           gS(0,-40), gS(-1,-19), gS(-4,-7), gS(-10,-1), gS(-6,0), gS(1,-2), gS(1,-9), gS(0,-46),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-2,9), gS(-7,11), gS(-8,10), gS(-2,0), gS(-1,1), gS(-5,1), gS(-2,18), gS(-3,7),
           gS(0,-3), gS(0,0), gS(-2,-1), gS(1,-17), gS(0,-14), gS(-2,-8), gS(-9,-3), gS(0,0),
           gS(0,10), gS(0,0), gS(2,-7), gS(0,-10), gS(0,-9), gS(0,-8), gS(0,0), gS(0,-2),
           gS(4,0), gS(0,5), gS(0,3), gS(-3,3), gS(-2,5), gS(-2,9), gS(4,-4), gS(8,0),
           gS(6,24), gS(0,14), gS(0,21), gS(-1,17), gS(-3,14), gS(4,19), gS(6,14), gS(10,14),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-13,9), gS(-11,13), gS(0,8), gS(-1,6), gS(1,3), gS(-2,1), gS(-5,6), gS(-19,4),
           gS(-15,0), gS(-8,0), gS(-4,0), gS(-3,-3), gS(-3,-2), gS(0,-9), gS(1,-9), gS(-13,-10),
           gS(-20,-8), gS(-4,-10), gS(1,-7), gS(0,-10), gS(12,-16), gS(9,-22), gS(5,-23), gS(-39,-11),
           gS(-4,-9), gS(1,-12), gS(3,-8), gS(11,-19), gS(14,-22), gS(13,-20), gS(-8,-10), gS(-3,-24),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(1,1), gS(0,3), gS(25,-3), gS(16,0), gS(22,0), gS(8,0), gS(8,-5),
           gS(-7,-2), gS(9,5), gS(4,2), gS(22,8), gS(16,9), gS(13,4), gS(8,0), gS(-1,-10),
           gS(7,-7), gS(-1,3), gS(8,4), gS(19,7), gS(23,5), gS(6,3), gS(8,0), gS(7,-17),
...
const int KNIGHT_PSQT_BLACK[64] = {
           gS(-158,-59), gS(-31,-5), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-77,2), gS(-29,-5), gS(-89,-64),
           gS(-30,-9), gS(-16,0), gS(-1,0), gS(23,5), gS(10,3), gS(31,-11), gS(-11,-1), gS(-16,-16),
           gS(-10,-1), gS(10,2), gS(14,19), gS(31,6), gS(45,0), gS(47,5), gS(16,-1), gS(13,-13),
           gS(6,-1), gS(7,0), gS(15,14), gS(32,15), gS(20,17), gS(35,11), gS(12,-2), gS(23,-10),
           gS(0,1), gS(13,5), gS(18,20), gS(23,16), gS(24,19), gS(29,12), gS(25,0), gS(10,0),
           gS(-7,-19), gS(10,-5), gS(10,7), gS(20,17), gS(23,14), gS(21,3), gS(25,-8), gS(3,-9),
           gS(-6,-26), gS(-10,3), gS(4,-3), gS(6,10), gS(12,7), gS(13,-2), gS(1,1), gS(3,-15),
           gS(-40,-31), gS(-13,-15), gS(-1,-5), gS(1,2), gS(9,4), gS(-2,-3), gS(-7,-5), gS(-19,-30),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-13,0), gS(0,11), gS(-3,14), gS(-4,23), gS(-9,28), gS(0,13), gS(-9,20), gS(-11,16),
           gS(-13,1), gS(-27,25), gS(-13,25), gS(-30,50), gS(-47,69), gS(-25,36), gS(-17,40), gS(1,14),
           gS(-9,-15), gS(0,0), gS(-3,23), gS(0,36), gS(-3,46), gS(0,39), gS(6,16), gS(-9,17),
           gS(-3,-16), gS(-6,8), gS(-5,19), gS(-4,40), gS(-8,54), gS(-6,39), gS(-5,29), gS(4,-3),
           gS(1,-26), gS(-5,0), gS(0,11), gS(-2,38), gS(3,34), gS(-4,11), gS(9,4), gS(-4,-2),
           gS(-1,-34), gS(11,-24), gS(7,-6), gS(4,0), gS(4,0), gS(9,-6), gS(15,-11), gS(5,-27),
           gS(5,-53), gS(12,-57), gS(20,-58), gS(13,-33), gS(15,-30), gS(22,-64), gS(26,-80), gS(1,-44),
           gS(6,-62), gS(9,-70), gS(7,-76), gS(5,-57), gS(8,-64), gS(-3,-75), gS(0,-68), gS(12,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(84,114), gS(506,683), gS(353,376), gS(377,398), gS(1000,1268),
};
