...
const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-12,-9), gS(-8,4), gS(-3,40),
           gS(16,53), gS(24,77), gS(48,87),
};
...
const int PASSED_PAWN_POS_ADVANCE[7] = {
           ...
           gS(9,27), gS(31,57), gS(67,107),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-3,-23), gS(17,1), gS(0,-17), gS(-7,-6),
...
const int KING_PASSER_DISTANCE_ENEMY[8] = {
           ...
           gS(1,13), gS(-3,23), gS(0,24), gS(-8,22),
};
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(61,36), gS(39,20), gS(41,46),
};
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(16,12), gS(15,13), gS(14,12), gS(17,9), gS(28,0), gS(30,10), gS(44,-9),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-35), gS(16,-8), gS(20,1), gS(24,9),
...
const int QUEEN_MOBILITY[28] = {
           gS(-11,-114), gS(-6,-148), gS(-6,-111), gS(-5,-73), gS(-4,-53), gS(-4,-35), gS(-3,-18),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,-12), gS(11,15), gS(-1,26), gS(-7,34), gS(-8,32), gS(0,25), gS(8,15), gS(-30,-15),
           gS(-10,-24), gS(0,2), gS(-4,15), gS(-14,22), gS(-14,21), gS(-21,16), gS(-1,1), gS(-38,-20),
           gS(-5,-30), gS(12,-6), gS(-11,6), gS(-30,16), gS(-25,15), gS(-22,7), gS(0,-6), gS(-5,-28),
           gS(5,-30), gS(0,-8), gS(-2,0), gS(-21,8), gS(-23,8), gS(-2,0), gS(-2,-8), gS(5,-33),
           gS(-13,-56), gS(8,-41), gS(-11,-20), gS(-34,-16), gS(10,-46), gS(-13,-27), gS(6,-38), gS(1,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(49,68), gS(40,73), gS(34,63), gS(64,48), gS(57,55), gS(38,60), gS(0,79), gS(0,67),
           gS(0,32), gS(6,28), gS(25,10), gS(37,-1), gS(36,0), gS(67,3), gS(22,21), gS(23,13),
           gS(-18,15), gS(-2,9), gS(0,0), gS(7,-2), gS(13,-3), gS(11,-2), gS(16,0), gS(-9,4),
           gS(-29,5), gS(-25,11), gS(-11,0), gS(4,-3), gS(4,-4), gS(4,-3), gS(-9,1), gS(-22,-5),
           gS(-29,-1), gS(-21,0), gS(-9,-3), gS(-6,0), gS(0,0), gS(-1,-2), gS(-4,-7), gS(-23,-10),
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(0,-27), gS(-3,-3), gS(-8,-6), gS(-4,0), gS(-8,-9), gS(-8,0), gS(2,-6), gS(0,-28),
           gS(0,-45), gS(-1,-20), gS(-6,-6), gS(-14,0), gS(-10,0), gS(0,-2), gS(0,-8), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(2,4), gS(-1,6), gS(-2,3), gS(-6,5), gS(-2,6), gS(-3,10), gS(3,-2), gS(6,3),
           gS(3,32), gS(-1,16), gS(-3,24), gS(-2,21), gS(-5,16), gS(2,20), gS(5,14), gS(8,20),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           gS(-36,-1), gS(-43,-2), gS(-74,16), gS(-81,16), gS(-53,15), gS(-91,13), gS(-26,-6), gS(-28,-16),
           gS(-37,-2), gS(-18,-1), gS(-13,0), gS(-12,9), gS(-12,6), gS(-16,3), gS(-26,-5), gS(-24,-7),
           gS(-4,0), gS(0,0), gS(-1,3), gS(20,-2), gS(12,1), gS(19,-1), gS(4,0), gS(5,-3),
           gS(-7,-1), gS(15,5), gS(4,3), gS(22,12), gS(18,12), gS(13,5), gS(13,2), gS(-1,-7),
           gS(4,-5), gS(-3,4), gS(7,6), gS(20,8), gS(23,6), gS(6,5), gS(7,0), gS(5,-14),
...
const int KNIGHT_PSQT_BLACK[64] = {
           gS(-166,-55), gS(-31,-3), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-82,2), gS(-29,-4), gS(-90,-64),
           gS(-34,-9), gS(-21,0), gS(-4,0), gS(19,6), gS(8,3), gS(25,-12), gS(-12,-2), gS(-21,-16),
           gS(-10,-1), gS(4,3), gS(9,20), gS(27,6), gS(41,1), gS(45,5), gS(10,-1), gS(13,-13),
           ...
           gS(-8,-22), gS(9,-7), gS(9,4), gS(20,15), gS(23,13), gS(22,1), gS(25,-10), gS(2,-12),
...
const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,7), gS(0,16), gS(-8,24), gS(0,9), gS(-10,17), gS(-13,15),
           gS(-14,2), gS(-28,22), gS(-13,25), gS(-26,43), gS(-40,62), gS(-21,30), gS(-13,27), gS(1,10),
           gS(-10,-15), gS(0,0), gS(-4,23), gS(0,35), gS(0,43), gS(3,31), gS(7,12), gS(-5,7),
...
const int MATERIAL_VALUES[5] = {
           gS(92,112), gS(517,680), gS(358,378), gS(381,396), gS(1004,1254),
};
