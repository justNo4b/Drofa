...
const int ROOK_LINE_TENSION = gS(16,-3);
...
const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-11,-9), gS(-8,5), gS(-2,40),
           gS(16,53), gS(24,77), gS(49,87),
};

const int PASSED_PAWN_FILES[4] = {
           gS(1,19), gS(-3,14), gS(0,6), gS(-1,-2),
};
...
const int CANDIDATE_PASSED_PAWN[7] = {
           gS(0,0), gS(-19,0), gS(-11,6), gS(0,10),
           gS(5,32), gS(8,55), gS(0,0),
};

const int CANDIDATE_PASSED_PAWN_FILES[4] = {
           gS(8,16), gS(0,8), gS(0,1), gS(-5,-1),
};

const int BACKWARD_PAWN[7] = {
           gS(0,0), gS(0,-5), gS(1,-4), gS(0,-7),
           gS(0,-3), gS(0,0), gS(0,0),
};

const int BACKWARD_OPEN_PAWN[7] = {
           gS(0,0), gS(-13,-11), gS(-7,-10), gS(-4,-9),
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(18,34), gS(15,35), gS(15,31),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-64), gS(3,-26), gS(10,-13), gS(15,-2), gS(17,6), gS(18,10), gS(17,13),
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(5,-30), gS(0,-8), gS(-2,0), gS(-21,8), gS(-23,8), gS(-2,0), gS(-2,-8), gS(5,-33),
           gS(-13,-56), gS(8,-40), gS(-11,-20), gS(-34,-16), gS(10,-46), gS(-13,-27), gS(6,-37), gS(1,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(49,68), gS(40,73), gS(35,63), gS(65,48), gS(58,55), gS(39,60), gS(0,79), gS(0,67),
           gS(0,32), gS(6,28), gS(25,10), gS(38,-1), gS(37,0), gS(68,3), gS(23,22), gS(24,13),
           gS(-18,15), gS(-2,9), gS(0,0), gS(7,-2), gS(13,-3), gS(12,-2), gS(17,0), gS(-9,3),
           gS(-28,4), gS(-23,11), gS(-11,0), gS(4,-3), gS(3,-4), gS(5,-3), gS(-7,0), gS(-22,-5),
           gS(-28,-1), gS(-21,0), gS(-8,-4), gS(-5,-1), gS(0,-1), gS(0,-3), gS(-4,-7), gS(-23,-10),
           gS(-38,6), gS(-19,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,5), gS(-5,0), gS(-29,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-3,-4), gS(-4,-2), gS(-11,-8), gS(0,-19), gS(0,-15), gS(-6,-4), gS(-6,0), gS(-5,0),
           gS(0,-18), gS(-3,-9), gS(2,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-5,0), gS(0,0),
           gS(0,-27), gS(-3,-4), gS(-7,-7), gS(-4,0), gS(-7,-9), gS(-8,0), gS(2,-6), gS(0,-28),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,14), gS(0,1), gS(0,-3), gS(0,-7), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(2,3), gS(-1,5), gS(-1,2), gS(-5,4), gS(-2,6), gS(-2,10), gS(3,-2), gS(6,3),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-4,0), gS(0,0), gS(-1,3), gS(20,-2), gS(12,0), gS(19,-1), gS(4,0), gS(5,-3),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-8,-22), gS(9,-7), gS(10,4), gS(20,15), gS(23,13), gS(22,1), gS(25,-10), gS(2,-11),
           gS(-6,-27), gS(-12,1), gS(3,-6), gS(5,6), gS(12,4), gS(12,-4), gS(0,0), gS(1,-15),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-14,2), gS(-28,22), gS(-13,25), gS(-27,43), gS(-40,62), gS(-21,30), gS(-13,28), gS(1,10),
           ...
           gS(3,-52), gS(10,-57), gS(18,-57), gS(11,-33), gS(13,-29), gS(20,-64), gS(24,-79), gS(0,-44),
