...
const int BISHOP_MOBILITY[14] = {
           gS(-24,-102), gS(-12,-42), gS(-6,-16), gS(-3,-1), gS(0,12), gS(1,23), gS(1,30),
           gS(0,32), gS(1,36), gS(4,34), gS(10,32), gS(27,21), gS(44,32), gS(75,-2),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-7,-71), gS(1,-24), gS(4,0), gS(7,14), gS(10,21),
           gS(12,27), gS(16,26), gS(23,18), gS(31,3),
};
...
const int ROOK_MOBILITY[15] = {
           gS(-21,-105), gS(-13,-69), gS(-9,-35), gS(-7,-14), gS(-8,4), gS(-9,18), gS(-4,21),
           gS(0,26), gS(4,30), gS(9,35), gS(11,40), gS(17,44), gS(21,44), gS(36,33),
           gS(89,3),
};

const int QUEEN_MOBILITY[28] = {
           gS(-44,-115), gS(-21,-186), gS(-10,-133), gS(-6,-76), gS(-4,-43), gS(-3,-21), gS(-1,-3),
           gS(0,8), gS(3,17), gS(5,23), gS(6,29), gS(7,34), gS(8,38), gS(7,43),
...
const int KING_LOW_DANGER = gS(4,8);
...
const int ISOLATED_PAWN_PENALTY = gS(-4,-9);
...
const int SPACE[17] = {
           gS(1,0), gS(0,-2), gS(-5,-2), gS(-4,-5), gS(-4,-3),
           gS(-3,-3), gS(3,0), gS(4,8), gS(7,6), gS(3,3),
           gS(0,1), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0),
};
...
const int HANGING_PIECE[5] = {
           gS(-2,11), gS(-27,-15), gS(-29,-49), gS(-32,-77), gS(-20,-14),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(0,-9), gS(1,14), gS(9,10), gS(-6,20),
           gS(-2,7), gS(-1,-30), gS(4,-9), gS(4,5),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(9,10), gS(-6,27), gS(18,7), gS(0,20),
           gS(8,5), gS(-3,-6), gS(-13,4), gS(7,0),
};
...
const int PAWN_CONNECTED[7] = {
           gS(0,0), gS(4,-1), gS(8,2), gS(6,9),
           gS(16,33), gS(16,35), gS(1,6),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-45,-13), gS(-1,0), gS(-3,13), gS(-27,31), gS(-14,27), gS(-13,18), gS(0,1), gS(-31,-14),
           gS(-12,-10), gS(-22,8), gS(-15,13), gS(-54,23), gS(-36,18), gS(-34,20), gS(-21,6), gS(-18,-18),
           gS(-29,-57), gS(-1,-26), gS(-32,-3), gS(-24,-25), gS(-15,-37), gS(-43,-5), gS(-4,-25), gS(-16,-73),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(62,66), gS(42,83), gS(60,82), gS(69,69), gS(77,68), gS(80,73), gS(-3,88), gS(-15,78),
           gS(0,45), gS(25,41), gS(39,35), gS(43,16), gS(52,18), gS(90,26), gS(56,32), gS(12,34),
           gS(-3,18), gS(2,15), gS(3,14), gS(18,-1), gS(26,2), gS(25,6), gS(7,12), gS(0,9),
           gS(-11,3), gS(-8,6), gS(-4,0), gS(3,-2), gS(8,-1), gS(3,2), gS(0,0), gS(-9,-5),
           gS(-18,-1), gS(-19,0), gS(-15,4), gS(-14,5), gS(-7,8), gS(-7,9), gS(-5,-5), gS(-15,-11),
           gS(-13,3), gS(-10,4), gS(-14,15), gS(-6,15), gS(-12,22), gS(8,17), gS(7,1), gS(-10,-14),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-8,12), gS(8,9), gS(16,11), gS(38,4), gS(31,4), gS(28,3), gS(28,1), gS(14,5),
           gS(-20,2), gS(-12,13), gS(-13,14), gS(-2,7), gS(-4,6), gS(-6,9), gS(5,6), gS(-8,-1),
           gS(-24,-15), gS(-7,-3), gS(-15,-3), gS(-7,-8), gS(-7,-7), gS(-8,-6), gS(9,-7), gS(-14,-17),
           gS(-55,-13), gS(-18,-18), gS(-10,-13), gS(-4,-16), gS(-3,-16), gS(-2,-20), gS(-3,-21), gS(-54,-12),
           gS(-16,-17), gS(-10,-14), gS(-6,-11), gS(0,-17), gS(-1,-17), gS(-3,-7), gS(-1,-15), gS(-11,-25),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-2,-10), gS(3,-1), gS(11,7), gS(17,8), gS(24,7), gS(2,6), gS(10,0), gS(0,-11),
           gS(-2,-17), gS(10,-8), gS(6,-3), gS(12,3), gS(8,4), gS(10,-4), gS(11,-8), gS(12,-11),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-17,-17), gS(5,0), gS(31,31), gS(32,30), gS(53,21), gS(44,27), gS(24,-6), gS(5,-15),
           gS(3,-10), gS(11,3), gS(29,27), gS(31,40), gS(23,33), gS(43,20), gS(22,3), gS(13,-8),
           gS(-3,-8), gS(11,8), gS(17,31), gS(23,34), gS(27,36), gS(22,32), gS(27,11), gS(7,0),
           gS(-18,-33), gS(2,-5), gS(7,10), gS(14,26), gS(18,24), gS(14,8), gS(8,0), gS(-3,-25),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-18,-7), gS(-54,28), gS(-16,19), gS(-41,68), gS(-37,101), gS(0,70), gS(-52,65), gS(-18,31),
           gS(-14,-19), gS(-8,-19), gS(-10,12), gS(-9,41), gS(2,60), gS(14,78), gS(34,42), gS(6,55),
           ...
           gS(-2,-58), gS(7,-40), gS(1,-19), gS(0,-26), gS(0,-25), gS(0,-9), gS(13,-30), gS(2,-43),
