...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(0,32), gS(1,36), gS(4,34), gS(10,32), gS(27,21), gS(44,33), gS(75,-2),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-7,-71), gS(1,-24), gS(5,0), gS(7,14), gS(10,22),
           gS(13,28), gS(17,26), gS(23,18), gS(32,3),
};
...
const int ROOK_MOBILITY[15] = {
           ...
           gS(0,26), gS(4,30), gS(9,35), gS(12,40), gS(17,44), gS(21,45), gS(36,33),
           gS(89,3),
};
...
const int KING_ATTACK_PAWN = gS(29,43);

const int KING_PASSER_DISTANCE_FRIENDLY[9] = {
           gS(0,0), gS(5,32), gS(-1,22), gS(-3,7),
           gS(-1,-3), gS(0,-7), gS(13,-13), gS(2,-24),
           gS(0,-10),
};

const int KING_PASSER_DISTANCE_ENEMY[9] = {
           gS(0,0), gS(30,35), gS(-17,27), gS(-1,6),
           gS(-1,-6), gS(0,-17), gS(6,-28), gS(16,-35),
           gS(0,-10),
};
...
const int HANGING_PIECE[5] = {
           gS(-2,12), gS(-29,-17), gS(-31,-50), gS(-35,-78), gS(-22,-14),
};

const int MINOR_ATTACKED_BY[5] = {
           gS(0,0), gS(0,19), gS(8,36), gS(10,31), gS(0,3),
};
...
const int KING_PAWN_SHIELD_QS[8] = {
           gS(9,10), gS(-7,28), gS(18,7), gS(-1,21),
           gS(8,5), gS(-2,-6), gS(-13,3), gS(8,0),
};
 ...
 */
const int PAWN_RAMMED_6TH[8] = {
           gS(-10,-8), gS(0,-1), gS(2,0), gS(5,8),
           gS(9,25), gS(7,16), gS(2,6), gS(0,-1),
};

const int PAWN_CONNECTED[7] = {
           gS(0,0), gS(4,-1), gS(8,2), gS(7,10),
           gS(16,34), gS(17,38), gS(1,7),
};

const int PASSED_PAWN_RANKS[8] = {
           gS(0,0), gS(-14,-11), gS(-17,1), gS(-10,37),
           gS(20,47), gS(37,75), gS(76,92), gS(0,0),
};

const int PASSED_PAWN_FILES[8] = {
           gS(11,11), gS(7,11), gS(1,-1), gS(0,-5),
           gS(-3,-6), gS(-13,-2), gS(-7,12), gS(8,8),
};

const int PASSED_PAWN_FREE[7] = {
           gS(0,0), gS(-7,8), gS(-11,2), gS(-8,5),
           gS(-9,10), gS(-13,30), gS(17,31),
};

const int PASSED_PAWN_POS_ADVANCE[7] = {
           gS(0,0), gS(4,5), gS(5,1), gS(6,13),
           gS(0,28), gS(0,69), gS(0,92),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-9,-9), gS(22,14), gS(30,29), gS(0,34), gS(7,29), gS(32,26), gS(28,13), gS(-38,-12),
           gS(-22,-31), gS(24,2), gS(26,22), gS(-14,40), gS(0,35), gS(6,23), gS(28,3), gS(-47,-22),
           gS(-45,-13), gS(-1,0), gS(-2,13), gS(-26,31), gS(-14,27), gS(-13,18), gS(0,1), gS(-31,-15),
           gS(-12,-10), gS(-22,8), gS(-15,13), gS(-54,24), gS(-36,18), gS(-34,20), gS(-21,6), gS(-19,-19),
           gS(-29,-58), gS(-1,-27), gS(-32,-3), gS(-24,-26), gS(-15,-37), gS(-43,-5), gS(-4,-26), gS(-16,-73),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(63,66), gS(42,83), gS(60,81), gS(69,69), gS(77,68), gS(80,72), gS(-3,88), gS(-14,78),
           gS(7,48), gS(25,41), gS(38,35), gS(42,16), gS(49,15), gS(85,19), gS(55,30), gS(13,35),
           gS(-2,20), gS(3,16), gS(4,13), gS(19,-1), gS(28,1), gS(27,5), gS(8,13), gS(0,10),
           gS(-11,4), gS(-8,6), gS(-4,-1), gS(2,-2), gS(8,-2), gS(3,0), gS(0,0), gS(-9,-4),
           gS(-18,0), gS(-19,0), gS(-15,4), gS(-14,5), gS(-7,8), gS(-7,8), gS(-5,-5), gS(-14,-10),
           gS(-13,4), gS(-10,5), gS(-14,16), gS(-6,17), gS(-12,24), gS(8,18), gS(7,2), gS(-10,-13),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int ROOK_PSQT_BLACK[64] = {
           ...
           gS(-55,-13), gS(-18,-18), gS(-10,-13), gS(-4,-17), gS(-4,-17), gS(-2,-21), gS(-3,-22), gS(-54,-13),
           gS(-17,-17), gS(-10,-14), gS(-6,-11), gS(0,-18), gS(-1,-17), gS(-3,-7), gS(-2,-15), gS(-11,-25),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-50,6), gS(-43,8), gS(-83,17), gS(-81,23), gS(-70,18), gS(-92,15), gS(-15,0), gS(-48,0),
           gS(-51,4), gS(-23,8), gS(-11,7), gS(-17,14), gS(-12,12), gS(0,6), gS(-32,7), gS(-26,-1),
           gS(0,4), gS(0,9), gS(16,6), gS(4,9), gS(22,8), gS(4,12), gS(21,3), gS(13,0),
           gS(-11,0), gS(15,5), gS(2,6), gS(23,12), gS(19,13), gS(14,3), gS(17,2), gS(-4,1),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-17,-21), gS(-12,-6), gS(20,-1), gS(45,17), gS(38,17), gS(47,-10), gS(-21,-3), gS(-11,-20),
           gS(-17,-16), gS(5,0), gS(32,31), gS(32,30), gS(54,22), gS(44,27), gS(24,-6), gS(5,-15),
           gS(3,-10), gS(12,3), gS(30,27), gS(31,40), gS(23,33), gS(43,20), gS(22,3), gS(14,-8),
           gS(-3,-8), gS(12,8), gS(17,31), gS(24,34), gS(28,36), gS(22,32), gS(28,11), gS(7,0),
           gS(-19,-33), gS(1,-5), gS(7,10), gS(15,26), gS(18,24), gS(14,8), gS(8,0), gS(-4,-25),
