...
const int KING_HIGH_DANGER = gS(-45,-64);
...
const int BISHOP_RAMMED_PENALTY = gS(-3,-4);
...
const int BISHOP_ATT_OUTPOSTED_BISHOP = gS(6,4);

const int BISHOP_ATT_OUTPOSTED_KNIGHT = gS(12,6);

const int KNIGHT_ATT_OUTPOSTED_BISHOP = gS(15,11);

const int KNIGHT_ATT_OUTPOSTED_KNIGHT = gS(15,4);
...
const int ROOK_RESTRICT_KING = gS(2,6);
...
const int PASSED_PAWN_RANKS[7] = {
           gS(0,0), gS(-12,-9), gS(-8,4), gS(-2,40),
           gS(16,53), gS(24,77), gS(49,87),
};

const int PASSED_PAWN_FILES[4] = {
           gS(1,19), gS(-3,14), gS(0,6), gS(-2,-3),
};
...
const int PASSED_PAWN_POS_ADVANCE[7] = {
           ...
           gS(9,27), gS(32,57), gS(66,107),
};

const int PASSED_PASSED_DISTANCE[8] = {
           gS(-3,-23), gS(17,2), gS(0,-17), gS(-7,-6),
...
const int KING_PASSER_DISTANCE_ENEMY[8] = {
           ...
           gS(1,13), gS(-3,23), gS(0,23), gS(-8,21),
};
...
const int BACKWARD_OPEN_PAWN[7] = {
           gS(0,0), gS(-13,-11), gS(-7,-10), gS(-6,-9),
...
const int HANGING_PIECE[5] = {
           gS(0,19), gS(-67,-40), gS(-54,-46), gS(-55,-66), gS(-50,-31),
};

const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,34), gS(17,35), gS(16,32),
};
...
const int KNIGHT_CHECKING_FORK[5] = {
           gS(0,11), gS(4,10), gS(0,0), gS(0,9), gS(2,0),
};
...
const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-35), gS(16,-8), gS(21,1), gS(25,8),
...
const int ROOK_MOBILITY[15] = {
           ...
           gS(6,7), gS(9,12), gS(12,16), gS(13,21), gS(15,23), gS(19,21), gS(25,20),
           gS(48,9),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(0,0), gS(27,25), gS(8,38), gS(0,39), gS(0,40), gS(16,36), gS(11,28), gS(0,-1),
           ...
           gS(-6,-30), gS(12,-6), gS(-11,6), gS(-30,16), gS(-25,15), gS(-22,7), gS(0,-6), gS(-6,-28),
           gS(5,-30), gS(0,-8), gS(-2,0), gS(-21,8), gS(-23,8), gS(-2,0), gS(-2,-8), gS(5,-34),
           gS(-13,-56), gS(7,-40), gS(-11,-19), gS(-34,-16), gS(10,-45), gS(-13,-26), gS(6,-37), gS(1,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(49,68), gS(40,73), gS(35,63), gS(65,49), gS(59,56), gS(39,60), gS(0,79), gS(0,67),
           gS(0,32), gS(6,28), gS(25,10), gS(38,-1), gS(37,0), gS(67,3), gS(22,21), gS(24,13),
           gS(-18,15), gS(-2,9), gS(0,0), gS(8,-2), gS(13,-3), gS(11,-2), gS(17,-1), gS(-9,3),
           gS(-28,4), gS(-24,11), gS(-10,0), gS(5,-3), gS(4,-4), gS(5,-3), gS(-8,1), gS(-22,-5),
           gS(-28,-1), gS(-21,0), gS(-8,-3), gS(-6,0), gS(0,-1), gS(-1,-2), gS(-4,-7), gS(-23,-10),
           gS(-38,7), gS(-18,6), gS(-14,7), gS(0,6), gS(0,9), gS(0,5), gS(-5,0), gS(-29,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-3,-4), gS(-3,-3), gS(-11,-8), gS(0,-19), gS(0,-15), gS(-6,-4), gS(-5,0), gS(-5,0),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,0), gS(0,0), gS(0,0), gS(1,-16), gS(0,-14), gS(0,-8), gS(-9,-3), gS(0,1),
           gS(0,15), gS(0,2), gS(0,-4), gS(0,-7), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(2,3), gS(-1,6), gS(-1,3), gS(-5,5), gS(-2,6), gS(-3,10), gS(3,-2), gS(6,3),
           gS(3,32), gS(-1,16), gS(-3,24), gS(-2,20), gS(-4,16), gS(2,20), gS(5,14), gS(8,20),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(29,11), gS(16,20), gS(0,26), gS(0,20), gS(5,19), gS(10,20), gS(23,17), gS(36,14),
           gS(5,14), gS(0,14), gS(15,10), gS(34,2), gS(26,4), gS(24,3), gS(-8,14), gS(6,10),
           gS(2,17), gS(17,8), gS(18,9), gS(26,1), gS(40,-3), gS(32,-1), gS(24,1), gS(-5,13),
           gS(0,12), gS(2,13), gS(19,7), gS(21,1), gS(21,1), gS(21,0), gS(9,4), gS(0,3),
           gS(-13,7), gS(-9,12), gS(0,7), gS(0,6), gS(1,3), gS(-1,2), gS(-4,6), gS(-19,4),
           ...
           gS(-5,-12), gS(0,-14), gS(1,-9), gS(10,-20), gS(13,-23), gS(12,-22), gS(-9,-11), gS(-3,-26),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(2,-14), gS(19,-4), gS(9,-3), gS(10,6), gS(6,11), gS(21,-8), gS(17,-10), gS(7,-11),
           gS(14,-19), gS(11,-24), gS(15,-10), gS(4,0), gS(13,0), gS(14,-6), gS(20,-21), gS(7,-29),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-34,-9), gS(-21,0), gS(-4,0), gS(18,6), gS(8,3), gS(25,-12), gS(-12,-2), gS(-22,-16),
           gS(-10,-1), gS(4,3), gS(10,20), gS(27,6), gS(40,0), gS(45,5), gS(10,-1), gS(13,-13),
           gS(5,-1), gS(12,1), gS(20,15), gS(35,18), gS(24,21), gS(40,13), gS(16,3), gS(22,-10),
           gS(0,0), gS(14,5), gS(20,19), gS(25,17), gS(24,20), gS(31,13), gS(25,1), gS(11,0),
           gS(-8,-21), gS(9,-7), gS(9,5), gS(20,15), gS(23,13), gS(22,1), gS(25,-9), gS(2,-11),
           gS(-7,-27), gS(-11,1), gS(3,-6), gS(5,6), gS(12,4), gS(12,-4), gS(0,0), gS(1,-15),
           gS(-40,-30), gS(-14,-17), gS(0,-5), gS(0,1), gS(7,3), gS(-2,-4), gS(-9,-8), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,10), gS(0,8), gS(0,16), gS(-8,24), gS(0,10), gS(-10,17), gS(-13,15),
           gS(-14,2), gS(-28,22), gS(-13,25), gS(-26,44), gS(-40,62), gS(-21,30), gS(-13,28), gS(1,10),
...
const int MATERIAL_VALUES[5] = {
           gS(91,113), gS(515,682), gS(358,377), gS(381,395), gS(1004,1256),
};
