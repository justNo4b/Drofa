...
const int KING_PASSER_DISTANCE_ENEMY[8] = {
           ...
           gS(2,12), gS(-3,22), gS(0,23), gS(-8,21),
};
...
const int CANDIDATE_PASSED_PAWN[6] = {
           gS(0,0), gS(-15,3), gS(-10,7), gS(-5,12),
           gS(0,29), gS(15,37),
};

const int CANDIDATE_MOVING_PAWN[7] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,2),
           gS(5,3), gS(10,4), gS(6,6),
};
...
const int KING_PAWN_SHIELD_KS[8] = {
           gS(-7,3), gS(6,10), gS(0,12), gS(0,7),
           gS(-8,5), gS(-21,0), gS(-5,17), gS(0,0),
};

const int KING_PAWN_SHIELD_QS[8] = {
           gS(8,0), gS(14,23), gS(15,4), gS(25,8),
...
const int BISHOP_MOBILITY[14] = {
           ...
           gS(16,11), gS(15,11), gS(15,10), gS(16,8), gS(28,-1), gS(30,10), gS(55,-11),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-14,-25), gS(1,1), gS(-3,16), gS(-16,25), gS(-14,24), gS(-21,18), gS(-1,1), gS(-45,-19),
           ...
           gS(-16,-55), gS(4,-39), gS(-15,-18), gS(-34,-15), gS(11,-46), gS(-13,-26), gS(3,-36), gS(-1,-68),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(53,69), gS(40,78), gS(37,66), gS(64,53), gS(64,58), gS(49,64), gS(0,85), gS(1,74),
           gS(1,30), gS(9,30), gS(25,12), gS(42,0), gS(43,0), gS(71,6), gS(27,24), gS(26,16),
           gS(-10,15), gS(3,11), gS(8,0), gS(15,-1), gS(22,-2), gS(22,0), gS(25,1), gS(-1,7),
           gS(-21,3), gS(-20,12), gS(-7,0), gS(11,-3), gS(11,-4), gS(11,-3), gS(-3,2), gS(-15,-3),
           gS(-23,-2), gS(-18,0), gS(-6,-4), gS(-4,-1), gS(1,-1), gS(2,-2), gS(-1,-6), gS(-18,-8),
           gS(-33,5), gS(-15,6), gS(-14,7), gS(0,6), gS(0,9), gS(2,5), gS(-3,1), gS(-25,-3),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-4,10), gS(-7,16), gS(-9,7), gS(-3,0), gS(-2,2), gS(-6,5), gS(-5,20), gS(-4,13),
           gS(-2,-5), gS(-4,-1), gS(-10,-8), gS(0,-20), gS(-2,-13), gS(-6,-4), gS(-7,0), gS(-3,0),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(-3,9), gS(-8,12), gS(-9,11), gS(-3,0), gS(-2,1), gS(-6,1), gS(-2,19), gS(-4,7),
           gS(0,-3), gS(0,0), gS(-2,-1), gS(1,-17), gS(-1,-14), gS(-2,-8), gS(-10,-3), gS(0,0),
           gS(0,11), gS(0,0), gS(2,-6), gS(0,-9), gS(0,-8), gS(0,-8), gS(0,0), gS(0,-1),
           gS(4,1), gS(0,5), gS(0,3), gS(-4,3), gS(-2,6), gS(-2,9), gS(4,-4), gS(8,0),
           gS(6,25), gS(0,14), gS(-1,22), gS(-1,18), gS(-4,15), gS(4,19), gS(6,14), gS(10,15),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,12), gS(15,21), gS(0,27), gS(0,21), gS(5,20), gS(12,20), gS(27,16), gS(38,14),
           gS(7,15), gS(0,16), gS(17,12), gS(35,3), gS(26,5), gS(28,3), gS(-6,15), gS(10,10),
           gS(4,17), gS(20,9), gS(19,10), gS(27,1), gS(43,-4), gS(37,-2), gS(29,1), gS(-3,12),
           ...
           gS(-20,-8), gS(-4,-10), gS(0,-8), gS(0,-10), gS(12,-16), gS(8,-23), gS(5,-23), gS(-39,-11),
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-4,0), gS(0,1), gS(0,4), gS(25,-3), gS(16,0), gS(22,-1), gS(8,0), gS(8,-5),
           gS(-7,-2), gS(9,5), gS(4,2), gS(22,9), gS(16,10), gS(12,4), gS(8,0), gS(-1,-10),
           gS(6,-7), gS(-2,3), gS(8,4), gS(19,7), gS(23,5), gS(6,3), gS(8,0), gS(6,-17),
...
const int KNIGHT_PSQT_BLACK[64] = {
           ...
           gS(-10,-1), gS(10,2), gS(13,19), gS(31,6), gS(44,0), gS(47,5), gS(15,-2), gS(13,-13),
           ...
           gS(-40,-30), gS(-13,-15), gS(0,-4), gS(1,3), gS(9,4), gS(-2,-3), gS(-7,-5), gS(-19,-30),
};
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(1,-26), gS(-5,0), gS(0,11), gS(-2,38), gS(4,34), gS(-4,11), gS(8,4), gS(-4,-2),
...
const int MATERIAL_VALUES[5] = {
           gS(85,113), gS(507,683), gS(353,375), gS(377,397), gS(1001,1265),
};
