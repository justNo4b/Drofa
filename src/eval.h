...
const int BISHOP_PAIR_BONUS = gS(31,51);

const int DOUBLED_PAWN_PENALTY = gS(-8,-21);

const int ISOLATED_PAWN_PENALTY = gS(-7,-6);
...
const int KING_PAWNLESS_FLANG = gS(-11,-60);
...
const int BACKWARD_PAWN[7] = {
           gS(0,0), gS(1,-5), gS(2,-4), gS(0,-7),
           gS(0,-4), gS(0,0), gS(0,0),
};

const int BACKWARD_OPEN_PAWN[7] = {
           gS(0,0), gS(-12,-11), gS(-6,-10), gS(-5,-9),
           gS(0,-4), gS(0,0), gS(0,0),
};
...
const int HANGING_PIECE[5] = {
           gS(0,18), gS(-67,-40), gS(-54,-46), gS(-55,-66), gS(-50,-31),
};
...
const int QUEEN_ATTACKED_BY[4] = {
           gS(0,0), gS(61,36), gS(39,20), gS(41,45),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-5,-64), gS(4,-25), gS(11,-12), gS(15,-1), gS(17,7), gS(18,10), gS(17,13),
           gS(16,12), gS(14,13), gS(14,12), gS(16,9), gS(28,0), gS(30,10), gS(45,-10),
};

const int KNIGHT_MOBILITY[9] = {
           gS(-2,-94), gS(10,-35), gS(16,-7), gS(21,1), gS(24,9),
           gS(27,13), gS(30,9), gS(33,3), gS(36,-5),
};

const int KING_MOBILITY[9] = {
           gS(13,-30), gS(5,-4), gS(0,5), gS(-2,9), gS(-5,7),
           gS(-8,5), gS(0,2), gS(0,-1), gS(13,-15),
};

const int ROOK_MOBILITY[15] = {
           gS(-28,-89), gS(-15,-52), gS(-8,-32), gS(0,-19), gS(2,-7), gS(0,5), gS(4,7),
           gS(6,7), gS(9,12), gS(12,16), gS(13,20), gS(15,23), gS(20,21), gS(25,20),
           gS(48,9),
};

const int QUEEN_MOBILITY[28] = {
           gS(-10,-114), gS(-5,-149), gS(-5,-111), gS(-4,-73), gS(-4,-53), gS(-3,-35), gS(-3,-18),
           gS(-1,-5), gS(0,6), gS(0,17), gS(0,24), gS(1,29), gS(1,33), gS(1,37),
           gS(1,39), gS(1,43), gS(0,46), gS(4,41), gS(6,39), gS(9,37), gS(13,30),
           gS(16,23), gS(9,25), gS(19,16), gS(0,7), gS(5,4), gS(8,4), gS(0,1),
};
...
const int KING_PSQT_BLACK[64] = {
           gS(0,-85), gS(0,-22), gS(0,-5), gS(0,-5), gS(0,-17), gS(0,-21), gS(0,-11), gS(0,-94),
           gS(0,-12), gS(0,34), gS(5,34), gS(0,33), gS(1,16), gS(0,35), gS(0,31), gS(-4,-20),
           gS(0,0), gS(27,25), gS(9,38), gS(0,39), gS(0,40), gS(17,36), gS(11,29), gS(0,-1),
           gS(0,-12), gS(11,15), gS(-1,26), gS(-7,35), gS(-8,32), gS(0,25), gS(8,15), gS(-30,-15),
           gS(-10,-24), gS(0,2), gS(-4,15), gS(-14,23), gS(-14,21), gS(-21,16), gS(-1,1), gS(-38,-20),
           gS(-6,-29), gS(12,-6), gS(-11,6), gS(-30,16), gS(-25,15), gS(-22,7), gS(0,-6), gS(-6,-28),
           gS(5,-30), gS(0,-8), gS(-2,0), gS(-22,7), gS(-23,8), gS(-2,0), gS(-2,-8), gS(5,-33),
           gS(-13,-56), gS(8,-40), gS(-11,-20), gS(-34,-17), gS(10,-46), gS(-13,-27), gS(6,-38), gS(1,-69),
};

const int PAWN_PSQT_BLACK[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(49,68), gS(40,73), gS(35,64), gS(65,49), gS(59,56), gS(39,60), gS(0,79), gS(0,67),
           gS(0,32), gS(6,28), gS(25,10), gS(38,0), gS(37,0), gS(68,3), gS(23,22), gS(24,14),
           gS(-17,16), gS(-2,10), gS(0,0), gS(8,-2), gS(13,-2), gS(12,-1), gS(17,0), gS(-8,4),
           gS(-27,5), gS(-24,12), gS(-10,0), gS(5,-2), gS(4,-3), gS(5,-2), gS(-8,1), gS(-21,-4),
           gS(-28,0), gS(-20,0), gS(-8,-3), gS(-5,0), gS(0,0), gS(0,-2), gS(-4,-6), gS(-22,-9),
           gS(-38,7), gS(-18,6), gS(-14,7), gS(0,6), gS(-1,9), gS(0,5), gS(-5,0), gS(-29,-5),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-3,16), gS(-2,10), gS(0,7), gS(0,3), gS(0,1), gS(0,1), gS(0,1), gS(0,7),
           gS(-6,12), gS(-7,18), gS(-11,8), gS(0,0), gS(0,2), gS(-7,5), gS(-4,21), gS(-5,14),
           gS(-3,-4), gS(-3,-3), gS(-11,-8), gS(0,-19), gS(0,-15), gS(-6,-4), gS(-6,0), gS(-5,0),
           gS(0,-18), gS(-4,-8), gS(2,-14), gS(0,-25), gS(0,-24), gS(0,-6), gS(-6,0), gS(0,0),
           gS(0,-26), gS(-3,-4), gS(-7,-6), gS(-4,0), gS(-7,-9), gS(-8,0), gS(2,-6), gS(0,-28),
           gS(0,-45), gS(-1,-21), gS(-6,-6), gS(-14,0), gS(-10,0), gS(0,-2), gS(0,-9), gS(0,-50),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,14), gS(0,2), gS(0,-3), gS(0,-7), gS(0,-5), gS(0,-8), gS(0,0), gS(0,0),
           gS(2,3), gS(-1,5), gS(-1,3), gS(-5,5), gS(-2,6), gS(-3,10), gS(3,-2), gS(6,3),
           gS(3,32), gS(-1,15), gS(-3,24), gS(-2,20), gS(-5,16), gS(2,20), gS(5,14), gS(7,20),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int ROOK_PSQT_BLACK[64] = {
           gS(28,10), gS(16,19), gS(0,25), gS(0,19), gS(5,19), gS(9,19), gS(22,16), gS(35,13),
           gS(5,14), gS(0,15), gS(16,11), gS(35,3), gS(27,5), gS(24,4), gS(-8,15), gS(6,10),
           gS(1,16), gS(17,8), gS(18,9), gS(25,1), gS(40,-3), gS(32,-1), gS(24,1), gS(-5,13),
           ...
           gS(-20,-9), gS(-5,-11), gS(0,-8), gS(0,-10), gS(11,-16), gS(8,-22), gS(5,-23), gS(-39,-11),
           gS(-5,-12), gS(0,-14), gS(1,-9), gS(11,-20), gS(13,-23), gS(12,-22), gS(-9,-11), gS(-3,-25),
};

const int BISHOP_PSQT_BLACK[64] = {
           gS(-35,-1), gS(-43,-2), gS(-74,16), gS(-81,16), gS(-53,15), gS(-91,13), gS(-26,-6), gS(-28,-16),
           gS(-37,-2), gS(-19,-1), gS(-13,0), gS(-12,9), gS(-12,6), gS(-16,3), gS(-26,-5), gS(-24,-7),
           gS(-4,0), gS(0,0), gS(-2,3), gS(19,-2), gS(12,0), gS(18,-1), gS(3,0), gS(5,-3),
           gS(-7,0), gS(15,5), gS(4,3), gS(22,11), gS(18,12), gS(13,5), gS(13,2), gS(-1,-7),
           gS(4,-5), gS(-4,4), gS(7,6), gS(20,7), gS(23,6), gS(7,5), gS(7,0), gS(5,-14),
           gS(3,-14), gS(19,-4), gS(10,-2), gS(10,6), gS(6,11), gS(21,-7), gS(17,-10), gS(8,-11),
           gS(14,-19), gS(11,-24), gS(15,-10), gS(3,0), gS(13,0), gS(14,-6), gS(20,-21), gS(7,-29),
           gS(-3,-32), gS(6,-5), gS(-2,-2), gS(1,0), gS(6,-4), gS(-12,4), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-164,-55), gS(-31,-3), gS(-81,8), gS(-13,-3), gS(0,-1), gS(-82,2), gS(-29,-4), gS(-90,-64),
           gS(-34,-9), gS(-20,0), gS(-4,0), gS(19,6), gS(8,3), gS(25,-12), gS(-12,-2), gS(-21,-16),
           gS(-10,-1), gS(4,3), gS(9,19), gS(27,6), gS(41,1), gS(45,5), gS(10,-1), gS(13,-13),
           gS(5,-1), gS(13,1), gS(19,15), gS(36,18), gS(24,21), gS(40,13), gS(15,2), gS(23,-10),
           gS(0,0), gS(13,5), gS(20,19), gS(25,17), gS(25,21), gS(31,13), gS(25,1), gS(11,0),
           gS(-8,-22), gS(9,-7), gS(9,5), gS(20,15), gS(23,13), gS(21,1), gS(24,-10), gS(2,-12),
           gS(-7,-27), gS(-11,1), gS(3,-6), gS(5,6), gS(11,4), gS(12,-4), gS(0,0), gS(1,-15),
           gS(-40,-30), gS(-15,-17), gS(0,-5), gS(0,1), gS(7,3), gS(-2,-4), gS(-9,-8), gS(-18,-29),
};

const int QUEEN_PSQT_BLACK[64] = {
           gS(-14,0), gS(0,9), gS(0,7), gS(0,15), gS(-8,23), gS(0,9), gS(-10,16), gS(-13,15),
           gS(-14,2), gS(-29,21), gS(-13,24), gS(-27,43), gS(-41,62), gS(-21,30), gS(-13,28), gS(1,9),
           gS(-11,-15), gS(-1,0), gS(-5,23), gS(0,35), gS(0,42), gS(3,31), gS(6,12), gS(-6,7),
           gS(-4,-16), gS(-4,8), gS(-4,19), gS(-2,40), gS(-5,53), gS(0,32), gS(0,24), gS(4,-4),
           gS(0,-26), gS(-7,0), gS(-1,11), gS(-3,38), gS(3,34), gS(-3,10), gS(8,4), gS(-5,-3),
           gS(-4,-32), gS(9,-23), gS(5,-5), gS(3,0), gS(3,0), gS(8,-4), gS(14,-11), gS(3,-26),
           gS(3,-51), gS(11,-57), gS(18,-56), gS(11,-33), gS(13,-29), gS(20,-63), gS(25,-78), gS(0,-44),
           gS(4,-62), gS(7,-67), gS(5,-74), gS(4,-57), gS(6,-63), gS(-4,-75), gS(0,-61), gS(13,-69),
};
...
const int MATERIAL_VALUES[5] = {
           gS(91,111), gS(515,681), gS(358,378), gS(381,396), gS(1003,1255),
};
