...
const int BISHOP_PAIR_BONUS = gS(31,50);
...
const int MINOR_ATTACKED_BY[4] = {
           gS(0,0), gS(17,33), gS(19,35), gS(15,28),
};
...
const int BISHOP_MOBILITY[14] = {
           gS(-6,-63), gS(2,-24), gS(9,-12), gS(14,-2), gS(17,6), gS(18,9), gS(17,11),
...
const int ROOK_MOBILITY[15] = {
           ...
           gS(9,7), gS(12,12), gS(14,15), gS(16,20), gS(18,22), gS(23,20), gS(28,19),
           gS(50,10),
};
...
const int KING_PSQT_BLACK[64] = {
           ...
           gS(-2,-13), gS(11,13), gS(0,25), gS(-6,35), gS(-7,33), gS(6,24), gS(10,13), gS(-35,-15),
           gS(-14,-24), gS(2,0), gS(-3,16), gS(-16,25), gS(-13,24), gS(-21,18), gS(-1,1), gS(-45,-18),
           gS(-17,-27), gS(11,-6), gS(-11,8), gS(-30,19), gS(-25,18), gS(-22,10), gS(-1,-5), gS(-9,-26),
...
const int PAWN_PSQT_BLACK[64] = {
           ...
           gS(52,69), gS(40,78), gS(37,66), gS(65,53), gS(64,58), gS(49,64), gS(0,85), gS(1,74),
           gS(1,30), gS(8,30), gS(25,12), gS(42,0), gS(44,0), gS(71,6), gS(27,24), gS(26,16),
           gS(-10,14), gS(2,11), gS(7,0), gS(15,-1), gS(22,-2), gS(21,-1), gS(25,1), gS(-1,7),
           gS(-21,3), gS(-20,12), gS(-6,-1), gS(10,-3), gS(10,-5), gS(11,-3), gS(-3,2), gS(-15,-3),
           gS(-23,-3), gS(-18,0), gS(-6,-4), gS(-4,-1), gS(1,-1), gS(2,-3), gS(-1,-7), gS(-18,-9),
           gS(-33,5), gS(-15,5), gS(-14,6), gS(0,6), gS(0,9), gS(2,4), gS(-2,1), gS(-24,-4),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_PSQT_BLACK_IS_ENEMY_QUEEN[64] = {
           ...
           gS(-3,10), gS(-6,16), gS(-8,7), gS(-2,0), gS(-2,2), gS(-6,4), gS(-5,20), gS(-4,13),
...
const int PAWN_PSQT_BLACK_IS_OWN_QUEEN[64] = {
           ...
           gS(0,-3), gS(0,0), gS(-2,-1), gS(0,-17), gS(-1,-14), gS(-2,-8), gS(-9,-3), gS(0,0),
           gS(0,10), gS(0,0), gS(2,-7), gS(0,-10), gS(0,-8), gS(0,-8), gS(0,0), gS(0,-1),
           gS(4,0), gS(0,5), gS(0,3), gS(-4,3), gS(-2,5), gS(-2,9), gS(4,-4), gS(8,0),
           gS(6,25), gS(0,14), gS(-1,21), gS(-1,17), gS(-4,14), gS(4,19), gS(6,14), gS(10,14),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int BISHOP_PSQT_BLACK[64] = {
           ...
           gS(-3,0), gS(1,1), gS(0,4), gS(25,-3), gS(16,0), gS(22,0), gS(8,0), gS(8,-5),
           gS(-7,-2), gS(9,5), gS(4,2), gS(22,9), gS(17,9), gS(13,4), gS(7,0), gS(-1,-10),
           gS(6,-7), gS(-1,3), gS(8,4), gS(19,7), gS(22,4), gS(6,3), gS(8,0), gS(7,-17),
           ...
           gS(-2,-32), gS(8,-7), gS(-1,-2), gS(2,0), gS(7,-4), gS(-11,4), gS(0,-8), gS(-1,-24),
};

const int KNIGHT_PSQT_BLACK[64] = {
           gS(-158,-58), gS(-31,-4), gS(-80,8), gS(-13,-3), gS(0,-1), gS(-78,2), gS(-29,-5), gS(-89,-64),
           gS(-31,-9), gS(-17,0), gS(-1,0), gS(22,5), gS(9,3), gS(30,-12), gS(-11,-1), gS(-17,-16),
           gS(-10,-1), gS(9,2), gS(14,19), gS(31,6), gS(45,0), gS(48,5), gS(15,-1), gS(13,-13),
           gS(5,-1), gS(7,0), gS(16,14), gS(32,15), gS(20,17), gS(35,11), gS(12,-2), gS(23,-10),
...
const int QUEEN_PSQT_BLACK[64] = {
           ...
           gS(-2,-33), gS(11,-24), gS(7,-6), gS(4,0), gS(4,0), gS(9,-6), gS(14,-11), gS(5,-27),
...
const int MATERIAL_VALUES[5] = {
           gS(86,114), gS(507,683), gS(353,376), gS(378,397), gS(1001,1266),
};
