...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(13,2), gS(29,5), gS(34,12), gS(24,16),
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(9,2), gS(6,11), gS(23,6), gS(19,17),
           gS(2,4), gS(13,2), gS(11,4), gS(10,9),
           gS(4,4), gS(13,8), gS(13,4), gS(10,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
