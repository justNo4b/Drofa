...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(12,2), gS(29,5), gS(33,13), gS(23,16),
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(-6,-1), gS(22,14), gS(30,10), gS(31,6),
...
const int BISHOP_OUTPOST_BLACK[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(6,0), gS(6,-1), gS(15,0), gS(12,6),
           gS(7,1), gS(22,1), gS(21,3), gS(32,12),
           gS(17,2), gS(19,2), gS(25,6), gS(25,9),
           gS(6,12), gS(5,6), gS(2,6), gS(9,3),
           gS(-2,0), gS(1,5), gS(-3,1), gS(0,3),
           gS(0,5), gS(-6,4), gS(-2,8), gS(-1,0),
};

const int PAWN_CONNECTED[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,2), gS(0,3), gS(0,0), gS(0,0),
           gS(7,20), gS(14,35), gS(12,25), gS(12,25),
           gS(16,10), gS(15,17), gS(26,20), gS(24,16),
           gS(1,3), gS(11,5), gS(7,11), gS(9,16),
           gS(2,4), gS(2,1), gS(7,6), gS(7,6),
           gS(9,-5), gS(3,2), gS(4,-3), gS(2,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_SUPPORTED[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(3,9), gS(9,9), gS(6,8), gS(6,13),
           gS(19,15), gS(31,16), gS(45,23), gS(50,26),
