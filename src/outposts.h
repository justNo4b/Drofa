...
const int BISHOP_OUTPOST_BLACK[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(6,0), gS(7,0), gS(16,0), gS(14,6),
           gS(7,2), gS(21,2), gS(22,3), gS(35,12),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(0,2), gS(10,5), gS(7,12), gS(10,17),
           gS(3,4), gS(2,0), gS(7,6), gS(7,7),
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(8,2), gS(7,11), gS(25,5), gS(20,16),
           gS(3,3), gS(16,1), gS(11,4), gS(11,8),
           gS(8,1), gS(15,7), gS(14,3), gS(10,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif