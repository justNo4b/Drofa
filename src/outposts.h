...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(13,2), gS(28,5), gS(33,12), gS(24,16),
           gS(19,6), gS(38,9), gS(29,21), gS(34,23),
           gS(14,-1), gS(15,2), gS(28,12), gS(38,8),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(16,7), gS(14,16), gS(27,21), gS(25,18),
           gS(1,2), gS(10,5), gS(7,11), gS(9,17),
