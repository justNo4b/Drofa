...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(20,7), gS(33,7), gS(27,20), gS(31,21),
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(0,0), gS(26,7), gS(25,6), gS(42,4),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           ...
           gS(10,-3), gS(21,6), gS(25,13), gS(43,7),
           gS(4,0), gS(4,1), gS(26,11), gS(27,10),
...
const int BISHOP_OUTPOST_BLACK[32] = {
           ...
           gS(6,2), gS(18,2), gS(23,2), gS(35,11),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(9,26), gS(19,47), gS(16,35), gS(17,35),
           gS(18,7), gS(13,14), gS(27,21), gS(25,17),
           gS(1,2), gS(10,4), gS(7,10), gS(9,16),
           gS(3,3), gS(1,0), gS(6,5), gS(7,6),
           gS(8,-4), gS(3,2), gS(4,-4), gS(1,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(3,5), gS(15,1), gS(10,5), gS(11,9),
           gS(7,3), gS(13,6), gS(13,3), gS(10,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif