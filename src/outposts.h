...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(11,2), gS(28,5), gS(33,13), gS(23,16),
           gS(19,6), gS(38,9), gS(29,21), gS(35,22),
           gS(14,-2), gS(15,2), gS(28,12), gS(37,8),
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(-6,-1), gS(21,14), gS(29,10), gS(30,6),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(7,18), gS(13,32), gS(11,23), gS(11,23),
           gS(15,10), gS(15,18), gS(25,21), gS(24,17),
...
const int PAWN_SUPPORTED[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(3,8), gS(8,8), gS(5,7), gS(5,12),
           gS(19,15), gS(30,16), gS(43,23), gS(48,26),
           gS(9,2), gS(7,11), gS(25,5), gS(19,17),
           gS(3,4), gS(15,1), gS(11,4), gS(11,9),
           gS(6,2), gS(14,7), gS(14,4), gS(11,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif