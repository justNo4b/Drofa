...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(19,7), gS(31,6), gS(24,19), gS(29,19),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           ...
           gS(8,-3), gS(18,5), gS(22,11), gS(40,6),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(18,7), gS(11,14), gS(28,21), gS(24,16),
           gS(1,2), gS(10,3), gS(7,10), gS(9,16),
           gS(2,3), gS(1,0), gS(6,4), gS(7,5),
           gS(8,-5), gS(3,0), gS(4,-5), gS(1,-1),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_SUPPORTED[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(3,15), gS(15,15), gS(13,14), gS(13,20),
           gS(19,15), gS(33,16), gS(49,24), gS(55,25),
           gS(10,5), gS(8,13), gS(27,8), gS(22,18),
           gS(3,5), gS(14,1), gS(10,5), gS(11,10),
