...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(15,2), gS(31,4), gS(34,12), gS(24,17),
           gS(20,7), gS(37,8), gS(29,21), gS(34,22),
           gS(14,-2), gS(16,2), gS(27,12), gS(37,7),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(3,4), gS(2,0), gS(7,5), gS(7,6),
           gS(9,-6), gS(3,2), gS(4,-4), gS(1,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(18,14), gS(32,15), gS(48,22), gS(54,24),
           gS(9,3), gS(10,13), gS(27,6), gS(21,17),
           gS(3,4), gS(16,1), gS(11,4), gS(11,8),
           gS(8,2), gS(16,5), gS(14,3), gS(11,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif