...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(13,4), gS(30,8), gS(26,19), gS(31,21),
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(-2,-2), gS(24,5), gS(25,3), gS(40,4),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           ...
           gS(0,-3), gS(0,0), gS(-8,7), gS(-4,5),
           gS(-5,-2), gS(0,1), gS(-5,1), gS(-9,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(14,17), gS(31,20), gS(53,29), gS(57,32),
           gS(3,11), gS(5,17), gS(24,14), gS(24,22),
           gS(1,3), gS(14,5), gS(14,6), gS(16,11),
