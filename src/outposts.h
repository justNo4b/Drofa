...
const int BISHOP_OUTPOST_BLACK[32] = {
           ...
           gS(7,1), gS(22,1), gS(19,3), gS(30,12),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(15,9), gS(15,18), gS(25,21), gS(25,18),
           gS(1,2), gS(11,5), gS(7,11), gS(10,17),
           gS(2,4), gS(2,1), gS(7,6), gS(8,6),
           gS(8,-3), gS(3,2), gS(5,-3), gS(2,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(19,14), gS(29,16), gS(42,23), gS(46,26),
