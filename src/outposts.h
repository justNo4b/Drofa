...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(16,2), gS(33,3), gS(34,12), gS(24,17),
           gS(19,7), gS(30,6), gS(24,19), gS(28,19),
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(16,19), gS(20,7), gS(3,12),
           gS(-7,-2), gS(23,14), gS(32,10), gS(36,5),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           ...
           gS(8,-4), gS(18,4), gS(22,11), gS(40,6),
           gS(4,-1), gS(4,1), gS(25,10), gS(26,9),
...
const int BISHOP_OUTPOST_BLACK[32] = {
           ...
           gS(0,6), gS(-7,5), gS(-2,6), gS(-2,0),
};

const int PAWN_CONNECTED[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,3), gS(0,6), gS(0,1), gS(0,1),
           gS(9,28), gS(21,52), gS(17,37), gS(19,38),
           gS(19,7), gS(12,13), gS(29,20), gS(25,15),
           gS(1,2), gS(10,3), gS(7,10), gS(10,16),
           gS(2,4), gS(1,0), gS(6,5), gS(7,5),
           gS(8,-5), gS(3,1), gS(4,-6), gS(1,-1),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};

const int PAWN_SUPPORTED[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(4,15), gS(15,15), gS(13,14), gS(13,21),
           gS(18,15), gS(33,16), gS(49,23), gS(55,24),
           gS(10,5), gS(8,14), gS(27,8), gS(21,19),
           gS(3,5), gS(15,2), gS(10,5), gS(11,10),
           gS(6,3), gS(14,6), gS(13,3), gS(10,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif