...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(14,-2), gS(16,2), gS(27,12), gS(36,7),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(9,25), gS(18,44), gS(15,34), gS(16,34),
           gS(17,7), gS(13,14), gS(27,21), gS(25,17),
           gS(0,2), gS(10,4), gS(7,10), gS(10,16),
           gS(3,3), gS(1,0), gS(7,5), gS(7,6),
           gS(9,-5), gS(3,2), gS(4,-4), gS(2,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(18,14), gS(33,15), gS(49,23), gS(54,24),
           gS(9,4), gS(8,12), gS(26,6), gS(21,17),
           gS(4,4), gS(16,1), gS(11,5), gS(11,9),
           gS(8,2), gS(16,4), gS(13,3), gS(10,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif