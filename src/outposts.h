...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(20,7), gS(32,6), gS(26,20), gS(30,20),
           gS(13,-2), gS(16,1), gS(25,11), gS(34,5),
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(0,0), gS(25,7), gS(25,6), gS(42,4),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           ...
           gS(9,-3), gS(20,6), gS(24,12), gS(42,6),
           gS(4,0), gS(4,1), gS(25,10), gS(27,10),
...
const int BISHOP_OUTPOST_BLACK[32] = {
           ...
           gS(6,2), gS(17,2), gS(23,2), gS(35,11),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(9,26), gS(19,48), gS(16,35), gS(17,35),
           gS(18,7), gS(12,13), gS(27,20), gS(25,16),
           gS(1,2), gS(10,3), gS(6,9), gS(9,16),
           gS(2,3), gS(0,0), gS(6,5), gS(6,6),
           gS(7,-3), gS(2,2), gS(5,-4), gS(1,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(9,4), gS(8,13), gS(25,7), gS(20,18),
           gS(2,5), gS(15,2), gS(10,5), gS(11,9),
           gS(6,4), gS(12,7), gS(12,4), gS(9,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif