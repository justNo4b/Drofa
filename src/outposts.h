...
const int KNIGHT_OUTPOST_BLACK[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-12,-14), gS(6,0), gS(5,0), gS(12,0),
           gS(11,-3), gS(25,6), gS(25,13), gS(45,8),
           gS(5,0), gS(4,1), gS(27,11), gS(28,10),
           gS(8,-6), gS(0,1), gS(1,14), gS(0,10),
           gS(0,-6), gS(-1,-1), gS(-12,4), gS(-7,4),
...
const int BISHOP_OUTPOST_BLACK[32] = {
           ...
           gS(7,2), gS(22,2), gS(22,3), gS(35,12),
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(20,15), gS(33,16), gS(48,23), gS(54,24),
           gS(8,2), gS(8,11), gS(25,5), gS(20,17),
           gS(3,4), gS(16,1), gS(11,4), gS(11,9),
           gS(7,2), gS(15,7), gS(14,3), gS(11,9),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif