...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(15,2), gS(32,4), gS(34,12), gS(24,17),
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(15,18), gS(19,7), gS(3,12),
           gS(-6,-2), gS(23,14), gS(31,10), gS(35,6),
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(20,15), gS(32,16), gS(48,23), gS(55,24),
           gS(8,2), gS(7,11), gS(25,5), gS(20,16),
           gS(3,4), gS(16,1), gS(11,4), gS(11,9),
           gS(7,2), gS(15,7), gS(14,3), gS(10,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif