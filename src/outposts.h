...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(11,2), gS(27,5), gS(32,12), gS(22,15),
           gS(19,6), gS(38,9), gS(29,21), gS(34,22),
           gS(14,-1), gS(15,2), gS(27,12), gS(36,8),
           gS(4,-2), gS(0,-2), gS(3,5), gS(11,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(-5,-1), gS(21,14), gS(29,11), gS(29,6),
           gS(0,0), gS(30,8), gS(22,7), gS(41,7),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           ...
           gS(10,-4), gS(26,5), gS(25,13), gS(45,8),
...
const int BISHOP_OUTPOST_BLACK[32] = {
           ...
           gS(17,2), gS(17,2), gS(25,5), gS(23,9),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(1,3), gS(11,5), gS(7,11), gS(9,16),
           gS(2,4), gS(1,1), gS(7,6), gS(7,6),
           gS(8,-3), gS(3,2), gS(4,-2), gS(2,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(9,2), gS(6,11), gS(24,5), gS(19,17),
           gS(3,3), gS(15,1), gS(11,4), gS(11,9),
           gS(6,2), gS(13,7), gS(13,3), gS(11,9),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif