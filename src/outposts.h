...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(18,7), gS(30,6), gS(24,19), gS(29,19),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           ...
           gS(8,-3), gS(18,5), gS(22,11), gS(41,6),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(9,28), gS(20,51), gS(17,37), gS(18,37),
           gS(18,7), gS(14,13), gS(29,19), gS(30,15),
           gS(2,2), gS(8,3), gS(7,11), gS(11,16),
           gS(1,3), gS(1,0), gS(5,5), gS(6,6),
           gS(8,-4), gS(3,0), gS(4,-5), gS(1,-1),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(19,15), gS(34,16), gS(50,24), gS(55,23),
           gS(8,5), gS(7,13), gS(27,7), gS(22,17),
           gS(3,5), gS(12,2), gS(10,5), gS(13,9),
           gS(5,3), gS(14,6), gS(12,3), gS(9,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif