...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(18,7), gS(30,5), gS(24,19), gS(28,20),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(18,7), gS(12,13), gS(28,20), gS(25,16),
           gS(1,2), gS(10,3), gS(7,10), gS(9,16),
           gS(1,3), gS(1,0), gS(6,5), gS(6,5),
           gS(7,-5), gS(3,1), gS(4,-5), gS(1,-1),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(19,15), gS(34,17), gS(50,25), gS(56,25),
           gS(9,5), gS(8,14), gS(26,9), gS(21,20),
           gS(2,5), gS(14,1), gS(10,5), gS(11,10),
           gS(5,2), gS(14,6), gS(13,3), gS(10,10),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif