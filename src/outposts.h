...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(20,7), gS(31,6), gS(25,20), gS(29,20),
           gS(13,-2), gS(16,0), gS(25,11), gS(34,5),
...
const int BISHOP_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(0,0), gS(24,7), gS(25,6), gS(41,4),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           ...
           gS(9,-3), gS(19,5), gS(23,11), gS(41,6),
...
const int BISHOP_OUTPOST_BLACK[32] = {
           ...
           gS(6,2), gS(16,2), gS(23,2), gS(35,10),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(9,26), gS(19,49), gS(16,35), gS(17,35),
           gS(18,7), gS(12,13), gS(27,20), gS(25,15),
...
const int PAWN_SUPPORTED[32] = {
           ...
           gS(9,4), gS(7,13), gS(25,8), gS(20,18),
           gS(2,6), gS(14,2), gS(10,5), gS(11,10),
           gS(6,4), gS(12,7), gS(13,4), gS(9,11),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
};
#endif