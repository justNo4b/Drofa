...
const int KNIGHT_PROT_OUTPOST_BLACK[32] = {
           ...
           gS(15,2), gS(32,2), gS(34,12), gS(24,16),
           gS(19,7), gS(30,6), gS(24,19), gS(28,20),
...
const int KNIGHT_OUTPOST_BLACK[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(-12,-16), gS(8,0), gS(7,0), gS(14,0),
           gS(8,-3), gS(18,4), gS(22,11), gS(41,5),
           gS(4,0), gS(4,1), gS(25,10), gS(26,8),
...
const int PAWN_CONNECTED[32] = {
           ...
           gS(19,7), gS(12,14), gS(28,20), gS(25,16),
           gS(1,2), gS(10,3), gS(7,10), gS(9,15),
...
const int PAWN_SUPPORTED[32] = {
           gS(0,0), gS(0,0), gS(0,0), gS(0,0),
           gS(3,15), gS(15,14), gS(13,13), gS(12,20),
           gS(19,15), gS(34,16), gS(50,24), gS(56,24),
           gS(10,5), gS(8,13), gS(26,8), gS(21,18),
